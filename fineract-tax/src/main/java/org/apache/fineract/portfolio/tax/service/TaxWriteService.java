...
public interface TaxWriteService {

    TaxComponentCreateResponse createTaxComponent(TaxComponentCreateRequest request);

    TaxComponentUpdateResponse updateTaxComponent(TaxComponentUpdateRequest request);

    TaxGroupCreateResponse createTaxGroup(TaxGroupCreateRequest request);

    TaxGroupUpdateResponse updateTaxGroup(TaxGroupUpdateRequest request);
}
