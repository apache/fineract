...
VALUES ('UGX', 2, 'Uganda Shilling', 'USh', 'currency.UGX');
...
(`is_deleted`,
 ...
 `enabled`)
VALUES (0, 1, 'keithwoodlock', 'Keith', 'Woodlock',
...
UPDATE `m_office`
SET `name` = 'CEDA Microfinance Ltd.'
WHERE id = 1;
...
(`parent_id`,
 ...
 `name`,
 `opening_date`)
VALUES (1, '.2.', 2, 'Uganda (Kampala)', '2009-01-01');
...
(`is_loan_officer`,
 ...
 `lastname`,
 `display_name`)
VALUES (1, 1, 'CEDA HO', 'LoanOfficer', 'LoanOfficer, CEDA HO'),
...
VALUES ('UGX', 2, 1000000.000000, 0, 1000000000000.000000, null, 'Kampala Product (with cash accounting)',
