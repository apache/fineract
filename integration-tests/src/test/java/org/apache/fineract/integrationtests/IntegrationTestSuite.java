...
// @Suite
// @SelectPackages({ "org.apache.fineract.integrationtests", "org.apache.fineract.integrationtests.**" })
...
public abstract class IntegrationTestSuite {
    ...
    public static final GenericContainer<?> fineract = new GenericContainer<>("fineract:latest").withNetworkAliases("fineract")
            ...
            .withCommand("java", "-cp", "/app/resources:/app/classes:/app/libs/*", "-Xmx1G", "-Xms1G", "-XshowSettings:vm",
                    ...
                    "org.apache.fineract.ServerApplication", "-Dfile.encoding=UTF-8", "-Duser.timezone=Asia/Kolkata",
