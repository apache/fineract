...
public class LoanImportHandlerTest {
    ...
    public void testLoanImport() throws InterruptedException, IOException, ParseException {
        ...
        firstLoanRow.createCell(LoanConstants.LOAN_COLLATERALS).setCellValue(collaterals.toString());
        ...
        /**
         * TODO: Add Loan Collaterals into the xls file importing since it's a mandatory field. For now integration test
         * won't be creating one. TODO: Change the type to `Imported` after adding array of collaterals into the
         * workbook sheet.
         */
