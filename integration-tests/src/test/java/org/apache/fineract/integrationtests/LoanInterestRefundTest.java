...
public class LoanInterestRefundTest extends BaseLoanIntegrationTest {
    ...
    public void verifyMerchantIssuedRefundPostingForBackdatedLoan() {
        runAt("29 January 2025", () -> {
            ...
            verifyTransactions(loanId, transaction(450.0, "Disbursement", "29 August 2024"),
                    transaction(500.0, "Merchant Issued Refund", "29 January 2025"), transaction(48.94, "Accrual", "29 January 2025"),
