...
public class AccountTransferTest extends FeignSavingsTestBase {
    ...
    public void testTransferWithNegativeAmount() {
        ...
        assertEquals(400,
                accountTransferHelper.createAccountTransferExpectingError(AccountTransferRequestBuilders.transfer(ACCOUNT_TRANSFER_DATE,
                        fixture.clientId, fixture.savingsId, PortfolioAccountType.SAVINGS, fixture.clientId, fixture.loanId,
                        PortfolioAccountType.LOAN, ACCOUNT_TRANSFER_NEGATIVE_AMOUNT)).getStatus());
    }
    ...
    public void testTransferWithInsufficientBalance() {
        ...
        assertEquals(403,
                accountTransferHelper.createAccountTransferExpectingError(AccountTransferRequestBuilders.transfer(ACCOUNT_TRANSFER_DATE,
                        fixture.clientId, fixture.savingsId, PortfolioAccountType.SAVINGS, fixture.clientId, fixture.loanId,
                        PortfolioAccountType.LOAN, ACCOUNT_TRANSFER_LARGE_AMOUNT)).getStatus());
    }

    @Test
    public void testTransferToInvalidAccountTypes() {
        SavingsToLoanFixture fixture = createSavingsToLoanFixture();
        assertEquals(400, accountTransferHelper
                .createAccountTransferExpectingError(
                        AccountTransferRequestBuilders.transfer(ACCOUNT_TRANSFER_DATE, fixture.clientId, fixture.savingsId,
                                INVALID_ACCOUNT_TYPE, fixture.clientId, fixture.loanId, INVALID_ACCOUNT_TYPE, ACCOUNT_TRANSFER_AMOUNT))
                .getStatus());
    }
    ...
    public void testTransferToNonExistentAccount() {
        ...
        assertEquals(404,
                accountTransferHelper.createAccountTransferExpectingError(AccountTransferRequestBuilders.transfer(ACCOUNT_TRANSFER_DATE,
                        fixture.clientId, fixture.savingsId, PortfolioAccountType.SAVINGS, fixture.clientId, INVALID_LOAN_ID,
                        PortfolioAccountType.LOAN, ACCOUNT_TRANSFER_AMOUNT)).getStatus());
    }
    ...
    private Long createActiveLoan(Long clientId) {
        ...
        LoanTestValidators.verifyLoanStatus(loanHelper.getLoanDetails(loanId), status -> Boolean.TRUE.equals(status.getPendingApproval()));
        ...
        LoanTestValidators.verifyLoanStatus(loanHelper.getLoanDetails(loanId), status -> Boolean.FALSE.equals(status.getPendingApproval()));
        ...
        loanHelper.disburseLoan(loanId,
                new PostLoansLoanIdRequest().actualDisbursementDate(LOAN_DISBURSAL_DATE)
                        ...
                        .dateFormat(LoanTestData.DATETIME_PATTERN).locale(LoanTestData.LOCALE));
        LoanTestValidators.verifyLoanStatus(loanHelper.getLoanDetails(loanId), status -> Boolean.TRUE.equals(status.getActive()));
        return loanId;
    }
