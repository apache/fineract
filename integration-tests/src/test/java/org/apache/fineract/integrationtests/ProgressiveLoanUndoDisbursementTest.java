...
public class ProgressiveLoanUndoDisbursementTest extends FeignLoanTestBase {
    ...
    public void testProgressiveLoanUndoDisbursementWithChargeAtDisbursement() {
        ...
        final ChargeCreateResponse disbCharge = chargesHelper.createCharge(new ChargeCreateRequest().active(true).chargeAppliesTo(1)
