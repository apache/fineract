...
public class CurrenciesTest {
    ...
    public void testCreateCurrencyPostApi_CurrencyCodeNotEqualToNull() throws IOException {
        ...
        assertThat(response.code()).isGreaterThanOrEqualTo(400);
    }
    ...
    @Test
    public void testCreateCurrencyPostApi_DecimalPlacesNotNull() throws IOException {
        CurrencyCreateRequest createCurrencyData = new CurrencyCreateRequest().code("XYZ").decimalPlaces(null).displaySymbol("¤")
                .inMultiplesOf(1).name("XYZ Token");
    ...
    @Test
    public void testCreateCurrencyPostApi_InMultiplesOfGreaterThanZero() throws IOException {
        CurrencyCreateRequest createCurrencyData = new CurrencyCreateRequest().code("XYZ").decimalPlaces(2).displaySymbol("¤")
                .inMultiplesOf(1).name("XYZ Token");
