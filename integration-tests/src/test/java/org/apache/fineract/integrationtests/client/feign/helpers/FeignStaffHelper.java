...
/**
 * Typed Feign helper for staff (organisation) operations. Standalone by design: nothing here is added to
 * {@code FeignLoanTestBase} (see FEIGN_BASE_MODULARIZATION.md). Fully typed via the generated {@code StaffApi} /
 * {@code StaffCreateRequest} model.
 */
