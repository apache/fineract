...
import org.apache.fineract.client.models.NoteResponse;
...
public final class NotesHelper {
    ...
    public static NoteResponse retrieveSavingsNote(RequestSpecification requestSpec, ResponseSpecification responseSpec, Integer savingsId,
            Integer noteId) {
        ...
        return GSON.fromJson(response, NoteResponse.class);
    }
