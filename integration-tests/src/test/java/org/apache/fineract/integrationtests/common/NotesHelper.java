...
public final class NotesHelper {
    ...
    // org.apache.fineract.client.models.PostLoansLoanIdRequest)
    @Deprecated(forRemoval = true)
    public static CreateNoteResponse createSavingsNote(RequestSpecification requestSpec, ResponseSpecification responseSpec,
        ...
        return GSON.fromJson(response, CreateNoteResponse.class);
    }
