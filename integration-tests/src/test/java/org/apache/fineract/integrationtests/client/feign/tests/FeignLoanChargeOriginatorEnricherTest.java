...
public class FeignLoanChargeOriginatorEnricherTest extends FeignIntegrationTest {
    ...
    public void testLoanAddChargeEventContainsOriginators() {
        ...
        try {
            ...
            @SuppressWarnings("unchecked") final List<Map<String, Object>> originatorList = (List<Map<String, Object>>) originators;
    ...
    public void testLoanAddChargeEventContainsMultipleOriginators() {
        ...
        try {
            ...
            @SuppressWarnings("unchecked") final List<Map<String, Object>> originatorList = (List<Map<String, Object>>) event.getPayLoad().get("originators");
