...
public class LoanChargeSpecificDueDateTest extends FeignLoanTestBase {
    ...
    public void testApplyLoanSpecificDueDateFeeWithDisbursementDate() {
        ...
        addChargesForLoan(loanId, specifiedDueDateCharge(loanChargeId, operationDate, 10.0));
    ...
    public void testApplyAndWaiveLoanSpecificDueDatePenaltyWithDisbursementDate() {
        ...
        final Long loanChargeId = addChargesForLoan(loanId, specifiedDueDateCharge(chargeId, operationDate, 10.0)).getResourceId();
        assertNotNull(loanChargeId);
    ...
    public void testApplyFeeAccrualOnClosedDate() {
        try {
            ...
            final Long loanChargeId01 = addChargesForLoan(loanId, specifiedDueDateCharge(chargeId, operationDate, 10.0)).getResourceId();
            ...
            updateBusinessDate(Utils.dateFormatter.format(transactionDate));
            operationDate = Utils.dateFormatter.format(transactionDate);
            final Long loanChargeId02 = addChargesForLoan(loanId, specifiedDueDateCharge(chargeId, operationDate, 15.0)).getResourceId();
            ...
            updateBusinessDate(Utils.dateFormatter.format(transactionDate));
            operationDate = Utils.dateFormatter.format(transactionDate);
            final Long loanChargeId03 = addChargesForLoan(loanId, specifiedDueDateCharge(chargeId, operationDate, 25.0)).getResourceId();
    ...
    private static ChargeRequest installmentFee() {
        return ChargeRequestBuilders.loanInstallmentFee(1.5).chargeCalculationType(CHARGE_CALCULATION_TYPE_PERCENTAGE_AMOUNT_AND_INTEREST)
                .penalty(false);
    }

    private PostLoansLoanIdChargesRequest specifiedDueDateCharge(Long chargeId, String dueDate, double amount) {
