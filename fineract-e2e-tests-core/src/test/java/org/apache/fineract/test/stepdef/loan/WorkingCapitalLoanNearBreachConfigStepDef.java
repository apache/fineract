...
public class WorkingCapitalLoanNearBreachConfigStepDef extends AbstractStepDef {
    ...
    public void adminCreatesWCNearBreachWithValues() {
        final WorkingCapitalLoanNearBreachRequest request = workingCapitalRequestFactory.defaultWorkingCapitalLoanNearBreachRequest();
        final CommandProcessingResult response = ok(
                () -> fineractFeignClient.workingCapitalNearBreaches().createWorkingCapitalLoanNearBreach(request));
    ...
    public void checkCreatedNearBreachHasTheFollowingValues() {
        ...
        final WorkingCapitalLoanNearBreachData data = ok(
                () -> fineractFeignClient.workingCapitalNearBreaches().retrieveWorkingCapitalLoanNearBreach(id));
        final WorkingCapitalLoanNearBreachRequest request = TestContext.INSTANCE
    ...
    public void createWCBreachWithInvalidDataFailed(final String fieldName, final String value, final String errorMessage) {
        final WorkingCapitalLoanNearBreachRequest request = setWCNearBreachFieldValue(
                workingCapitalRequestFactory.defaultWorkingCapitalLoanNearBreachRequest(), fieldName, value);
    ...
    public void adminCreatesWCNearBreachWithValuesForUpdate() {
        final WorkingCapitalLoanNearBreachRequest request = workingCapitalRequestFactory.defaultWorkingCapitalLoanNearBreachRequest()
                ...
                .nearBreachFrequencyType(WorkingCapitalLoanBreachFrequencyType.YEARS.getCode()) //
    ...
    public void adminCreateWCNearBreachWithDuplicateNameFailure() {
        ...
        WorkingCapitalLoanNearBreachRequest nearBreachRequestForUpdate = TestContext.INSTANCE
        ...
        WorkingCapitalLoanNearBreachRequest breachRequest = workingCapitalRequestFactory.defaultWorkingCapitalLoanNearBreachRequest()
                .nearBreachName(name); //
    ...
    public void adminModifiesWCBreachWithValues() {
        ...
        ok(() -> fineractFeignClient.workingCapitalNearBreaches().updateWorkingCapitalLoanNearBreach(id, request));
    ...
    public void checkUpdatedBreachHasTheFollowingValues() {
        ...
        final WorkingCapitalLoanNearBreachData data = ok(
                () -> fineractFeignClient.workingCapitalNearBreaches().retrieveWorkingCapitalLoanNearBreach(id));
        final WorkingCapitalLoanNearBreachRequest request = TestContext.INSTANCE
                .get(TestContextKey.WORKING_CAPITAL_NEAR_BREACH_UPDATE_REQUEST);
        checkNearBreachData(request, data);
    }
    ...
    public void adminUpdateWCBreachWithDuplicateNameFailure() {
        ...
        WorkingCapitalLoanNearBreachRequest nearBreachRequestForUpdate = TestContext.INSTANCE
                .get(TestContextKey.WORKING_CAPITAL_NEAR_BREACH_CREATE_REQUEST);
        String name = nearBreachRequestForUpdate.getNearBreachName();
        WorkingCapitalLoanNearBreachRequest nearBreachRequest = workingCapitalRequestFactory.defaultWorkingCapitalLoanNearBreachRequest() //
                .nearBreachName(name); //
    ...
    public void adminDeletesWCNearBreachWithValues() {
        final Long id = TestContext.INSTANCE.get(TestContextKey.WORKING_CAPITAL_NEAR_BREACH_ID);
        ok(() -> fineractFeignClient.workingCapitalNearBreaches().deleteWorkingCapitalLoanNearBreach(id));
    }
    ...
    public void adminDeleteWCBreachAssignedToWCLPFailure() {
        ...
        final CallFailedRuntimeException exception = fail(
                () -> fineractFeignClient.workingCapitalNearBreaches().deleteWorkingCapitalLoanNearBreach(id));
        assertThat(exception.getStatus()).isEqualTo(403);
        assertThat(exception.getMessage()).contains(errorMessage);
    }

    private void checkNearBreachData(final WorkingCapitalLoanNearBreachRequest request, final WorkingCapitalLoanNearBreachData response) {
    ...
    private WorkingCapitalLoanNearBreachRequest setWCNearBreachFieldValue(final WorkingCapitalLoanNearBreachRequest request,
    ...
    private void checkCreateWCNearBreachWithInvalidDataFailure(final WorkingCapitalLoanNearBreachRequest request, final String errorMessage,
            final int errorCode) {
        final CallFailedRuntimeException exception = fail(
                () -> fineractFeignClient.workingCapitalNearBreaches().createWorkingCapitalLoanNearBreach(request));
    ...
    private void checkUpdateWCNearBreachWithInvalidDataFailure(final Long id, final WorkingCapitalLoanNearBreachRequest request,
            final String errorMessage, final int errorCode) {
        final CallFailedRuntimeException exception = fail(
                () -> fineractFeignClient.workingCapitalNearBreaches().updateWorkingCapitalLoanNearBreach(id, request));
        assertThat(exception.getStatus()).as(ErrorMessageHelper.incorrectExpectedValueInResponse()).isEqualTo(errorCode);
        assertThat(exception.getDeveloperMessage()).contains(errorMessage);
    }
