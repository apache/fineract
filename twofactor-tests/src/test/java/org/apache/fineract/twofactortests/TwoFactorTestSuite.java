...
@Suite
@SelectPackages({ "org.apache.fineract.twofactortests" })
@SuiteDisplayName("Fineract 2FA Test Suite")
@SuppressWarnings({ "HideUtilityClassConstructor" })
public class TwoFactorTestSuite {

    private static final Logger log = LoggerFactory.getLogger(TwoFactorTestSuite.class);
    ...
    public static final GenericContainer<?> fineract = new GenericContainer<>("fineract:latest").withNetworkAliases("fineract")
            ...
            .withEnv("FINERACT_DEFAULT_TENANTDB_CONN_PARAMS", "").withEnv("FINERACT_SECURITY_BASICAUTH_ENABLED", "true")
            .withEnv("FINERACT_SECURITY_2FA_ENABLED", "true")
