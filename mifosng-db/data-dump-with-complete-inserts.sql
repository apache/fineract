...
INSERT INTO `admin_appuser_role` (`appuser_id`, `role_id`) VALUES (1,1),(2,1),(3,5),(4,2),(5,3),(6,4),(7,1),(8,1);
...
INSERT INTO `admin_role_permission` (`role_id`, `permission_id`) VALUES (1,1),(1,2),(1,3),(1,4),(2,4),(2,5),(2,6),(2,13),(2,20),(3,3),(4,4),(4,7),(4,8),(4,9),(4,10),(4,11),(4,12),(5,3),(5,4);
...
INSERT INTO `org_office` (`id`, `parent_id`, `hierarchy`, `external_id`, `name`, `opening_date`, `createdby_id`, `created_date`, `lastmodified_date`, `lastmodifiedby_id`) VALUES (1,NULL,'.','1','CreoCore USA','2009-01-01',NULL,NULL,'2012-07-13 17:04:20',1),(2,1,'.2.','2','sub branch 1','2012-01-02',1,'2012-04-14 05:42:40','2012-04-16 11:47:05',1),(3,1,'.3.','3','sub branch 2','2012-03-01',1,'2012-04-16 04:12:02','2012-04-16 11:47:14',1),(4,1,'.4.',NULL,'sub branch 3','2012-04-17',1,'2012-04-17 06:01:10','2012-04-17 06:01:10',1),(5,1,'.5.',NULL,'Majmoua','2012-04-18',2,'2012-04-18 18:29:01','2012-04-18 18:29:01',2),(6,1,'.6.',NULL,'Intrasoft Technologies','2012-04-01',2,'2012-04-21 07:05:41','2012-04-21 07:05:41',2),(7,1,'.7.',NULL,'Hugo technologies','2010-05-01',1,'2012-05-01 22:44:53','2012-05-01 22:44:53',1);
...
INSERT INTO `portfolio_loan_extra_additional information` (`id`, `Business Location`, `Business Location Other`, `Business`, `Business Description`, `Business Title`) VALUES (4,NULL,NULL,'New',NULL,NULL),(5,NULL,NULL,'New',NULL,NULL),(14,'North Sikkim',NULL,'New',NULL,NULL),(18,'West Sikkim',NULL,NULL,NULL,NULL),(27,NULL,NULL,'New',NULL,NULL),(40,'North Sikkim',NULL,'Existing','we grow vegtables and sell in local markets at a profit.','North sikkim vegtable co-op');
...
INSERT INTO `portfolio_office_transaction` (`id`, `from_office_id`, `to_office_id`, `currency_code`, `currency_digits`, `transaction_amount`, `transaction_date`, `description`, `created_date`, `createdby_id`, `lastmodified_date`, `lastmodifiedby_id`) VALUES (1,NULL,1,'USD',2,'100000.000000','2011-09-01',NULL,'2012-07-16 17:00:24',1,'2012-07-16 17:00:24',1),(2,1,2,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:01:37',1,'2012-07-16 17:01:37',1),(3,1,1,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:09:42',1,'2012-07-16 17:09:42',1),(4,1,1,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:11:02',1,'2012-07-16 17:11:02',1),(5,1,1,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:12:46',1,'2012-07-16 17:12:46',1),(6,1,1,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:13:54',1,'2012-07-16 17:13:54',1),(7,1,1,'USD',2,'1000.000000','2011-09-17',NULL,'2012-07-16 17:14:31',1,'2012-07-16 17:14:31',1);
...
INSERT INTO `ref_loan_status` (`id`, `display_name`) VALUES (100,'Submitted and awaiting approval'),(200,'Approved'),(300,'Active'),(400,'Withdrawn by client'),(500,'Rejected'),(600,'Closed');
...
INSERT INTO `stretchy_report_parameter` (`report_id`, `parameter_id`, `report_parameter_name`) VALUES (29,5,NULL),(30,5,NULL),(31,5,NULL),(32,5,NULL),(32,6,NULL),(34,5,NULL),(34,6,NULL),(35,5,NULL),(35,6,NULL),(38,5,NULL),(38,6,NULL),(39,5,NULL),(39,7,NULL),(40,5,NULL),(40,7,NULL),(41,5,NULL),(42,5,NULL),(43,5,NULL);
...
INSERT INTO `stretchydata_allowed_list` (`id`, `name`) VALUES (2,'Business'),(8,'Education'),(3,'Ethnic Group'),(7,'Football Team'),(4,'Gender'),(5,'Knowledge of Person'),(1,'Location'),(6,'Religion');
...
INSERT INTO `stretchydata_dataset` (`id`, `name`, `datasettype_id`) VALUES (1,'Additional Information',1),(9,'Highly Improbable Info',1),(8,'Additional Information',2);
...
INSERT INTO `stretchydata_datasettype` (`id`, `name`) VALUES (1,'portfolio_client'),(2,'portfolio_loan');
...
-- Dump completed on 2012-07-16 21:42:57
