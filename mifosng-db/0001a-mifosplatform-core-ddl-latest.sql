...
CREATE TABLE `m_loan` (
  ...
  `principal_repaid_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `principal_writtenoff_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_repaid_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_waived_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_writtenoff_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_repaid_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_waived_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_writtenoff_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_repaid_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_waived_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_writtenoff_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `principal_outstanding_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_outstanding_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_outstanding_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_outstanding_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `principal_overdue_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `interest_overdue_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `fee_charges_overdue_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `penalty_charges_overdue_derived` DECIMAL(19,6) NOT NULL DEFAULT 0.0,
  `first_overdue_installment_date_derived` DATE NULL,
  `createdby_id` bigint(20) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `lastmodified_date` datetime DEFAULT NULL,
  `lastmodifiedby_id` bigint(20) DEFAULT NULL,
