...
public class NoteCreateHandler implements CommandHandler<NoteCreateRequest, NoteCreateResponse> {
    ...
    public NoteCreateResponse handle(Command<NoteCreateRequest> command) {
        return this.writePlatformService.createNote(command.getPayload());
    }
}
