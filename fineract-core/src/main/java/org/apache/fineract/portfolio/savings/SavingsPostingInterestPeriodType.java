...
public enum SavingsPostingInterestPeriodType {
    ...
    BIANNUAL(6, "savingsPostingInterestPeriodType.biannual"), ANNUAL(7, "savingsPostingInterestPeriodType.annual"), ACTIVATIONDATE(8,
            "savingsPostingInterestPeriodType.activationDate");
