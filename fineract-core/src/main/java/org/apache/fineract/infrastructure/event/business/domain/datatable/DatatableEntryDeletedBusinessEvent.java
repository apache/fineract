...
public class DatatableEntryDeletedBusinessEvent extends DatatableEntryBusinessEvent implements NoExternalEvent {

    public static final String TYPE = "DatatableEntryDeletedBusinessEvent";

    public DatatableEntryDeletedBusinessEvent(final DatatableEntryDetails datatableEntryDetails) {
