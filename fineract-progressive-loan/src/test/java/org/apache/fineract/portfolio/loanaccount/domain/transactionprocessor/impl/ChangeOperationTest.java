...
public class ChangeOperationTest {
    ...
    private static final MockedStatic<DateUtils> dateUtils = Mockito.mockStatic(DateUtils.class);

    @BeforeAll
    public static void init() {
        dateUtils.when(() -> DateUtils.getOffsetDateTimeOfTenantFromLocalDate(LocalDate.parse("2023-10-17")))
                .thenReturn(OffsetDateTime.parse("2023-10-17T00:00:00+01:00"));
    }
