...
public class ProgressiveLoanModelProcessingServiceWrapper {

    private final ProgressiveLoanModelProcessingService modelProcessingService;
    private final InterestScheduleModelRepositoryWrapper modelRepositoryWrapper;

    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public void recalculateModelAndSave(Loan loan) {
