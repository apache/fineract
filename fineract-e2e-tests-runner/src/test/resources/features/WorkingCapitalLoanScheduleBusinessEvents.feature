...
Feature: Working Capital Loan Schedule Business Events
  ...
  Scenario: Working Capital loan raises Delinquency Pause, Resume, Disable and Enable business events on the matching delinquency actions
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin initiate a Working Capital loan delinquency resume with startDate "04 January 2026"
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin initiate a Working Capital loan delinquency enable with startDate "06 January 2026"
  ...
  Scenario: Working Capital loan raises Breach Pause, Resume, Disable and Enable business events on the matching breach actions
    ...
    When Admin sets the business date to "06 January 2026"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin initiate a Working Capital loan breach enable with startDate "06 January 2026"
