...
public interface ExternalAssetOwnerLoanProductAttributesMapper {

    @Mapping(target = "attributeId", source = "id")
    ExternalTransferLoanProductAttributesData mapLoanProductAttributes(ExternalAssetOwnerLoanProductAttributes attributes);
}
