...
public interface ExternalAssetOwnerReadMapper {

    ExternalTransferResponse toTransferResponse(ExternalTransferData source);

    ExternalOwnerTransferJournalEntryResponse toTransferJournalEntryResponse(ExternalOwnerTransferJournalEntryData source);

    ExternalOwnerJournalEntryResponse toOwnerJournalEntryResponse(ExternalOwnerJournalEntryData source);
