...
public class CancelTransactionFromExternalAssetOwnerHandler
        implements CommandHandler<ExternalAssetOwnerCancelRequest, ExternalAssetOwnerTransferResponse> {

    private final ExternalAssetOwnersWriteService externalAssetOwnersWriteService;

    @Retry(name = "commandExternalAssetOwnerCancel", fallbackMethod = "fallback")
    @Override
    @Transactional
    public ExternalAssetOwnerTransferResponse handle(Command<ExternalAssetOwnerCancelRequest> command) {
        return externalAssetOwnersWriteService.cancelTransfer(command.getPayload());
    }

    @Override
    public ExternalAssetOwnerTransferResponse fallback(Command<ExternalAssetOwnerCancelRequest> command, Throwable t) {
