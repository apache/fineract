...
@NoArgsConstructor
@AllArgsConstructor
public class ExternalAssetOwnerIntermediarySaleRequest implements Serializable {
    ...
    @NotBlank(message = "{org.apache.fineract.investor.transfer.owner-external-id.not-blank}")
    @Size(max = 100, message = "{org.apache.fineract.investor.transfer.owner-external-id.size}")
    private String ownerExternalId;

    @NotBlank(message = "{org.apache.fineract.investor.transfer.purchase-price-ratio.not-blank}")
