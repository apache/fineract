...
public class BuybackLoanFromExternalAssetOwnerHandler
        implements CommandHandler<ExternalAssetOwnerBuybackRequest, ExternalAssetOwnerTransferResponse> {

    private final ExternalAssetOwnersWriteService externalAssetOwnersWriteService;

    @Retry(name = "commandExternalAssetOwnerBuyback", fallbackMethod = "fallback")
    @Override
    @Transactional
    public ExternalAssetOwnerTransferResponse handle(Command<ExternalAssetOwnerBuybackRequest> command) {
        return externalAssetOwnersWriteService.buybackLoan(command.getPayload());
    }

    @Override
    public ExternalAssetOwnerTransferResponse fallback(Command<ExternalAssetOwnerBuybackRequest> command, Throwable t) {
