...
Current Apache Fineract development is focused on Fineract 1.x in this repository.
Fineract1.x, prior to its donation to Apache, was called mifosX and by design consists of a "headless" solution focused on APIs.
