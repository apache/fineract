 ...
 * read/written through the public API of the {@link SavingsAccount} entity, while the stateless {@link SavingsHelper}
 * collaborator is injected here (rather than read off the entity's transient fields) to keep that dependency out of the
 * domain entity.
 */
