...
public class SavingsSchedularInterestPoster {
        ...
        for (SavingsAccountData savingsAccountData : savingsAccountDataList) {
            ...
            for (SavingsAccountTransactionData savingsAccountTransactionData : savingsAccountTransactionDataList) {
                if (savingsAccountTransactionData.getId() == null) {
                    ...
                    /*
                     * if (MathUtil.isLessThanZero(savingsAccountTransactionData.getRunningBalance()) &&
                     * isNegativeBalance && (savingsAccountTransactionData.getFlagValidationInterest() &&
                     * savingsAccountTransactionData.getFlagValidationOverdraft())) {
                     * paramsForGLInsertion.addAll(accuntNegative(savingsAccountData,
                     * userId,savingsAccountTransactionData,key,savingsAccountTransactionDataHashMap)); }else{
                     */
    ...
    public List<Object[]> accuntNegative(SavingsAccountData savingsAccountData, Long userId,
            SavingsAccountTransactionData savingsAccountTransactionData, final String key,
            final HashMap<String, SavingsAccountTransactionData> savingsAccountTransactionDataHashMap) {
        ...
        paramsForGLInsertion.add(new Object[] { savingsAccountData.getGlAccountIdForInterestReceivablePositiveInterestNegative(),
                ...
                JournalEntryType.CREDIT.getValue().longValue(), savingsAccountData.getInterestPosting(), null,
        ...
        paramsForGLInsertion.add(new Object[] { savingsAccountData.getGlAccountIdForSavingsControlAcountPositiveInterestNegative(),
                ...
                savingsAccountData.getInterestPosting(), null, JournalEntryType.DEBIT.getValue().longValue(), savingsAccountData.getId(),
        ...
        paramsForGLInsertion.add(new Object[] { savingsAccountData.getGlAccountIdForInterestReceivablePositiveInterestNegative(),
                ...
                SAVINGS_TRANSACTION_IDENTIFIER + savingsAccountTransactionData.getId().toString(), savingsAccountTransactionData.getId(),
                null, false, null, false, savingsAccountTransactionData.getTransactionDate(),
                JournalEntryType.CREDIT.getValue().longValue(), amountCreditsecond.abs(), null,
                JournalEntryType.CREDIT.getValue().longValue(), savingsAccountData.getId(), auditDatetime, auditDatetime, false,
                BigDecimal.ZERO, BigDecimal.ZERO, null, savingsAccountTransactionData.getTransactionDate(), null, userId, userId,
                DateUtils.getBusinessLocalDate() });
        ...
        paramsForGLInsertion.add(new Object[] { savingsAccountData.getGlAccountIdForOverdraftPorfolioNegative(),
                ...
                SAVINGS_TRANSACTION_IDENTIFIER + savingsAccountTransactionData.getId().toString(), savingsAccountTransactionData.getId(),
                null, false, null, false, savingsAccountTransactionData.getTransactionDate(), JournalEntryType.DEBIT.getValue().longValue(),
                amountCreditsecond.abs(), null, JournalEntryType.DEBIT.getValue().longValue(), savingsAccountData.getId(), auditDatetime,
                auditDatetime, false, BigDecimal.ZERO, BigDecimal.ZERO, null, savingsAccountTransactionData.getTransactionDate(), null,
                userId, userId, DateUtils.getBusinessLocalDate() });
