...
public interface CashierSessionReadPlatformService {
    ...
    Optional<CashierSessionData> findActiveSession(Long cashierId, Long tellerId);

    List<CashierSessionData> findAllSessions(Long cashierId, Long tellerId);

    CashierSessionData findSessionById(Long sessionId);

    CashierSessionSummaryData getSessionSummary(Long sessionId);

    Optional<CashierSessionData> findActiveSessionForUser(Long userId, Long officeId);

    List<CashierSessionData> findOpenSessionsByOffice(Long officeId);
}
