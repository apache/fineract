...
public abstract class WorkingCapitalLoanTransactionBusinessEvent extends AbstractBusinessEvent<WorkingCapitalLoanTransaction> {
    ...
    public WorkingCapitalLoanTransactionBusinessEvent(final WorkingCapitalLoanTransaction value) {
        super(value);
        this.aggregateRootId = value != null && value.getWcLoan() != null ? value.getWcLoan().getId() : null;
    }

    public WorkingCapitalLoanTransactionBusinessEvent(final WorkingCapitalLoanTransaction value, final Long aggregateRootId) {
        super(value);
