...
@Service
public class WorkingCapitalLoanAccountLockServiceImpl extends AbstractAccountLockService<WorkingCapitalLoanAccountLock> {

    public WorkingCapitalLoanAccountLockServiceImpl(final AccountLockRepository<WorkingCapitalLoanAccountLock> loanAccountLockRepository,
