...
public class StateTransitionWorkingCapitalLoanByExternalIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        final String loanExternalId = pathParameters.get(2).substring(0, pathParameters.get(2).indexOf("?"));
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanApiResource.stateTransitionByExternalId(loanExternalId,
