...
/**
 * Batches a breach action on a working capital loan identified by its id.
 *
 * <p>
...
public class CreateWorkingCapitalLoanBreachActionCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") final UriInfo uriInfo) {
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanBreachActionApiResource.createBreachAction(loanId,
                request.getBody());
