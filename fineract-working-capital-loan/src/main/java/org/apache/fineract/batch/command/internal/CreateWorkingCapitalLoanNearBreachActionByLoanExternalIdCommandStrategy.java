...
/**
 * Batches a near breach action on a working capital loan identified by its external id.
 *
 * <p>
...
public class CreateWorkingCapitalLoanNearBreachActionByLoanExternalIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") final UriInfo uriInfo) {
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanNearBreachActionApiResource
                .createNearBreachActionByExternalId(loanExternalId, request.getBody());
