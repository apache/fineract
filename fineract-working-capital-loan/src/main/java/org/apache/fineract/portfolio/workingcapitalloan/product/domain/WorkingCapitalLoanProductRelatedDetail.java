...
public class WorkingCapitalLoanProductRelatedDetail {
    ...
    private WorkingCapitalLoanAmortizationType amortizationType;
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "breach_start_type", nullable = false)
    private WorkingCapitalLoanBreachStartType breachStartType;
}
