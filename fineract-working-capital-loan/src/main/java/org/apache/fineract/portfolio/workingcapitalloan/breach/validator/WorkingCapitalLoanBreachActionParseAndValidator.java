...
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.ACTION;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.DATE_FORMAT;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.END_DATE;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.FREQUENCY;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.FREQUENCY_TYPE;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.LOCALE;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.MINIMUM_PAYMENT;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.MINIMUM_PAYMENT_TYPE;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.RESTART_PERIOD_FROM_RESET_DATE;
import static org.apache.fineract.portfolio.workingcapitalloan.breach.validator.WorkingCapitalLoanBreachActionParameters.START_DATE;
...
import org.apache.fineract.portfolio.workingcapitalloan.breach.service.WorkingCapitalLoanActiveBreachResetResolver;
...
public class WorkingCapitalLoanBreachActionParseAndValidator extends ParseAndValidator {
    ...
    private WorkingCapitalLoanBreachAmountCalculationType extractMinimumPaymentType(final JsonElement json,
            final DataValidatorBuilder dataValidator) {
        ...
        try {
            return WorkingCapitalLoanBreachAmountCalculationType.valueOf(value.toUpperCase(Locale.ROOT));
