...
@CommandType(entity = CommandWrapperConstants.ENTITY_WORKINGCAPITALLOANCHARGE, action = CommandWrapperConstants.ACTION_WAIVE)
public class WorkingCapitalLoanChargeWaiverCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writePlatformService.waiveLoanCharge(command.getLoanId(), command.entityId(), command);
    }
}
