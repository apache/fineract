...
import org.apache.fineract.portfolio.workingcapitalloan.breach.data.WorkingCapitalLoanBreachScheduleData;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreach;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachAction;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachActionType;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachPauseUtils;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachSchedule;
import org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachScheduleEvaluationUtils;
import org.apache.fineract.portfolio.workingcapitalloan.breach.mapper.WorkingCapitalLoanBreachScheduleMapper;
import org.apache.fineract.portfolio.workingcapitalloan.breach.repository.WorkingCapitalLoanBreachActionRepository;
import org.apache.fineract.portfolio.workingcapitalloan.breach.repository.WorkingCapitalLoanBreachScheduleRepository;
import org.apache.fineract.portfolio.workingcapitalloan.loan.domain.WorkingCapitalLoan;
import org.apache.fineract.portfolio.workingcapitalloan.loan.domain.WorkingCapitalLoanBalance;
import org.apache.fineract.portfolio.workingcapitalloan.loan.domain.WorkingCapitalLoanPausePeriod;
import org.apache.fineract.portfolio.workingcapitalloan.loan.domain.WorkingCapitalLoanPausePeriodUtils;
import org.apache.fineract.portfolio.workingcapitalloan.loan.domain.WorkingCapitalLoanPeriodBounds;
...
import org.apache.fineract.portfolio.workingcapitalloan.loan.repository.WorkingCapitalLoanBalanceRepository;
...
import org.apache.fineract.portfolio.workingcapitalloan.transaction.data.TransactionDateAndAmountHolder;
import org.apache.fineract.portfolio.workingcapitalloan.transaction.repository.WorkingCapitalLoanTransactionRepository;
...
public class WorkingCapitalLoanBreachScheduleServiceImpl implements WorkingCapitalLoanBreachScheduleService {
    ...
    public void generateInitialPeriod(final WorkingCapitalLoan loan) {
        final Optional<WorkingCapitalLoanBreach> breachOpt = getBreachConfig(loan);
    ...
    private Optional<WorkingCapitalLoanBreach> getBreachConfig(final WorkingCapitalLoan loan) {
    ...
    private BigDecimal calculateMinPaymentAmount(final WorkingCapitalLoan loan, final EffectiveBreachRescheduleParams params) {
        ...
        if (WorkingCapitalLoanBreachAmountCalculationType.FLAT.equals(params.minimumPaymentType())) {
            return breachAmount;
        }
    ...
    private EffectiveBreachRescheduleParams resolveEffectiveRescheduleParams(final Long loanId, final WorkingCapitalLoanBreach breach) {
        ...
        return new EffectiveBreachRescheduleParams(
                ...
                latestWithPayment.map(WorkingCapitalLoanBreachAction::getMinimumPaymentType)
                        ...
                        .orElse(WorkingCapitalLoanBreachAmountCalculationType.PERCENTAGE),
