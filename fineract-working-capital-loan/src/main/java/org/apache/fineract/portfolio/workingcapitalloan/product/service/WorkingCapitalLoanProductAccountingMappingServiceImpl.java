...
public class WorkingCapitalLoanProductAccountingMappingServiceImpl implements WorkingCapitalLoanProductAccountingMappingService {
    ...
    public void createAccountMapping(final Long wcLoanProductId, final JsonCommand command) {
        ...
        final WorkingCapitalLoanAccountingRuleType accountingRuleType = WorkingCapitalLoanAccountingRuleType.valueOf(accountingRuleValue);
    ...
    public Map<String, Object> updateAccountMapping(final Long wcLoanProductId, final JsonCommand command,
            final boolean accountingRuleChanged, final WorkingCapitalLoanAccountingRuleType accountingRuleType) {
    ...
    public Map<String, GLAccountData> fetchAccountMappingDetails(final Long wcLoanProductId,
            final WorkingCapitalLoanAccountingRuleType accountingRuleType) {
