...
public final class TvmFunctions {
    ...
    /**
     * Compounds a periodic rate across a year: {@code (1 + periodicRate)^periodsPerYear − 1}.
     *
     * @param periodicRate
     *            the per-period rate to compound
     ...
     *
     * @param annualRate
     *            the annual rate to spread back across the year (as a decimal, not a percentage)
     * @param periodsPerYear
     *            number of periods in a year, i.e. the day-count convention
     * @param mc
     *            math context for precision
