...
import org.apache.fineract.portfolio.workingcapitalloan.loan.mapper.WorkingCapitalLoanPaymentAllocationMapper;
...
public class WorkingCapitalLoanAssemblerImpl implements WorkingCapitalLoanAssembler {
    ...
    private final WorkingCapitalLoanAdvancedPaymentAllocationsJsonParser paymentAllocationParser;
    ...
    private List<WorkingCapitalLoanPaymentAllocationData> copyPaymentAllocationRules(final WorkingCapitalLoan loan,
            final JsonCommand command, final WorkingCapitalLoanProduct product) {
    ...
    public Map<String, Object> updateFrom(final JsonCommand command, final WorkingCapitalLoan loan) {
        ...
        if (command.arrayOfParameterNamed(WorkingCapitalLoanProductConstants.paymentAllocationParamName) != null) {
            List<WorkingCapitalLoanPaymentAllocationData> newPaymentAllocationRules = copyPaymentAllocationRules(loan, command,
                    loan.getLoanProduct());
    ...
    private WorkingCapitalLoanBreach findBreachById(final Long breachId) {
    ...
    private WorkingCapitalLoanNearBreach findNearBreachById(final Long nearBreachId) {
