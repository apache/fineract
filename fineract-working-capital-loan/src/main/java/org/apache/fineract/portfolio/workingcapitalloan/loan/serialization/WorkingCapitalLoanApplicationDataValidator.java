 ...
 * under the License.
 */
package org.apache.fineract.portfolio.workingcapitalloan.loan.serialization;
...
import org.apache.fineract.portfolio.workingcapitalloan.loan.exception.WorkingCapitalLoanApplicationDateException;
import org.apache.fineract.portfolio.workingcapitalloan.loan.exception.WorkingCapitalLoanApplicationNotInSubmittedStateCannotBeModifiedException;
...
public class WorkingCapitalLoanApplicationDataValidator {
    ...
    private final WorkingCapitalLoanPaymentAllocationDataValidator paymentAllocationDataValidator;
    ...
    private final WorkingCapitalLoanNearBreachParseAndValidator workingCapitalNearBreachValidator;
     ...
     * {@link org.apache.fineract.portfolio.workingcapitalloan.loan.service.WorkingCapitalLoanAssemblerImpl}: requested
    ...
    private void validateOverridables(final JsonElement element, final DataValidatorBuilder baseDataValidator,
            final WorkingCapitalLoanProductConfigurableAttributes config, final WorkingCapitalLoanBreach currentBreach,
            final WorkingCapitalLoanNearBreach currentNearBreach) {
