...
public final class WorkingCapitalLoanConstants {
    ...
    public static final String DISCOUNT_FEE_ADJUSTMENT_UNDO_LOAN_COMMAND = "undoDiscountFeeAdjustment";
    ...
    public static final String DISCOUNT_FEE_ADJUSTMENT_CLASSIFICATION_CODE_NAME = "working_capital_loan_discount_fee_adjustment_classification";
