...
/**
 * Replay order mirrors the core loan module's LoanTransactionComparator: transaction date, then submitted-on date, then
 * creation time, then id.
 */
public final class WorkingCapitalLoanTransactionComparator {

    public static final Comparator<WorkingCapitalLoanTransaction> TRANSACTION_ORDER = Comparator
    ...
    private WorkingCapitalLoanTransactionComparator() {}
}
