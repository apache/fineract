...
public interface WorkingCapitalLoanBreachReadPlatformService {

    WorkingCapitalLoanBreachTemplateResponse retrieveTemplate();

    List<WorkingCapitalLoanBreachData> retrieveAll();

    WorkingCapitalLoanBreachData retrieveOne(Long breachId);
}
