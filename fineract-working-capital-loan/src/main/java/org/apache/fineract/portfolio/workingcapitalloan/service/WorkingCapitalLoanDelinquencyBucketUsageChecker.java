...
public class WorkingCapitalLoanDelinquencyBucketUsageChecker implements DelinquencyBucketUsageChecker {

    private final WorkingCapitalLoanRepository repository;

    @Override
    public boolean hasUsages(final DelinquencyBucket delinquencyBucket) {
        return repository.existsByLoanProductRelatedDetails_DelinquencyBucket(delinquencyBucket);
    }
}
