...
import org.apache.fineract.portfolio.workingcapitalloan.product.domain.WorkingCapitalLoanPaymentAllocationTypeListConverter;
...
public class WorkingCapitalLoanPaymentAllocationRule extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    @Convert(converter = WorkingCapitalLoanPaymentAllocationTypeListConverter.class)
    @Column(name = "allocation_types", nullable = false)
    private List<WorkingCapitalLoanPaymentAllocationType> allocationTypes;
}
