 ...
 * under the License.
 */
package org.apache.fineract.portfolio.workingcapitalloan.breach.domain;
...
@NoArgsConstructor
@Entity
@Table(name = "m_wc_loan_breach_action")
public class WorkingCapitalLoanBreachAction extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    private WorkingCapitalLoanBreachActionType action;
    ...
    private WorkingCapitalLoanBreachAmountCalculationType minimumPaymentType;
