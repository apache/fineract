...
@Service
@AllArgsConstructor
@CommandType(entity = "WORKINGCAPITALLOAN", action = "CREATE")
public class WorkingCapitalLoanApplicationSubmittalCommandHandler implements NewCommandSourceHandler {
