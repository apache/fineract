...
public enum WorkingCapitalLoanAmortizationType implements ApiFacingEnum<WorkingCapitalLoanAmortizationType> {
     ...
     */
    public static WorkingCapitalLoanAmortizationType fromString(final String amortizationTypeValue) {
    ...
    public boolean isEIR() {
        return this.equals(WorkingCapitalLoanAmortizationType.EIR);
    }
