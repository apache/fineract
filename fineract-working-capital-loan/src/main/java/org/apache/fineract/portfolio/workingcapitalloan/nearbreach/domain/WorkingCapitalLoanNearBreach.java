 ...
 * under the License.
 */
package org.apache.fineract.portfolio.workingcapitalloan.nearbreach.domain;
...
@NoArgsConstructor
@AllArgsConstructor
public class WorkingCapitalLoanNearBreach extends AbstractPersistableCustom<Long> {
