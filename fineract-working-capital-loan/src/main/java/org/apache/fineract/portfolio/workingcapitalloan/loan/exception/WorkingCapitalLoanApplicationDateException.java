...
/**
 * Thrown when a Working Capital Loan application date violates a domain rule (e.g. expected disbursement date on
 * non-working day or holiday when not allowed by configuration).
 */
