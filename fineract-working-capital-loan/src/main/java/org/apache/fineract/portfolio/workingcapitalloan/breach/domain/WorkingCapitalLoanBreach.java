...
@Setter
@NoArgsConstructor
public class WorkingCapitalLoanBreach extends AbstractPersistableCustom<Long> {
    ...
    private WorkingCapitalLoanBreachAmountCalculationType breachAmountCalculationType;
