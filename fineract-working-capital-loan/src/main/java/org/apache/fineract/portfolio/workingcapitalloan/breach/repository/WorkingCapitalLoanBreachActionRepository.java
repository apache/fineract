 ...
 * under the License.
 */
package org.apache.fineract.portfolio.workingcapitalloan.breach.repository;
...
public interface WorkingCapitalLoanBreachActionRepository extends JpaRepository<WorkingCapitalLoanBreachAction, Long> {
    ...
    @Query("""
            ...
            WHERE action.action = org.apache.fineract.portfolio.workingcapitalloan.breach.domain.WorkingCapitalLoanBreachActionType.DISABLE
