...
import org.apache.fineract.portfolio.workingcapitalloan.product.mapper.WorkingCapitalLoanProductMapper;
...
public class WorkingCapitalLoanProductReadPlatformServiceImpl implements WorkingCapitalLoanProductReadPlatformService {
    ...
    private final WorkingCapitalLoanNearBreachReadPlatformService nearBreachReadPlatformService;
    ...
    public WorkingCapitalLoanProductData retrieveNewWorkingCapitalLoanProductDetails() {
        ...
        final List<StringEnumOptionData> amortizationTypeOptions = ApiFacingEnum
                .getValuesAsStringEnumOptionDataList(WorkingCapitalLoanAmortizationType.class);
        ...
        final List<WorkingCapitalLoanBreachData> breachOptions = breachReadPlatformService.retrieveAll();
        final List<StringEnumOptionData> advancedPaymentAllocationTypes = ApiFacingEnum
                .getValuesAsStringEnumOptionDataList(WorkingCapitalLoanPaymentAllocationType.class);
        ...
        final List<WorkingCapitalLoanNearBreachData> nearBreachOptions = nearBreachReadPlatformService.retrieveAll();
        final List<PaymentTypeData> paymentTypeOptions = this.paymentTypeReadService.retrieveAllPaymentTypes();

        final List<StringEnumOptionData> accountingRuleOptions = WorkingCapitalLoanAccountingRuleType.toStringEnumOptions();
