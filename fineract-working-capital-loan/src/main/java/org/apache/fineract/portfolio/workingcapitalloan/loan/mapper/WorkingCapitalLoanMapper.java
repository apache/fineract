...
import org.apache.fineract.portfolio.workingcapitalloan.transaction.mapper.WorkingCapitalLoanTransactionMapper;
...
@Mapper(config = MapstructMapperConfig.class, uses = { DelinquencyBucketMapper.class, WorkingCapitalLoanProductMapper.class,
        ...
        WorkingCapitalLoanBreachMapper.class, WorkingCapitalLoanNearBreachMapper.class, WorkingCapitalLoanSummaryDataMapper.class,
