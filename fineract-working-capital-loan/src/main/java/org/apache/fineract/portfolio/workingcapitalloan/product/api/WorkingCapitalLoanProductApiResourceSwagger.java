 ...
 * under the License.
 */
package org.apache.fineract.portfolio.workingcapitalloan.product.api;
...
public final class WorkingCapitalLoanProductApiResourceSwagger {
    ...
    public static final class PostWorkingCapitalLoanProductsRequest {
        ...
        public List<WorkingCapitalLoanPostChargeOffReasonToExpenseAccountMappings> chargeOffReasonToExpenseAccountMappings;
        public List<WorkingCapitalLoanPostWriteOffReasonToExpenseAccountMappings> writeOffReasonsToExpenseMappings;
        ...
        @Schema(description = "WorkingCapitalLoanPostChargeOffReasonToExpenseAccountMappings")
        public static final class WorkingCapitalLoanPostChargeOffReasonToExpenseAccountMappings {

            private WorkingCapitalLoanPostChargeOffReasonToExpenseAccountMappings() {}

            public Long chargeOffReasonCodeValueId;
            public Long expenseAccountId;
        }

        @Schema(description = "WorkingCapitalLoanPostWriteOffReasonToExpenseAccountMappings")
        public static final class WorkingCapitalLoanPostWriteOffReasonToExpenseAccountMappings {

            private WorkingCapitalLoanPostWriteOffReasonToExpenseAccountMappings() {}
    ...
    public static final class GetWorkingCapitalLoanProductsTemplateResponse {
        ...
        public List<WorkingCapitalLoanBreachData> breachOptions;
        public List<WorkingCapitalLoanNearBreachData> nearBreachOptions;
    ...
    public static final class PutWorkingCapitalLoanProductsProductIdRequest {
        ...
        public List<PostWorkingCapitalLoanProductsRequest.WorkingCapitalLoanPostChargeOffReasonToExpenseAccountMappings> chargeOffReasonToExpenseAccountMappings;
        public List<PostWorkingCapitalLoanProductsRequest.WorkingCapitalLoanPostWriteOffReasonToExpenseAccountMappings> writeOffReasonsToExpenseMappings;
