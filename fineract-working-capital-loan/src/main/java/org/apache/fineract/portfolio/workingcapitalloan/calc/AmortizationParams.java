...
final class AmortizationParams {
    ...
    static Solved solve(final WorkingCapitalAmortizationType amortizationType, final BigDecimal balance, final BigDecimal unearnedFee,
        ...
        return solveFromKnownPayment(amortizationType, balance, unearnedFee, daily, mc, npvDayCount, currencyScale);
    }
    ...
    static Solved solveFromKnownPayment(final WorkingCapitalAmortizationType amortizationType, final BigDecimal balance,
            final BigDecimal unearnedFee, final BigDecimal daily, final MathContext mc, final int npvDayCount, final int currencyScale) {
     ...
     * sizes the daily payment from the target annual EIR, then earns fee via {@link #flatRatio}.
     */
    static Solved solveFromAnnualEir(final WorkingCapitalAmortizationType amortizationType, final BigDecimal netDisbursement,
            final BigDecimal discountFee, final BigDecimal annualEirPercent, final int npvDayCount, final int currencyScale,
            final MathContext mc) {
        ...
        return solveFromKnownPayment(amortizationType, netDisbursement, discountFee, daily, mc, npvDayCount, currencyScale);
    }
