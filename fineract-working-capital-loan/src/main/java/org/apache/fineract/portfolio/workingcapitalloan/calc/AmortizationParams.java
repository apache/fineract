...
final class AmortizationParams {
    ...
    static Solved solve(final BigDecimal balance, final BigDecimal unearnedFee, final BigDecimal totalPaymentVolume,
        ...
        return solveFromKnownPayment(balance, unearnedFee, daily, mc, npvDayCount);
    }
     ...
     *             when the inputs cannot produce a payable schedule
     */
    static Solved solveFromKnownPayment(final BigDecimal balance, final BigDecimal unearnedFee, final BigDecimal daily,
            final MathContext mc, final int npvDayCount) {
    ...
    static Solved solveFromAnnualEir(final BigDecimal netDisbursement, final BigDecimal discountFee, final BigDecimal annualEirPercent,
        ...
        return solveFromKnownPayment(netDisbursement, discountFee, daily, mc, npvDayCount);
    }
