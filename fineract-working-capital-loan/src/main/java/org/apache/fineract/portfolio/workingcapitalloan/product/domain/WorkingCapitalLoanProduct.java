...
public class WorkingCapitalLoanProduct extends AbstractPersistableCustom<Long> {
    ...
    private WorkingCapitalLoanBreach breach;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "near_breach_id")
    private WorkingCapitalLoanNearBreach nearBreach;
    ...
    private WorkingCapitalLoanAccountingRuleType accountingRule;
    ...
    public WorkingCapitalLoanProduct(final String name, final String shortName, final ExternalId externalId, final Fund fund,
            ...
            final WorkingCapitalLoanAccountingRuleType accountingRule, final MonetaryCurrency currency,
            ...
            final WorkingCapitalLoanProductConfigurableAttributes configurableAttributes, final WorkingCapitalLoanBreach breach,
            final WorkingCapitalLoanNearBreach nearBreach) {
        this.name = name;
