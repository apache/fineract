...
public interface WorkingCapitalLoanNearBreachReadPlatformService {

    List<WorkingCapitalLoanNearBreachData> retrieveAll();

    WorkingCapitalLoanNearBreachData retrieveOne(Long nearBreachId);
}
