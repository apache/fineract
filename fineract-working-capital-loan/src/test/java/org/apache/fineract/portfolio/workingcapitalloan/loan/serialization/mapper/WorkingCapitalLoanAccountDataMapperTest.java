...
class WorkingCapitalLoanAccountDataMapperTest {
    ...
    private static WorkingCapitalLoanBreachData fullBreach() {
        return WorkingCapitalLoanBreachData.builder().id(80L).name("Breach rule").breachFrequency(2)
    ...
    private static WorkingCapitalLoanNearBreachData fullNearBreach() {
        return WorkingCapitalLoanNearBreachData.builder().id(81L).name("Near breach rule").frequency(1)
