...
class LoanCOBEnabledConditionTest {
    ...
    @InjectMocks
    private LoanCOBEnabledCondition testObj = new LoanCOBEnabledCondition();
    ...
    @Test
    public void testMatchesShouldReturnFalseWhenLoanCobIsDisabled() {
    ...
    @Test
    public void testMatchesShouldReturnTrueWhenLoanCobIsEnabled() {
