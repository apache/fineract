...
public class LoanScheduleTestDataHelper {
   ...
   */
  public static List<LoanRepaymentScheduleInstallment> createSimpleLoanSchedule(
      final LocalDate firstDueDate, final MonetaryCurrency currency) {
    final LoanRepaymentScheduleInstallment firstInstallment =
        new LoanRepaymentScheduleInstallmentBuilder(currency)
    ...
    final LoanRepaymentScheduleInstallment secondInstallment =
        new LoanRepaymentScheduleInstallmentBuilder(currency)
    ...
    final LoanRepaymentScheduleInstallment thirdInstallment =
        new LoanRepaymentScheduleInstallmentBuilder(currency)
   ...
   */
  public static List<LoanRepaymentScheduleInstallment>
      createSimpleLoanScheduleWithFirstInstallmentFullyPaid(
          final LocalDate firstDueDate, final MonetaryCurrency currency) {
