...
public class ClasspathHellDuplicatesChecker {
  ...
  public static final ClasspathHellDuplicatesChecker INSTANCE =
      new ClasspathHellDuplicatesChecker();
  ...
  private boolean skipJAR(String jarPath) {
    // ./gradlew test finds classes from the Gradle Wrapper (which don't show up in-IDE), exclude
    // those
    return jarPath.contains("/.gradle/wrapper/dists/")
        || jarPath.contains(
            "/io.rest-assured/"); // TODO FINERACT-884 remove when RestAssured was bumped from 3.3.0
    // to 4.3.0 in Spring BOM
  }
  ...
  protected boolean isHarmlessDuplicate(String resourcePath) {
    ...
    return resourcePath.equals("META-INF/MANIFEST.MF")
        ...
        // super proper way to address this cleanly would be to make our own JAR for
        // javax.annotation
        // and have it contain ONLY what is not already in package javax.annotation in rt.jar.. but
        // for now:
        || resourcePath.equals("javax/annotation/Resource$AuthenticationType.class")
        // NEUTRON-205: javax.inject is a mess :( because of javax.inject:javax.inject (which we
        // widely use in ODL)
        // VS. org.glassfish.hk2.external:javax.inject (which Glassfish Jersey has dependencies on).
        //  Attempts to
        ...
        // org.glassfish.jersey.containers.jersey-container-servlet-core (2.25.1) has a non-optional
        // Package-Import
        // for javax.inject, but we made javax.inject:javax.inject <optional>true in odlparent, and
        // don't bundle it.
