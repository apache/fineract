...
public class BusinessDateValidatorTest {
    ...
    public void validateAndParseUpdateWithInvalidDateFormat() {
        ...
        PlatformApiDataValidationException exception = assertThrows(PlatformApiDataValidationException.class,
                () -> businessDateDataParserAndValidator.validateAndParseUpdate(command));
        assertEquals(
                "PlatformApiDataValidationException{errors=[The parameter `date` is invalid based on the dateFormat: `y2yyy-MM-dd` and locale: `hu` provided:]}",
                exception.toString());
    }
    ...
    public void validateAndParseUpdateWithInvalidDate() {
        ...
        PlatformApiDataValidationException exception = assertThrows(PlatformApiDataValidationException.class,
                () -> businessDateDataParserAndValidator.validateAndParseUpdate(command));
        assertEquals(
                "PlatformApiDataValidationException{errors=[The parameter `date` is invalid based on the dateFormat: `yyyy-MM-dd` and locale: `hu` provided:]}",
                exception.toString());
    }
