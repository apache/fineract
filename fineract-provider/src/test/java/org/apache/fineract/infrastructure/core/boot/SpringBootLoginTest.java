...
/**
 * This is a simple example integration test.
 */
public class SpringBootLoginTest extends AbstractSpringBootIntegrationTest {
    ...
    public void hasPlatformStarted() {
        ...
        assertThat(response.get(0).get("username"), is("interopUser"));
    }
}
