...
public class BusinessDataSerialized {
    ...
    public void serializeBusinessDateData() {
        ...
        assertEquals(
                "{\"description\":\"Business Date\",\"type\":\"BUSINESS_DATE\",\"date\":[" + now.getYear() + "," + now.getMonthValue() + "," + now.getDayOfMonth() + "]}",
                result);
    }
    ...
    public void serializeBusinessDateData_COB() {
        ...
        String result = jsonSerializer.serialize(businessDateData);
        assertEquals(
                "{\"description\":\"Close of Business Date\",\"type\":\"COB_DATE\",\"date\":[" + now.getYear() + "," + now.getMonthValue() + "," + now.getDayOfMonth() + "]}",
                result);
    }
