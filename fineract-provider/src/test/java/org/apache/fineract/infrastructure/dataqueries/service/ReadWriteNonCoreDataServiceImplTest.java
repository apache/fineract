...
public class ReadWriteNonCoreDataServiceImplTest {
    ...
    public void testQueryDataTable() {
        ...
        ResultsetColumnHeaderData rschd1 = ResultsetColumnHeaderData.detailed("cf1", "text", 10L, false, false, null, null);
        when(genericDataService.fillResultsetColumnHeaders("table")).thenReturn(List.of(rschd1));
