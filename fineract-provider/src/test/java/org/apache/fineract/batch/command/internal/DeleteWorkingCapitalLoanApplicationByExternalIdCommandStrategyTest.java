...
/**
 * Test class for {@link DeleteWorkingCapitalLoanApplicationByExternalIdCommandStrategy}.
 */
public class DeleteWorkingCapitalLoanApplicationByExternalIdCommandStrategyTest {

    /**
     * Test {@link DeleteWorkingCapitalLoanApplicationByExternalIdCommandStrategy#execute} happy path scenario.
     */
    @Test
    public void testExecuteSuccessScenario() {
        ...
        given(testContext.workingCapitalLoanApiResource.deleteLoanApplication(eq(loanExternalId))).willReturn(processingResult);
        ...
        verify(testContext.workingCapitalLoanApiResource).deleteLoanApplication(eq(loanExternalId));
        verify(testContext.toApiJsonSerializer).serialize(processingResult);
    }

    /**
     * Creates and returns a batch request for {@code DELETE working-capital-loans/external-id/{loanExternalId}}.
     *
    ...
    private BatchRequest getBatchRequest(final String loanExternalId) {
        ...
        br.setRelativeUrl("v1/working-capital-loans/external-id/" + loanExternalId);
    ...
    private static class TestContext {
        ...
        private final DeleteWorkingCapitalLoanApplicationByExternalIdCommandStrategy subjectToTest;

        TestContext() {
            MockitoAnnotations.openMocks(this);
            subjectToTest = new DeleteWorkingCapitalLoanApplicationByExternalIdCommandStrategy(workingCapitalLoanApiResource,
                    toApiJsonSerializer);
        }
    }
}
