...
INSERT INTO `c_configuration` (`id`, `name`, `value`, `enabled`, `is_trap_door`, `description`) VALUES
	...
	(20, 'officeId-specific-products-enabled', 0, 0, 0, 'Whether products and fees should be officeId specific or not? This property should NOT be changed once Mifos is Live.'),
	(21, 'restrict-products-to-user-officeId', 0, 0, 0, 'This should be enabled only if, products & fees are officeId specific (i.e. officeId-specific-products-enabled is enabled). This property specifies if the products should be auto-restricted to officeId of the user who created the proudct? Note: This property should NOT be changed once Mifos is Live.'),
	(22, 'officeId-opening-balances-contra-account', 0, 1, 0, NULL),
...
INSERT INTO `schema_version` (`version_rank`, `installed_rank`, `version`, `description`, `type`, `script`, `checksum`, `installed_by`, `installed_on`, `execution_time`, `success`) VALUES
	...
	(105, 105, '105', 'track loan transaction against officeId', 'SQL', 'V105__track_loan_transaction_against_office.sql', 785650440, 'root', '2014-03-08 02:29:26', 1260, 1),
	...
	(108, 108, '108', 'client has transfer officeId', 'SQL', 'V108__client_has_transfer_office.sql', -1748734810, 'root', '2014-03-08 02:29:27', 356, 1),
	...
	(114, 114, '113', 'track savings transaction against officeId', 'SQL', 'V113__track_savings_transaction_against_office.sql', -1390529632, 'root', '2014-03-08 02:29:30', 799, 1),
