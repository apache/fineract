...
ADD COLUMN `annual_fee_on_month` SMALLINT NULL DEFAULT NULL AFTER `annual_fee_amount`,
ADD COLUMN `annual_fee_on_day` SMALLINT NULL DEFAULT NULL AFTER `annual_fee_on_month`;
