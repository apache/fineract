...
ALTER TABLE `m_product_loan`
    ...
    ADD COLUMN `min_number_of_repayments` SMALLINT NOT NULL AFTER `number_of_repayments`,
    ADD COLUMN `max_number_of_repayments` SMALLINT NOT NULL AFTER `min_number_of_repayments`;
...
ALTER TABLE `m_loan`
    ...
    CHANGE COLUMN `min_number_of_repayments` `min_number_of_repayments` SMALLINT NULL AFTER `number_of_repayments`,
    CHANGE COLUMN `max_number_of_repayments` `max_number_of_repayments` SMALLINT NULL AFTER `min_number_of_repayments`;
