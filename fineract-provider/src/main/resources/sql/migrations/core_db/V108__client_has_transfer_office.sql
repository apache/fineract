...
/***Store destination officeId Id while client is pending transfers and effective joining date in a particular branch**/
...
/**For current Clients, set the officeId joining date to activation date**/
