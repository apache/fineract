...
ALTER TABLE `m_charge`
    ADD COLUMN `income_or_liability_account_id` BIGINT NULL AFTER `fee_frequency`,
...
ALTER TABLE `acc_gl_journal_entry`
    ADD COLUMN `client_transaction_id` BIGINT NULL DEFAULT NULL AFTER `savings_transaction_id`,
