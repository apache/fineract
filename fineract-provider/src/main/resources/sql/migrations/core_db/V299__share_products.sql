...
`issued_shares` BIGINT NULL DEFAULT NULL,
`totalsubscribed_shares` BIGINT NULL DEFAULT NULL,
`unit_price` DECIMAL(10,2) NOT NULL,
`capital_amount` DECIMAL(20,2) NOT NULL,
`minimum_client_shares` BIGINT NULL DEFAULT NULL,
`nominal_client_shares` BIGINT NOT NULL,
`maximum_client_shares` BIGINT NULL DEFAULT NULL,
`minimum_active_period_frequency` DECIMAL(19,6) NULL DEFAULT NULL,
`minimum_active_period_frequency_enum` SMALLINT NULL DEFAULT NULL,
`lockin_period_frequency` DECIMAL(19,6) NULL DEFAULT NULL,
`lockin_period_frequency_enum` SMALLINT NULL DEFAULT NULL,
`allow_dividends_inactive_clients` SMALLINT NULL DEFAULT 0,
...
`total_approved_shares` BIGINT NULL DEFAULT NULL,
`total_pending_shares` BIGINT NULL DEFAULT NULL,
`submitted_date` DATE NOT NULL,
`submitted_userid` BIGINT NULL DEFAULT NULL,
`approved_date` DATE NULL DEFAULT NULL,
`approved_userid` BIGINT NULL DEFAULT NULL,
`rejected_date` DATE NULL DEFAULT NULL,
`rejected_userid` BIGINT NULL DEFAULT NULL,
`activated_date` DATE NULL DEFAULT NULL,
`activated_userid` BIGINT NULL DEFAULT NULL,
`closed_date` DATE NULL DEFAULT NULL,
`closed_userid` BIGINT NULL DEFAULT NULL,
`currency_code` VARCHAR(3) NOT NULL,
`currency_digits` SMALLINT NOT NULL,
`currency_multiplesof` SMALLINT NULL DEFAULT NULL,
...
`status_enum` SMALLINT NOT NULL DEFAULT '300',
`type_enum` SMALLINT NULL DEFAULT NULL,
`is_active` tinyint NOT NULL DEFAULT '1',
PRIMARY KEY (`id`),
...
`id` BIGINT NOT NULL AUTO_INCREMENT,
`share_transaction_id` BIGINT NULL DEFAULT NULL,
`charge_transaction_id` BIGINT NULL DEFAULT NULL,
