...
public class LoanRescheduleRequestReadPlatformServiceImpl
    implements LoanRescheduleRequestReadPlatformService {

  private final JdbcTemplate jdbcTemplate;
  private final LoanRepositoryWrapper loanRepositoryWrapper;
  private final LoanRescheduleRequestRowMapper loanRescheduleRequestRowMapper =
      new LoanRescheduleRequestRowMapper();
  private final CodeValueReadPlatformService codeValueReadPlatformService;

  @Autowired
  public LoanRescheduleRequestReadPlatformServiceImpl(
  ...
  private static final class LoanRescheduleRequestRowMapper
      implements RowMapper<LoanRescheduleRequestData> {
    ...
    public LoanRescheduleRequestRowMapper() {
      ...
      sqlBuilder.append(
          "join m_loan_reschedule_request_term_variations_mapping rrtvm on lr.id ="
              + " rrtvm.loan_reschedule_request_id ");
      sqlBuilder.append(
          "join m_loan_term_variations tv on tv.id = rrtvm.loan_term_variations_id and"
              + " tv.parent_id is null");
    ...
    private LoanTermVariationsData fetchLoanTermVariation(final ResultSet rs) throws SQLException {
      ...
      final LoanTermVariationsData loanTermVariationsData =
  ...
  private static final class LoanRescheduleRequestRowMapperForBulkApproval
      implements RowMapper<LoanRescheduleRequestData> {
    ...
    public String schema() {
      ...
      sqlBuilder.append(
          "lrr.id as id, lrr.status_enum as statusEnum, lrr.reschedule_from_date as"
              + " rescheduleFromDate, ");
      sqlBuilder.append(
          "cv.id as rescheduleReasonCvId, cv.code_value as rescheduleReasonCvValue, ");
      sqlBuilder.append(
          " loan.id as loanId, loan.account_no as loanAccountNumber, client.id as clientId,"
    ...
    @Override
    public LoanRescheduleRequestData mapRow(
  ...
  public List<LoanRescheduleRequestData> readLoanRescheduleRequests(Long loanId) {
    ...
    final String sql =
        "select " + this.loanRescheduleRequestRowMapper.schema() + " where lr.loan_id = ?";
  ...
  public LoanRescheduleRequestData readLoanRescheduleRequest(Long requestId) {
    ...
    try {
      final String sql =
          "select " + this.loanRescheduleRequestRowMapper.schema() + " where lr.id = ?";

      return this.jdbcTemplate.queryForObject(
          sql, this.loanRescheduleRequestRowMapper, new Object[] {requestId});
  ...
  public List<LoanRescheduleRequestData> readLoanRescheduleRequests(
    ...
    final String sql =
        "select "
            + this.loanRescheduleRequestRowMapper.schema()
            + " where lr.loan_id = ?"
            + " and lr.status_enum = ?";
    return this.jdbcTemplate.query(
        sql, this.loanRescheduleRequestRowMapper, new Object[] {loanId, statusEnum});
  }

  @Override
  public LoanRescheduleRequestData retrieveAllRescheduleReasons(String loanRescheduleReason) {
    final List<CodeValueData> rescheduleReasons =
        new ArrayList<>(
  ...
  public List<LoanRescheduleRequestData> retrieveAllRescheduleRequests(String command) {
    ...
    if (!StringUtils.isNullOrEmpty(command)
      ...
      return this.jdbcTemplate.query(
          sql, loanRescheduleRequestRowMapperForBulkApproval, new Object[] {statusParam});
    }
    return this.jdbcTemplate.query(
        sql, loanRescheduleRequestRowMapperForBulkApproval, new Object[] {});
  }
}
