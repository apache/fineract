...
public class EqualAmortizationUnsupportedFeatureException
  ...
  public EqualAmortizationUnsupportedFeatureException(String code, String property) {
    super(
        "error.msg.equal.amortization.does.not.support." + code,
        "Equal Amortization does not support " + property,
        property);
  }
}
