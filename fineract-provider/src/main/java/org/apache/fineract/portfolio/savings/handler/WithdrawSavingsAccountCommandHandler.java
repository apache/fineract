...
public class WithdrawSavingsAccountCommandHandler implements SavingsTransactionCommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        throw SavingsTransactionCommandEnvelope.untrustedOrigin(SavingsTransactionKind.WITHDRAWAL);
    }
    ...
    public CommandProcessingResult processTransaction(JsonCommand command, SavingsTransactionExecutionContext context) {
        ...
        context.requireKind(SavingsTransactionKind.WITHDRAWAL);
        validator.validate(command);
        authority.require(context, SavingsTransactionKind.WITHDRAWAL, accounts.findOneWithNotFoundDetection(command.getSavingsId()),
