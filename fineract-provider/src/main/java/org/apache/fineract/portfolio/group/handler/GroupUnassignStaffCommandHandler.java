...
public class GroupUnassignStaffCommandHandler implements CommandHandler<GroupUnassignStaffRequest, GroupCommandResponse> {
    ...
    @Override
    @Transactional
    public GroupCommandResponse handle(Command<GroupUnassignStaffRequest> command) {
        return writeService.unassignStaff(command.getPayload());
    }

    @Override
    public GroupCommandResponse fallback(Command<GroupUnassignStaffRequest> command, Throwable t) {
