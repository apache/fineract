...
public class LoanAccountData {
  ...
  @Transient private final BigDecimal feeChargesAtDisbursementCharged;
  ...
  public static LoanAccountData importInstanceIndividual(
      EnumOptionData loanTypeEnumOption,
      Long clientId,
      Long productId,
      Long loanOfficerId,
      ...
      EnumOptionData repaidEveryFrequencyEnums,
      Integer loanTermFrequency,
      EnumOptionData loanTermFrequencyTypeEnum,
      BigDecimal nominalInterestRate,
      LocalDate expectedDisbursementDate,
      EnumOptionData amortizationEnumOption,
      EnumOptionData interestMethodEnum,
      EnumOptionData interestCalculationPeriodTypeEnum,
    ...
    return new LoanAccountData(
        ...
        numberOfRepayments,
        repaymentEvery,
        repaidEveryFrequencyEnums,
        loanTermFrequency,
        loanTermFrequencyTypeEnum,
        nominalInterestRate,
        expectedDisbursementDate,
        amortizationEnumOption,
        interestMethodEnum,
  ...
  public static LoanAccountData importInstanceGroup(
      EnumOptionData loanTypeEnumOption,
      ...
      EnumOptionData amortizationEnumOption,
      EnumOptionData interestMethodEnum,
      EnumOptionData interestCalculationPeriodEnum,
      BigDecimal arrearsTolerance,
      Long transactionProcessingStrategyId,
      Integer graceOnPrincipalPayment,
      Integer graceOnInterestPayment,
      Integer graceOnInterestCharged,
  ...
  public static final Comparator<LoanAccountData> ClientNameComparator =
      new Comparator<LoanAccountData>() {
   ...
   * for now.
   */
  public static LoanAccountData collateralTemplate(
   ...
   * defaulted.
   */
  public static LoanAccountData clientDefaults(
      final Long clientId,
    ...
    final LoanApplicationTimelineData timeline =
        LoanApplicationTimelineData.templateDefault(expectedDisbursementDate);
    final LoanSummaryData summary = null;
    final BigDecimal feeChargesDueAtDisbursementCharged = null;
  ...
  public static LoanAccountData populateClientDefaults(
      final LoanAccountData acc, final LoanAccountData clientAcc) {
    ...
    return new LoanAccountData(
        ...
        acc.externalId,
        clientAcc.clientId,
        clientAcc.clientAccountNo,
        clientAcc.clientName,
        clientAcc.clientOfficeId,
        acc.group,
        acc.loanType,
        acc.loanProductId,
        acc.loanProductName,
        acc.loanProductDescription,
        acc.isLoanProductLinkedToFloatingRate,
        acc.fundId,
        acc.fundName,
        acc.loanPurposeId,
        acc.loanPurposeName,
        ...
        acc.loanOfficerName,
        acc.currency,
        acc.proposedPrincipal,
        acc.principal,
        acc.approvedPrincipal,
        acc.totalOverpaid,
        acc.inArrearsTolerance,
        acc.termFrequency,
        acc.termPeriodFrequencyType,
        acc.numberOfRepayments,
        acc.repaymentEvery,
        acc.repaymentFrequencyType,
        acc.repaymentFrequencyNthDayType,
        acc.repaymentFrequencyDayOfWeekType,
        acc.transactionProcessingStrategyId,
        acc.transactionProcessingStrategyName,
        acc.amortizationType,
        acc.interestRatePerPeriod,
        acc.interestRateFrequencyType,
        acc.annualInterestRate,
        acc.interestType,
        acc.isFloatingInterestRate,
        acc.interestRateDifferential,
        acc.interestCalculationPeriodType,
        acc.allowPartialPeriodInterestCalcualtion,
        acc.expectedFirstRepaymentOnDate,
        acc.graceOnPrincipalPayment,
        acc.recurringMoratoriumOnPrincipalPeriods,
        acc.graceOnInterestPayment,
        acc.graceOnInterestCharged,
        acc.interestChargedFromDate,
        clientAcc.timeline,
        acc.summary,
        acc.feeChargesAtDisbursementCharged,
        ...
        acc.chargeOptions,
        null,
        acc.loanOfficerOptions,
        acc.loanPurposeOptions,
        acc.loanCollateralOptions,
        acc.calendarOptions,
        acc.syncDisbursementWithMeeting,
        acc.loanCounter,
        acc.loanProductCounter,
        acc.notes,
        acc.accountLinkingOptions,
        acc.linkedAccount,
        acc.disbursementDetails,
        acc.multiDisburseLoan,
        acc.canDefineInstallmentAmount,
        acc.fixedEmiAmount,
        acc.maxOutstandingLoanBalance,
        acc.emiAmountVariations,
        acc.memberVariations,
        acc.product,
        acc.inArrears,
        ...
        acc.interestRecalculationData,
        acc.originalSchedule,
        acc.createStandingInstructionAtDisbursement,
        acc.paidInAdvance,
        acc.interestRatesPeriods,
        acc.isVariableInstallmentsAllowed,
        acc.minimumGap,
        acc.maximumGap,
        acc.subStatus,
        acc.canUseForTopup,
        acc.clientActiveLoanOptions,
        acc.isTopup,
        acc.closureLoanId,
        acc.closureLoanAccountNo,
        acc.topupAmount,
        acc.isEqualAmortization,
        acc.rates,
        acc.isRatesEnabled);
  }
   ...
   * defaulted.
   */
  public static LoanAccountData groupDefaults(
      final GroupGeneralData group, final LocalDate expectedDisbursementDate) {
  ...
  public static LoanAccountData populateGroupDefaults(
      final LoanAccountData acc, final LoanAccountData groupAcc) {
  ...
  public static LoanAccountData loanProductWithTemplateDefaults(
    ...
    if (product.useBorrowerCycle() && loanCycleNumber > 0) {
      Collection<LoanProductBorrowerCycleVariationData> principalVariationsForBorrowerCycle =
          product.getPrincipalVariationsForBorrowerCycle();
      Collection<LoanProductBorrowerCycleVariationData> interestForVariationsForBorrowerCycle =
          product.getInterestRateVariationsForBorrowerCycle();
      Collection<LoanProductBorrowerCycleVariationData> repaymentVariationsForBorrowerCycle =
      ...
      interestRatePerPeriod =
          fetchLoanCycleDefaultValue(interestForVariationsForBorrowerCycle, loanCycleNumber);
      BigDecimal numberofRepaymentval =
          fetchLoanCycleDefaultValue(repaymentVariationsForBorrowerCycle, loanCycleNumber);
    ...
    return new LoanAccountData(
        ...
        null,
        null,
        product.getTransactionProcessingStrategyId(),
        transactionProcessingStrategyName,
        ...
        linkedAccount,
        disbursementData,
        product.getMultiDisburseLoan(),
        product.canDefineInstallmentAmount(),
        fixedEmi,
        product.getOutstandingLoanBalance(),
        emiAmountVariations,
        memberVariations,
        product,
        inArrears,
        product.getGraceOnArrearsAgeing(),
        product.overdueFeeCharges(),
        isNPA,
        product.getDaysInMonthType(),
  ...
  public static LoanAccountData populateLoanProductDefaults(
      final LoanAccountData acc, final LoanProductData product) {
    ...
    return new LoanAccountData(
        ...
        null,
        product.getTransactionProcessingStrategyId(),
        product.getTransactionProcessingStrategyName(),
        product.getAmortizationType(),
   ...
   * query.
   */
  public static LoanAccountData basicLoanDetails(
      final Long id,
      ...
      final BigDecimal proposedPrincipal,
      ...
      EnumOptionData repaymentFrequencyNthDayType,
      EnumOptionData repaymentFrequencyDayOfWeekType,
      final Long transactionStrategyId,
      final String transactionStrategyName,
   ...
   * account data
   */
  public static LoanAccountData associationsAndTemplate(
      final LoanAccountData acc,
      ...
      final Collection<DisbursementData> disbursementDetails,
  ...
  public static LoanAccountData associationsAndTemplate(
      final LoanAccountData acc,
      final Collection<LoanProductData> productOptions,
      final Collection<StaffData> allowedLoanOfficers,
      final Collection<CalendarData> calendarOptions,
      final Collection<PortfolioAccountData> accountLinkingOptions,
      final Boolean isRatesEnabled) {
  ...
  public static LoanAccountData associateGroup(
      final LoanAccountData acc, final GroupGeneralData group) {
  ...
  public static LoanAccountData associateMemberVariations(
      final LoanAccountData acc, final Map<Long, Integer> memberLoanCycle) {

    final Map<Long, LoanBorrowerCycleData> memberVariations =
        new HashMap<Long, LoanBorrowerCycleData>();
    for (Map.Entry<Long, Integer> mapEntry : memberLoanCycle.entrySet()) {
      ...
      if (acc.product.useBorrowerCycle() && loanCycleNumber != null && loanCycleNumber > 0) {
        Collection<LoanProductBorrowerCycleVariationData> principalVariationsForBorrowerCycle =
            acc.product.getPrincipalVariationsForBorrowerCycle();
        Collection<LoanProductBorrowerCycleVariationData> interestForVariationsForBorrowerCycle =
            acc.product.getInterestRateVariationsForBorrowerCycle();
        Collection<LoanProductBorrowerCycleVariationData> repaymentVariationsForBorrowerCycle =
            acc.product.getNumberOfRepaymentVariationsForBorrowerCycle();
        principal =
      ...
      LoanBorrowerCycleData borrowerCycleData =
          new LoanBorrowerCycleData(
              principal, interestRatePerPeriod, numberOfRepayments, termFrequency);
  ...
  public static LoanAccountData withInterestRecalculationCalendarData(
      final LoanAccountData acc,
      final CalendarData calendarData,
      final CalendarData compoundingCalendarData) {

    final LoanInterestRecalculationData interestRecalculationData =
        LoanInterestRecalculationData.withCalendarData(
  ...
  public static LoanAccountData withLoanCalendarData(
      final LoanAccountData acc, final CalendarData calendarData) {
    return new LoanAccountData(
        acc.id,
        acc.accountNo,
        acc.status,
        ...
        acc.repaymentEvery,
        acc.repaymentFrequencyType,
        calendarData.getRepeatsOnNthDayOfMonth(),
        calendarData.getRepeatsOnDay(),
        acc.transactionProcessingStrategyId,
        acc.transactionProcessingStrategyName,
        acc.amortizationType,
        acc.interestRatePerPeriod,
  ...
  public static LoanAccountData withOriginalSchedule(
      final LoanAccountData acc, final LoanScheduleData originalSchedule) {
  ...
  private LoanAccountData(
      ...
      final Integer repaymentEvery,
      final EnumOptionData repaymentFrequencyType, //
      final EnumOptionData repaymentFrequencyNthDayType,
      final EnumOptionData repaymentFrequencyDayOfWeekType,
      ...
      final Boolean isVariableInstallmentsAllowed,
      final Integer minimumGap,
      final Integer maximumGap,
      final EnumOptionData subStatus,
      final Boolean canUseForTopup,
      final Collection<LoanAccountSummaryData> clientActiveLoanOptions,
      final boolean isTopup,
    ...
    if (this.status != null && LoanStatus.fromInt(this.status.id().intValue()).isApproved()) {
      ...
      if (this.multiDisburseLoan != null
    ...
    if (this.product != null) {
      this.product.setloanProductConfigurableAttributes(
          product.getloanProductConfigurableAttributes());
    }
  ...
  public RepaymentScheduleRelatedLoanData repaymentScheduleRelatedData() {
    return this.timeline.repaymentScheduleRelatedData(
        this.currency,
        this.principal,
  ...
  private static BigDecimal fetchLoanCycleDefaultValue(
      Collection<LoanProductBorrowerCycleVariationData> borrowerCycleVariationData,
  ...
  private static boolean isLoanCycleValuesWhenConditionGreterthan(
      Integer loanCycleNumber,
      Integer cycleNumberSelected,
  ...
  private static boolean isLoanCycleValuesWhenConditionEqual(
      Integer loanCycleNumber, LoanProductBorrowerCycleVariationData data) {
  ...
  public BigDecimal getTotalOutstandingAmount() {
    if (this.summary != null) return this.summary.getTotalOutstanding();
    else return null;
  }
  ...
  public boolean isMonthlyRepaymentFrequencyType() {
    return (this.repaymentFrequencyType.getId().intValue()
        == PeriodFrequencyType.MONTHS.getValue());
  }
