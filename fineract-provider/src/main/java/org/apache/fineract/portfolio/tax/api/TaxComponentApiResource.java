...
@SwaggerDefinition(
    tags = {@Tag(name = "Tax Components", description = "This defines the Tax Components")})
public class TaxComponentApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = TaxComponentApiResourceSwagger.GetTaxesComponentsResponse.class,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Tax Component",
      httpMethod = "GET",
      notes = "Retrieve Tax Component")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
  ...
  public String retrieveTaxComponent(
      @PathParam("taxComponentId") @ApiParam(value = "taxComponentId") final Long taxComponentId,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create a new Tax Component",
      httpMethod = "POST",
      notes =
          "Creates a new Tax Component\n\n"
              + "Mandatory Fields: name, percentage\n\n"
              + "Optional Fields: debitAccountType, debitAcountId, creditAccountType,"
              + " creditAcountId, startDate")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = TaxComponentApiResourceSwagger.PostTaxesComponentsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = TaxComponentApiResourceSwagger.PostTaxesComponentsResponse.class)
  })
  public String createTaxCompoent(@ApiParam(hidden = true) final String apiRequestBodyAsJson) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createTaxComponent().withJson(apiRequestBodyAsJson).build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update Tax Component",
      httpMethod = "PUT",
      notes =
          "Updates Tax component. Debit and credit account details cannot be modified. All the"
              + " future tax components would be replaced with the new percentage.")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        format = "body",
        dataTypeClass =
            TaxComponentApiResourceSwagger.PutTaxesComponentsTaxComponentIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = TaxComponentApiResourceSwagger.PutTaxesComponentsTaxComponentIdResponse.class)
  })
  public String updateTaxCompoent(
      @PathParam("taxComponentId") @ApiParam(value = "taxComponentId") final Long taxComponentId,
      @ApiParam(hidden = true) final String apiRequestBodyAsJson) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateTaxComponent(taxComponentId)
