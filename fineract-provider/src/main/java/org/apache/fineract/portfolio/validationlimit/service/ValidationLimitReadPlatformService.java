...
public interface ValidationLimitReadPlatformService {

    ValidationLimitData retrieveTemplateDetails();

    ValidationLimitData retrieveValidationLimit(Long validationLimitId);

    Collection<ValidationLimitData> retrieveAllValidationLimits();
