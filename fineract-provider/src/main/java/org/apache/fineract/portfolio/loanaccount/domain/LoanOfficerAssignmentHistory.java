...
public class LoanOfficerAssignmentHistory extends AbstractAuditableCustom {
  ...
  public static LoanOfficerAssignmentHistory createNew(
      final Loan loan, final Staff loanOfficer, final LocalDate startDate) {
  ...
  private LoanOfficerAssignmentHistory(
      final Loan loan, final Staff loanOfficer, final Date startDate, final Date endDate) {
    this.loan = loan;
