...
public interface StandingInstructionRepository
    extends JpaRepository<AccountTransferStandingInstruction, Long>,
        JpaSpecificationExecutor<AccountTransferStandingInstruction> {
  public static final String FIND_BY_LOAN_AND_STATUS_QUERY =
  ...
  public static final String FIND_BY_SAVINGS_AND_STATUS_QUERY =
      "select accountTransferStandingInstruction from AccountTransferStandingInstruction"
          + " accountTransferStandingInstruction where accountTransferStandingInstruction.status ="
          + " :status and"
  ...
  public Collection<AccountTransferStandingInstruction> findByLoanAccountAndStatus(
      @Param("loan") Loan loan, @Param("status") Integer status);
