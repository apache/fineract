      ...
      @Tag(
          ...
          description =
              "An MFIs savings product offerings are modeled using this API.\n"
                  + "When creating savings accounts, the details from the savings product are used"
                  + " to auto fill details of the savings account application process.")
    })
public class SavingsProductsApiResource {
  ...
  @Autowired
  public SavingsProductsApiResource(
  ...
  @ApiOperation(
      value = "Create a Savings Product",
      httpMethod = "POST",
      notes =
          "Creates a Savings Product\n\n"
              ...
              + "Optional Fields: minRequiredOpeningBalance, lockinPeriodFrequency,"
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SavingsProductsApiResourceSwagger.PostSavingsProductsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsProductsApiResourceSwagger.PostSavingsProductsResponse.class)
  })
  public String create(@ApiParam(hidden = true) final String apiRequestBodyAsJson) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createSavingProduct().withJson(apiRequestBodyAsJson).build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Savings Product",
      httpMethod = "PUT",
      notes = "Updates a Savings Product")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SavingsProductsApiResourceSwagger.PutSavingsProductsProductIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsProductsApiResourceSwagger.PutSavingsProductsProductIdResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response = SavingsProductsApiResourceSwagger.GetSavingsProductsResponse.class)
  })
  public String retrieveAll(@Context final UriInfo uriInfo) {
    ...
    final Collection<SavingsProductData> products =
        this.savingProductReadPlatformService.retrieveAll();

    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, products, SavingsApiSetConstants.SAVINGS_PRODUCT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Savings Product",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsProductsApiResourceSwagger.GetSavingsProductsProductIdResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Savings Product Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsProductsApiResourceSwagger.GetSavingsProductsTemplateResponse.class)
  })
  public String retrieveTemplate(@Context final UriInfo uriInfo) {
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, savingProduct, SavingsApiSetConstants.SAVINGS_PRODUCT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a Savings Product",
      httpMethod = "DELETE",
      notes = "Deletes a Savings Product")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsProductsApiResourceSwagger.DeleteSavingsProductsProductIdResponse.class)
  })
  public String delete(
      @PathParam("productId") @ApiParam(value = "productId") final Long productId) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteSavingProduct(productId).build();
