...
public class SavingsOfficerAssignmentHistory extends AbstractAuditableCustom {
  ...
  public static SavingsOfficerAssignmentHistory createNew(
      final SavingsAccount account, final Staff savingsOfficer, final LocalDate assignmentDate) {
    return new SavingsOfficerAssignmentHistory(
        account, savingsOfficer, assignmentDate.toDate(), null);
  }
  ...
  private SavingsOfficerAssignmentHistory(
      final SavingsAccount account,
      final Staff savingsOfficer,
