...
public class DepositAccountInterestRateChartData {
  ...
  public static DepositAccountInterestRateChartData instance(
      Long id,
      String name,
      String description,
      LocalDate fromDate,
    ...
    return new DepositAccountInterestRateChartData(
        id,
        name,
        description,
        fromDate,
  ...
  public static DepositAccountInterestRateChartData from(InterestRateChartData productChartData) {
    ...
    return new DepositAccountInterestRateChartData(
        id,
        productChartData.name(),
        productChartData.description(),
        productChartData.fromDate(),
        productChartData.endDate(),
        productChartData.isPrimaryGroupingByAmount(),
        accountId,
        accountNumber,
        fromProdChartSlabs,
        productChartData.periodTypes(),
        productChartData.entityTypeOptions(),
  ...
  public static DepositAccountInterestRateChartData withSlabs(
      DepositAccountInterestRateChartData interestRateChartData,
      Collection<DepositAccountInterestRateChartSlabData> chartSlabs) {
    return new DepositAccountInterestRateChartData(
        ...
        interestRateChartData.accountNumber,
        chartSlabs,
  ...
  public static DepositAccountInterestRateChartData withTemplate(
      DepositAccountInterestRateChartData interestRateChartData,
      Collection<EnumOptionData> periodTypes,
  ...
  public static DepositAccountInterestRateChartData template(
      Collection<EnumOptionData> periodTypes,
      final Collection<EnumOptionData> entityTypeOptions,
      final Collection<EnumOptionData> attributeNameOptions,
      final Collection<EnumOptionData> conditionTypeOptions,
  ...
  private DepositAccountInterestRateChartData(
      Long id,
      String name,
      String description,
      LocalDate fromDate,
