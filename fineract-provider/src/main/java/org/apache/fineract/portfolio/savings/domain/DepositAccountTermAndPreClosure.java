...
public class DepositAccountTermAndPreClosure extends AbstractPersistableCustom {
  ...
  private DepositAccountTermAndPreClosure(
      ...
      final LocalDate expectedFirstDepositOnDate,
      final DepositAccountOnClosureType accountOnClosureType,
      Boolean transferInterest) {
    this.depositAmount = depositAmount;
    this.maturityAmount = maturityAmount;
    this.maturityDate = (maturityDate == null) ? null : maturityDate.toDate();
    this.depositPeriod = depositPeriod;
    this.depositPeriodFrequency =
        (depositPeriodFrequency == null) ? null : depositPeriodFrequency.getValue();
    this.preClosureDetail = preClosureDetail;
    this.depositTermDetail = depositTermDetail;
    this.account = account;
    this.expectedFirstDepositOnDate =
        expectedFirstDepositOnDate == null ? null : expectedFirstDepositOnDate.toDate();
    this.onAccountClosureType =
        (accountOnClosureType == null) ? null : accountOnClosureType.getValue();
  ...
  public Map<String, Object> update(
    ...
    if (command.isChangeInIntegerParameterNamed(
        depositPeriodFrequencyIdParamName, this.depositPeriodFrequency)) {
      final Integer newValue =
          command.integerValueOfParameterNamed(depositPeriodFrequencyIdParamName);
      actualChanges.put(
          depositPeriodFrequencyIdParamName,
          SavingsEnumerations.depositTermFrequencyType(newValue));
    ...
    if (command.isChangeInLocalDateParameterNamed(
        expectedFirstDepositOnDateParamName, this.getExpectedFirstDepositOnDate())) {
      ...
      final String newValueAsString =
          command.stringValueOfParameterNamed(expectedFirstDepositOnDateParamName);
    ...
    if (command.isChangeInBooleanParameterNamed(
        transferInterestToSavingsParamName, this.transferInterestToLinkedAccount)) {
  ...
  public void updateMaturityDetails(
      ...
      final BigDecimal interestPayable,
      final LocalDate maturityDate) {
    this.depositAmount = depositAmount;
  ...
  public Integer getActualDepositPeriod(
    ...
    switch (depositPeriodFrequencyType) {
      ...
      case WEEKS:
        actualDepositPeriod =
            Weeks.weeksBetween(depositFromDate, interestPostingUpToDate).getWeeks();
        break;
      case MONTHS:
        actualDepositPeriod =
            Months.monthsBetween(depositFromDate, interestPostingUpToDate).getMonths();
        break;
      case YEARS:
        actualDepositPeriod =
            Years.yearsBetween(depositFromDate, interestPostingUpToDate).getYears();
        break;
      case INVALID:
  ...
  public DepositAccountTermAndPreClosure copy(BigDecimal depositAmount) {
    ...
    final SavingsPeriodFrequencyType depositPeriodFrequency =
        SavingsPeriodFrequencyType.fromInt(this.depositPeriodFrequency);
