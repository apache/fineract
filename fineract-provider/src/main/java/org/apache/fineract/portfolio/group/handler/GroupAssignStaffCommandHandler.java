...
public class GroupAssignStaffCommandHandler implements CommandHandler<GroupAssignStaffRequest, GroupCommandResponse> {
    ...
    @Override
    @Transactional
    public GroupCommandResponse handle(Command<GroupAssignStaffRequest> command) {
        return writeService.assignStaff(command.getPayload());
    }

    @Override
    public GroupCommandResponse fallback(Command<GroupAssignStaffRequest> command, Throwable t) {
