...
@Service
@CommandType(entity = "REPAYMENTWITHPOSTDATEDCHECKS", action = "CREATE")
public class AddPostDatedChecksHandler implements NewCommandSourceHandler {

    private final RepaymentWithPostDatedChecksWritePlatformService repaymentWithPostDatedChecksWritePlatformService;

    @Autowired
    public AddPostDatedChecksHandler(
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.repaymentWithPostDatedChecksWritePlatformService.addPostDatedChecks(command);
    }
}
