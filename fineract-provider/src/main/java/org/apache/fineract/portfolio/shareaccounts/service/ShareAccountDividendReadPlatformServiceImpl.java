...
public class ShareAccountDividendReadPlatformServiceImpl
  ...
  private final PaginationHelper<ShareAccountDividendData> paginationHelper =
  ...
  public List<Map<String, Object>> retriveDividendDetailsForPostDividents() {
    ...
    sb.append(
        " inner join m_share_product_dividend_pay_out spdpo on spdpo.id ="
    ...
    return this.jdbcTemplate.queryForList(
        sb.toString(),
        ShareProductDividendStatusType.APPROVED.getValue(),
        ShareAccountDividendStatusType.INITIATED.getValue());
  }

  @Override
  public Page<ShareAccountDividendData> retriveAll(
      final Long payoutDetailId, final SearchParameters searchParameters) {
  ...
  private static final class ShareAccountDividendMapper
    ...
    @Override
    public ShareAccountDividendData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      ...
      final ShareAccountData accountData =
          ShareAccountData.lookup(accounId, accountNumber, clientId, clientName);
      return new ShareAccountDividendData(
          id, accountData, amount, statusEnum, savingsTransactionId);
    }
  }
}
