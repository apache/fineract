...
public class GuarantorsApiResource {
    ...
    @Operation(summary = "Retrieve Guarantor Account Linking Template", description = "Retrieves a JSON template with metadata required to link a guarantor’s savings account to a loan. "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Guarantor Details", description = "Retrieves a guarantor details from the database. "
            + "This API is part of The Apache Fineract platform's guarantor management module.")
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Guarantor Details with Optional Template Metadata", description = "Fetches details of a specific guarantor associated with a given loan using the `loanId` and `guarantorId` path parameters. "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Add a Guarantor to a Loan Account", description = "Creates and attaches a new guarantor to the specified loan account. "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update an Existing Guarantor details on a Loan Account", description = "Updates the details of an existing guarantor associated with a specified loan account. "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Guarantor from a Loan Account", description = "Removes an existing guarantor associated with the specified loan account. "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Guarantor Account Linking Options Template", description = "Provides a template containing available savings accounts for a client that can be linked as guarantor funding sources for a loan. "
