...
public class ClientFamilyMembers extends AbstractPersistableCustom {
  ...
  private ClientFamilyMembers(
      ...
      final CodeValue relationship,
      final CodeValue maritalStatus,
  ...
  public static ClientFamilyMembers fromJson(
      final Client client,
      final String firstName,
      final String middleName,
      final String lastName,
      ...
      final Date dateOfBirth,
      final CodeValue profession) {
    return new ClientFamilyMembers(
        client,
        firstName,
        middleName,
        lastName,
