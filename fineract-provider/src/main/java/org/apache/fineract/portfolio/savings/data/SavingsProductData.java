...
public class SavingsProductData implements Serializable {
  ...
  public static SavingsProductData withCharges(
      final SavingsProductData product, final Collection<ChargeData> charges) {
    return new SavingsProductData(
        product.id,
        product.name,
        product.shortName,
        ...
        product.minRequiredBalance,
        product.enforceMinRequiredBalance,
   ...
   *            TODO
   */
  public static SavingsProductData withTemplate(
      final SavingsProductData existingProduct,
      final Collection<CurrencyData> currencyOptions,
      final Collection<EnumOptionData> interestCompoundingPeriodTypeOptions,
      final Collection<EnumOptionData> interestPostingPeriodTypeOptions,
      final Collection<EnumOptionData> interestCalculationTypeOptions,
    ...
    return new SavingsProductData(
        ...
        existingProduct.minRequiredOpeningBalance,
        existingProduct.lockinPeriodFrequency,
        existingProduct.lockinPeriodFrequencyType,
        existingProduct.withdrawalFeeForTransfers,
        ...
        existingProduct.allowOverdraft,
        ...
        existingProduct.daysToInactive,
        existingProduct.daysToDormancy,
        existingProduct.daysToEscheat);
  }

  public static SavingsProductData withAccountingDetails(
      final SavingsProductData existingProduct,
