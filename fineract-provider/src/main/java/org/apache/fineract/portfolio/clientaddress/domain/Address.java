...
private Address(String street,String address_line_1,String address_line_2,String address_line_3,
        String town_village,String city,String county_district,CodeValue state_province,
        CodeValue country,String postal_code,BigDecimal latitude,BigDecimal longitude,String created_by,Date created_on
...
public static Address fromJson(JsonCommand command,CodeValue state_province,CodeValue country)
{
    ...
    return new Address(street,address_line_1,address_line_2,address_line_3,
            town_village,city,county_district,state_province,
            country,postal_code,latitude,longitude,created_by,created_on
...
public static Address fromJsonObject(JsonObject jsonObject,CodeValue state_province,CodeValue country)
{
 ...
 /*   final String created_by=jsonObject.get("created_by").getAsString();
    ...
    return new Address(street,address_line_1,address_line_2,address_line_3,
            town_village,city,county_district,state_province,
            country,postal_code,latitude,longitude,null,null
            ,null,null);
}
...
public void setState_province(CodeValue state_province) {
    this.state_province = state_province;
}
