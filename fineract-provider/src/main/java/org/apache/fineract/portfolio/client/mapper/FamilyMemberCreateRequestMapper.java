...
public abstract class FamilyMemberCreateRequestMapper {

    @Mapping(ignore = true, target = "id")
    @Mapping(ignore = true, target = "client")
    @Mapping(ignore = true, target = "relationship")
    @Mapping(ignore = true, target = "maritalStatus")
    @Mapping(ignore = true, target = "gender")
    @Mapping(ignore = true, target = "profession")
    public abstract ClientFamilyMembers map(FamilyMemberCreateRequest source);
}
