...
public final class LoanScheduleModelRepaymentPeriod implements LoanScheduleModelPeriod {
  ...
  private final Set<LoanInterestRecalcualtionAdditionalDetails> loanCompoundingDetails =
      new HashSet<>();

  public static LoanScheduleModelRepaymentPeriod repayment(
    ...
    return new LoanScheduleModelRepaymentPeriod(
        periodNumber,
        startDate,
        scheduledDueDate,
        principalDue,
  ...
  public LoanScheduleModelRepaymentPeriod(
      final int periodNumber,
