 ...
 */
public class LoanApplicationNotInSubmittedAndPendingApprovalStateCannotBeDeleted
  ...
  public LoanApplicationNotInSubmittedAndPendingApprovalStateCannotBeDeleted(final Long id) {
    super(
        "error.msg.loan.cannot.delete.loan.in.its.present.state",
        "Loan with identifier " + id + " cannot be deleted in its current state.",
        id);
  }
}
