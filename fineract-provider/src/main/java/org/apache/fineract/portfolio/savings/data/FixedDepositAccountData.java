...
public class FixedDepositAccountData extends DepositAccountData {
  ...
  public static FixedDepositAccountData importInstance(
      Long clientId,
      Long productId,
      Long fieldOfficerId,
    ...
    return new FixedDepositAccountData(
        clientId,
        productId,
        fieldOfficerId,
        submittedOnDate,
  ...
  public static FixedDepositAccountData instance(
  ...
  public static FixedDepositAccountData withInterestChart(
  ...
  public static FixedDepositAccountData associationsAndTemplate(
      final FixedDepositAccountData account,
  ...
  public static FixedDepositAccountData withTemplateOptions(
      final FixedDepositAccountData account,
      ...
      final Collection<SavingsAccountData> savingsAccounts) {
  ...
  public static FixedDepositAccountData withClientTemplate(
  ...
  public static FixedDepositAccountData preClosureDetails(
  ...
  public static FixedDepositAccountData withClosureTemplateDetails(
      final FixedDepositAccountData account,
      final Collection<EnumOptionData> onAccountClosureOptions,
      final Collection<PaymentTypeData> paymentTypeOptions,
      final Collection<SavingsAccountData> savingsAccountDatas) {
