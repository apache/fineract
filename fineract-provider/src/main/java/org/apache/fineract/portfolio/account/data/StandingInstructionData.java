...
public class StandingInstructionData {
  ...
  public static StandingInstructionData template(
    ...
    return new StandingInstructionData(
        id,
        accountDetailId,
        name,
        fromOffice,
  ...
  public static StandingInstructionData instance(
      final Long id,
      ...
      final EnumOptionData transferType,
      final EnumOptionData priority,
      final EnumOptionData instructionType,
      final EnumOptionData status,
      final BigDecimal amount,
      final LocalDate validFrom,
      final LocalDate validTill,
      final EnumOptionData recurrenceType,
  ...
  public static StandingInstructionData withTemplateData(
      StandingInstructionData instructionData, StandingInstructionData templateData) {
    return new StandingInstructionData(
        instructionData.id,
        instructionData.accountDetailId,
        instructionData.name,
        instructionData.fromOffice,
        instructionData.fromClient,
        instructionData.fromAccountType,
        instructionData.fromAccount,
        instructionData.toOffice,
        instructionData.toClient,
        instructionData.toAccountType,
        instructionData.toAccount,
        instructionData.transferType,
        instructionData.priority,
        instructionData.instructionType,
        instructionData.status,
        instructionData.amount,
        instructionData.validFrom,
        instructionData.validTill,
        instructionData.recurrenceType,
        instructionData.recurrenceFrequency,
        instructionData.recurrenceInterval,
        instructionData.recurrenceOnMonthDay,
        instructionData.transactions,
        templateData.fromOfficeOptions,
        templateData.fromClientOptions,
        templateData.fromAccountTypeOptions,
        templateData.fromAccountOptions,
        templateData.toOfficeOptions,
        templateData.toClientOptions,
        templateData.toAccountTypeOptions,
        templateData.toAccountOptions,
        templateData.transferTypeOptions,
        templateData.statusOptions,
        templateData.instructionTypeOptions,
        templateData.priorityOptions,
        templateData.recurrenceTypeOptions,
  ...
  public static StandingInstructionData template(
      OfficeData fromOffice,
      ClientData fromClient,
      EnumOptionData fromAccountType,
      PortfolioAccountData fromAccount,
      LocalDate transferDate,
      OfficeData toOffice,
      ClientData toClient,
      EnumOptionData toAccountType,
      PortfolioAccountData toAccount,
      final Collection<OfficeData> fromOfficeOptions,
      final Collection<ClientData> fromClientOptions,
      final Collection<EnumOptionData> fromAccountTypeOptions,
      final Collection<PortfolioAccountData> fromAccountOptions,
  ...
  public static StandingInstructionData withTransferData(
      StandingInstructionData instructionData, final Page<AccountTransferData> transactions) {
    return new StandingInstructionData(
        instructionData.id,
        instructionData.accountDetailId,
        instructionData.name,
        ...
        instructionData.recurrenceOnMonthDay,
        transactions,
        instructionData.fromOfficeOptions,
        instructionData.fromClientOptions,
        instructionData.fromAccountTypeOptions,
        instructionData.fromAccountOptions,
        instructionData.toOfficeOptions,
        instructionData.toClientOptions,
        instructionData.toAccountTypeOptions,
        instructionData.toAccountOptions,
        instructionData.transferTypeOptions,
        instructionData.statusOptions,
        instructionData.instructionTypeOptions,
        instructionData.priorityOptions,
        instructionData.recurrenceTypeOptions,
  ...
  public StandingInstructionType instructionType() {
    ...
    if (this.instructionType != null) {
      standingInstructionType =
          StandingInstructionType.fromInt(this.instructionType.getId().intValue());
    }
  ...
  public AccountTransferRecurrenceType recurrenceType() {
    ...
    if (this.recurrenceType != null) {
      recurrenceType =
          AccountTransferRecurrenceType.fromInt(this.recurrenceType.getId().intValue());
    }
