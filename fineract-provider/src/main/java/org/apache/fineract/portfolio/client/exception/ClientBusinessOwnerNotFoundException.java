 ...
 */
public class ClientBusinessOwnerNotFoundException extends AbstractPlatformResourceNotFoundException {

    public ClientBusinessOwnerNotFoundException(final Long id) {
