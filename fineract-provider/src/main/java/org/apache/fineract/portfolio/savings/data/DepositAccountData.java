...
public class DepositAccountData {
  ...
  public static DepositAccountData instance(
      final Long id,
  ...
  public static DepositAccountData lookup(
      final Long id, final String accountNo, final EnumOptionData depositType) {
