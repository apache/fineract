...
public class LoanWritePlatformServiceJpaRepositoryImpl implements LoanWritePlatformService {
    ...
    public CommandProcessingResult disburseLoan(final Long loanId, final JsonCommand command, Boolean isAccountTransfer) {
        ...
        if (loan.loanProduct().isDisallowExpectedDisbursements()) {
            //create artificial 'tranche/expected disbursal' as current disburse code expects it for multi-disbursal products
            final Date artificialExpectedDate = Date.from(loan.getExpectedDisbursedOnLocalDate().atStartOfDay(ZoneId.systemDefault()).toInstant());
    ...
    private void validateMultiDisbursementData(final JsonCommand command, LocalDate expectedDisbursementDate, boolean isDisallowExpectedDisbursements) {
