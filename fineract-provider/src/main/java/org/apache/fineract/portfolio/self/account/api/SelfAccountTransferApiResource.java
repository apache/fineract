...
public class SelfAccountTransferApiResource {
  ...
  @ApiOperation(
      value = "Retrieve Account Transfer Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response = SelfAccountTransferApiResourceSwagger.GetAccountTransferTemplateResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        responseContainer = "List",
        response = SelfAccountTransferApiResourceSwagger.PostNewTransferResponse.class)
  })
