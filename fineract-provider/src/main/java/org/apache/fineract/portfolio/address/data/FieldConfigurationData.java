...
public class FieldConfigurationData {
  ...
  private FieldConfigurationData(
  ...
  public static FieldConfigurationData instance(
      final long fieldConfigurationId,
      final String entity,
      final String subentity,
      final String field,
      ...
      final boolean is_mandatory,
      final String validation_regex) {
    return new FieldConfigurationData(
        fieldConfigurationId, entity, subentity, field, is_enabled, is_mandatory, validation_regex);
  }
