...
public class LoanConvenienceData {
  ...
  public LoanConvenienceData(
      final int maxSubmittedOnOffsetFromToday,
      final int maxApprovedOnOffsetFromToday,
      final int maxDisbursedOnOffsetFromToday,
      final int expectedLoanTermInDays,
      final int actualLoanTermInDays,
      final int expectedLoanTermInMonths,
      final int actualLoanTermInMonths) {
