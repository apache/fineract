...
public class PocketAccountMappingData {
  ...
  private PocketAccountMappingData(
      final Collection<PocketAccountMapping> loanAccounts,
      Collection<PocketAccountMapping> savingsAccounts,
  ...
  public static PocketAccountMappingData instance(
      final Collection<PocketAccountMapping> loanAccounts,
      final Collection<PocketAccountMapping> savingsAccounts,
      final Collection<PocketAccountMapping> shareAccounts) {
