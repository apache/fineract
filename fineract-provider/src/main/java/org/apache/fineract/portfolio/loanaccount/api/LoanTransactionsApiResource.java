...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Capabilities include loan repayment's, interest waivers and the ability to 'adjust'"
                  + " an existing transaction. An 'adjustment' of a transaction is really a"
                  + " 'reversal' of existing transaction followed by creation of a new transaction"
                  + " with the provided details.")
    })
public class LoanTransactionsApiResource {

  private final Set<String> RESPONSE_DATA_PARAMETERS =
      new HashSet<>(Arrays.asList("id", "type", "date", "currency", "amount", "externalId"));
  ...
  @ApiOperation(
      value = "Retrieve Loan Transaction Template",
      httpMethod = "GET",
      notes =
  ...
  public String retrieveTransactionTemplate(
      ...
      @QueryParam("transactionDate") @ApiParam(value = "transactionDate")
          final DateParam transactionDateParam,
    ...
    if (is(commandParam, "repayment")) {
      ...
      transactionData =
          this.loanReadPlatformService.retrieveLoanPrePaymentTemplate(loanId, transactionDate);
      ...
      transactionData =
          this.loanReadPlatformService.retrieveLoanForeclosureTemplate(loanId, transactionDate);
    } else {
    ...
    return this.toApiJsonSerializer.serialize(
        settings, transactionData, this.RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Transaction Details",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            LoanTransactionsApiResourceSwagger.GetLoansLoanIdTransactionsTransactionIdResponse
                .class)
  })
  public String retrieveTransaction(
    ...
    transactionData.setLoanChargePaidByList(
        this.loanChargePaidByReadPlatformService.getLoanChargesPaidByTransactionId(transactionId));
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
  ...
  @ApiOperation(
      value =
          "Make a Repayment | Make a Refund of an Active Loan by Cash | Foreclosure of an Active"
              + " Loan | Waive Interest | Write-off Loan | Make Recovery Payment | Undo Loan"
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = LoanTransactionsApiResourceSwagger.PostLoansLoanIdTransactionsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = LoanTransactionsApiResourceSwagger.PostLoansLoanIdTransactionsResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            LoanTransactionsApiResourceSwagger.PostLoansLoanIdTransactionsTransactionIdRequest
                .class)
  })
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            LoanTransactionsApiResourceSwagger.PostLoansLoanIdTransactionsTransactionIdResponse
                .class)
  })
