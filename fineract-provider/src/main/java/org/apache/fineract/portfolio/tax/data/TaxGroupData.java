...
public class TaxGroupData implements Serializable {
  ...
  public static TaxGroupData instance(
      final Long id, final String name, final Collection<TaxGroupMappingsData> taxAssociations) {
  ...
  public static TaxGroupData template(
      final TaxGroupData taxGroupData, final Collection<TaxComponentData> taxComponents) {
    return new TaxGroupData(
        taxGroupData.id, taxGroupData.name, taxGroupData.taxAssociations, taxComponents);
  }

  private TaxGroupData(
      final Long id,
      final String name,
