...
public class LoanProductVariableInstallmentConfig extends AbstractPersistableCustom {
  ...
  public LoanProductVariableInstallmentConfig(
      final LoanProduct loanProduct, final Integer minimumGap, final Integer maximumGap) {
  ...
  public Map<? extends String, ? extends Object> update(JsonCommand command) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        LoanProductConstants.minimumGapBetweenInstallments, this.minimumGap)) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        LoanProductConstants.maximumGapBetweenInstallments, this.maximumGap)) {
      final Integer newValue =
