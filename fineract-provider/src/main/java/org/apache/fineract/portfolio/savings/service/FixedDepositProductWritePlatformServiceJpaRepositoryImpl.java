...
public class FixedDepositProductWritePlatformServiceJpaRepositoryImpl
  ...
  @Autowired
  public FixedDepositProductWritePlatformServiceJpaRepositoryImpl(
  ...
  public CommandProcessingResult create(final JsonCommand command) {
    ...
    try {
      ...
      final FixedDepositProduct product =
          this.depositProductAssembler.assembleFixedDepositProduct(command);
      ...
      this.accountMappingWritePlatformService.createSavingProductToGLAccountMapping(
          product.getId(), command, DepositAccountType.FIXED_DEPOSIT);
