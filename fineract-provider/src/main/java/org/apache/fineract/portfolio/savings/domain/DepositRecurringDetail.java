...
public class DepositRecurringDetail {
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    if (command.isChangeInBooleanParameterNamed(
        isMandatoryDepositParamName, this.isMandatoryDeposit)) {
    ...
    if (command.isChangeInBooleanParameterNamed(
        adjustAdvanceTowardsFuturePaymentsParamName, this.adjustAdvanceTowardsFuturePayments)) {
      final boolean newValue =
  ...
  public DepositRecurringDetail copy() {
    return DepositRecurringDetail.createFrom(
        this.isMandatoryDeposit, this.allowWithdrawal, this.adjustAdvanceTowardsFuturePayments);
  }
}
