...
public class LoanChargeData {
  ...
  public LoanChargeData(
      LoanChargeData chargeData, Collection<LoanInstallmentChargeData> installmentChargeData) {
    this.id = chargeData.id;
    this.chargeId = chargeData.chargeId;
  ...
  public LoanChargeData(
      final Long id, final LocalDate dueAsOfDate, final BigDecimal amountOrPercentage) {
    this.id = id;
    this.chargeId = null;
    this.name = null;
    this.currency = null;
  ...
  public boolean isChargePayable() {
    ...
    if (this.chargePaymentMode != null) {
      isAccountTransfer =
          ChargePaymentMode.fromInt(this.chargePaymentMode.getId().intValue())
  ...
  public boolean isInstallmentFee() {
    ...
    if (this.chargeTimeType != null) {
      isInstalmentFee =
          ChargeTimeType.fromInt(this.chargeTimeType.getId().intValue()).isInstalmentFee();
    }
