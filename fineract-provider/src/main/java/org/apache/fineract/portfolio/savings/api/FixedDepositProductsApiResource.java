...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "This is one of the advanced term deposit product offered by MFI's. The Fixed"
                  + " Deposit Products (aka FD) product offerings are modeled using this API.\n"
                  + "\n"
                  + "The FD products are deposit accounts which are held for a fixed term – like 1"
                  + " year, 2 years etc.\n"
                  + "\n"
                  + "When creating fixed deposit accounts, the details from the fixed deposit"
                  + " product are used to auto fill details of the fixed deposit account"
                  + " application process.")
    })
public class FixedDepositProductsApiResource {
  ...
  @Autowired
  public FixedDepositProductsApiResource(
  ...
  @ApiOperation(
      value = "Create a Fixed Deposit Product",
      httpMethod = "POST",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = FixedDepositProductsApiResourceSwagger.PostFixedDepositProductsResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Fixed Deposit Product",
      httpMethod = "PUT",
      notes = "Updates a Fixed Deposit Product")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
  ...
  public String update(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateFixedDepositProduct(productId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "List Fixed Deposit Products",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = FixedDepositProductsApiResourceSwagger.GetFixedDepositProductsResponse.class,
  ...
  public String retrieveAll(@Context final UriInfo uriInfo) {
    ...
    this.context
        .authenticatedUser()
        .validateHasReadPermission(DepositsApiConstants.FIXED_DEPOSIT_PRODUCT_RESOURCE_NAME);

    @SuppressWarnings({"unchecked", "rawtypes"})
    final Collection<FixedDepositProductData> products =
        (Collection)
            this.depositProductReadPlatformService.retrieveAll(DepositAccountType.FIXED_DEPOSIT);

    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, products, DepositsApiConstants.FIXED_DEPOSIT_PRODUCT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Fixed Deposit Product",
      httpMethod = "GET",
      notes =
  ...
  public String retrieveOne(
    ...
    FixedDepositProductData fixedDepositProductData =
        (FixedDepositProductData)
            this.depositProductReadPlatformService.retrieveOne(
    ...
    final Collection<InterestRateChartData> charts =
        this.chartReadPlatformService.retrieveAllWithSlabsWithTemplate(productId);
    fixedDepositProductData =
        FixedDepositProductData.withInterestChart(fixedDepositProductData, charts);
    ...
    if (fixedDepositProductData.hasAccountingEnabled()) {
      final Map<String, Object> accountingMappings =
          this.accountMappingReadPlatformService.fetchAccountMappingDetailsForSavingsProduct(
              productId, fixedDepositProductData.accountingRuleTypeId());
      ...
      fixedDepositProductData =
          FixedDepositProductData.withAccountingDetails(
              fixedDepositProductData,
              accountingMappings,
  ...
  private FixedDepositProductData handleTemplateRelatedData(
      final FixedDepositProductData savingsProduct) {
    ...
    final Collection<EnumOptionData> interestCompoundingPeriodTypeOptions =
        this.savingsDropdownReadPlatformService.retrieveCompoundingInterestPeriodTypeOptions();

    final Collection<EnumOptionData> interestPostingPeriodTypeOptions =
        this.savingsDropdownReadPlatformService.retrieveInterestPostingPeriodTypeOptions();

    final Collection<EnumOptionData> interestCalculationTypeOptions =
        this.savingsDropdownReadPlatformService.retrieveInterestCalculationTypeOptions();

    final Collection<EnumOptionData> interestCalculationDaysInYearTypeOptions =
        this.savingsDropdownReadPlatformService.retrieveInterestCalculationDaysInYearTypeOptions();

    final Collection<EnumOptionData> lockinPeriodFrequencyTypeOptions =
        this.savingsDropdownReadPlatformService.retrieveLockinPeriodFrequencyTypeOptions();

    final Collection<EnumOptionData> withdrawalFeeTypeOptions =
        this.savingsDropdownReadPlatformService.retrievewithdrawalFeeTypeOptions();
    ...
    final Collection<EnumOptionData> preClosurePenalInterestOnTypeOptions =
        this.depositsDropdownReadPlatformService.retrievePreClosurePenalInterestOnTypeOptions();
    ...
    Collection<ChargeData> penaltyOptions =
        this.chargeReadPlatformService.retrieveSavingsApplicablePenalties();
    ...
    final InterestRateChartData chartTemplate =
        this.interestRateChartReadPlatformService.template();

    FixedDepositProductData fixedDepositProductToReturn = null;
    if (savingsProduct != null) {
      fixedDepositProductToReturn =
          FixedDepositProductData.withTemplate(
              savingsProduct,
              currencyOptions,
      ...
      fixedDepositProductToReturn =
          FixedDepositProductData.template(
              currency,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a Fixed Deposit Product",
      httpMethod = "DELETE",
      notes = "Deletes a Fixed Deposit Product")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response =
            FixedDepositProductsApiResourceSwagger.DeleteFixedDepositProductsProductIdResponse
                .class)
  })
  public String delete(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteFixedDepositProduct(productId).build();
