...
public class CollateralCannotBeCreatedException extends AbstractPlatformDomainRuleException {
  ...
  public static enum LoanCollateralCannotBeCreatedReason {
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("LOAN_NOT_IN_SUBMITTED_AND_PENDING_APPROVAL_STAGE")) {
        return "This collateral cannot be created as the loan it is associated with is not in"
  ...
  public CollateralCannotBeCreatedException(
      final LoanCollateralCannotBeCreatedReason reason, final Long loanId) {
