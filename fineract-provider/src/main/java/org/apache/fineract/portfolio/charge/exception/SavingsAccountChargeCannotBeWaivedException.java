...
public class SavingsAccountChargeCannotBeWaivedException
  ...
  public static enum SavingsAccountChargeCannotBeWaivedReason {
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("ALREADY_PAID")) {
        ...
        return "This savings account charge cannot be waived as the Savings account associated"
  ...
  public SavingsAccountChargeCannotBeWaivedException(
      final SavingsAccountChargeCannotBeWaivedReason reason, final Long savingsAccountChargeId) {
