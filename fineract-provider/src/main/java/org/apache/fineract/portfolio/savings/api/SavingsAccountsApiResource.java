...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Savings accounts are instances of a particular savings product created for an"
                  + " individual or group. An application process around the creation of accounts"
                  + " is also supported.")
    })
public class SavingsAccountsApiResource {
  ...
  @ApiOperation(
      value = "Retrieve Savings Account Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.GetSavingsAccountsTemplateResponse.class)
  })
  public String template(
    ...
    final SavingsAccountData savingsAccount =
        this.savingsAccountReadPlatformService.retrieveTemplate(
            clientId, groupId, productId, staffInSelectedOfficeOnly);

    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, savingsAccount, SavingsApiSetConstants.SAVINGS_ACCOUNT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "List savings applications/accounts",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.GetSavingsAccountsResponse.class)
  })
  public String retrieveAll(
    ...
    final SearchParameters searchParameters =
        SearchParameters.forSavings(sqlSearch, externalId, offset, limit, orderBy, sortOrder);
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, products, SavingsApiSetConstants.SAVINGS_ACCOUNT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Submit new savings application",
      httpMethod = "POST",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SavingsAccountsApiResourceSwagger.PostSavingsAccountsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.PostSavingsAccountsResponse.class)
  })
  public String submitApplication(@ApiParam(hidden = true) final String apiRequestBodyAsJson) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createSavingsAccount().withJson(apiRequestBodyAsJson).build();
  ...
  public String submitGSIMApplication(final String apiRequestBodyAsJson) {
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createGSIMAccount().withJson(apiRequestBodyAsJson).build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a savings application/account",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.GetSavingsAccountsAccountIdResponse.class)
  })
  ...
  private SavingsAccountData populateTemplateAndAssociations(
    ...
    if (!associationParameters.isEmpty()) {
      ...
      if (associationParameters.contains(SavingsApiConstants.transactions)) {
        ...
        final Collection<SavingsAccountTransactionData> currentTransactions =
            this.savingsAccountReadPlatformService.retrieveAllTransactions(
                accountId, DepositAccountType.SAVINGS_DEPOSIT);
    ...
    return SavingsAccountData.withTemplateOptions(
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Modify a savings application | Modify savings account withhold tax applicability",
      httpMethod = "PUT",
      notes =
          "Modify a savings application:\n\n"
              + "Savings application can only be modified when in 'Submitted and pending approval'"
              + " state. Once the application is approved, the details cannot be changed using"
              + " this method. Specific api endpoints will be created to allow change of interest"
              + " detail such as rate, compounding period, posting period etc\n\n"
              + "Modify savings account withhold tax applicability:\n\n"
              + "Savings application's withhold tax can be modified when in 'Active' state. Once"
              + " the application is activated, can modify the account withhold tax to post tax or"
              + " vice-versaShowing request/response for 'Modify a savings application'")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SavingsAccountsApiResourceSwagger.PutSavingsAccountsAccountIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.PutSavingsAccountsAccountIdResponse.class)
  })
  public String update(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateSavingsAccount(accountId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  public String updateGsim(
      @PathParam("parentAccountId") final Long parentAccountId, final String apiRequestBodyAsJson) {
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateGSIMAccount(parentAccountId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public String handleGSIMCommands(
      @PathParam("parentAccountId") final Long parentAccountId,
      @QueryParam("command") final String commandParam,
    ...
    if (result == null) {
      throw new UnrecognizedQueryParamException(
          ...
          new Object[] {
            ...
            SavingsApiConstants.COMMAND_BLOCK_DEBIT,
            SavingsApiConstants.COMMAND_UNBLOCK_DEBIT,
            SavingsApiConstants.COMMAND_BLOCK_CREDIT,
  ...
  @ApiOperation(
      value =
          "Approve savings application | Undo approval savings application | Assign Savings"
              + " Officer | Unassign Savings Officer | Reject savings application | Withdraw"
              + " savings application | Activate a savings account | Close a savings account |"
              + " Calculate Interest on Savings Account | Post Interest on Savings Account | Block"
              + " Savings Account | Unblock Savings Account | Block Savings Account Credit"
              + " transactions | Unblock Savings Account Credit transactions | Block Savings"
              + " Account Debit transactions | Unblock Savings Account debit transactions",
      httpMethod = "POST",
      notes =
          "Approve savings application:\n\n"
              + "Approves savings application so long as its in 'Submitted and pending approval'"
              + " state.\n\n"
              + "Undo approval savings application:\n\n"
              + "Will move 'approved' savings application back to 'Submitted and pending approval'"
              + " state.\n\n"
              ...
              + "Rejects savings application so long as its in 'Submitted and pending approval'"
              + " state.\n\n"
              + "Withdraw savings application:\n\n"
              + "Used when an applicant withdraws from the savings application. It must be in"
              + " 'Submitted and pending approval' state.\n\n"
              + "Activate a savings account:\n\n"
              + "Results in an approved savings application being converted into an 'active'"
              + " savings account.\n\n"
              + "Close a savings account:\n\n"
              + "Results in an Activated savings application being converted into an 'closed'"
              + " savings account.\n"
              + "\n"
              + "closedOnDate is closure date of savings account\n"
              + "\n"
              + "withdrawBalance is a boolean value, true value of this field performs a"
              + " withdrawal transaction with account's running balance.\n\n"
              + "Mandatory Fields: dateFormat,locale,closedOnDate\n\n"
              + "Optional Fields: note, withdrawBalance, paymentTypeId, accountNumber,"
              + " checkNumber, routingCode, receiptNumber, bankNumber\n\n"
              + "Calculate Interest on Savings Account:\n\n"
              + "Calculates interest earned on a savings account based on todays date. It does not"
              + " attempt to post or credit the interest on the account. That is responsibility of"
              + " the Post Interest API that will likely be called by overnight process.\n\n"
              + "Post Interest on Savings Account:\n\n"
              + "Calculates and Posts interest earned on a savings account based on today's date"
              + " and whether an interest posting or crediting event is due.\n\n"
              + "Block Savings Account:\n\n"
              + "Blocks Savings account from all types of credit and debit transactions\n\n"
              + "Unblock Savings Account:\n\n"
              + "Unblock a blocked account. On unblocking account, user can perform debit and"
              + " credit transactions\n\n"
              ...
              + "It unblocks the Saving account's credit operations. Now all types of credits can"
              + " be transacted to Savings account\n\n"
              ...
              + "It unblocks the Saving account's debit operations. Now all types of debits can be"
              + " transacted from Savings account\n\n"
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SavingsAccountsApiResourceSwagger.PostSavingsAccountsAccountIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.PostSavingsAccountsAccountIdResponse.class)
  })
  public String handleCommands(
    ...
    if (is(commandParam, "reject")) {
      ...
      final CommandWrapper commandRequest =
          builder.withNoJsonBody().blockSavingsAccount(accountId).build();
      result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    } else if (is(commandParam, SavingsApiConstants.COMMAND_UNBLOCK_ACCOUNT)) {
      final CommandWrapper commandRequest =
          builder.withNoJsonBody().unblockSavingsAccount(accountId).build();
      result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a savings application",
      httpMethod = "DELETE",
      notes =
          "At present we support hard delete of savings application so long as its in 'Submitted"
              + " and pending approval' state. One the application is moves past this state, it is"
              + " not possible to do a 'hard' delete of the application or the account. An API"
              + " endpoint will be added to close/de-activate the savings account.")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SavingsAccountsApiResourceSwagger.DeleteSavingsAccountsAccountIdResponse.class)
  })
  public String delete(
      @PathParam("accountId") @ApiParam(value = "accountId") final Long accountId) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteSavingsAccount(accountId).build();
  ...
  public Response getSavingsTemplate(
  ...
  public String postSavingsTemplate(
  ...
  @Produces("application/vnd.ms-excel")
  public Response getSavingsTransactionTemplate(
      @QueryParam("officeId") final Long officeId,
      @QueryParam("dateFormat") final String dateFormat) {
    return bulkImportWorkbookPopulatorService.getTemplate(
        GlobalEntityType.SAVINGS_TRANSACTIONS.toString(), officeId, null, dateFormat);
  }

  @POST
  @Path("transactions/uploadtemplate")
  @Consumes(MediaType.MULTIPART_FORM_DATA)
  public String postSavingsTransactionTemplate(
      @FormDataParam("file") InputStream uploadedInputStream,
      @FormDataParam("file") FormDataContentDisposition fileDetail,
      @FormDataParam("locale") final String locale,
      @FormDataParam("dateFormat") final String dateFormat) {
    final Long importDocumentId =
        this.bulkImportWorkbookService.importWorkbook(
            GlobalEntityType.SAVINGS_TRANSACTIONS.toString(),
            uploadedInputStream,
            fileDetail,
            locale,
            dateFormat);
