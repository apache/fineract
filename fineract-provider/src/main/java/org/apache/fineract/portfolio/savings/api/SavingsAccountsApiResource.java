    ...
    private SavingsAccountData populateTemplateAndAssociations(final Long accountId, final SavingsAccountData savingsAccount,
        ...
        if (!associationParameters.isEmpty()) {
            ...
            if (associationParameters.contains(SavingsApiConstants.transactions)) {
                ...
                transactionSize = this.savingsAccountReadPlatformService.getSavingsAccountTransactionTotalFiltered(accountId, DepositAccountType.SAVINGS_DEPOSIT,true);
            ...
            if (associationParameters.contains(SavingsApiConstants.accrualTransactions)) {
                ...
                transactionSize = this.savingsAccountReadPlatformService.getSavingsAccountTransactionTotalFiltered(accountId, DepositAccountType.SAVINGS_DEPOSIT,false);
                if (!CollectionUtils.isEmpty(currentTransactions)) {
                    transactions = currentTransactions;
                }
            }
        ...
        SavingsAccountData savingsAccountData =  SavingsAccountData.withTemplateOptions(savingsAccount, templateData, transactions, charges, blockNarrationsOptions, blockNarrationHistoryData);
