...
public final class CalculateLoanScheduleQueryFromApiJsonHelper {
  ...
  public void validate(final String json) {
    ...
    validateRepaymentsStartingFromDateIsAfterDisbursementDate(
        dataValidationErrors, expectedDisbursementDate, repaymentsStartingFromDate);
        ...
        if (loanTermFrequency.intValue() < suggestsedLoanTerm) {
          final ApiParameterError error =
              ApiParameterError.parameterError(
                  ...
                  "The parameter loanTermFrequency is less than the suggest loan term as indicated"
                      + " by numberOfRepayments and repaymentEvery.",
                  "loanTermFrequency",
                  loanTermFrequency,
                  numberOfRepayments,
                  repaymentEvery);
          ...
          if (loanTermFrequency.intValue() > suggestsedLoanTerm) {
            final ApiParameterError error =
                ApiParameterError.parameterError(
                    ...
                    "The parameter loanTermFrequency is greater than the suggested loan term as"
                        + " indicated by numberOfRepayments and repaymentEvery.",
                    "loanTermFrequency",
                    loanTermFrequency,
                    numberOfRepayments,
                    repaymentEvery);
      ...
      if (repaymentsStartingFromDate != null
        ...
        final ApiParameterError error =
            ApiParameterError.parameterError(
                ...
                "The parameter expectedDisbursementDate has a date which falls after the date for"
                    + " repaymentsStartingFromDate.",
