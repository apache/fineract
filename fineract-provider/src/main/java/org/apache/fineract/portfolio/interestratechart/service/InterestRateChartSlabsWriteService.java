...
public interface InterestRateChartSlabsWriteService {

    InterestRateChartSlabsCreateResponse createInterestRateChartSlab(InterestRateChartSlabsCreateRequest request);

    InterestRateChartSlabsUpdateResponse updateInterestRateChartSlab(InterestRateChartSlabsUpdateRequest request);

    InterestRateChartSlabsDeleteResponse deleteInterestRateChartSlab(InterestRateChartSlabsDeleteRequest request);
}
