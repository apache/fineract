...
public class ShareAccountReadPlatformServiceImpl implements ShareAccountReadPlatformService {
  ...
  public ShareAccountData retrieveTemplate(Long clientId, Long productId) {
    ...
    ProductReadPlatformService service =
        (ProductReadPlatformService) this.applicationContext.getBean(serviceName);
    ...
    if (productId != null) {
      ...
      final Collection<ShareAccountChargeData> charges =
          convertChargesToShareAccountCharges(productCharges);
      final Collection<EnumOptionData> lockinPeriodFrequencyTypeOptions =
          this.shareProductDropdownReadPlatformService.retrieveLockinPeriodFrequencyTypeOptions();
      ...
      final Collection<SavingsAccountData> clientSavingsAccounts =
          this.savingsAccountReadPlatformService.retrieveActiveForLookup(
              clientId, DepositAccountType.SAVINGS_DEPOSIT, productData.getCurrency().code());
      toReturn =
          new ShareAccountData(
              client.id(),
              client.displayName(),
      ...
      toReturn =
          new ShareAccountData(client.id(), client.displayName(), productOptions, chargeOptions);
    }
    return toReturn;
  }
  ...
  public ShareAccountData retrieveOne(final Long id, final boolean includeTemplate) {
    ...
    ShareAccountData data =
        (ShareAccountData) this.jdbcTemplate.queryForObject(query, mapper, new Object[] {id});
    String serviceName = "share" + ProductsApiConstants.READPLATFORM_NAME;
    ProductReadPlatformService service =
        (ProductReadPlatformService) this.applicationContext.getBean(serviceName);
    final ShareProductData productData =
        (ShareProductData) service.retrieveOne(data.getProductId(), false);
    ...
    if (includeTemplate) {
      ...
      final Collection<SavingsAccountData> clientSavingsAccounts =
          this.savingsAccountReadPlatformService.retrieveActiveForLookup(
              ...
              productData.getCurrency().code());
      Collection<ProductData> productOptions = service.retrieveAllForLookup();
      final Collection<ChargeData> chargeOptions =
          this.chargeReadPlatformService.retrieveSharesApplicableCharges();
      data =
          ShareAccountData.template(
              data,
              productOptions,
              chargeOptions,
              clientSavingsAccounts,
  ...
  private Collection<ShareAccountDividendData> retrieveAssociatedDividends(
  ...
  public Page<AccountData> retrieveAll(final Integer offSet, final Integer limit) {
    ...
    return this.shareAccountDataPaginationHelper.fetchPage(
        this.jdbcTemplate, sqlCountRows, sqlBuilder.toString(), whereClauseItemsitems, mapper);
  }
  ...
  @Override
  public Collection<ShareAccountData> retrieveAllShareAccountDataForDividends(
      final Long id, final boolean fetchInActiveAccounts, final LocalDate startDate) {
  ...
  public Collection<ShareAccountChargeData> convertChargesToShareAccountCharges(
      Collection<ChargeData> productCharges) {
  ...
  private static final class ShareAccountMapper implements RowMapper<AccountData> {
    ...
    public ShareAccountMapper(
      ...
      StringBuilder buff =
          new StringBuilder()
              ...
              .append(
                  "sa.account_no as accountNo, sa.total_approved_shares as approvedShares,"
                      + " sa.total_pending_shares as pendingShares, ")
              .append(
                  "sa.savings_account_id as savingsAccountNo, sa.minimum_active_period_frequency"
                      + " as minimumactivePeriod, ")
              .append("sa.minimum_active_period_frequency_enum as minimumactivePeriodEnum, ")
              .append(
                  "sa.lockin_period_frequency as lockinPeriod, sa.lockin_period_frequency_enum as"
                      + " lockinPeriodEnum, ")
              ...
              .append(
                  "curr.name as currencyName, curr.internationalized_name_code as"
                      + " currencyNameCode, ")
              .append(
                  "curr.display_symbol as currencyDisplaySymbol, sa.product_id as productId,"
                      + " p.name as productName, p.short_name as shortProductName ")
    ...
    @Override
    public ShareAccountData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      ...
      final Boolean allowdividendsforinactiveclients =
          rs.getBoolean("allowdividendsforinactiveclients");
      ...
      final ShareAccountApplicationTimelineData timeline =
          new ShareAccountApplicationTimelineData(
              submittedOnDate,
              submittedByUsername,
      ...
      if (lockinPeriodFrequencyTypeValue != null) {
        lockinPeriodFrequencyType =
            SharesEnumerations.lockinPeriodFrequencyType(lockinPeriodFrequencyTypeValue);
      }
      ...
      final Integer minimumActivePeriodTypeValue =
          JdbcSupport.getInteger(rs, "minimumactivePeriodEnum");
      if (minimumActivePeriodTypeValue != null) {
        minimumActivePeriodType =
            SharesEnumerations.minimumActivePeriodFrequencyType(minimumActivePeriodTypeValue);
      }

      final String shortProductName = null;
      final ShareAccountSummaryData summary =
          new ShareAccountSummaryData(
              id,
              accountNo,
              externalId,
              productId,
  ...
  private static final class ShareAccountMapperForDividents implements RowMapper<ShareAccountData> {
    ...
    private final String schema;
    final PurchasedSharesDataRowMapper purchasedSharesDataRowMapper =
        new PurchasedSharesDataRowMapper();
  ...
  private static final class PurchasedSharesDataRowMapper
      implements RowMapper<ShareAccountTransactionData> {
    ...
    public PurchasedSharesDataRowMapper() {
      StringBuilder buff =
          new StringBuilder()
              .append(
                  "saps.id as purchasedId, saps.account_id as accountId, saps.transaction_date as"
                      + " transactionDate, saps.total_shares as purchasedShares, saps.unit_price"
                      + " as unitPrice, ")
              .append(
                  "saps.status_enum as purchaseStatus, saps.type_enum as purchaseType, saps.amount"
                      + " as amount, saps.charge_amount as chargeamount, ")
    ...
    @Override
    public ShareAccountTransactionData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      ...
      return new ShareAccountTransactionData(
          id,
          accountId,
          transactionDate,
          numberOfShares,
  ...
  private static final class ShareAccountDividendRowMapper
      implements RowMapper<ShareAccountDividendData> {
    ...
    public ShareAccountDividendData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      return new ShareAccountDividendData(
          id, postedDate, shareAccountData, postedAmount, statusEnum, savingTransactionId);
    }
