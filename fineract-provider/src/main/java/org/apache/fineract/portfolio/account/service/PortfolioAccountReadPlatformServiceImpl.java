...
public class PortfolioAccountReadPlatformServiceImpl
  ...
  @Override
  public PortfolioAccountData retrieveOne(
      final Long accountId, final Integer accountTypeId, final String currencyCode) {
  ...
  @Override
  public Collection<PortfolioAccountData> retrieveAllForLookup(
    ...
    switch (accountType) {
      ...
      case LOAN:
        ...
        if (portfolioAccountDTO.getClientId() != null) {
          sql +=
              " la.client_id = ? and la.loan_status_id in ("
      ...
      case SAVINGS:
        ...
        if (portfolioAccountDTO.getClientId() != null) {
          sql +=
              " sa.client_id = ? and sa.status_enum in (" + defaultAccountStatus.toString() + ") ";
          sqlParams.add(portfolioAccountDTO.getClientId());
        } else {
  ...
  private static final class PortfolioSavingsAccountMapper
    ...
    @Override
    public PortfolioAccountData mapRow(
      ...
      return new PortfolioAccountData(
          id,
          accountNo,
          externalId,
          groupId,
  ...
  private static final class PortfolioLoanAccountMapper implements RowMapper<PortfolioAccountData> {
    ...
    public PortfolioAccountData mapRow(
      ...
      final Integer currencyDigits = JdbcSupport.getInteger(rs, "currencyDigits");
      final Integer inMulitplesOf = JdbcSupport.getInteger(rs, "inMultiplesOf");
      final BigDecimal amtForTransfer =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "totalOverpaid");
      final CurrencyData currency =
          new CurrencyData(
              currencyCode,
              currencyName,
  ...
  private static final class PortfolioLoanAccountRefundByTransferMapper
    ...
    public PortfolioLoanAccountRefundByTransferMapper() {
      ...
      amountQueryString.append("SUM(ifnull(mr.fee_charges_completed_derived, 0)) + ");
      amountQueryString.append(
          "SUM(ifnull(mr.penalty_charges_completed_derived, 0))) > 0) as totalOverpaid ");
  ...
  public PortfolioAccountData retrieveOneByPaidInAdvance(Long accountId, Integer accountTypeId) {
    ...
    try {
      ...
      accountData =
          this.jdbcTemplate.queryForObject(sql, this.accountRefundByTransferMapper, sqlParams);
