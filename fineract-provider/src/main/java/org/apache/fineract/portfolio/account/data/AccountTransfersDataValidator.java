...
public class AccountTransfersDataValidator {
    ...
    public void validate(final JsonCommand command) {
        ...
        validateTransferTime(element, dataValidationErrors);
    ...
    private void validateTransferTime(final JsonElement element, final List<ApiParameterError> dataValidationErrors) {
        try {
