...
public class NubanAccountServiceImpl implements NubanAccountService {
     ...
     * VFD Group code is  566
     * Assume a NUBAN serial number of 000021457 in VFD Group
     * The check digit would be computed as follows:
     * Step 1: 5*3+6*7+6*3+0*3+0*7+0*3+0*3+2*7+1*3+4*3+5*7+7*3 = 160
     * Step 2: Modulo 10 of 160 is 0 i.e. 0 is the remainder when you divide 160 by 10
     * Step 3: Subtract 0 from 10 to get 10
     * Step 4: So the check digit is 0 (if the result is 10 use 0 as the check digit)
