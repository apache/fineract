...
public final class LoanScheduleModelDisbursementPeriod implements LoanScheduleModelPeriod {
  ...
  public static LoanScheduleModelDisbursementPeriod disbursement(
      final LoanApplicationTerms loanApplicationTerms,
      final BigDecimal chargesDueAtTimeOfDisbursement) {

    final int periodNumber = 0;
    return new LoanScheduleModelDisbursementPeriod(
        periodNumber,
  ...
  public static LoanScheduleModelDisbursementPeriod disbursement(
      ...
      final BigDecimal chargesDueAtTimeOfDisbursement) {
    return new LoanScheduleModelDisbursementPeriod(
        null, disbursementDate, principalDisbursed, chargesDueAtTimeOfDisbursement);
  }

  private LoanScheduleModelDisbursementPeriod(
  ...
  public LoanSchedulePeriodData toData() {
    return LoanSchedulePeriodData.disbursementOnlyPeriod(
        this.disbursementDate,
        this.principalDisbursed.getAmount(),
        this.chargesDueAtTimeOfDisbursement,
        false);
  }
  ...
  @Override
  public void addLoanCharges(
      @SuppressWarnings("unused") BigDecimal feeCharge,
