...
public class SavingsProductReadPlatformServiceImpl implements SavingsProductReadPlatformService {
  ...
  @Autowired
  public SavingsProductReadPlatformServiceImpl(
  ...
  public Collection<SavingsProductData> retrieveAll() {
    ...
    String sql =
        "select " + this.savingsProductRowMapper.schema() + "where sp.deposit_type_enum = ?";
  ...
  private static final class SavingProductMapper implements RowMapper<SavingsProductData> {
    ...
    public SavingsProductData mapRow(
      ...
      final BigDecimal nominalAnnualInterestRateOverdraft =
          rs.getBigDecimal("nominalAnnualInterestRateOverdraft");
      final BigDecimal minOverdraftForInterestCalculation =
          rs.getBigDecimal("minOverdraftForInterestCalculation");
