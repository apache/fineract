...
public class AccountDetailsReadPlatformServiceJpaRepositoryImpl
  ...
  public AccountSummaryCollectionData retrieveClientAccountDetails(final Long clientId) {
    ...
    // note to self: investigate the effect of have loans stored as another type especially given
    // that we want to maintain how the system currently handles loans of exisiting types.
    final String savingswhereClause =
        " where sa.client_id = ? order by sa.status_enum ASC, sa.account_no ASC";

    final String guarantorWhereClause =
        " where g.entity_id = ? and g.is_active = 1 order by l.account_no ASC";
    ...
    final List<SavingsAccountSummaryData> savingsAccounts =
        retrieveAccountDetails(savingswhereClause, new Object[] {clientId});
    ...
    final List<GuarantorAccountSummaryData> guarantorloanAccounts =
        retrieveGuarantorLoanAccountDetails(guarantorWhereClause, new Object[] {clientId});
    return new AccountSummaryCollectionData(
        loanAccounts, glimAccounts, savingsAccounts, shareAccounts, guarantorloanAccounts);
  }
  ...
  public AccountSummaryCollectionData retrieveGroupAccountDetails(final Long groupId) {
    ...
    final String loanWhereClauseForGroupAndLoanType =
        " where l.group_id = ? and l.loan_type_enum=4";
    ...
    final String savingswhereClauseForGroup =
        " where sa.group_id = ? and sa.client_id is null order by sa.status_enum ASC,"
            + " sa.account_no ASC";
    final String savingswhereClauseForMembers =
        " where sa.group_id = ? and sa.client_id is not null order by sa.status_enum ASC,"
            + " sa.account_no ASC";

    final String guarantorWhereClauseForGroup =
        " where l.group_id = ? and l.client_id is null and g.is_active = 1 order by l.account_no"
            + " ASC";
    final String guarantorWhereClauseForMembers =
        " where l.group_id = ? and l.client_id is not null and g.is_active = 1 order by"
            + " l.account_no ASC";
    final List<LoanAccountSummaryData> glimAccounts =
    ...
    final List<SavingsAccountSummaryData> groupSavingsAccounts =
        retrieveAccountDetails(savingswhereClauseForGroup, new Object[] {groupId});
    final List<GuarantorAccountSummaryData> groupGuarantorloanAccounts =
        retrieveGuarantorLoanAccountDetails(guarantorWhereClauseForGroup, new Object[] {groupId});
    final List<LoanAccountSummaryData> memberLoanAccounts =
        retrieveLoanAccountDetails(loanWhereClauseForMembers, new Object[] {groupId});
    final List<SavingsAccountSummaryData> memberSavingsAccounts =
        retrieveAccountDetails(savingswhereClauseForMembers, new Object[] {groupId});

    final List<GuarantorAccountSummaryData> memberGuarantorloanAccounts =
        retrieveGuarantorLoanAccountDetails(guarantorWhereClauseForMembers, new Object[] {groupId});
    return new AccountSummaryCollectionData(
        groupLoanAccounts,
        glimAccounts,
        groupSavingsAccounts,
        groupGuarantorloanAccounts,
        memberLoanAccounts,
        memberSavingsAccounts,
        memberGuarantorloanAccounts);
  }

  @Override
  public AccountSummaryCollectionData retrieveGroupAccountDetails(
      final Long groupId, final Long gsimId) {
    // Check if group exists
    this.groupReadPlatformService.retrieveOne(groupId);
    final String loanWhereClauseForGroup = " where l.group_id = ? and l.client_id is null";
    final String loanWhereClauseForGroupAndLoanType =
    ...
    final String loanWhereClauseForMembers = " where l.group_id = ? and l.client_id is not null";
    final String savingswhereClauseForGroup =
        " where sa.group_id = ? and sa.gsim_id = ? sa.client_id is null order by sa.status_enum"
            + " ASC, sa.account_no ASC";
    final String savingswhereClauseForMembers =
        " where sa.group_id = ? and sa.client_id is not null order by sa.status_enum ASC,"
            + " sa.account_no ASC";
  ...
  public List<LoanAccountSummaryData> retrieveLoanAccountDetailsByGroupIdAndGlimAccountNumber(
      final Long groupId, final String glimAccount) {
    final LoanAccountSummaryDataMapper rm = new LoanAccountSummaryDataMapper();
    final String loanWhereClauseForGroupAndLoanType =
        " where l.group_id =? and glim.account_number=? and l.loan_type_enum=4";
    final String sql =
        "select " + rm.loanAccountSummarySchema() + loanWhereClauseForGroupAndLoanType;
  ...
  private List<LoanAccountSummaryData> retrieveLoanAccountDetails(
   ...
   * @return
   */
  private List<SavingsAccountSummaryData> retrieveAccountDetails(
  ...
  private static final class ShareAccountSummaryDataMapper
      implements RowMapper<ShareAccountSummaryData> {
    ...
    public ShareAccountSummaryData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      return new ShareAccountSummaryData(
          id,
          accountNo,
          externalId,
          productId,
  ...
  private static final class SavingsAccountSummaryDataMapper
      implements RowMapper<SavingsAccountSummaryData> {
    ...
    public SavingsAccountSummaryDataMapper() {
      ...
      accountsSummary.append(
          "sa.id as id, sa.account_no as accountNo, sa.external_id as externalId, sa.status_enum"
              + " as statusEnum, ");
  ...
  private static final class LoanAccountSummaryDataMapper
      implements RowMapper<LoanAccountSummaryData> {

    public String loanAccountSummarySchema() {

      final StringBuilder accountsSummary =
          new StringBuilder("l.id as id, l.account_no as accountNo, l.external_id as externalId,");
      accountsSummary
          .append(
              " l.product_id as productId, lp.name as productName, lp.short_name as"
                  + " shortProductName,")
          ...
          .append(
              " sbu.username as submittedByUsername, sbu.firstname as submittedByFirstname,"
                  + " sbu.lastname as submittedByLastname,")
          .append(" l.rejectedon_date as rejectedOnDate,")
          .append(
              " rbu.username as rejectedByUsername, rbu.firstname as rejectedByFirstname,"
                  + " rbu.lastname as rejectedByLastname,")
          .append(" l.withdrawnon_date as withdrawnOnDate,")
          .append(
              " wbu.username as withdrawnByUsername, wbu.firstname as withdrawnByFirstname,"
                  + " wbu.lastname as withdrawnByLastname,")
          .append(" l.approvedon_date as approvedOnDate,")
          .append(
              " abu.username as approvedByUsername, abu.firstname as approvedByFirstname,"
                  + " abu.lastname as approvedByLastname,")
          .append(
              " l.expected_disbursedon_date as expectedDisbursementDate, l.disbursedon_date as"
          ...
          .append(
              " l.writtenoffon_date as writtenOffOnDate, l.expected_maturedon_date as"
    ...
    public LoanAccountSummaryData mapRow(
      ...
      final BigDecimal originalLoan =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "originalLoan");
      final BigDecimal loanBalance =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "loanBalance");
  ...
  private static final class GuarantorLoanAccountSummaryDataMapper
      implements RowMapper<GuarantorAccountSummaryData> {
    ...
    @Override
    public GuarantorAccountSummaryData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
      ...
      final BigDecimal onHoldAmount =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "on_hold_funds_derived");
      ...
      return new GuarantorAccountSummaryData(
          id,
          accountNo,
          externalId,
          productId,
