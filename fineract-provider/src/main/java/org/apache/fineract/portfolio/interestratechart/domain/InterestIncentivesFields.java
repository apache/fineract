...
public class InterestIncentivesFields {
  ...
  public static InterestIncentivesFields createNew(
      final Integer entityType,
      final Integer attributeName,
      final Integer conditionType,
      final String attributeValue,
      final Integer incentiveType,
      final BigDecimal amount,
      final DataValidatorBuilder baseDataValidator) {
    return new InterestIncentivesFields(
        entityType,
        attributeName,
        conditionType,
        attributeValue,
  ...
  private InterestIncentivesFields(
      final Integer entityType,
      final Integer attributeName,
      final Integer conditionType,
      final String attributeValue,
  ...
  public void update(
    ...
    if (command.isChangeInIntegerParameterNamed(
        attributeNameParamName, this.attributeName, locale)) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        conditionTypeParamName, this.conditionType, locale)) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        incentiveTypeparamName, this.incentiveType, locale)) {
  ...
  public void validateIncentiveData(final DataValidatorBuilder baseDataValidator) {
    ...
    switch (attributeName()) {
      case GENDER:
        baseDataValidator
            .reset()
            .parameter(attributeValueParamName)
