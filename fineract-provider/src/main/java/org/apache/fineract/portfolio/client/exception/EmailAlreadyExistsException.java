 ...
 */
public class EmailAlreadyExistsException extends AbstractPlatformResourceNotFoundException {

    public EmailAlreadyExistsException(final String email) {
        super("error.msg.owner.email.exists", "Owner with Email " + email + " already exists", email);
    }
}
