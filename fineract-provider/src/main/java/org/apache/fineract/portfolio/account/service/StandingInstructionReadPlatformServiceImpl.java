...
public class StandingInstructionReadPlatformServiceImpl
  ...
  @Autowired
  public StandingInstructionReadPlatformServiceImpl(
  ...
  @Override
  public StandingInstructionData retrieveTemplate(
    ...
    Collection<OfficeData> fromOfficeOptions =
    ...
    final Collection<EnumOptionData> transferTypeOptions =
        Arrays.asList(
            transferType(AccountTransferType.ACCOUNT_TRANSFER),
    ...
    final Collection<EnumOptionData> recurrenceTypeOptions =
        Arrays.asList(
    ...
    return StandingInstructionData.template(
        fromOffice,
        fromClient,
        fromAccountTypeData,
        fromAccount,
  ...
  private Collection<PortfolioAccountData> retrieveToAccounts(
    ...
    final String currencyCode =
        excludeThisAccountFromOptions != null ? excludeThisAccountFromOptions.currencyCode() : null;

    PortfolioAccountDTO portfolioAccountDTO =
        new PortfolioAccountDTO(toAccountType, toClientId, currencyCode, null, null);
  ...
  public Page<StandingInstructionData> retrieveAll(
    ...
    if (standingInstructionDTO.fromAccountType() != null
        && standingInstructionDTO.fromAccount() != null) {
      PortfolioAccountType accountType =
          PortfolioAccountType.fromInt(standingInstructionDTO.fromAccountType());
      if (addAndCaluse) {
        sqlBuilder.append(" and ");
      }
  ...
  public Collection<StandingInstructionData> retrieveAll(final Integer status) {
    ...
    sqlBuilder
        .append(
            " where atsi.status=? and CURRENT_DATE() >= atsi.valid_from and (atsi.valid_till IS"
                + " NULL or CURRENT_DATE() < atsi.valid_till) ")
  ...
  public StandingInstructionData retrieveOne(final Long instructionId) {
    ...
    try {
      ...
      return this.jdbcTemplate.queryForObject(
          sql, this.standingInstructionMapper, new Object[] {instructionId});
  ...
  private static final class StandingInstructionMapper
      implements RowMapper<StandingInstructionData> {
    ...
    public StandingInstructionMapper() {
      ...
      sqlBuilder.append(
          "atsi.recurrence_type as recurrenceType, atsi.recurrence_frequency as"
              + " recurrenceFrequency,");
      sqlBuilder.append(
          "atsi.recurrence_interval as recurrenceInterval, atsi.recurrence_on_day as"
              + " recurrenceOnDay,");
    ...
    @Override
    public StandingInstructionData mapRow(
      ...
      EnumOptionData priorityEnum =
          AccountTransferEnumerations.standingInstructionPriority(priority);
      ...
      EnumOptionData instructionTypeEnum =
      ...
      EnumOptionData recurrenceTypeEnum =
          AccountTransferEnumerations.recurrenceType(recurrenceType);
      ...
      if (recurrenceFrequency != null) {
        recurrenceFrequencyEnum =
            CommonEnumerations.termFrequencyType(recurrenceFrequency, "recurrence");
      }
  ...
  private static final class StandingInstructionLoanDuesMapper
      implements RowMapper<StandingInstructionDuesData> {
    ...
    @Override
    public StandingInstructionDuesData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
      ...
      final BigDecimal principalPaid =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "principalCompleted");
      ...
      final BigDecimal principalOutstanding =
          principalDue.subtract(principalPaid).subtract(principalWrittenOff);

      final BigDecimal interestExpectedDue =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "interestAmount");
      final BigDecimal interestPaid =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "interestCompleted");
      ...
      final BigDecimal interestWaived =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "interestWaived");
      ...
      final BigDecimal penaltyChargesExpectedDue =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "penalityAmount");
      ...
      final BigDecimal penaltyChargesWrittenOff =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "penaltyWrittenOff");
      final BigDecimal penaltyChargesWaived =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "penaltyWaived");
      final BigDecimal penaltyChargesActualDue =
          penaltyChargesExpectedDue
              .subtract(penaltyChargesWaived)
              .subtract(penaltyChargesWrittenOff);
      final BigDecimal penaltyChargesOutstanding =
          penaltyChargesActualDue.subtract(penaltyChargesPaid);

      final BigDecimal feeChargesExpectedDue =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "feeAmount");
      final BigDecimal feeChargesPaid =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "feecompleted");
      final BigDecimal feeChargesWrittenOff =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "feeWrittenOff");
      final BigDecimal feeChargesWaived =
          JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "feeWaived");
      final BigDecimal feeChargesActualDue =
          feeChargesExpectedDue.subtract(feeChargesWaived).subtract(feeChargesWrittenOff);
