...
public class JLGClientData {
  ...
  public static JLGClientData instance(
      final Long clientId, final String clientName, final EnumOptionData attendanceType) {
  ...
  public static JLGClientData withSavings(
      final JLGClientData client, final Collection<SavingsDueData> savings) {
    final Collection<LoanDueData> loans = null;
  ...
  public static JLGClientData withAttendance(
      final Long clientId, final String clientName, final EnumOptionData attendanceType) {
    final Collection<LoanDueData> loans = null;
    final Collection<SavingsDueData> savings = null;
    return new JLGClientData(clientId, clientName, loans, savings, attendanceType);
