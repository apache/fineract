...
public class TaxReadPlatformServiceImpl implements TaxReadPlatformService {
  ...
  @Autowired
  public TaxReadPlatformServiceImpl(
  ...
  public TaxComponentData retrieveTaxComponentTemplate() {
    return TaxComponentData.template(
  ...
  private static final class TaxComponentMapper implements RowMapper<TaxComponentData> {
    ...
    private TaxComponentHistoryDataMapper componentHistoryDataMapper =
    ...
    public TaxComponentMapper() {
      ...
      sb.append(
          "dgl.id as debitAccountId, dgl.name as debitAccountName,  dgl.gl_code as"
              + " debitAccountGlCode,");
    ...
    public TaxComponentData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      if (creditAccountTypeEnum != null && creditAccountTypeEnum > 0) {
        ...
        creditAccountData =
            new GLAccountData(creditAccountId, creditAccountName, creditAccountGlCode);
      }
      ...
      return TaxComponentData.instance(
          id,
          name,
          percentage,
          debitAccountType,
  ...
  private static final class TaxComponentHistoryDataMapper
      implements RowMapper<TaxComponentHistoryData> {

    @Override
    public TaxComponentHistoryData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
  ...
  private static final class TaxGroupMappingsDataMapper implements RowMapper<TaxGroupMappingsData> {
    ...
    @Override
    public TaxGroupMappingsData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
  ...
  private static final class TaxComponentLookUpMapper implements RowMapper<TaxComponentData> {
    ...
    @Override
    public TaxComponentData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      final Long id = rs.getLong("id");
      final String name = rs.getString("name");
  ...
  private static final class TaxGroupLookUpMapper implements RowMapper<TaxGroupData> {
    ...
    @Override
    public TaxGroupData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      final Long id = rs.getLong("id");
      final String name = rs.getString("name");
