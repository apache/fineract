...
public class ShareAccountData implements Serializable, AccountData {
  ...
  public static ShareAccountData importInstance(
      Long clientId,
      Long productId,
  ...
  public ShareAccountData(
      ...
      final ShareAccountSummaryData summaryData,
      ...
      final EnumOptionData minimumActivePeriodTypeEnum,
  ...
  public ShareAccountData(
      ...
      final CurrencyData currency,
      final Collection<ShareAccountChargeData> charges,
      final BigDecimal currentMarketPrice,
  ...
  private ShareAccountData(
      ...
      final Collection<SavingsAccountData> clientSavingsAccounts,
      final Collection<EnumOptionData> lockinPeriodFrequencyTypeOptions,
      final Collection<EnumOptionData> minimumActivePeriodFrequencyTypeOption,
      final BigDecimal currenMarketPrice) {
    this.id = id;
    this.accountNo = accountNo;
    this.externalId = externalId;
    this.savingsAccountId = savingsAccountId;
  ...
  public static ShareAccountData template(
  ...
  public static ShareAccountData lookup(
      final Long id, final String accountNo, final Long clientId, final String clientName) {
