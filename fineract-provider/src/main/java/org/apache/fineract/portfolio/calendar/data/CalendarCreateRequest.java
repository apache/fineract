...
@NoArgsConstructor
@AllArgsConstructor
public class CalendarCreateRequest implements Serializable {
    ...
    @NotBlank(message = "{org.apache.fineract.portfolio.calendar.title.not-blank}")
    @Length(max = 100, message = "{org.apache.fineract.portfolio.calendar.title.max}")
    private String title;

    @NotNull(message = "{org.apache.fineract.portfolio.calendar.start-date.not-null}")
