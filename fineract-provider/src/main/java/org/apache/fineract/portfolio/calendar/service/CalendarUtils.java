...
public class CalendarUtils {
	...
	public static Collection<LocalDate> getRecurringDates(final String recurringRule, final LocalDate seedDate,
			...
			boolean isSkippMeetingOnFirstDay, final int numberOfDays) {

		final Recur recur = CalendarUtils.getICalRecur(recurringRule);

		return getRecurringDates(recur, seedDate, periodStartDate, periodEndDate, maxCount, isSkippMeetingOnFirstDay,
				numberOfDays);
	}
	...
	private static Collection<LocalDate> skipMeetingOnFirstdayOfMonth(Collection<LocalDate> recurringDates,
	...
	public static LocalDate adjustRecurringDate(LocalDate recuringDate, final int numberOfDays) {
	...
	public static LocalDate getNewRepaymentMeetingDate(final String recurringRule, final LocalDate seedDate,
			...
			final WorkingDays workingDays, final boolean isSkipRepaymentOnFirstDayofMonth, final int numberOfDays) {
		final Recur recur = CalendarUtils.getICalRecur(recurringRule);
		if (recur == null) {
			return null;
		}
		...
		LocalDate nextRapaymentDate = getNextRepaymentMeetingDate(recurringRule, seedDate, oldRepaymentDate,
	...
	public static LocalDate getNextRepaymentMeetingDate(final String recurringRule, final LocalDate seedDate,
			...
			final WorkingDays workingDays, boolean isSkipRepaymentOnFirstDayofMonth, final int numberOfDays) {
		...
		if (isSkipRepaymentOnFirstDayofMonth) {
			...
			final LocalDate nextRepaymentDateTemp = getNextRecurringDate(recur, seedDate, newRepaymentDatetemp);
			return WorkingDaysUtil.getOffSetDateIfNonWorkingDay(newRepaymentDatetemp, nextRepaymentDateTemp,
					workingDays);
		}
