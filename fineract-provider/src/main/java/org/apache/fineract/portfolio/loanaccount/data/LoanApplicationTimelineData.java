...
public class LoanApplicationTimelineData {
  ...
  public static LoanApplicationTimelineData templateDefault(
    ...
    return new LoanApplicationTimelineData(
        submittedOnDate,
        submittedByUsername,
  ...
  public LoanApplicationTimelineData(
      ...
      final String rejectedByFirstname,
      final String rejectedByLastname,
      final LocalDate withdrawnOnDate,
      final String withdrawnByUsername,
      final String withdrawnByFirstname,
      final String withdrawnByLastname,
      ...
      final String disbursedByUsername,
      final String disbursedByFirstname,
      final String disbursedByLastname,
      final LocalDate closedOnDate,
      final String closedByUsername,
      final String closedByFirstname,
      final String closedByLastname,
      final LocalDate expectedMaturityDate,
      final LocalDate writeOffOnDate,
      final String writeOffByUsername,
      final String writeOffByFirstname,
      final String writeOffByLastname) {
  ...
  public RepaymentScheduleRelatedLoanData repaymentScheduleRelatedData(
    ...
    return new RepaymentScheduleRelatedLoanData(
        this.expectedDisbursementDate,
        this.actualDisbursementDate,
        currency,
        principal,
        inArrearsTolerance,
        totalFeeChargesAtDisbursement);
  }
