...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Loan Term Variations provides the ability to change due dates, amounts and number"
                  + " of instalments before loan approval.")
    })
public class LoanScheduleApiResource {
  ...
  @Autowired
  public LoanScheduleApiResource(
  ...
  @ApiOperation(
      value =
          "Calculate loan repayment schedule based on Loan term variations | Updates loan"
              + " repayment schedule based on Loan term variations | Updates loan repayment"
      ...
      notes =
          "Calculate loan repayment schedule based on Loan term variations:\n\n"
              ...
              + "Showing request/response for 'Updates loan repayment schedule by removing Loan"
              + " term variations'")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = LoanScheduleApiResourceSwagger.PostLoansLoanIdScheduleRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = LoanScheduleApiResourceSwagger.PostLoansLoanIdScheduleResponse.class)
  })
    ...
    if (is(commandParam, "calculateLoanSchedule")) {
      ...
      commandRequest =
          new CommandWrapperBuilder()
              .createScheduleExceptions(loanId)
