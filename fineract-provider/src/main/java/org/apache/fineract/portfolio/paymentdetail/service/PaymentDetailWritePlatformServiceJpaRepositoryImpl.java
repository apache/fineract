...
@Service
public class PaymentDetailWritePlatformServiceJpaRepositoryImpl
    implements PaymentDetailWritePlatformService {
  ...
  @Autowired
  public PaymentDetailWritePlatformServiceJpaRepositoryImpl(
  ...
  public PaymentDetail createPaymentDetail(
    ...
    final PaymentDetail paymentDetail =
        PaymentDetail.generatePaymentDetail(paymentType, command, changes);
  ...
  @Override
  @Transactional
  public PaymentDetail createAndPersistPaymentDetail(
      final JsonCommand command, final Map<String, Object> changes) {
