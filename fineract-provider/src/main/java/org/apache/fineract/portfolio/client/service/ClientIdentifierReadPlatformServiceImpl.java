...
public class ClientIdentifierReadPlatformServiceImpl implements ClientIdentifierReadPlatformService {
    ...
    private static final class ClientIdentityMapper implements RowMapper<ClientIdentifierData> {
        ...
        public String schema() {
            return "ci.id as id, ci.client_id as clientId, ci.document_type_id as documentTypeId, ci.document_issue_country as documentIssueCountry, ci.status as status, ci.document_key as documentKey,"
        ...
        public ClientIdentifierData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final String documentIssueCountry = rs.getString("documentIssueCountry");
            ...
            return ClientIdentifierData.singleItem(id, clientId, documentType, documentIssueCountry, documentKey, status, description);
        }
