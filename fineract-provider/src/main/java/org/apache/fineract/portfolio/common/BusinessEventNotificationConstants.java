...
public class BusinessEventNotificationConstants {
    ...
    public static enum BUSINESS_EVENTS {
        LOAN_APPROVED("loan_approved"), LOAN_REJECTED("loan_reject"), LOAN_UNDO_APPROVAL("loan_undo_approval"), LOAN_UNDO_DISBURSAL(
                ...
                "loan_interest_recalculation"), LOAN_REFUND("loan_refund"), LOAN_FORECLOSURE("loan_foreclosure"), LOAN_CREATE("loan_create"), LOAN_PRODUCT_CREATE(
                "loan_product_create"),  SAVINGS_ACTIVATE("savings_activated"), SAVINGS_REJECT("savings_reject"), SAVINGS_POST_INTEREST("savings_post_interest"), SAVINGS_DEPOSIT(
                "savings_deposit"), SAVINGS_CLOSE("savings_close"), SAVINGS_WITHDRAWAL("savings_withdrawal"),  SAVINGS_APPROVE("savings_approve"), SAVINGS_CREATE(
                ...
                "centers_create"), GROUPS_CREATE("groups_create"), SHARE_PRODUCT_DIVIDENDS_CREATE("share_product_dividends_create"), FIXED_DEPOSIT_ACCOUNT_CREATE(
                "fixed_deposit_account_create"), SHARE_ACCOUNT_APPROVE("share_account_approve"), RECURRING_DEPOSIT_ACCOUNT_CREATE("recurring_deposit_account_create");
    ...
    public static enum BUSINESS_ENTITY {
        LOAN("loan"), LOAN_TRANSACTION("loan_transaction"), LOAN_CHARGE("loan_charge"), LOAN_ADJUSTED_TRANSACTION(
        		...
        		GROUP("group"), SHARE_ACCOUNT("share_account"), SHARE_PRODUCT("share_product"), DEPOSIT_ACCOUNT("deposit_account"),
