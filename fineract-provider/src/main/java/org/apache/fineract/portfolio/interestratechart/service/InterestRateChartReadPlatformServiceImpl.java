...
public class InterestRateChartReadPlatformServiceImpl
  ...
  public InterestRateChartData retrieveOneWithSlabs(Long chartId) {
    this.context.authenticatedUser();
    final String sql =
        "select " + this.chartExtractor.schema() + " where irc.id = ? order by ircd.id asc";
    Collection<InterestRateChartData> chartDatas =
        this.jdbcTemplate.query(sql, this.chartExtractor, new Object[] {chartId});
  ...
  public InterestRateChartData retrieveWithTemplate(InterestRateChartData chartData) {
    ...
    return InterestRateChartData.withTemplate(
        chartData,
  ...
  @Override
  public InterestRateChartData retrieveOneWithSlabsOnProductId(
      @SuppressWarnings("unused") Long productId) {
  ...
  public InterestRateChartData template() {
    ...
    final List<CodeValueData> clientClassificationOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(
                ClientApiConstants.CLIENT_CLASSIFICATION));
    return InterestRateChartData.template(
        this.chartDropdownReadPlatformService.retrievePeriodTypeOptions(),
        this.interestIncentiveDropdownReadPlatformService.retrieveEntityTypeOptions(),
        this.interestIncentiveDropdownReadPlatformService.retrieveAttributeNameOptions(),
        this.interestIncentiveDropdownReadPlatformService.retrieveConditionTypeOptions(),
  ...
  private static final class InterestRateChartExtractor
      implements ResultSetExtractor<Collection<InterestRateChartData>> {
      ...
      sqlBuilder
          ...
          .append(
              "m_interest_rate_chart irc left join m_interest_rate_slab ircd on"
                  + " irc.id=ircd.interest_rate_chart_id ")
          ...
          .append(
              "left join m_deposit_product_interest_rate_chart dpirc on"
                  + " irc.id=dpirc.interest_rate_chart_id ")
    ...
    @Override
    public Collection<InterestRateChartData> extractData(ResultSet rs)
  ...
  public static final class InterestRateChartMapper implements RowMapper<InterestRateChartData> {
    ...
    @Override
    public InterestRateChartData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      ...
      return InterestRateChartData.instance(
          id,
          name,
          description,
          fromDate,
  ...
  private static final class InterestRateChartSlabsMapper
      implements RowMapper<InterestRateChartSlabData> {
    ...
    private InterestRateChartSlabsMapper() {
      ...
      sqlBuilder
          ...
          .append("code.code_value as attributeValueDesc ")
          .append("from ")
          .append("m_interest_rate_slab ircd ")
          .append(" left join m_interest_incentives iri on iri.interest_rate_slab_id = ircd.id ")
          .append(" left join m_code_value code on code.id = iri.attribute_value ")
          .append("left join m_currency curr on ircd.currency_code= curr.code ");
      this.schemaSql = sqlBuilder.toString();
    ...
    @Override
    public InterestRateChartSlabData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
      ...
      return InterestRateChartSlabData.instance(
          id,
          description,
          periodType,
          fromPeriod,
  ...
  private static final class InterestRateChartSlabExtractor
      implements ResultSetExtractor<InterestRateChartSlabData> {
    ...
    @Override
    public InterestRateChartSlabData extractData(ResultSet rs)
        throws SQLException, DataAccessException {
    ...
    private static final class InterestIncentiveMapper implements RowMapper<InterestIncentiveData> {
      ...
      @Override
      public InterestIncentiveData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
          throws SQLException {
        ...
        return InterestIncentiveData.instance(
            id,
            entityTypeData,
            attributeNameData,
            conditionTypeData,
