...
public class GroupCloseCommandHandler implements CommandHandler<GroupCloseRequest, GroupCommandResponse> {
    ...
    @Override
    @Transactional
    public GroupCommandResponse handle(Command<GroupCloseRequest> command) {
        return writeService.closeGroup(command.getPayload());
    }

    @Override
    public GroupCommandResponse fallback(Command<GroupCloseRequest> command, Throwable t) {
