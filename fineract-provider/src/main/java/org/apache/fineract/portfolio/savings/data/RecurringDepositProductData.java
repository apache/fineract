...
public class RecurringDepositProductData extends DepositProductData {
  ...
  public static RecurringDepositProductData template(
    ...
    return new RecurringDepositProductData(
        id,
        name,
        shortName,
        description,
  ...
  public static RecurringDepositProductData withCharges(
      final RecurringDepositProductData existingProduct, final Collection<ChargeData> charges) {
    return new RecurringDepositProductData(
        existingProduct.id,
   ...
   *            TODO
   */
  public static RecurringDepositProductData withTemplate(
      final RecurringDepositProductData existingProduct,
      final Collection<CurrencyData> currencyOptions,
      final Collection<EnumOptionData> interestCompoundingPeriodTypeOptions,
      final Collection<EnumOptionData> interestPostingPeriodTypeOptions,
      final Collection<EnumOptionData> interestCalculationTypeOptions,
  ...
  public static RecurringDepositProductData withAccountingDetails(
      final RecurringDepositProductData existingProduct,
  ...
  public static RecurringDepositProductData instance(
  ...
  public static RecurringDepositProductData withInterestChart(
      final RecurringDepositProductData product,
    ...
    return new RecurringDepositProductData(
        ...
        product.interestCalculationType,
        ...
        product.currencyOptions,
        product.interestCompoundingPeriodTypeOptions,
        product.interestPostingPeriodTypeOptions,
        product.interestCalculationTypeOptions,
        product.interestCalculationDaysInYearTypeOptions,
        product.lockinPeriodFrequencyTypeOptions,
        product.withdrawalFeeTypeOptions,
        product.paymentTypeOptions,
        product.accountingRuleOptions,
        product.accountingMappingOptions,
        product.charges,
        product.chargeOptions,
        product.penaltyOptions,
        product.feeToIncomeAccountMappings,
        product.penaltyToIncomeAccountMappings,
        interestRateCharts,
        product.chartTemplate,
        product.preClosurePenalApplicable,
        product.preClosurePenalInterest,
        product.preClosurePenalInterestOnType,
        product.preClosurePenalInterestOnTypeOptions,
        product.minDepositTerm,
        product.maxDepositTerm,
        product.minDepositTermType,
        product.maxDepositTermType,
        product.inMultiplesOfDepositTerm,
        ...
        product.periodFrequencyTypeOptions,
  ...
  private RecurringDepositProductData(
      final Long id,
      final String name,
