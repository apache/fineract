...
public enum LoanTermVariationType {
    ...
    INTEREST_RATE_FOR_INSTALLMENT(10, "loanTermType.interestRateForInstallment");
    ...
    public static LoanTermVariationType fromInt(final Integer value) {
        ...
        switch (value) {
            ...
            break;
            case 10:
                enumeration = LoanTermVariationType.INTEREST_RATE_FOR_INSTALLMENT;
            break;
        }
        return enumeration;
    }
    ...
    public boolean isInterestRateForInstallment() {
        return this.value.equals(LoanTermVariationType.INTEREST_RATE_FOR_INSTALLMENT.getValue());
    }
}
