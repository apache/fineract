...
public class LoanRepositoryWrapper {
  ...
  public Collection<Loan> findActiveLoansByLoanIdAndGroupId(Long clientId, Long groupId) {
    ...
    final Collection<Loan> loans =
        this.repository.findByClientIdAndGroupIdAndLoanStatus(clientId, groupId, loanStatuses);
    return loans;
  }
  ...
  public List<Loan> getGroupLoansDisbursedAfter(
  ...
  public List<Loan> getClientOrJLGLoansDisbursedAfter(
  ...
  public Integer getMaxClientOrJLGLoanProductCounter(
  ...
  public List<Loan> getGroupLoansToUpdateLoanCounter(
  ...
  // Only root entities are enough
  public List<Loan> getClientOrJLGLoansToUpdateLoanCounter(
  ...
  // Only root entities are enough
  public List<Loan> getGroupLoansToUpdateLoanProductCounter(
      @Param("loanProductCounter") Integer loanProductCounter,
      @Param("groupId") Long groupId,
      @Param("groupLoanType") Integer groupLoanType) {
    return this.repository.getGroupLoansToUpdateLoanProductCounter(
        loanProductCounter, groupId, groupLoanType);
  }

  // Only root entities are enough
  public List<Loan> getClientLoansToUpdateLoanProductCounter(
  ...
  @Transactional(readOnly = true)
  public List<Loan> findByClientIdAndGroupId(
  ...
  public List<Loan> findByIdsAndLoanStatusAndLoanType(
      @Param("ids") Collection<Long> ids,
      @Param("loanStatuses") Collection<Integer> loanStatuses,
      @Param("loanTypes") Collection<Integer> loanTypes) {
    List<Loan> loans =
        this.repository.findByIdsAndLoanStatusAndLoanType(ids, loanStatuses, loanTypes);
    if (loans != null && loans.size() > 0) {
      for (Loan loan : loans) {
        loan.initializeLazyCollections();
      }
  ...
  // Repayments Schedule
  public List<Loan> findByClientOfficeIdsAndLoanStatus(
  ...
  // Repayments Schedule
  public List<Loan> findByGroupOfficeIdsAndLoanStatus(
      @Param("officeIds") Collection<Long> officeIds,
      @Param("loanStatuses") Collection<Integer> loanStatuses) {
  ...
  public List<Long> findActiveLoansLoanProductIdsByClient(
  ...
  public List<Long> findActiveLoansLoanProductIdsByGroup(
  ...
  @Transactional(readOnly = true)
  public Loan findNonClosedLoanThatBelongsToClient(
