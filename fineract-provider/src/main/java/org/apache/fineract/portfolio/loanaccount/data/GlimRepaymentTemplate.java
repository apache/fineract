...
public class GlimRepaymentTemplate {
  ...
  private GlimRepaymentTemplate(
      final BigDecimal glimId,
      final BigDecimal groupId,
      final BigDecimal clientId,
      final String clientName,
      final BigDecimal childLoanId,
      final String parentAccountNo,
      final BigDecimal parentPrincipalAmount,
      final String childLoanAccountNo,
      final BigDecimal childPrincipalAmount) {
    this.glimId = glimId;
  ...
  public static GlimRepaymentTemplate getInstance(
      final BigDecimal glimId,
      final BigDecimal groupId,
      final BigDecimal clientId,
      final String clientName,
      ...
      final String childLoanAccountNo,
      final BigDecimal childPrincipalAmount) {
    return new GlimRepaymentTemplate(
        glimId,
        groupId,
        clientId,
        clientName,
