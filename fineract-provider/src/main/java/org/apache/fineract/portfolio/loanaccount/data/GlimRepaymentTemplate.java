...
public class GlimRepaymentTemplate
{
     ...
     private GlimRepaymentTemplate(final BigDecimal glimId,final BigDecimal groupId,final BigDecimal clientId,
     ...
     public static GlimRepaymentTemplate getInstance(final BigDecimal glimId,final BigDecimal groupId,final BigDecimal clientId,
               ...
               final String childLoanAccountNo,final BigDecimal childPrincipalAmount)
     {
          return new GlimRepaymentTemplate(glimId,groupId,clientId,clientName,childLoanId,parentAccountNo,
