...
public class SavingsAccountData implements Serializable {
  ...
  public static SavingsAccountData importInstanceIndividual(
      Long clientId,
      Long productId,
      Long fieldOfficerId,
  ...
  public static SavingsAccountData importInstanceGroup(
      Long groupId,
      Long productId,
      Long fieldOfficerId,
      LocalDate submittedOnDate,
  ...
  public static SavingsAccountData instance(
      final Long id,
      ...
      final Integer daysToDormancy,
      final Integer daysToEscheat,
  ...
  public static SavingsAccountData lookup(
      final Long accountId, final String accountNo, final EnumOptionData depositType) {
  ...
  public static SavingsAccountData withTemplateOptions(
  ...
  public static SavingsAccountData withClientTemplate(
