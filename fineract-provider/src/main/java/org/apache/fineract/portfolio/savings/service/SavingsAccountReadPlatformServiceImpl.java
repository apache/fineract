...
public class SavingsAccountReadPlatformServiceImpl implements SavingsAccountReadPlatformService {
    ...
    //Pagination Read service for Savings Account Post Interest Job
    @Override
    public Page<SavingsAccountData> retrieveSavingsAccount(final Integer maxPazeSize,final Integer pageNumber, final Integer status) {
