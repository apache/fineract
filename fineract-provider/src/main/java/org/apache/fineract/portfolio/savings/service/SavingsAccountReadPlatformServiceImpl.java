    ...
    public Page<SavingsAccountData> retrieveAll(final SearchParameters searchParameters) {
        ...
        if (searchParameters != null) {
            ...
            if (searchParameters.getDateOfBirth() != null) {
                // TODO: How would we handle leap years? Do we count Feb 29th on Feb 28th on non-leap years?
                sqlBuilder.append("and MONTH(c.date_of_birth) = ? and DAYOFMONTH(c.date_of_birth) = ?");
                objectArray[arrayPos] = searchParameters.getDateOfBirth().getMonth().getValue();
                arrayPos = arrayPos + 1;
                objectArray[arrayPos] = searchParameters.getDateOfBirth().getDayOfMonth();
                arrayPos = arrayPos + 1;
            }
