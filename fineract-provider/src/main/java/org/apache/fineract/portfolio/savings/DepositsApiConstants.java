...
public class DepositsApiConstants {
  ...
  public static final String SAVINGS_ACCOUNT_TRANSACTION_RESOURCE_NAME =
  ...
  public static final String interestCompoundingPeriodTypeParamName =
  ...
  public static final String interestCalculationDaysInYearTypeParamName =
  ...
  public static final String preClosurePenalInterestOnTypeIdParamName =
  ...
  public static final String inMultiplesOfDepositTermTypeIdParamName =
  ...
  public static final String mandatoryRecommendedDepositAmountParamName =
  ...
  public static final String adjustAdvanceTowardsFuturePaymentsParamName =
   ...
   */
  private static final Set<String> DEPOSIT_PRODUCT_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              localeParamName,
              ...
              inMultiplesOfParamName,
              nominalAnnualInterestRateParamName,
  ...
  private static final Set<String> PRECLOSURE_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
  ...
  private static final Set<String> PRECLOSURE_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              preClosurePenalApplicableParamName,
              preClosurePenalInterestParamName,
  ...
  private static final Set<String> DEPOSIT_TERM_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              minDepositTermParamName,
              maxDepositTermParamName,
              minDepositTermTypeIdParamName,
              maxDepositTermTypeIdParamName,
              inMultiplesOfDepositTermParamName,
              inMultiplesOfDepositTermTypeIdParamName,
              depositAmountParamName,
              depositMinAmountParamName,
              depositMaxAmountParamName));

  private static final Set<String> DEPOSIT_TERM_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              minDepositTermParamName,
              maxDepositTermParamName,
  ...
  private static final Set<String> RECURRING_DETAILS_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              mandatoryRecommendedDepositAmountParamName,
              isMandatoryDepositParamName,
              allowWithdrawalParamName,
              adjustAdvanceTowardsFuturePaymentsParamName,
              recurringFrequencyTypeParamName,
              recurringFrequencyParamName,
              isCalendarInheritedParamName));

  private static final Set<String> RECURRING_DETAILS_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              mandatoryRecommendedDepositAmountParamName,
              isMandatoryDepositParamName,
  ...
  private static final Set<String> DEPOSIT_PRECLOSURE_CALCULATION_REQUEST_DATA_PARAMETERS =
      new HashSet<>(Arrays.asList(preMatureCloseOnDateParamName));

  public static final Set<String> FIXED_DEPOSIT_PRODUCT_REQUEST_DATA_PARAMETERS =
      fixedDepositProductRequestData();
  public static final Set<String> FIXED_DEPOSIT_PRODUCT_RESPONSE_DATA_PARAMETERS =
      fixedDepositProductResponseData();

  public static final Set<String> RECURRING_DEPOSIT_PRODUCT_REQUEST_DATA_PARAMETERS =
      recurringDepositProductRequestData();
  public static final Set<String> RECURRING_DEPOSIT_PRODUCT_RESPONSE_DATA_PARAMETERS =
      recurringDepositProductResponseData();
   ...
   */
  private static final Set<String> DEPOSIT_ACCOUNT_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              localeParamName,
              dateFormatParamName,
              ...
              chartsParamName,
              depositAmountParamName,
              depositPeriodParamName,
              depositPeriodFrequencyIdParamName,
              savingsAccounts,
              expectedFirstDepositOnDateParamName,
              SavingsApiConstants.withHoldTaxParamName));

  public static final Set<String> FIXED_DEPOSIT_ACCOUNT_REQUEST_DATA_PARAMETERS =
      fixedDepositAccountRequestData();
  public static final Set<String> FIXED_DEPOSIT_ACCOUNT_RESPONSE_DATA_PARAMETERS =
      fixedDepositAccountResponseData();

  public static final Set<String> RECURRING_DEPOSIT_ACCOUNT_REQUEST_DATA_PARAMETERS =
      recurringDepositAccountRequestData();
  public static final Set<String> RECURRING_DEPOSIT_ACCOUNT_RESPONSE_DATA_PARAMETERS =
  ...
  private static final Set<String> RECURRING_DEPOSIT_TRANSACTION_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              idParamName,
              "accountId",
              ...
              runningBalanceParamName,
              reversedParamName));

  private static final Set<String> SAVINGS_ACCOUNT_ACTIVATION_REQUEST_DATA_PARAMETERS =
      new HashSet<>(Arrays.asList(localeParamName, dateFormatParamName, activatedOnDateParamName));

  private static final Set<String> SAVINGS_ACCOUNT_CHARGES_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              chargeIdParamName,
              savingsAccountChargeIdParamName,
              chargeNameParamName,
              penaltyParamName,
              chargeTimeTypeParamName,
              dueAsOfDateParamName,
              chargeCalculationTypeParamName,
              percentageParamName,
              amountPercentageAppliedToParamName,
              currencyParamName,
              amountWaivedParamName,
              amountWrittenOffParamName,
              amountOutstandingParamName,
              amountOrPercentageParamName,
              amountParamName,
              amountPaidParamName,
              chargeOptionsParamName));

  private static final Set<String> SAVINGS_ACCOUNT_CHARGES_ADD_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              chargeIdParamName,
              amountParamName,
              ...
              dateFormatParamName,
              localeParamName,
              feeOnMonthDayParamName,
              monthDayFormatParamName,
              feeIntervalParamName));

  private static final Set<String> SAVINGS_ACCOUNT_CHARGES_PAY_CHARGE_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
