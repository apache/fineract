...
public final class ClientData implements Comparable<ClientData>, Serializable {
    ...
    private final CodeValueData socialStatus;
    ...
    private final Collection<CodeValueData> socialStatusOptions;
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
            ...
            final Collection<CodeValueData> clientNonPersonMainBusinessLineOptions, final Collection<CodeValueData> socialStatusOptions,
            final List<EnumOptionData> clientLegalFormOptions, final ClientFamilyMembersData familyMemberOptions,
            final Collection<AddressData> address, final Boolean isAddressEnabled, final List<DatatableData> datatables) {
        ...
        final CodeValueData socialStatus = null;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename, lastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender, socialStatus,
                ...
                clientNonPersonMainBusinessLineOptions, socialStatusOptions, clientNonPersonDetails, clientLegalFormOptions,
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.emailAddress, clientData.dateOfBirth, clientData.gender, clientData.socialStatus, clientData.activationDate,
                ...
                templateData.clientNonPersonMainBusinessLineOptions, templateData.socialStatusOptions, clientData.clientNonPersonDetails,
                templateData.clientLegalFormOptions, templateData.familyMemberOptions, clientData.legalForm, clientData.address,
                clientData.isAddressEnabled, null, clientData.isStaff, clientCollateralManagements);
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.clientNonPersonMainBusinessLineOptions, clientData.socialStatusOptions, clientData.clientNonPersonDetails,
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.socialStatusOptions, clientData.clientNonPersonDetails, clientData.clientLegalFormOptions,
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
        ...
        final Collection<CodeValueData> socialStatusOptions = null;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                savingProductOptions, savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions, clientType,
                clientClassification, clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions,
                clientNonPersonMainBusinessLineOptions, socialStatusOptions, clientNonPerson, clientLegalFormOptions, familyMemberOptions,
                legalForm, null, null, null, isStaff, clientCollateralManagements);
    }
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
            ...
            final CodeValueData clientType, final CodeValueData clientClassification, final CodeValueData socialStatus,
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                socialStatusOptions, clientNonPerson, clientLegalFormOptions, familyMemberOptions, legalForm, null, null, null, isStaff,
                null);
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final CodeValueData subStatus, final Long officeId,
            ...
            final String firstname, final String middlename, final String lastname, final String fullname, final String displayName,
            final String externalId, final String mobileNo, final String emailAddress, final LocalDate dateOfBirth,
            final CodeValueData gender, final CodeValueData socialStatus, final LocalDate activationDate, final Long imageId,
            final Long staffId, final String staffName, final Collection<OfficeData> allowedOffices,
            ...
            final ClientFamilyMembersData familyMemberOptions, final EnumOptionData legalForm, final Collection<AddressData> address,
        ...
        this.socialStatusOptions = socialStatusOptions;
