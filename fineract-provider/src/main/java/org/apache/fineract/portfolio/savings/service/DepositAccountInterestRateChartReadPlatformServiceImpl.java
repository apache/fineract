...
public class DepositAccountInterestRateChartReadPlatformServiceImpl
  ...
  private final DepositAccountInterestRateChartMapper chartRowMapper =
      new DepositAccountInterestRateChartMapper();
  private final DepositAccountInterestRateChartExtractor chartExtractor =
      new DepositAccountInterestRateChartExtractor();
  ...
  @Autowired
  public DepositAccountInterestRateChartReadPlatformServiceImpl(
  ...
  public DepositAccountInterestRateChartData retrieveOneWithSlabs(Long chartId) {
    ...
    Collection<DepositAccountInterestRateChartData> chartDatas =
        this.jdbcTemplate.query(sql.toString(), this.chartExtractor, new Object[] {chartId});
  ...
  @Override
  public DepositAccountInterestRateChartData retrieveWithTemplate(
      DepositAccountInterestRateChartData chartData) {

    final List<CodeValueData> genderOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(ClientApiConstants.GENDER));

    final List<CodeValueData> clientTypeOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(
                ClientApiConstants.CLIENT_TYPE));

    final List<CodeValueData> clientClassificationOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(
                ClientApiConstants.CLIENT_CLASSIFICATION));

    return DepositAccountInterestRateChartData.withTemplate(
        chartData,
  ...
  public DepositAccountInterestRateChartData retrieveOneWithSlabsOnAccountId(Long accountId) {
    ...
    Collection<DepositAccountInterestRateChartData> chartDatas =
        this.jdbcTemplate.query(sql.toString(), this.chartExtractor, new Object[] {accountId});
    if (chartDatas == null || chartDatas.isEmpty()) {
  ...
  private static final class DepositAccountInterestRateChartExtractor
      ...
      sqlBuilder
          ...
          .append(
              "ircd.id as ircdId, ircd.description as ircdDescription, ircd.period_type_enum"
                  + " ircdPeriodTypeId, ")
          .append(
              "ircd.from_period as ircdFromPeriod, ircd.to_period as ircdToPeriod,"
                  + " ircd.amount_range_from as ircdAmountRangeFrom, ")
          .append(
              "ircd.amount_range_to as ircdAmountRangeTo, ircd.annual_interest_rate as"
                  + " ircdAnnualInterestRate, ")
          .append(
              "curr.code as currencyCode, curr.name as currencyName,"
                  + " curr.internationalized_name_code as currencyNameCode, ")
          .append(
              "curr.display_symbol as currencyDisplaySymbol, curr.decimal_places as"
                  + " currencyDigits, curr.currency_multiplesof as inMultiplesOf, ")
          ...
          .append("from ")
          .append(
              "m_savings_account_interest_rate_chart irc left join"
                  + " m_savings_account_interest_rate_slab ircd on"
                  + " irc.id=ircd.savings_account_interest_rate_chart_id ")
          .append(
              " left join m_savings_interest_incentives  iri on"
                  + " iri.deposit_account_interest_rate_slab_id =ircd.id ")
    ...
    @Override
    public Collection<DepositAccountInterestRateChartData> extractData(ResultSet rs)
      ...
      while (rs.next()) {
        ...
        if (chartData == null
            || (interestRateChartId != null && !interestRateChartId.equals(tempIrcId))) {

          interestRateChartId = tempIrcId;
          chartData = chartMapper.mapRow(rs, ircIndex++);
          chartDataList.add(chartData);
        }
        final DepositAccountInterestRateChartSlabData chartSlabsData =
            chartSlabsMapper.extractData(rs);
  ...
  public static final class DepositAccountInterestRateChartMapper
      implements RowMapper<DepositAccountInterestRateChartData> {
    ...
    private DepositAccountInterestRateChartMapper() {
      ...
      sqlBuilder
          ...
          .append("from ")
          .append(
              "m_savings_account_interest_rate_chart irc left join m_savings_account sa on"
                  + " irc.savings_account_id=sa.id ");
      this.schemaSql = sqlBuilder.toString();
    }

    @Override
    public DepositAccountInterestRateChartData mapRow(
      ...
      return DepositAccountInterestRateChartData.instance(
          id,
          name,
          description,
          fromDate,
  ...
  private static final class InterestRateChartSlabExtractor
      implements ResultSetExtractor<DepositAccountInterestRateChartSlabData> {

    DepositAccountInterestRateChartSlabsMapper chartSlabsMapper =
        new DepositAccountInterestRateChartSlabsMapper();
    InterestIncentiveMapper incentiveMapper = new InterestIncentiveMapper();

    @Override
    public DepositAccountInterestRateChartSlabData extractData(ResultSet rs)
        throws SQLException, DataAccessException {
      ...
      while (rs.next()) {
        ...
        if (interestRateChartSlabId == null || interestRateChartSlabId.equals(tempIrcdId)) {
          ...
          final DepositAccountInterestIncentiveData incentiveData =
              incentiveMapper.mapRow(rs, ircdIndex++);
  ...
  private static final class DepositAccountInterestRateChartSlabsMapper
      implements RowMapper<DepositAccountInterestRateChartSlabData> {
    ...
    @Override
    public DepositAccountInterestRateChartSlabData mapRow(
        ResultSet rs, @SuppressWarnings("unused") int rowNum) throws SQLException {
      ...
      return DepositAccountInterestRateChartSlabData.instance(
          id,
          description,
          periodType,
          fromPeriod,
  ...
  private static final class InterestIncentiveMapper
      implements RowMapper<DepositAccountInterestIncentiveData> {

    @Override
    public DepositAccountInterestIncentiveData mapRow(
        ResultSet rs, @SuppressWarnings("unused") int rowNum) throws SQLException {
      ...
      if (InterestIncentiveAttributeName.isCodeValueAttribute(
          InterestIncentiveAttributeName.fromInt(attributeName))) {
        attributeValueDesc = rs.getString("attributeValueDesc");
      }
      final EnumOptionData attributeNameData =
          InterestIncentivesEnumerations.attributeName(attributeName);
      final Integer conditionType = JdbcSupport.getInteger(rs, "conditionType");
      final EnumOptionData conditionTypeData =
          CommonEnumerations.conditionType(conditionType, "incentive");
      final Integer incentiveType = JdbcSupport.getInteger(rs, "incentiveType");
      final EnumOptionData incentiveTypeData =
          InterestIncentivesEnumerations.incentiveType(incentiveType);
      final BigDecimal amount = rs.getBigDecimal("amount");

      return DepositAccountInterestIncentiveData.instance(
          id,
          entityTypeData,
          attributeNameData,
          conditionTypeData,
