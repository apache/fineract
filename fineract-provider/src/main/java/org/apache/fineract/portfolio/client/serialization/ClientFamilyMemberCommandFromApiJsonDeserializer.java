...
public class ClientFamilyMemberCommandFromApiJsonDeserializer {
  ...
  public void validateForCreate(String json) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("FamilyMembers");

    final JsonElement element = this.fromApiJsonHelper.parse(json);

    if (this.fromApiJsonHelper.extractArrayNamed("familyMembers", element) != null) {
      final JsonArray familyMembers =
          this.fromApiJsonHelper.extractJsonArrayNamed("familyMembers", element);
      baseDataValidator.reset().value(familyMembers).arrayNotEmpty();
    } else {
      baseDataValidator
          .reset()
          .value(this.fromApiJsonHelper.extractJsonArrayNamed("familyMembers", element))
          .arrayNotEmpty();
    }
  ...
  public void validateForCreate(final long clientId, String json) {
    ...
    if (this.fromApiJsonHelper.extractStringNamed("firstName", element) != null) {
      ...
      baseDataValidator
          .reset()
          .parameter("firstName")
          .value(this.fromApiJsonHelper.extractStringNamed("firstName", element))
          .notNull()
          .notBlank()
          .notExceedingLengthOf(100);
    }
    ...
    if (this.fromApiJsonHelper.extractStringNamed("qualification", element) != null) {
      final String qualification =
          this.fromApiJsonHelper.extractStringNamed("qualification", element);
      baseDataValidator
          .reset()
    ...
    if (this.fromApiJsonHelper.extractStringNamed("mobileNumber", element) != null) {
      final String mobileNumber =
          this.fromApiJsonHelper.extractStringNamed("mobileNumber", element);
      baseDataValidator
          .reset()
    ...
    if (this.fromApiJsonHelper.extractBooleanNamed("isDependent", element) != null) {
      final Boolean isDependent =
          this.fromApiJsonHelper.extractBooleanNamed("isDependent", element);
      baseDataValidator
          .reset()
    ...
    if (this.fromApiJsonHelper.extractLongNamed("relationShipId", element) != null) {
      final long relationShipId =
          this.fromApiJsonHelper.extractLongNamed("relationShipId", element);
      baseDataValidator
          .reset()
      ...
      baseDataValidator
          .reset()
          .parameter("relationShipId")
          .value(this.fromApiJsonHelper.extractLongNamed("relationShipId", element))
          .notBlank()
          .longGreaterThanZero();
    }
    ...
    if (this.fromApiJsonHelper.extractLongNamed("maritalStatusId", element) != null) {
      final long maritalStatusId =
          this.fromApiJsonHelper.extractLongNamed("maritalStatusId", element);
      baseDataValidator
          .reset()
          .parameter("maritalStatusId")
    ...
    if (this.fromApiJsonHelper.extractLocalDateNamed("dateOfBirth", element) != null) {
      final LocalDate dateOfBirth =
          this.fromApiJsonHelper.extractLocalDateNamed("dateOfBirth", element);
      baseDataValidator
          .reset()
  ...
  public void validateForUpdate(final long familyMemberId, String json) {
    ...
    if (this.fromApiJsonHelper.extractLocalDateNamed("dateOfBirth", element) != null) {
      ...
      baseDataValidator
          ...
          .parameter("dateOfBirth")
          .value(dateOfBirth)
          .validateDateBefore(currentDate.toLocalDate());
    }
  }
