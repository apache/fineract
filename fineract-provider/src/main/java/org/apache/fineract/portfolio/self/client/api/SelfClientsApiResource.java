...
public class SelfClientsApiResource {
  ...
  @ApiOperation(
      value = "List Clients associated to the user",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfClientsApiResourceSwagger.GetSelfClientsResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfClientsApiResourceSwagger.GetSelfClientsClientIdResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfClientsApiResourceSwagger.GetSelfClientsClientIdAccountsResponse.class)
  })
  ...
  @ApiOperation(
      value = "Retrieve Client Image",
      httpMethod = "GET",
      notes =
          "Optional arguments are identical to those of Get Image associated with an Entity"
              + " (Binary file)\n"
              + "\n"
              + "Example Requests:\n"
              + "\n"
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfClientsApiResourceSwagger.GetSelfClientsClientIdChargesResponse.class)
  })
  public String retrieveAllClientCharges(
      ...
      @DefaultValue(ClientApiConstants.CLIENT_CHARGE_QUERY_PARAM_STATUS_VALUE_ALL)
          ...
          @ApiParam(value = "chargeStatus")
          final String chargeStatus,
      @QueryParam("pendingPayment") @ApiParam(value = "pendingPayment")
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Client Charge",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            SelfClientsApiResourceSwagger.GetSelfClientsClientIdChargesChargeIdResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "List Client Transactions",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfClientsApiResourceSwagger.GetSelfClientsClientIdTransactionsResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Client Transaction",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            SelfClientsApiResourceSwagger.GetSelfClientsClientIdTransactionsTransactionIdResponse
                .class)
  })
  ...
  public String addNewClientImage(
    ...
    validateAppuserClientsMapping(clientId);
    return this.imagesApiResource.addNewClientImage(
        ClientApiConstants.clientEntityName,
        clientId,
        fileSize,
        inputStream,
        fileDetails,
  ...
  public String addNewClientImage(
    ...
    validateAppuserClientsMapping(clientId);
    return this.imagesApiResource.addNewClientImage(
        ClientApiConstants.clientEntityName, clientId, jsonRequestBody);
  }
