...
@Component
@Scope("singleton")
@Api(tags = {"Savings Charges"})
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Savings Charges",
          description =
              "Its typical for MFIs to add maintenance and operating charges. They can be either"
                  + " Fees or Penalties.\n"
                  + "\n"
                  + "Savings Charges are instances of Charges and represent either fees and"
                  + " penalties for savings products. Refer Charges for documentation of the"
                  + " various properties of a charge, Only additional properties ( specific to the"
                  + " context of a Charge being associated with a Savings account) are described"
                  + " here")
    })
public class SavingsAccountChargesApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .GetSavingsAccountsSavingsAccountIdChargesResponse.class)
  })
  public String retrieveAllSavingsAccountCharges(
      @PathParam("savingsAccountId") @ApiParam(value = "savingsAccountId")
    ...
    this.context
        .authenticatedUser()
        .validateHasReadPermission(SAVINGS_ACCOUNT_CHARGE_RESOURCE_NAME);
    ...
    final Collection<SavingsAccountChargeData> savingsAccountCharges =
        this.savingsAccountChargeReadPlatformService.retrieveSavingsAccountCharges(
            savingsAccountId, chargeStatus);
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Savings Charges Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .GetSavingsAccountsSavingsAccountIdChargesTemplateResponse.class)
  })
  public String retrieveTemplate(
    ...
    final Collection<ChargeData> chargeOptions =
        this.chargeReadPlatformService.retrieveSavingsAccountApplicableCharges(savingsAccountId);
    final SavingsAccountChargeData savingsAccountChargeTemplate =
        SavingsAccountChargeData.template(chargeOptions);
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse.class)
  })
  public String retrieveSavingsAccountCharge(
    ...
    final SavingsAccountChargeData savingsAccountCharge =
        this.savingsAccountChargeReadPlatformService.retrieveSavingsAccountChargeDetails(
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create a Savings account Charge",
      httpMethod = "POST",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataTypeClass =
            SavingsAccountChargesApiResourceSwagger
                .PostSavingsAccountsSavingsAccountIdChargesRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .PostSavingsAccountsSavingsAccountIdChargesResponse.class)
  })
  public String addSavingsAccountCharge(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .createSavingsAccountCharge(savingsAccountId)
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Savings account Charge",
      httpMethod = "PUT",
      notes =
          "Currently Savings account Charges may be updated only if the Savings account is not yet"
              + " approved.")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        ...
        dataTypeClass =
            SavingsAccountChargesApiResourceSwagger
                .PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse.class)
  })
  public String updateSavingsAccountCharge(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateSavingsAccountCharge(savingsAccountId, savingsAccountChargeId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @ApiOperation(
      value =
          "Pay a Savings account Charge | Waive off a Savings account Charge | Inactivate a"
              + " Savings account Charge",
      httpMethod = "POST",
      notes =
          "Pay a Savings account Charge:\n\n"
              + "An active charge will be paid when savings account is active and having"
              + " sufficient balance.\n\n"
              + "Waive off a Savings account Charge:\n\n"
              + "Outstanding charge amount will be waived off.\n\n"
              + "Inactivate a Savings account Charge:\n\n"
              + "A charge will be allowed to inactivate when savings account is active and not"
              + " having any dues as of today. If charge is overpaid, corresponding charge payment"
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataTypeClass =
            SavingsAccountChargesApiResourceSwagger
                .PostSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .PostSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a Savings account Charge",
      httpMethod = "DELETE",
      notes =
          "Note: Currently, A Savings account Charge may only be removed from Savings that are not"
              + " yet approved.")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        ...
        response =
            SavingsAccountChargesApiResourceSwagger
                .DeleteSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse.class)
  })
  public String deleteSavingsAccountCharge(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .deleteSavingsAccountCharge(savingsAccountId, savingsAccountChargeId)
            .build();
