...
public class Loan extends AbstractPersistable<Long> {
	...
	public Map<String, Object> loanApplicationModification(final JsonCommand command,
		...
		updateLoanInterestRecalculationSettings(recalculationRestFrequencyDate, recalculationCompoundingFrequencyDate,
				command, actualChanges);
	...
	public void updateLoanInterestRecalculationSettings(final LocalDate recalculationRestFrequencyDate,
			final LocalDate recalculationCompoundingFrequencyDate, final JsonCommand command,
	...
	public void loanApplicationSubmittal(final AppUser currentUser, final LoanScheduleModel loanSchedule,
			...
			final List<Holiday> holidays, final WorkingDays workingDays, final boolean allowTransactionsOnNonWorkingDay,
			final LocalDate recalculationRestFrequencyDate, final LocalDate recalculationCompoundingFrequencyDate) {
	...
	public void updateLoanRepaymentScheduleDates(final LocalDate meetingStartDate, final String recuringRule,
			...
			final LocalDate newMeetingDate, final boolean isSkipRepaymentonfirstdayofmonth, final int numberofDays) {
	...
	public LoanApplicationTerms getLoanApplicationTerms(final ApplicationCurrency applicationCurrency,
		...
		return LoanApplicationTerms.assembleFrom(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType,
				...
				getApprovedPrincipal(), annualNominalInterestRate, loanTermVariations, numberofdays,
