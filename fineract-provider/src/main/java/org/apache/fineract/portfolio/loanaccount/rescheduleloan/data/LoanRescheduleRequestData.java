...
public class LoanRescheduleRequestData {
   ...
   **/
  private LoanRescheduleRequestData(
      Long id,
      Long loanId,
      ...
      LoanRescheduleRequestTimelineData timeline,
   ...
   **/
  public static LoanRescheduleRequestData instance(
      Long id,
      Long loanId,
      LoanRescheduleRequestStatusEnumData statusEnum,
      Integer rescheduleFromInstallment,
    ...
    return new LoanRescheduleRequestData(
        id,
        loanId,
        statusEnum,
