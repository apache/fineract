...
public class LoanScheduleAccrualData {
  ...
  public LoanScheduleAccrualData(
      final Long loanId,
      final Long officeId,
      ...
      final Long repaymentScheduleId,
      final Long loanProductId,
      final BigDecimal interestIncome,
      final BigDecimal feeIncome,
      final BigDecimal penaltyIncome,
  ...
  public void updateChargeDetails(
      final Map<LoanChargeData, BigDecimal> applicableCharges,
      final BigDecimal dueDateFeeIncome,
