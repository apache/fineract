...
public class GroupLoanIndividualMonitoringAccountData {
  ...
  private GroupLoanIndividualMonitoringAccountData(
  ...
  public static GroupLoanIndividualMonitoringAccountData getInstance(
      final BigDecimal glimId,
      final BigDecimal groupId,
      final String accountNumber,
      final String childAccountNumber,
      ...
      final Long childAccountsCount,
      final String loanStatus) {
    return new GroupLoanIndividualMonitoringAccountData(
        glimId,
        groupId,
        accountNumber,
        childAccountNumber,
  ...
  public static GroupLoanIndividualMonitoringAccountData getInstance1(
      final BigDecimal glimId,
      final BigDecimal groupId,
      final String accountNumber,
      final BigDecimal parentPrincipalAmount,
      final String loanStatus) {
    return new GroupLoanIndividualMonitoringAccountData(
        glimId, groupId, accountNumber, null, null, parentPrincipalAmount, null, loanStatus);
  }
