...
public class InterestRateChartSlabData {
  ...
  public static InterestRateChartSlabData instance(
      final Long id,
    ...
    return new InterestRateChartSlabData(
        id,
        description,
        periodType,
        fromPeriod,
  ...
  public static InterestRateChartSlabData withTemplate(
      final InterestRateChartSlabData chartSlab,
  ...
  public static InterestRateChartSlabData template(
      final Collection<EnumOptionData> periodTypes,
      final Collection<EnumOptionData> entityTypeOptions,
      final Collection<EnumOptionData> attributeNameOptions,
      final Collection<EnumOptionData> conditionTypeOptions,
  ...
  private InterestRateChartSlabData(
      final Long id,
      final String description,
      final EnumOptionData periodType,
      final Integer fromPeriod,
      ...
      final BigDecimal annualInterestRate,
      final CurrencyData currency,
      final Set<InterestIncentiveData> incentivesData,
      final Collection<EnumOptionData> periodTypes,
      final Collection<EnumOptionData> entityTypeOptions,
      final Collection<EnumOptionData> attributeNameOptions,
      final Collection<EnumOptionData> conditionTypeOptions,
