...
public class PostInterestAsOnException extends AbstractPlatformDomainRuleException{
    public static enum PostInterestAsOnException_Enum {
    ...
    public PostInterestAsOnException(final PostInterestAsOnException_Enum reason) {
