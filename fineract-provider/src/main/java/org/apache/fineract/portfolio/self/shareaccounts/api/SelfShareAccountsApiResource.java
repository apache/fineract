...
public class SelfShareAccountsApiResource {
  ...
  public SelfShareAccountsApiResource(
      ...
      final ShareAccountReadPlatformService readPlatformService,
  ...
  @ApiOperation(
      value = "Retrieve Share Account Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            SelfShareAccountsApiResourceSwagger.GetShareAccountsClientIdProductIdResponse.class)
  })
  public String template(
      @QueryParam("clientId") @ApiParam("clientId") final Long clientId,
      @QueryParam("productId") @ApiParam("productId") final Long productId,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Submit new share application",
      httpMethod = "POST",
      notes =
          "Mandatory fields:\n"
              + "\n"
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        responseContainer = "List",
        response = SelfShareAccountsApiResourceSwagger.PostNewShareApplicationResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a share application/account",
      httpMethod = "GET",
      notes = "\n" + "\n" + "\n" + "Example Requests:\n" + "\n" + "self/shareaccounts/12\n")
  // TODO actually write SelfShareAccountsApiResourceSwagger.GetShareAccountResponse (it currently
  // does not exist)
  // @ApiResponses({@ApiResponse(code = 200, message = "OK", responseContainer = "List", response =
  ...
  private void validateAppuserShareAccountMapping(final Long accountId) {
    ...
    final boolean isMapped =
        this.appUserShareAccountsMapperReadPlatformService.isShareAccountsMappedToUser(
