...
public class SavingsProductAssembler {
  ...
  @Autowired
  public SavingsProductAssembler(
  ...
  public SavingsProduct assemble(final JsonCommand command) {
    ...
    if (command.parameterExists(withdrawalFeeForTransfersParamName)) {
      iswithdrawalFeeApplicableForTransfer =
    ...
    if (command.parameterExists(nominalAnnualInterestRateOverdraftParamName)) {
      nominalAnnualInterestRateOverdraft =
          command.bigDecimalValueOfParameterNamed(nominalAnnualInterestRateOverdraftParamName);
    }
    ...
    if (command.parameterExists(minOverdraftForInterestCalculationParamName)) {
      minOverdraftForInterestCalculation =
          command.bigDecimalValueOfParameterNamed(minOverdraftForInterestCalculationParamName);
    }
    ...
    final Boolean isDormancyTrackingActive =
        command.booleanObjectValueOfParameterNamed(isDormancyTrackingActiveParamName);
    ...
    return SavingsProduct.createNew(
        name,
        shortName,
        description,
        currency,
