...
public class CreateNoteCommandHandler implements CommandHandler<NoteCreateRequest, CreateNoteResponse> {

    private final NoteWritePlatformService writePlatformService;

    @Transactional
    @Override
    public CreateNoteResponse handle(Command<NoteCreateRequest> command) {
