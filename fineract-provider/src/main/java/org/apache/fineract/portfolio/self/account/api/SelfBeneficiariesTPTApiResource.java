...
@SwaggerDefinition(tags = {@Tag(name = "Self Third Party Transfer", description = "")})
public class SelfBeneficiariesTPTApiResource {
  ...
  @ApiOperation(
      value = "Beneficiary Third Party Transfer Template",
      httpMethod = "GET",
      notes =
          "Returns Account Type enumerations. Self User is expected to know office name and"
              + " account number to be able to add beneficiary.\n"
              + "\n"
              + "Example Requests:\n"
              + "\n"
  ...
  @ApiOperation(
      ...
      notes =
          "Api to add third party beneficiary linked to current user.\n"
              ...
              + "\n"
              + "transferLimit : Each transfer initiated to this account will not exceed this"
              + " amount\n"
              + "\n"
              + "Example Requests:\n"
              + "\n"
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfBeneficiariesTPTApiResourceSwagger.PostSelfBeneficiariesTPTResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            SelfBeneficiariesTPTApiResourceSwagger.PutSelfBeneficiariesTPTBeneficiaryIdRequest
                .class)
  })
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            SelfBeneficiariesTPTApiResourceSwagger.PutSelfBeneficiariesTPTBeneficiaryIdResponse
                .class)
  })
  public String update(
      @PathParam("beneficiaryId") @ApiParam(value = "beneficiaryId") final Long beneficiaryId,
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            SelfBeneficiariesTPTApiResourceSwagger.DeleteSelfBeneficiariesTPTBeneficiaryIdResponse
                .class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfBeneficiariesTPTApiResourceSwagger.GetSelfBeneficiariesTPTResponse.class,
  ...
  public String retrieveAll(@Context final UriInfo uriInfo) {
    ...
    this.context
        .authenticatedUser()
        .validateHasReadPermission(SelfBeneficiariesTPTApiConstants.BENEFICIARY_ENTITY_NAME);
