...
public class LoanEnumerations {
      ...
      case DAYS:
        optionData =
            new EnumOptionData(
                ...
                codePrefix + PeriodFrequencyType.DAYS.getCode(),
                "Days");
        break;
      case WEEKS:
        optionData =
            new EnumOptionData(
                ...
                codePrefix + PeriodFrequencyType.WEEKS.getCode(),
                "Weeks");
        break;
      case MONTHS:
        optionData =
      ...
      case YEARS:
        optionData =
            new EnumOptionData(
                ...
                codePrefix + PeriodFrequencyType.YEARS.getCode(),
                "Years");
        break;
      default:
        optionData =
  ...
  public static EnumOptionData repaymentFrequencyNthDayType(final NthDayType type) {
    ...
    switch (type) {
      ...
      default:
        optionData =
            new EnumOptionData(
                Integer.valueOf(0).longValue(), codePrefix + type.getCode(), "invalid");
        break;
    }
  ...
  public static EnumOptionData repaymentFrequencyDayOfWeekType(final DayOfWeekType type) {
    ...
    EnumOptionData optionData =
        new EnumOptionData(
            type.getValue().longValue(), codePrefix + type.getCode(), type.toString());
  ...
  public static EnumOptionData interestRateFrequencyType(final PeriodFrequencyType type) {
    ...
    switch (type) {
      ...
      case WHOLE_TERM:
        optionData =
            new EnumOptionData(
                PeriodFrequencyType.WHOLE_TERM.getValue().longValue(),
  ...
  public static EnumOptionData amortizationType(final AmortizationMethod amortizationMethod) {
    ...
    switch (amortizationMethod) {
      case EQUAL_INSTALLMENTS:
        optionData =
            new EnumOptionData(
                AmortizationMethod.EQUAL_INSTALLMENTS.getValue().longValue(),
                AmortizationMethod.EQUAL_INSTALLMENTS.getCode(),
                "Equal installments");
        break;
      case EQUAL_PRINCIPAL:
        optionData =
            new EnumOptionData(
                AmortizationMethod.EQUAL_PRINCIPAL.getValue().longValue(),
                AmortizationMethod.EQUAL_PRINCIPAL.getCode(),
                "Equal principal payments");
        break;
      default:
        optionData =
            new EnumOptionData(
                AmortizationMethod.INVALID.getValue().longValue(),
  ...
  public static EnumOptionData interestType(final InterestMethod type) {
    ...
    switch (type) {
      case FLAT:
        optionData =
            new EnumOptionData(
                InterestMethod.FLAT.getValue().longValue(), InterestMethod.FLAT.getCode(), "Flat");
        break;
      case DECLINING_BALANCE:
        optionData =
            new EnumOptionData(
                InterestMethod.DECLINING_BALANCE.getValue().longValue(),
                InterestMethod.DECLINING_BALANCE.getCode(),
                "Declining Balance");
        break;
      default:
        optionData =
            new EnumOptionData(
                InterestMethod.INVALID.getValue().longValue(),
                InterestMethod.INVALID.getCode(),
                "Invalid");
        break;
    }
    return optionData;
  ...
  public static EnumOptionData interestCalculationPeriodType(
      final InterestCalculationPeriodMethod type) {
    EnumOptionData optionData = null;
    switch (type) {
      case DAILY:
        optionData =
            new EnumOptionData(
                InterestCalculationPeriodMethod.DAILY.getValue().longValue(),
                InterestCalculationPeriodMethod.DAILY.getCode(),
                "Daily");
        break;
      case SAME_AS_REPAYMENT_PERIOD:
        optionData =
            new EnumOptionData(
                ...
                InterestCalculationPeriodMethod.SAME_AS_REPAYMENT_PERIOD.getCode(),
                "Same as repayment period");
        break;
      default:
        optionData =
            new EnumOptionData(
                InterestCalculationPeriodMethod.INVALID.getValue().longValue(),
  ...
  public static LoanTransactionEnumData transactionType(final LoanTransactionType type) {
    ...
    switch (type) {
      case INVALID:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.INVALID.getValue().longValue(),
      ...
      case DISBURSEMENT:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.DISBURSEMENT.getValue().longValue(),
      ...
      case REPAYMENT:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.REPAYMENT.getValue().longValue(),
                LoanTransactionType.REPAYMENT.getCode(),
                "Repayment");
        break;
      ...
      case CONTRA:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.CONTRA.getValue().longValue(),
      ...
      case WAIVE_INTEREST:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.WAIVE_INTEREST.getValue().longValue(),
                LoanTransactionType.WAIVE_INTEREST.getCode(),
                "Waive interest");
        break;
      case MARKED_FOR_RESCHEDULING:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.MARKED_FOR_RESCHEDULING.getValue().longValue(),
                LoanTransactionType.MARKED_FOR_RESCHEDULING.getCode(),
                "Close (as rescheduled)");
        break;
      case WRITEOFF:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.WRITEOFF.getValue().longValue(),
                LoanTransactionType.WRITEOFF.getCode(),
                "Close (as written-off)");
        break;
      case RECOVERY_REPAYMENT:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.RECOVERY_REPAYMENT.getValue().longValue(),
                LoanTransactionType.RECOVERY_REPAYMENT.getCode(),
                "Repayment (after write-off)");
        break;
      case WAIVE_CHARGES:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.WAIVE_CHARGES.getValue().longValue(),
                LoanTransactionType.WAIVE_CHARGES.getCode(),
                "Waive loan charges");
        break;
      case ACCRUAL:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.ACCRUAL.getValue().longValue(),
                LoanTransactionType.ACCRUAL.getCode(),
                "Accrual");
        break;
      case APPROVE_TRANSFER:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.APPROVE_TRANSFER.getValue().longValue(),
                LoanTransactionType.APPROVE_TRANSFER.getCode(),
                "Transfer approved");
        break;
      case INITIATE_TRANSFER:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.INITIATE_TRANSFER.getValue().longValue(),
                LoanTransactionType.INITIATE_TRANSFER.getCode(),
                "Transfer initiated");
        break;
      case WITHDRAW_TRANSFER:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.WITHDRAW_TRANSFER.getValue().longValue(),
                LoanTransactionType.WITHDRAW_TRANSFER.getCode(),
                "Transfer Withdrawn");
        break;
      case REJECT_TRANSFER:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.REJECT_TRANSFER.getValue().longValue(),
                LoanTransactionType.REJECT_TRANSFER.getCode(),
                "Transfer Rejected");
        break;
      case REFUND:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.REFUND.getValue().longValue(),
                LoanTransactionType.REFUND.getCode(),
                "Transfer Refund");
        break;
      case CHARGE_PAYMENT:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.CHARGE_PAYMENT.getValue().longValue(),
                LoanTransactionType.CHARGE_PAYMENT.getCode(),
                "Charge Payment");
        break;
      case REFUND_FOR_ACTIVE_LOAN:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.REFUND_FOR_ACTIVE_LOAN.getValue().longValue(),
      ...
      case INCOME_POSTING:
        optionData =
            new LoanTransactionEnumData(
                LoanTransactionType.INCOME_POSTING.getValue().longValue(),
                LoanTransactionType.INCOME_POSTING.getCode(),
                "Income Posting");
        break;
      default:
        break;
  ...
  public static LoanStatusEnumData status(final LoanStatus status) {
    LoanStatusEnumData optionData =
        new LoanStatusEnumData(
            LoanStatus.INVALID.getValue().longValue(), LoanStatus.INVALID.getCode(), "Invalid");
    switch (status) {
      case INVALID:
        optionData =
            new LoanStatusEnumData(
      ...
      case ACTIVE:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.ACTIVE.getValue().longValue(), LoanStatus.ACTIVE.getCode(), "Active");
        break;
      case REJECTED:
        optionData =
            new LoanStatusEnumData(
      ...
      case WITHDRAWN_BY_CLIENT:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.WITHDRAWN_BY_CLIENT.getValue().longValue(),
                LoanStatus.WITHDRAWN_BY_CLIENT.getCode(),
                "Withdrawn by applicant");
        break;
      case CLOSED_OBLIGATIONS_MET:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.CLOSED_OBLIGATIONS_MET.getValue().longValue(),
                LoanStatus.CLOSED_OBLIGATIONS_MET.getCode(),
                "Closed (obligations met)");
        break;
      case CLOSED_WRITTEN_OFF:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.CLOSED_WRITTEN_OFF.getValue().longValue(),
                LoanStatus.CLOSED_WRITTEN_OFF.getCode(),
                "Closed (written off)");
        break;
      ...
      case OVERPAID:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.OVERPAID.getValue().longValue(),
                LoanStatus.OVERPAID.getCode(),
                "Overpaid");
        break;
      case TRANSFER_IN_PROGRESS:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.TRANSFER_IN_PROGRESS.getValue().longValue(),
                LoanStatus.TRANSFER_IN_PROGRESS.getCode(),
                "Transfer in progress");
        break;
      case TRANSFER_ON_HOLD:
        optionData =
            new LoanStatusEnumData(
                LoanStatus.TRANSFER_ON_HOLD.getValue().longValue(),
                LoanStatus.TRANSFER_ON_HOLD.getCode(),
                "Transfer on hold");
        break;
      default:
        break;
  ...
  public static EnumOptionData loanCycleValueConditionType(
      final LoanProductValueConditionType type) {
    EnumOptionData optionData = null;
    switch (type) {
      case EQUAL:
        optionData =
            new EnumOptionData(
                LoanProductValueConditionType.EQUAL.getValue().longValue(),
                LoanProductValueConditionType.EQUAL.getCode(),
                "equals");
        break;
      case GREATERTHAN:
        optionData =
            new EnumOptionData(
                LoanProductValueConditionType.GREATERTHAN.getValue().longValue(),
                LoanProductValueConditionType.GREATERTHAN.getCode(),
                "greater than");
        break;
      default:
        optionData =
            new EnumOptionData(
                LoanProductValueConditionType.INVALID.getValue().longValue(),
                LoanProductValueConditionType.INVALID.getCode(),
                "Invalid");
        break;
    }
    return optionData;
  ...
  public static EnumOptionData loanCycleParamType(final LoanProductParamType type) {
    ...
    switch (type) {
      case PRINCIPAL:
        optionData =
            new EnumOptionData(
                LoanProductParamType.PRINCIPAL.getValue().longValue(),
                LoanProductParamType.PRINCIPAL.getCode(),
                "principal");
        break;
      case INTERESTRATE:
        optionData =
            new EnumOptionData(
                LoanProductParamType.INTERESTRATE.getValue().longValue(),
                LoanProductParamType.INTERESTRATE.getCode(),
                "Interest rate");
        break;
      case REPAYMENT:
        optionData =
            new EnumOptionData(
                LoanProductParamType.REPAYMENT.getValue().longValue(),
                LoanProductParamType.REPAYMENT.getCode(),
                "repayment");
        break;
      default:
        optionData =
            new EnumOptionData(
                LoanProductParamType.INVALID.getValue().longValue(),
  ...
  public static EnumOptionData loanvariationType(final LoanTermVariationType type) {
    ...
    switch (type) {
      case EMI_AMOUNT:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.EMI_AMOUNT.getValue().longValue(),
                LoanTermVariationType.EMI_AMOUNT.getCode(),
                "emiAmount");
        break;
      case INTEREST_RATE:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.INTEREST_RATE.getValue().longValue(),
                LoanTermVariationType.INTEREST_RATE.getCode(),
                "interestRate");
        break;
      case DELETE_INSTALLMENT:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.DELETE_INSTALLMENT.getValue().longValue(),
                LoanTermVariationType.DELETE_INSTALLMENT.getCode(),
                "deleteInstallment");
        break;
      case DUE_DATE:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.DUE_DATE.getValue().longValue(),
                LoanTermVariationType.DUE_DATE.getCode(),
                "dueDate");
        break;
      case INSERT_INSTALLMENT:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.INSERT_INSTALLMENT.getValue().longValue(),
                LoanTermVariationType.DUE_DATE.getCode(),
                "insertInstallment");
        break;
      case PRINCIPAL_AMOUNT:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.PRINCIPAL_AMOUNT.getValue().longValue(),
      ...
      case GRACE_ON_INTEREST:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.GRACE_ON_INTEREST.getValue().longValue(),
      ...
      case GRACE_ON_PRINCIPAL:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.GRACE_ON_PRINCIPAL.getValue().longValue(),
      ...
      case EXTEND_REPAYMENT_PERIOD:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.EXTEND_REPAYMENT_PERIOD.getValue().longValue(),
      ...
      default:
        optionData =
            new EnumOptionData(
                LoanTermVariationType.INVALID.getValue().longValue(),
  ...
  public static EnumOptionData interestRecalculationCompoundingType(
      final InterestRecalculationCompoundingMethod type) {
    EnumOptionData optionData = null;
    switch (type) {
      case FEE:
        optionData =
            new EnumOptionData(
                InterestRecalculationCompoundingMethod.FEE.getValue().longValue(),
                InterestRecalculationCompoundingMethod.FEE.getCode(),
                "Fee");
        break;
      case INTEREST:
        optionData =
            new EnumOptionData(
                InterestRecalculationCompoundingMethod.INTEREST.getValue().longValue(),
                InterestRecalculationCompoundingMethod.INTEREST.getCode(),
                "Interest");
        break;
      case INTEREST_AND_FEE:
        optionData =
            new EnumOptionData(
                InterestRecalculationCompoundingMethod.INTEREST_AND_FEE.getValue().longValue(),
                InterestRecalculationCompoundingMethod.INTEREST_AND_FEE.getCode(),
                "Fee and Interest");
        break;
      default:
        optionData =
            new EnumOptionData(
                InterestRecalculationCompoundingMethod.NONE.getValue().longValue(),
                InterestRecalculationCompoundingMethod.NONE.getCode(),
                "None");
        break;
    }
    return optionData;
  ...
  public static EnumOptionData interestRecalculationCompoundingDayOfWeekType(
      final DayOfWeekType type) {
    final String codePrefix = "interestRecalculationCompounding.";
    EnumOptionData optionData =
        new EnumOptionData(
            type.getValue().longValue(), codePrefix + type.getCode(), type.toString());
  ...
  public static EnumOptionData rescheduleStrategyType(final LoanRescheduleStrategyMethod type) {
    ...
    switch (type) {
      case REDUCE_EMI_AMOUNT:
        optionData =
            new EnumOptionData(
                LoanRescheduleStrategyMethod.REDUCE_EMI_AMOUNT.getValue().longValue(),
      ...
      case REDUCE_NUMBER_OF_INSTALLMENTS:
        optionData =
            new EnumOptionData(
                ...
                LoanRescheduleStrategyMethod.REDUCE_NUMBER_OF_INSTALLMENTS.getCode(),
      ...
      case RESCHEDULE_NEXT_REPAYMENTS:
        optionData =
            new EnumOptionData(
                ...
                LoanRescheduleStrategyMethod.RESCHEDULE_NEXT_REPAYMENTS.getCode(),
                "Reschedule next repayments");
        break;
      default:
        optionData =
            new EnumOptionData(
                LoanRescheduleStrategyMethod.INVALID.getValue().longValue(),
                LoanRescheduleStrategyMethod.INVALID.getCode(),
                "Invalid");
        break;
    }
    return optionData;
  ...
  public static EnumOptionData interestRecalculationFrequencyType(
      final RecalculationFrequencyType type) {
    EnumOptionData optionData = null;
    switch (type) {
      case DAILY:
        optionData =
            new EnumOptionData(
                RecalculationFrequencyType.DAILY.getValue().longValue(),
                RecalculationFrequencyType.DAILY.getCode(),
                "Daily");
        break;
      case MONTHLY:
        optionData =
            new EnumOptionData(
                RecalculationFrequencyType.MONTHLY.getValue().longValue(),
                RecalculationFrequencyType.MONTHLY.getCode(),
                "Monthly");
        break;
      case SAME_AS_REPAYMENT_PERIOD:
        optionData =
            new EnumOptionData(
                RecalculationFrequencyType.SAME_AS_REPAYMENT_PERIOD.getValue().longValue(),
                RecalculationFrequencyType.SAME_AS_REPAYMENT_PERIOD.getCode(),
                "Same as repayment period");
        break;
      case WEEKLY:
        optionData =
            new EnumOptionData(
                RecalculationFrequencyType.WEEKLY.getValue().longValue(),
                RecalculationFrequencyType.WEEKLY.getCode(),
                "Weekly");
        break;
      default:
        optionData =
            new EnumOptionData(
                RecalculationFrequencyType.INVALID.getValue().longValue(),
                RecalculationFrequencyType.INVALID.getCode(),
                "Invalid");
        break;
    }
    return optionData;
  ...
  public static EnumOptionData preCloseInterestCalculationStrategy(final int id) {
    return preCloseInterestCalculationStrategy(
        LoanPreClosureInterestCalculationStrategy.fromInt(id));
  }

  public static EnumOptionData preCloseInterestCalculationStrategy(
      final LoanPreClosureInterestCalculationStrategy type) {
    EnumOptionData optionData = null;
    switch (type) {
      ...
      case TILL_REST_FREQUENCY_DATE:
        optionData =
            new EnumOptionData(
                LoanPreClosureInterestCalculationStrategy.TILL_REST_FREQUENCY_DATE
                    .getValue()
                    .longValue(),
