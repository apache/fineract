...
public class LoanEnumerations {
    ...
    public static EnumOptionData loanvariationType(final LoanTermVariationType type) {
        ...
        switch (type) {
            ...
            break;
            case INTEREST_RATE_FOR_INSTALLMENT:
                optionData = new EnumOptionData(LoanTermVariationType.INTEREST_RATE_FOR_INSTALLMENT.getValue().longValue(),
                        LoanTermVariationType.INTEREST_RATE_FOR_INSTALLMENT.getCode(), "interestRateForInstallment");
            break;
            default:
