...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
  ...
  @Autowired
  public ClientReadPlatformServiceImpl(
  ...
  public ClientData retrieveTemplate(final Long officeId, final boolean staffInSelectedOfficeOnly) {
    ...
    final List<CodeValueData> clientNonPersonConstitutionOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(
                ClientApiConstants.CLIENT_NON_PERSON_CONSTITUTION));

    final List<CodeValueData> clientNonPersonMainBusinessLineOptions =
        new ArrayList<>(
            this.codeValueReadPlatformService.retrieveCodeValuesByCode(
    ...
    final List<DatatableData> datatableTemplates =
        this.entityDatatableChecksReadService.retrieveTemplates(
            StatusEnum.CREATE.getCode().longValue(), EntityTables.CLIENT.getName(), null);
  ...
  public Page<ClientData> retrieveAll(final SearchParameters searchParameters) {
    ...
    List<Object> paramList =
        new ArrayList<>(Arrays.asList(underHierarchySearchString, underHierarchySearchString));
    ...
    if (searchParameters != null) {
      ...
      final String extraCriteria =
          buildSqlStringFromClientCriteria(this.clientMapper.schema(), searchParameters, paramList);
  ...
  private String buildSqlStringFromClientCriteria(
      String schemaSql, final SearchParameters searchParameters, List<Object> paramList) {
    ...
    try {
      ...
      final Collection<GroupGeneralData> parentGroups =
          this.jdbcTemplate.query(
              clientGroupsSql, this.clientGroupsMapper, new Object[] {clientId});
  ...
  public Collection<ClientData> retrieveAllForLookupByOfficeId(final Long officeId) {
    ...
    final String sql =
        "select " + this.lookupMapper.schema() + " where c.office_id = ? and c.status_enum != ?";

    return this.jdbcTemplate.query(
        sql, this.lookupMapper, new Object[] {officeId, ClientStatus.CLOSED.getValue()});
  }
  ...
  public Collection<ClientData> retrieveClientMembersOfGroup(final Long groupId) {
    ...
    return this.jdbcTemplate.query(
        sql, this.membersOfGroupMapper, new Object[] {hierarchySearchString, groupId});
  }
  ...
  private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
    ...
    public ClientMembersOfGroupMapper() {
      ...
      sqlBuilder.append(
          "c.default_savings_product as savingsProductId, sp.name as savingsProductName, ");
    ...
    public ClientData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
      ...
      final CodeValueData subStatus =
          CodeValueData.instance(subStatusId, subStatusValue, subStatusDesc, isActive);
      ...
      final CodeValueData classification =
          CodeValueData.instance(classificationId, classificationValue);
      ...
      if (legalFormEnum != null) legalForm = ClientEnumerations.legalForm(legalFormEnum);
      ...
      final ClientNonPersonData clientNonPerson =
          new ClientNonPersonData(
              constitution, incorpNo, incorpValidityTill, mainBusinessLine, remarks);

      final ClientTimelineData timeline =
          new ClientTimelineData(
              submittedOnDate,
              submittedByUsername,
  ...
  public ClientData retrieveClientByIdentifier(
      final Long identifierTypeId, final String identifierKey) {
    try {
      ...
      return this.jdbcTemplate.queryForObject(
          sql, mapper, new Object[] {identifierTypeId, identifierKey});
    } catch (final EmptyResultDataAccessException e) {
      return null;
    }
  }
  ...
  private static final class ClientIdentifierMapper implements RowMapper<ClientData> {
    ...
    public ClientData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
      ...
      return ClientData.clientIdentifier(
          id,
          accountNo,
          firstname,
          middlename,
  ...
  public ClientData retrieveAllNarrations(final String clientNarrations) {
    final List<CodeValueData> narrations =
        new ArrayList<>(
