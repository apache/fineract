...
public class ShareAccountChargeReadPlatformServiceImpl
    implements ShareAccountChargeReadPlatformService {
  ...
  private static final class ShareAccountChargeMapper implements RowMapper<ShareAccountChargeData> {
    ...
    public ShareAccountChargeMapper() {
      StringBuilder buff =
          new StringBuilder()
              ...
              .append(
                  "sc.amount_waived_derived as amountWaived, sc.amount_writtenoff_derived as"
                      + " amountWrittenOff, ")
              .append(
                  "sc.amount_outstanding_derived as amountOutstanding, sc.calculation_percentage"
                      + " as percentageOf, ")
              .append(
                  "sc.calculation_on_amount as amountPercentageAppliedTo, sc.charge_time_enum as"
                      + " chargeTime, ")
              ...
              .append(
                  "oc.decimal_places as currencyDecimalPlaces, oc.currency_multiplesof as"
                      + " inMultiplesOf, oc.display_symbol as currencyDisplaySymbol, ")
    ...
    public ShareAccountChargeData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      return new ShareAccountChargeData(
          id,
          chargeId,
          accountId,
          name,
