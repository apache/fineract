...
public class StandingInstructionHistoryReadPlatformServiceImpl
  ...
  // pagination
  private final PaginationHelper<StandingInstructionHistoryData> paginationHelper =
      new PaginationHelper<>();

  @Autowired
  public StandingInstructionHistoryReadPlatformServiceImpl(
  ...
  public Page<StandingInstructionHistoryData> retrieveAll(
    ...
    if (standingInstructionDTO.transferType() != null
        ...
        || (standingInstructionDTO.fromAccountType() != null
            && standingInstructionDTO.fromAccount() != null)
        || standingInstructionDTO.startDateRange() != null
        || standingInstructionDTO.endDateRange() != null) {
  ...
  private static final class StandingInstructionHistoryMapper
      implements RowMapper<StandingInstructionHistoryData> {
    ...
    public StandingInstructionHistoryMapper() {
      ...
      sqlBuilder.append(
          " join m_account_transfer_standing_instructions atsi on atsi.id ="
              + " atsih.standing_instruction_id ");
      sqlBuilder.append(
    ...
    @Override
    public StandingInstructionHistoryData mapRow(
      ...
      return new StandingInstructionHistoryData(
          id,
          name,
          fromOffice,
          fromClient,
