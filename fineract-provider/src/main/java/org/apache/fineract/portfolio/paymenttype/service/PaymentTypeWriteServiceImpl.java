...
public class PaymentTypeWriteServiceImpl implements PaymentTypeWriteService {
  ...
  @Autowired
  public PaymentTypeWriteServiceImpl(
      PaymentTypeRepository repository,
      PaymentTypeRepositoryWrapper repositoryWrapper,
  ...
  private void handleDataIntegrityIssues(final DataIntegrityViolationException dve) {
    ...
    if (realCause.getMessage().contains("acc_product_mapping")) {
      throw new PlatformDataIntegrityException(
          "error.msg.payment.type.association.exist",
    ...
    throw new PlatformDataIntegrityException(
        "error.msg.paymenttypes.unknown.data.integrity.issue",
