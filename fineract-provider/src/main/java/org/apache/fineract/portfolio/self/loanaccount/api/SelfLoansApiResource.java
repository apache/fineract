...
public class SelfLoansApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.GetSelfLoansLoanIdResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Loan Transaction Details",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            SelfLoansApiResourceSwagger.GetSelfLoansLoanIdTransactionsTransactionIdResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.GetSelfLoansLoanIdChargesResponse.class,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Loan Details Template",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.GetSelfLoansTemplateResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Calculate Loan Repayment Schedule | Submit a new Loan Application",
      httpMethod = "POST",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SelfLoansApiResourceSwagger.PostSelfLoansRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.PostSelfLoansResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Loan Application",
      httpMethod = "PUT",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SelfLoansApiResourceSwagger.PutSelfLoansLoanIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.PutSelfLoansLoanIdResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Applicant Withdraws from Loan Application",
      httpMethod = "POST",
      notes = "Applicant Withdraws from Loan Application\n\n" + "Mandatory Fields: withdrawnOnDate")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SelfLoansApiResourceSwagger.PostSelfLoansLoanIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = SelfLoansApiResourceSwagger.PostSelfLoansLoanIdResponse.class)
  })
