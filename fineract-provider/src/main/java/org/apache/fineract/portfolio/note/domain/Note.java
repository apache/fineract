...
public class Note extends AbstractAuditableCustom {
  ...
  public static Note loanTransactionNote(
      final Loan loan, final LoanTransaction loanTransaction, final String note) {
  ...
  public static Note savingsTransactionNote(
