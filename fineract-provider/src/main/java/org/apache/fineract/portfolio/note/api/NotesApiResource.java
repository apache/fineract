...
public class NotesApiResource {
  ...
  private final Set<String> NOTE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              "id",
              "clientId",
  ...
  public NotesApiResource(
      ...
      final NoteReadPlatformService readPlatformService,
  ...
  @ApiOperation(
      value = "Retrieve a Resource's Notes",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response = NotesApiResourceSwagger.GetResourceTypeResourceIdNotesResponse.class)
  })
  public String retrieveNotesByResource(
      @PathParam("resourceType") @ApiParam(value = "resourceType") final String resourceType,
      @PathParam("resourceId") @ApiParam(value = "resourceId") final Long resourceId,
    ...
    this.context
        .authenticatedUser()
        .validateHasReadPermission(getResourceDetails(noteType, resourceId).entityName());

    final Integer noteTypeId = noteType.getValue();

    final Collection<NoteData> notes =
        this.readPlatformService.retrieveNotesByResource(resourceId, noteTypeId);
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Resource Note",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = NotesApiResourceSwagger.GetResourceTypeResourceIdNotesNoteIdResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = NotesApiResourceSwagger.PostResourceTypeResourceIdNotesRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = NotesApiResourceSwagger.PostResourceTypeResourceIdNotesResponse.class)
  })
  public String addNewNote(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .createNote(resourceDetails, resourceType, resourceId)
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Resource Note",
      httpMethod = "PUT",
      notes = "Updates a Resource Note")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = NotesApiResourceSwagger.PutResourceTypeResourceIdNotesNoteIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = NotesApiResourceSwagger.PutResourceTypeResourceIdNotesNoteIdResponse.class)
  })
  public String updateNote(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateNote(resourceDetails, resourceType, resourceId, noteId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a Resource Note",
      httpMethod = "DELETE",
      notes = "Deletes a Resource Note")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = NotesApiResourceSwagger.DeleteResourceTypeResourceIdNotesNoteIdResponse.class)
  })
  public String deleteNote(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .deleteNote(resourceDetails, resourceType, resourceId, noteId)
            .build();
  ...
  private CommandWrapper getResourceDetails(final NoteType type, final Long resourceId) {
    ...
    switch (type) {
      ...
      case LOAN_TRANSACTION:
        ...
        // updating loanId, to distinguish saving transaction note and loan transaction note as we
        // are using subEntityId for both.
        resourceDetails.withLoanId(resourceId);
