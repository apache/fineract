...
public class AdHocQuerySearchConditions {
  ...
  public static AdHocQuerySearchConditions instance(
      final List<String> loanStatus,
      final List<Long> loanProducts,
      final List<Long> offices,
    ...
    return new AdHocQuerySearchConditions(
        loanStatus,
        loanProducts,
        offices,
        loanDateOption,
  ...
  public AdHocQuerySearchConditions(
      final List<String> loanStatus,
      final List<Long> loanProducts,
      final List<Long> offices,
      final String loanDateOption,
      ...
      final BigDecimal maxOutStandingAmountPercentage,
      final BigDecimal outStandingAmountPercentage,
      final Boolean includeOutstandingAmount,
      final String outstandingAmountCondition,
      final BigDecimal minOutstandingAmount,
      final BigDecimal maxOutstandingAmount,
      final BigDecimal outstandingAmount) {
