...
public class AttendanceEnumerations {
  ...
  public static EnumOptionData attendanceType(final AttendanceType attendanceType) {
    ...
    EnumOptionData optionData =
        new EnumOptionData(
            AttendanceType.INVALID.getValue().longValue(),
            AttendanceType.INVALID.getCode(),
            "Invalid");
    ...
    switch (attendanceType) {
      ...
      case PRESENT:
        optionData =
            new EnumOptionData(
                AttendanceType.PRESENT.getValue().longValue(),
                AttendanceType.PRESENT.getCode(),
                "Present");
        break;
      case ABSENT:
        optionData =
            new EnumOptionData(
                AttendanceType.ABSENT.getValue().longValue(),
                AttendanceType.ABSENT.getCode(),
                "Absent");
        break;
      case APPROVED:
        optionData =
            new EnumOptionData(
                AttendanceType.APPROVED.getValue().longValue(),
                AttendanceType.APPROVED.getCode(),
                "Approved");
        break;
      case LEAVE:
        optionData =
            new EnumOptionData(
                AttendanceType.LEAVE.getValue().longValue(),
                AttendanceType.LEAVE.getCode(),
                "Leave");
        break;
      case LATE:
        optionData =
            new EnumOptionData(
                AttendanceType.LATE.getValue().longValue(), AttendanceType.LATE.getCode(), "Late");
        break;
    }
    return optionData;
  }
