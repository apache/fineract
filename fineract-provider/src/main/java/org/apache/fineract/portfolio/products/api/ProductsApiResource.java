...
public class ProductsApiResource {
  ...
  public String retrieveTemplate(
      @PathParam("type") @ApiParam(value = "type") final String productType,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Share Product",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = ProductsApiResourceSwagger.GetProductsTypeProductIdResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = ProductsApiResourceSwagger.GetProductsTypeResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create a Share Product",
      httpMethod = "POST",
      notes =
          "Creates a Share Product\n\n"
              + "Mandatory Fields: name, shortName, description, currencyCode,"
              + " digitsAfterDecimal,inMultiplesOf, locale, totalShares, unitPrice,"
              + " nominalShares,allowDividendCalculationForInactiveClients,accountingRule\n\n"
              ...
              + "Optional Fields: sharesIssued, minimumShares, maximumShares,"
              + " minimumActivePeriodForDividends, minimumactiveperiodFrequencyType,"
              + " lockinPeriodFrequency, lockinPeriodFrequencyType, marketPricePeriods,"
              + " chargesSelected")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ProductsApiResourceSwagger.PostProductsTypeRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = ProductsApiResourceSwagger.PostProductsTypeResponse.class)
  })
  ...
  public String handleCommands(
      ...
      @SuppressWarnings("unused") @Context final UriInfo uriInfo,
      @ApiParam(hidden = true) final String apiRequestBodyAsJson) {
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Share Product",
      httpMethod = "PUT",
      notes = "Updates a Share Product")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ProductsApiResourceSwagger.PutProductsTypeProductIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = ProductsApiResourceSwagger.PutProductsTypeProductIdResponse.class)
  })
  public String updateProduct(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateProduct(productType, productId)
            .withJson(apiRequestBodyAsJson)
            .build();
