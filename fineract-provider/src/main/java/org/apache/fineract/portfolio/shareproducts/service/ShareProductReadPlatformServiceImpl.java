...
public class ShareProductReadPlatformServiceImpl implements ProductReadPlatformService {
  ...
  @Autowired
  public ShareProductReadPlatformServiceImpl(
  ...
  public Page<ProductData> retrieveAllProducts(Integer offSet, Integer limit) {
    ...
    return this.shareProductDataPaginationHelper.fetchPage(
  ...
  public ProductData retrieveOne(Long productId, boolean includeTemplate) {
    ...
    try {
      ...
      final Collection<ShareProductMarketPriceData> shareMarketCollection =
          this.jdbcTemplate.query(sql1, marketRowMapper, new Object[] {productId});
      ...
      if (data.hasAccountingEnabled()) {
        final Map<String, Object> accountingMappings =
            this.accountMappingReadPlatformService.fetchAccountMappingDetailsForShareProduct(
                productId, data.accountingRuleTypeId());
        ...
        Collection<ChargeToGLAccountMapper> feeToGLAccountMappings =
            this.accountMappingReadPlatformService.fetchFeeToIncomeAccountMappingsForShareProduct(
                productId);
        data =
            ShareProductData.withAccountingDetails(
                data,
                accountingMappings,
  ...
  public ProductData retrieveTemplate() {
    ...
    final Collection<EnumOptionData> minimumActivePeriodFrequencyTypeOptions =
        this.shareProductDropdownReadPlatformService
            .retrieveMinimumActivePeriodFrequencyTypeOptions();
    final Map<String, List<GLAccountData>> accountingMappingOptions =
        this.accountingDropdownReadPlatformService.retrieveAccountMappingOptionsForShareProducts();
    return ShareProductData.template(
        currencyOptions,
        chargeOptions,
        minimumActivePeriodFrequencyTypeOptions,
        lockinPeriodFrequencyTypeOptions,
  ...
  private static final class AllShareProductRowMapper implements RowMapper<ProductData> {
    ...
    public String schema() {
      return "shareproduct.id, shareproduct.name, shareproduct.short_name,"
          + " shareproduct.total_shares from m_share_product shareproduct";
    }
  }

  private static final class MarketPriceRowMapper
      implements RowMapper<ShareProductMarketPriceData> {
    ...
    public String schema() {
      return "marketData.id, marketData.from_date, marketData.share_value from"
          + " m_share_product_market_price marketData";
    }
  }
  ...
  private static final class ShareProductRowMapper implements RowMapper<ProductData> {
    ...
    ShareProductRowMapper(
      ...
      buff.append("shareproduct.id, shareproduct.name, shareproduct.short_name, ")
          ...
          .append(
              "shareproduct.end_date, shareproduct.currency_code, shareproduct.currency_digits, ")
          .append(
              "shareproduct.currency_multiplesof, shareproduct.total_shares,"
                  + " shareproduct.issued_shares, ")
          ...
          .append(
              "shareproduct.maximum_client_shares, shareproduct.minimum_active_period_frequency, ")
          .append(
              "shareproduct.minimum_active_period_frequency_enum,"
                  + " shareproduct.lockin_period_frequency, ")
          .append(
              "shareproduct.lockin_period_frequency_enum,"
                  + " shareproduct.allow_dividends_inactive_clients, ")
          .append(
              "shareproduct.createdby_id, created.username as createdName, modified.username as"
                  + " modifiedName, ")
          .append(
              "shareproduct.created_date, shareproduct.lastmodifiedby_id,"
                  + " shareproduct.lastmodified_date, ")
          .append(
    ...
    public ShareProductData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      final Integer minimumActivePeriod =
          JdbcSupport.getInteger(rs, "minimum_active_period_frequency");
      ...
      if (minimumActviePeriodEnumValue != null) {
        minimumActivePeriodType =
            SharesEnumerations.minimumActivePeriodFrequencyType(minimumActviePeriodEnumValue);
      }
