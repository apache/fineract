...
public class DepositPreClosureDetail {
  ...
  public static DepositPreClosureDetail createFrom(
    ...
    return new DepositPreClosureDetail(
  ...
  private DepositPreClosureDetail(
      final boolean preClosurePenalApplicable,
      final BigDecimal preClosurePenalInterest,
      final PreClosurePenalInterestOnType preClosurePenalInterestType) {
    this.preClosurePenalApplicable = preClosurePenalApplicable;
    this.preClosurePenalInterest = preClosurePenalInterest;
    this.preClosurePenalInterestOnType =
        (preClosurePenalInterestType == null) ? null : preClosurePenalInterestType.getValue();
  }
  ...
  protected Map<String, Object> update(
    ...
    if (command.isChangeInBooleanParameterNamed(
        preClosurePenalApplicableParamName, this.preClosurePenalApplicable)) {
      final boolean newValue =
          command.booleanPrimitiveValueOfParameterNamed(preClosurePenalApplicableParamName);
    ...
    if (this.preClosurePenalApplicable) {
      if (command.isChangeInBigDecimalParameterNamed(
          preClosurePenalInterestParamName, this.preClosurePenalInterest)) {
      ...
      if (command.isChangeInIntegerParameterNamed(
          preClosurePenalInterestOnTypeIdParamName, this.preClosurePenalInterestOnType)) {
        ...
        actualChanges.put(
            ...
            SavingsEnumerations.preClosurePenaltyInterestOnType(newValue));
        actualChanges.put(localeParamName, localeAsInput);
      ...
      if (this.preClosurePenalInterest == null) {
        baseDataValidator
            ...
            .value(this.preClosurePenalInterest)
      ...
      if (this.preClosurePenalInterestOnType == null) {
        baseDataValidator
            ...
            .value(this.preClosurePenalInterestOnType)
            .cantBeBlankWhenParameterProvidedIs(
                preClosurePenalApplicableParamName, this.preClosurePenalApplicable);
      }
  ...
  public DepositPreClosureDetail copy() {
    ...
    final PreClosurePenalInterestOnType preClosurePenalInterestType =
        PreClosurePenalInterestOnType.fromInt(this.preClosurePenalInterestOnType);

    return DepositPreClosureDetail.createFrom(
        preClosurePenalApplicable, preClosurePenalInterest, preClosurePenalInterestType);
  }
}
