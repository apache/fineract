...
public final class ClientIdentifierCommandFromApiJsonDeserializer
  ...
  private final Set<String> supportedParameters =
      new HashSet<>(Arrays.asList("documentTypeId", "documentKey", "status", "description"));
  ...
  public ClientIdentifierCommand commandFromApiJson(final String json) {
    ...
    final String documentDescription =
        this.fromApiJsonHelper.extractStringNamed("documentDescription", element);
    final String statusString = this.fromApiJsonHelper.extractStringNamed("status", element);
    return new ClientIdentifierCommand(
        documentTypeId, documentKey, statusString, documentDescription);
  }
}
