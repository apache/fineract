...
public interface FamilyMemberWriteService {
    ...
    FamilyMemberUpdateResponse updateFamilyMember(FamilyMemberUpdateRequest request);

    FamilyMemberDeleteResponse deleteFamilyMember(FamilyMemberDeleteRequest request);
}
