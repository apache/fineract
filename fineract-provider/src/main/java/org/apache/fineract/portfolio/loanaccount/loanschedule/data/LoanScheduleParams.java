...
public class LoanScheduleParams {
  ...
  private LoanScheduleParams(
      final int periodNumber,
      final int instalmentNumber,
      int loanTermInDays,
      LocalDate periodStartDate,
      final LocalDate actualRepaymentDate,
      ...
      Money totalOutstandingInterestPaymentDueToGrace,
      ...
      final Map<LocalDate, Money> disburseDetailMap,
  ...
  public static LoanScheduleParams createLoanScheduleParamsForPartialUpdate(
      final int periodNumber,
      final int instalmentNumber,
      int loanTermInDays,
      LocalDate periodStartDate,
      ...
      final Map<LocalDate, Money> latePaymentMap,
      final Map<LocalDate, Money> compoundingMap,
      Money unCompoundedAmount,
      final Map<LocalDate, Money> disburseDetailMap,
      final Money principalToBeScheduled,
      final Money outstandingBalance,
      final Money outstandingBalanceAsPerRest,
      final List<LoanRepaymentScheduleInstallment> installments,
      final Collection<RecalculationDetail> recalculationDetails,
  ...
  public static LoanScheduleParams createLoanScheduleParamsForCompleteUpdate(
      final Collection<RecalculationDetail> recalculationDetails,
      final LoanRepaymentScheduleTransactionProcessor loanRepaymentScheduleTransactionProcessor,
      final LocalDate scheduleTillDate,
      final boolean applyInterestRecalculation) {
  ...
  public static LoanScheduleParams createLoanScheduleParams(
      final MonetaryCurrency currency,
      final Money chargesDueAtTimeOfDisbursement,
  ...
  public static LoanScheduleParams createLoanScheduleParams(
    ...
    final boolean partialUpdate = false;
    final Collection<RecalculationDetail> recalculationDetails =
        loanScheduleParams.recalculationDetails;
    final LoanRepaymentScheduleTransactionProcessor loanRepaymentScheduleTransactionProcessor =
        loanScheduleParams.loanRepaymentScheduleTransactionProcessor;
  ...
  public void setTotalOutstandingInterestPaymentDueToGrace(
      Money totalOutstandingInterestPaymentDueToGrace) {
    this.totalOutstandingInterestPaymentDueToGrace = totalOutstandingInterestPaymentDueToGrace;
  }
