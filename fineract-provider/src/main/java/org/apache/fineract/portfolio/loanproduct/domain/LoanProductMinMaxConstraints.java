...
public class LoanProductMinMaxConstraints {
  ...
  public static LoanProductMinMaxConstraints createFrom(
      final BigDecimal minPrincipal,
      final BigDecimal maxPrincipal,
      final BigDecimal minNominalInterestRatePerPeriod,
      final BigDecimal maxNominalInterestRatePerPeriod,
      final Integer minNumberOfRepayments,
      final Integer maxNumberOfRepayments) {

    return new LoanProductMinMaxConstraints(
        minPrincipal,
        maxPrincipal,
  ...
  public LoanProductMinMaxConstraints(
      ...
      final Integer defaultMinNumberOfRepayments,
      final Integer defaultMaxNumberOfRepayments) {
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    if (command.isChangeInBigDecimalParameterNamedWithNullCheck(
        minPrincipalParamName, this.minPrincipal)) {
    ...
    if (command.isChangeInBigDecimalParameterNamedWithNullCheck(
        maxPrincipalParamName, this.maxPrincipal)) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        minNumberOfRepaymentsParamName, this.minNumberOfRepayments)) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        maxNumberOfRepaymentsParamName, this.maxNumberOfRepayments)) {
    ...
    if (command.isChangeInBigDecimalParameterNamedWithNullCheck(
        minInterestRatePerPeriodParamName, this.minNominalInterestRatePerPeriod)) {
      final BigDecimal newValue =
          command.bigDecimalValueOfParameterNamed(minInterestRatePerPeriodParamName);
    ...
    if (command.isChangeInBigDecimalParameterNamedWithNullCheck(
        maxInterestRatePerPeriodParamName, this.maxNominalInterestRatePerPeriod)) {
      final BigDecimal newValue =
          command.bigDecimalValueOfParameterNamed(maxInterestRatePerPeriodParamName);
  ...
  public BigDecimal getMinNominalInterestRatePerPeriod() {
    return this.minNominalInterestRatePerPeriod == null
        ? null
        : BigDecimal.valueOf(
            Double.valueOf(this.minNominalInterestRatePerPeriod.stripTrailingZeros().toString()));
  }

  public BigDecimal getMaxNominalInterestRatePerPeriod() {
    return this.maxNominalInterestRatePerPeriod == null
        ? null
        : BigDecimal.valueOf(
            Double.valueOf(this.maxNominalInterestRatePerPeriod.stripTrailingZeros().toString()));
  }
