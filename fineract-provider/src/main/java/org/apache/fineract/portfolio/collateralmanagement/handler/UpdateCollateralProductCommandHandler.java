...
public class UpdateCollateralProductCommandHandler
        implements CommandHandler<CollateralManagementProductUpdateRequest, CollateralManagementProductUpdateResponse> {

    private final CollateralManagementWritePlatformService collateralManagementWritePlatformService;

    @Transactional
    @Override
    public CollateralManagementProductUpdateResponse handle(Command<CollateralManagementProductUpdateRequest> command) {
        return this.collateralManagementWritePlatformService.updateCollateral(command.getPayload().getCollateralId(), command.getPayload());
    }
}
