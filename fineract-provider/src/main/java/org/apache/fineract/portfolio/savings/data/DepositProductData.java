...
public class DepositProductData {
  ...
  public static DepositProductData template(
  ...
  public static DepositProductData withCharges(
      final DepositProductData existingProduct, final Collection<ChargeData> charges) {
    return new DepositProductData(
        existingProduct.id,
   ...
   *            TODO
   */
  public static DepositProductData withTemplate(
      final DepositProductData existingProduct,
      final Collection<CurrencyData> currencyOptions,
      final Collection<EnumOptionData> interestCompoundingPeriodTypeOptions,
      final Collection<EnumOptionData> interestPostingPeriodTypeOptions,
      final Collection<EnumOptionData> interestCalculationTypeOptions,
  ...
  public static DepositProductData withAccountingDetails(
      final DepositProductData existingProduct,
  ...
  public static DepositProductData instance(
      final Long id,
      final String name,
  ...
  public static InterestRateChartData activeChart(
      Collection<InterestRateChartData> interestRateCharts) {
