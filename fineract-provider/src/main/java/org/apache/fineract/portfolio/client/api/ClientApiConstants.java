...
public class ClientApiConstants {
    ...
    // Client Identifier Code Value
    public static final String clientIdentifierPassportParamName = "Passport";
    public static final String clientIdentifierCountryParamName = "COUNTRY";
