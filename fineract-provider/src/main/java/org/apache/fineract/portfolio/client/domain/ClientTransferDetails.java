...
public class ClientTransferDetails extends AbstractPersistableCustom {
  ...
  private ClientTransferDetails(
      final Long clientId,
      final Long fromOfficeId,
      final Long toOfficeId,
      final Date proposedTransferDate,
      final Integer transferEventType,
      final Date submittedOn,
  ...
  public static ClientTransferDetails instance(
      final Long clientId,
      final Long fromOfficeId,
      final Long toOfficeId,
      final Date proposedTransferDate,
      ...
      final Date submittedOn,
      final Long submittedBy) {
    return new ClientTransferDetails(
        clientId,
        fromOfficeId,
        toOfficeId,
