...
public class AddMoreMembersToGSIMApplicationModificationCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public AddMoreMembersToGSIMApplicationModificationCommandHandler(
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.savingAccountWritePlatformService.addMoreMembersToGSIMApplication(command.entityId(), command);
    }
