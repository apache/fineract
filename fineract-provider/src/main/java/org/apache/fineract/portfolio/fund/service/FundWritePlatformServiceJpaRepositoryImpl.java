...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(FundWritePlatformServiceJpaRepositoryImpl.class);
   ...
   * is.
   */
  private void handleFundDataIntegrityIssues(
    ...
    if (realCause.getMessage().contains("fund_externalid_org")) {
      ...
      throw new PlatformDataIntegrityException(
          ...
          "A fund with external id '" + externalId + "' already exists",
          "externalId",
          externalId);
    } else if (realCause.getMessage().contains("fund_name_org")) {
      final String name = command.stringValueOfParameterNamed("name");
      throw new PlatformDataIntegrityException(
          "error.msg.fund.duplicate.name",
          "A fund with name '" + name + "' already exists",
          "name",
          name);
    }
