...
public class SelfServiceApiConstants {
  ...
  public static final Set<String> CREATE_USER_REQUEST_DATA_PARAMETERS =
      Collections.unmodifiableSet(
          new HashSet<>(Arrays.asList(requestIdParamName, authenticationTokenParamName)));
  public static final Object[] SUPPORTED_AUTHENTICATION_MODE_PARAMETERS =
      new Object[] {emailModeParamName, mobileModeParamName};
