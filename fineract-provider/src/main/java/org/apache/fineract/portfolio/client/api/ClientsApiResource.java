...
public class ClientsApiResource {
    ...
    public Response getClientTemplate(@QueryParam("entityType")final String entityType ,@QueryParam("officeId")final Long officeId,@QueryParam("staffId")final Long staffId) {
        return bulkImportWorkbookPopulatorService.getTemplate(entityType, officeId, staffId,null,
    ...
    public Response postClientTemplate(@QueryParam("entityType")final String entityType ,@FormDataParam("file") InputStream uploadedInputStream,
