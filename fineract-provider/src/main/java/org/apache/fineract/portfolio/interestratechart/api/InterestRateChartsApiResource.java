...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "This defines an interest rate scheme that can be associated to a term deposit"
                  + " product. This will have a slab (band or range) of deposit periods and the"
                  + " associated interest rates applicable along with incentives for each band.")
    })
public class InterestRateChartsApiResource {
  ...
  private static final Set<String> INTERESTRATE_CHART_RESPONSE_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              InterestRateChartApiConstants.localeParamName,
              InterestRateChartApiConstants.dateFormatParamName,
              idParamName,
              nameParamName,
  ...
  public InterestRateChartsApiResource(
      ...
      final DefaultToApiJsonSerializer<InterestRateChartData> toApiJsonSerializer,
  ...
  @ApiOperation(
      value = "Retrieve Chart Details Template",
      httpMethod = "GET",
      notes =
          "This is a convenience resource. It can be useful when building maintenance user"
              + " interface screens for creating a chart. The template data returned consists of"
              + " any or all of:\n"
              + "\n"
              + "Field Defaults\n"
              + "Allowed Value Lists\n"
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = InterestRateChartsApiResourceSwagger.GetInterestRateChartsTemplateResponse.class)
  })
  public String template(@Context final UriInfo uriInfo) {
    this.context
        .authenticatedUser()
        .validateHasReadPermission(InterestRateChartApiConstants.INTERESTRATE_CHART_RESOURCE_NAME);
    ...
    return this.toApiJsonSerializer.serialize(
        settings, chartData, INTERESTRATE_CHART_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response = InterestRateChartsApiResourceSwagger.GetInterestRateChartsResponse.class)
  })
  public String retrieveAll(
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, chartDatas, INTERESTRATE_CHART_RESPONSE_DATA_PARAMETERS);
  }
  ...
  @ApiOperation(
      ...
      httpMethod = "POST",
      notes = "Creates a new chart which can be attached to a term deposit products (FD or RD).")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = InterestRateChartsApiResourceSwagger.PostInterestRateChartsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = InterestRateChartsApiResourceSwagger.PostInterestRateChartsResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            InterestRateChartsApiResourceSwagger.PutInterestRateChartsChartIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = InterestRateChartsApiResourceSwagger.PutInterestRateChartsChartIdResponse.class)
  })
  public String update(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateInterestRateChart(chartId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            InterestRateChartsApiResourceSwagger.DeleteInterestRateChartsChartIdResponse.class)
  })
  public String delete(@PathParam("chartId") @ApiParam(value = "chartId") final Long chartId) {
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteInterestRateChart(chartId).build();
    final CommandProcessingResult result =
        this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    return this.toApiJsonSerializer.serialize(result);
  }
