...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Client Identifiers refer to documents that are used to uniquely identify a"
                  + " customer\n"
                  + "Ex: Drivers License, Passport, Ration card etc ")
    })
public class ClientIdentifiersApiResource {

  private static final Set<String> CLIENT_IDENTIFIER_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              "id",
              "clientId",
  ...
  @Autowired
  public ClientIdentifiersApiResource(
  ...
  @ApiOperation(
      value = "List all Identifiers for a Client",
      notes =
          "Example Requests:\n"
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response = ClientIdentifiersApiResourceSwagger.GetClientsClientIdIdentifiersResponse.class)
  })
  public String retrieveAllClientIdentifiers(
    ...
    return this.toApiJsonSerializer.serialize(
        settings, clientIdentifiers, CLIENT_IDENTIFIER_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Client Identifier Details Template",
      notes =
          "This is a convenience resource useful for building maintenance user interface screens"
              + " for client applications. The template data returned consists of any or all of:\n"
              + "\n"
              + " Field Defaults\n"
              + " Allowed Value Lists\n"
              + "\n\n"
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            ClientIdentifiersApiResourceSwagger.GetClientsClientIdIdentifiersTemplateResponse.class)
  })
  public String newClientIdentifierDetails(@Context final UriInfo uriInfo) {
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.toApiJsonSerializer.serialize(
        settings, clientIdentifierData, CLIENT_IDENTIFIER_DATA_PARAMETERS);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create an Identifier for a Client",
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response = ClientIdentifiersApiResourceSwagger.PostClientsClientIdIdentifiersResponse.class)
  })
  public String createClientIdentifier(
      @PathParam("clientId") @ApiParam(value = "clientId") final Long clientId,
    ...
    try {
      ...
      if (e.getDocumentTypeId() != null) {
        ...
        final ClientData clientInfo =
            this.clientReadPlatformService.retrieveClientByIdentifier(
                e.getDocumentTypeId(), e.getIdentifierKey());
        rethrowas =
            new DuplicateClientIdentifierException(
                clientInfo.displayName(),
                clientInfo.officeName(),
                e.getIdentifierType(),
                e.getIdentifierKey());
      }
      throw rethrowas;
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Client Identifier",
      notes =
          "Example Requests:\n"
  ...
  public String retrieveClientIdentifiers(
      @PathParam("clientId") @ApiParam(value = "clientId") final Long clientId,
    ...
    ClientIdentifierData clientIdentifierData =
        this.clientIdentifierReadPlatformService.retrieveClientIdentifier(
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            ClientIdentifiersApiResourceSwagger.PutClientsClientIdIdentifiersIdentifierIdRequest
                .class)
  })
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            ClientIdentifiersApiResourceSwagger.PutClientsClientIdIdentifiersIdentifierIdResponse
                .class)
  })
  public String updateClientIdentifer(
      @PathParam("clientId") @ApiParam(value = "clientId") final Long clientId,
      @PathParam("identifierId") @ApiParam(value = "identifierId") final Long clientIdentifierId,
      @ApiParam(hidden = true) final String apiRequestBodyAsJson) {
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            ClientIdentifiersApiResourceSwagger.DeleteClientsClientIdIdentifiersIdentifierIdResponse
                .class)
  })
  public String deleteClientIdentifier(
      @PathParam("clientId") @ApiParam(value = "clientId") final Long clientId,
      @PathParam("identifierId") @ApiParam(value = "identifierId") final Long clientIdentifierId) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteClientIdentifier(clientId, clientIdentifierId).build();
