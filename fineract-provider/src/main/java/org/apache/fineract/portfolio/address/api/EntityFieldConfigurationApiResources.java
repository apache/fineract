...
public class EntityFieldConfigurationApiResources {
  ...
  @ApiOperation(
      httpMethod = "GET",
      value = "Retrieves the Entity Field Configuration",
      notes = "It retrieves all the Entity Field Configuration")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
  ...
  public String getAddresses(
      @PathParam("entity") @ApiParam(value = "entity") final String entityname,
    ...
    return this.toApiJsonSerializerfld.serialize(
        settings, fldconfig, this.RESPONSE_DATA_PARAMETERS);
  }
}
