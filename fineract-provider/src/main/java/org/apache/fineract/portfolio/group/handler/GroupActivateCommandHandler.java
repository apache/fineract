...
public class GroupActivateCommandHandler implements CommandHandler<GroupActivateRequest, GroupCommandResponse> {
    ...
    @Override
    @Transactional
    public GroupCommandResponse handle(Command<GroupActivateRequest> command) {
        return writeService.activateGroup(command.getPayload());
    }

    @Override
    public GroupCommandResponse fallback(Command<GroupActivateRequest> command, Throwable t) {
