...
public class AccountAssociations extends AbstractPersistableCustom {
  ...
  public static AccountAssociations associateSavingsAccount(
      final Loan loan,
      final SavingsAccount savingsAccount,
      final Integer associationType,
      boolean isActive) {
  ...
  public static AccountAssociations associateSavingsAccount(
    ...
    return new AccountAssociations(
        null, savingsAccount, null, linkedSavingsAccount, associationType, isActive);
  }
