...
public class DepositAccountInterestRateChartSlabData {
  ...
  public static DepositAccountInterestRateChartSlabData instance(
      final Long id,
    ...
    return new DepositAccountInterestRateChartSlabData(
        id,
        description,
        periodType,
        fromPeriod,
  ...
  public static DepositAccountInterestRateChartSlabData from(
      final InterestRateChartSlabData chartSlabData) {
    final Long id = null;
    ...
    return new DepositAccountInterestRateChartSlabData(
        id,
        chartSlabData.description(),
        chartSlabData.periodType(),
        chartSlabData.fromPeriod(),
        chartSlabData.toPeriod(),
        chartSlabData.amountRangeFrom(),
        chartSlabData.amountRangeTo(),
        chartSlabData.annualInterestRate(),
        fromProdIncentives,
        chartSlabData.currency(),
        chartSlabData.periodTypes(),
        chartSlabData.entityTypeOptions(),
        chartSlabData.attributeNameOptions(),
        chartSlabData.conditionTypeOptions(),
        chartSlabData.incentiveTypeOptions(),
        chartSlabData.genderOptions(),
        chartSlabData.clientTypeOptions(),
        chartSlabData.clientClassificationOptions());
  }

  public static DepositAccountInterestRateChartSlabData withTemplate(
  ...
  private DepositAccountInterestRateChartSlabData(
      final Long id,
      final String description,
      final EnumOptionData periodType,
      final Integer fromPeriod,
      ...
      final BigDecimal amountRangeTo,
      final BigDecimal annualInterestRate,
      final Collection<DepositAccountInterestIncentiveData> incentivesData,
      final CurrencyData currency,
      final Collection<EnumOptionData> periodTypes,
      final Collection<EnumOptionData> entityTypeOptions,
      final Collection<EnumOptionData> attributeNameOptions,
