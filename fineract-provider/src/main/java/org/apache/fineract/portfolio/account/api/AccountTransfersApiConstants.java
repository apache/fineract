...
public final class AccountTransfersApiConstants {
     ...
     */
    static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(AccountDetailConstants.idParamName,
            transferDescriptionParamName, currencyParamName, requestedDateParamName, requestedShares));
}
