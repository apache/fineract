...
public interface NoteRepository extends JpaRepository<Note, Long>, JpaSpecificationExecutor<Note> {
    ...
    @Modifying
    @Query("delete from Note note where note.savingsAccount = :savingsAccount")
    void deleteNotesBySavingsAccount(@Param("savingsAccount") SavingsAccount savingsAccount);
}
