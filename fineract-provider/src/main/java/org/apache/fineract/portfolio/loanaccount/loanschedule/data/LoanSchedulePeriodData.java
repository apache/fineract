...
public class LoanSchedulePeriodData {
  ...
  public static LoanSchedulePeriodData disbursementOnlyPeriod(
    ...
    return new LoanSchedulePeriodData(
        ...
        disbursementDate,
        principalDisbursed,
        feeChargesDueAtTimeOfDisbursement,
        isDisbursed);
  }
  ...
  public static LoanSchedulePeriodData WithPaidDetail(
      final LoanSchedulePeriodData loanSchedulePeriodData,
      final boolean complete,
      final BigDecimal principalPaid,
      final BigDecimal interestPaid,
      final BigDecimal feeChargesPaid,
    ...
    return new LoanSchedulePeriodData(
        loanSchedulePeriodData.period,
        loanSchedulePeriodData.fromDate,
        loanSchedulePeriodData.dueDate,
        loanSchedulePeriodData.obligationsMetOnDate,
        complete,
        loanSchedulePeriodData.principalOriginalDue,
        principalPaid,
        loanSchedulePeriodData.principalWrittenOff,
        loanSchedulePeriodData.principalOutstanding,
        loanSchedulePeriodData.principalLoanBalanceOutstanding,
        loanSchedulePeriodData.interestDue,
        interestPaid,
        loanSchedulePeriodData.interestWaived,
        loanSchedulePeriodData.interestWrittenOff,
        loanSchedulePeriodData.interestOutstanding,
        loanSchedulePeriodData.feeChargesDue,
        feeChargesPaid,
        loanSchedulePeriodData.feeChargesWaived,
        loanSchedulePeriodData.feeChargesWrittenOff,
        loanSchedulePeriodData.feeChargesOutstanding,
        loanSchedulePeriodData.penaltyChargesDue,
        penaltyChargesPaid,
        loanSchedulePeriodData.penaltyChargesWaived,
        loanSchedulePeriodData.penaltyChargesWrittenOff,
        loanSchedulePeriodData.penaltyChargesOutstanding,
        loanSchedulePeriodData.totalDueForPeriod,
  ...
  private LoanSchedulePeriodData(
    ...
    this.totalActualCostOfLoanForPeriod =
        interestDueOnPrincipalOutstanding.add(feeChargesDueForPeriod);
