...
@Service
public class DepositAccountOnHoldTransactionReadPlatformServiceImpl
    implements DepositAccountOnHoldTransactionReadPlatformService {
  ...
  @Override
  public Page<DepositAccountOnHoldTransactionData> retriveAll(
      Long savingsId, Long guarantorFundingId, SearchParameters searchParameters) {
    ...
    return this.paginationHelper.fetchPage(
        this.jdbcTemplate, sqlCountRows, sqlBuilder.toString(), finalObjectArray, this.mapper);
  }

  private static final class DepositAccountOnHoldTransactionsMapper
      implements RowMapper<DepositAccountOnHoldTransactionData> {
    ...
    public DepositAccountOnHoldTransactionsMapper() {
      ...
      sqlBuilder.append(
          "sc.display_name as savingsClientName, ml.id as loanid, sa.id as savingid, ");
    ...
    @Override
    public DepositAccountOnHoldTransactionData mapRow(
      ...
      final EnumOptionData transactionType =
          SavingsEnumerations.onHoldTransactionType(transactionTypeInt);
      ...
      return DepositAccountOnHoldTransactionData.instance(
          id,
          amount,
          transactionType,
          date,
