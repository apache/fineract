...
public class LoanChargeCannotBeWaivedException extends AbstractPlatformDomainRuleException {
  ...
  public static enum LoanChargeCannotBeWaivedReason {
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("ALREADY_PAID")) {
        ...
        return "This loan charge can be waived as the loan associated with it is currently"
            + " inactive";
  ...
  public LoanChargeCannotBeWaivedException(
      final LoanChargeCannotBeWaivedReason reason, final Long loanChargeId) {
