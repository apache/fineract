...
public class LoanManualRepaymentData {
    ...
    public LoanManualRepaymentData(MonetaryCurrency currency, BigDecimal principalPortion, BigDecimal interestPortion, BigDecimal feeChargesPortion, BigDecimal penaltyChargesPortion) {
