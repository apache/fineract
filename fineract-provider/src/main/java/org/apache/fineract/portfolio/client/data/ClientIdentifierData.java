...
public class ClientIdentifierData {
    ...
    public static ClientIdentifierData singleItem(final Long id, final Long clientId, final CodeValueData documentType,
            final String documentIssueCountryCode, final String documentKey, final String status, final String description) {
        return new ClientIdentifierData(id, clientId, documentType, null, documentIssueCountryCode, documentKey, description, status, null);
    }
    ...
    public static ClientIdentifierData template(final ClientIdentifierData data, final Collection<CodeValueData> codeValues) {
        return new ClientIdentifierData(data.id, data.clientId, data.documentType, data.documentTypeData, data.documentIssueCountryCode,
    ...
    public ClientIdentifierData(final Long id, final Long clientId, final CodeValueData documentType,
            final Collection<CodeData> documentTypeData, final String documentIssueCountryCode, final String documentKey,
