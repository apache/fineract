...
public class LoanCollateral extends AbstractPersistableCustom {
  ...
  public static LoanCollateral from(
      final CodeValue collateralType, final BigDecimal value, final String description) {
  ...
  public static LoanCollateral fromJson(
      final Loan loan, final CodeValue collateralType, final JsonCommand command) {
    final String description =
        command.stringValueOfParameterNamed(CollateralJSONinputParams.DESCRIPTION.getValue());
    final BigDecimal value =
        command.bigDecimalValueOfParameterNamed(CollateralJSONinputParams.VALUE.getValue());
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    final String collateralTypeIdParamName =
        CollateralJSONinputParams.COLLATERAL_TYPE_ID.getValue();
