...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Recurring Deposits are a special kind of Term Deposits offered by MFI's. The"
                  + " Recurring Deposit Products (aka RD) product offerings are modeled using this"
                  + " API.\n"
                  + "\n"
                  + "Recurring Deposits help people with regular incomes to deposit a fixed amount"
                  + " every month (specified recurring frequency) into their Recurring Deposit"
                  + " account.\n"
                  + "\n"
                  + "When creating recurring deposit accounts, the details from the recurring"
                  + " deposit product are used to auto fill details of the recurring deposit"
...
public class RecurringDepositProductsApiResource {
  ...
  @ApiOperation(
      value = "Create a Recurring Deposit Product",
      httpMethod = "POST",
      notes =
          "Creates a Recurring Deposit Product\n\n"
              ...
              + " minDepositTermTypeId, recurringDepositFrequency,"
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Update a Recurring Deposit Product",
      httpMethod = "PUT",
      notes = "Updates a Recurring Deposit Product")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        format = "body",
        dataTypeClass =
            RecurringDepositProductsApiResourceSwagger.PutRecurringDepositProductsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response =
            RecurringDepositProductsApiResourceSwagger.PutRecurringDepositProductsResponse.class)
  })
  public String update(
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateRecurringDepositProduct(productId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "List Recuring Deposit Products",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            RecurringDepositProductsApiResourceSwagger.GetRecurringDepositProductsResponse.class)
  })
  public String retrieveAll(@Context final UriInfo uriInfo) {

    this.context
        .authenticatedUser()
        .validateHasReadPermission(DepositsApiConstants.RECURRING_DEPOSIT_PRODUCT_RESOURCE_NAME);

    @SuppressWarnings({"unchecked", "rawtypes"})
    final Collection<RecurringDepositProductData> products =
        (Collection)
            this.depositProductReadPlatformService.retrieveAll(
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Recurring Deposit Product",
      httpMethod = "GET",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "OK",
        response =
            RecurringDepositProductsApiResourceSwagger.GetRecurringDepositProductsProductIdResponse
                .class)
  })
  public String retrieveOne(
    ...
    RecurringDepositProductData recurringDepositProductData =
    ...
    recurringDepositProductData =
        RecurringDepositProductData.withCharges(recurringDepositProductData, charges);

    final Collection<InterestRateChartData> charts =
        this.chartReadPlatformService.retrieveAllWithSlabsWithTemplate(productId);
    recurringDepositProductData =
        RecurringDepositProductData.withInterestChart(recurringDepositProductData, charts);
    ...
    if (recurringDepositProductData.hasAccountingEnabled()) {
      final Map<String, Object> accountingMappings =
          this.accountMappingReadPlatformService.fetchAccountMappingDetailsForSavingsProduct(
              productId, recurringDepositProductData.accountingRuleTypeId());
      ...
      recurringDepositProductData =
          RecurringDepositProductData.withAccountingDetails(
              recurringDepositProductData,
              accountingMappings,
  ...
  private RecurringDepositProductData handleTemplateRelatedData(
      final RecurringDepositProductData savingsProduct) {
    ...
    if (savingsProduct != null) {
      recurringDepositProductToReturn =
          RecurringDepositProductData.withTemplate(
              savingsProduct,
              currencyOptions,
      ...
      recurringDepositProductToReturn =
          RecurringDepositProductData.template(
              currency,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Delete a Recurring Deposit Product",
      httpMethod = "DELETE",
      notes = "Deletes a Recurring Deposit Product")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "OK",
        response =
            RecurringDepositProductsApiResourceSwagger
                .DeleteRecurringDepositProductsProductIdResponse.class)
  })
  public String delete(
      @PathParam("productId") @ApiParam(value = "productId") final Long productId) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteRecurringDepositProduct(productId).build();
