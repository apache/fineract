...
public class GuarantorNotFoundException extends AbstractPlatformResourceNotFoundException {
  ...
  public GuarantorNotFoundException(final Long id) {
    super(
        "error.msg.loan.guarantor.not.found",
        "Guarantor with identifier " + id + " does not exist",
        id);
  }
  ...
  public GuarantorNotFoundException(
      final Long loanId, final Long guarantorId, final Long guarantorFundingId) {
    super(
        "error.msg.loan.guarantor.not.found",
        "Guarantor with identifier "
            + guarantorId
