...
final class FixedDepositProductsApiResourceSwagger {
  ...
  public static final class GetFixedDepositProductsResponse {
    ...
    public GetFixedDepositProductsInterestCalculationDaysInYearType
  ...
  public static final class GetFixedDepositProductsProductIdResponse {
    ...
    final class GetFixedDepositProductsProductIdActiveChart {
      ...
      public Set<
              GetFixedDepositProductsProductIdChartSlabs.GetFixedDepositProductsProductIdPeriodType>
          periodTypes;
    }
    ...
    public GetFixedDepositProductsProductIdCurrency currency;
    public GetFixedDepositProductsProductIdInterestCompoundingPeriodType
        interestCompoundingPeriodType;
    public GetFixedDepositProductsResponse.GetFixedDepositProductsInterestPostingPeriodType
        interestPostingPeriodType;
    public GetFixedDepositProductsResponse.GetFixedDepositProductsInterestCalculationType
        interestCalculationType;
    public GetFixedDepositProductsResponse.GetFixedDepositProductsInterestCalculationDaysInYearType
        interestCalculationDaysInYearType;
    public GetFixedDepositProductsProductIdAccountingMappings accountingMappings;
    public Set<GetFixedDepositProductsProductIdFeeToIncomeAccountMappings>
        feeToIncomeAccountMappings;
    public Set<GetFixedDepositProductsProductIdPenaltyToIncomeAccountMappings>
    ...
    public GetFixedDepositProductsProductIdPreClosurePenalInterestOnType
