 ...
 **/
public class LoanRescheduleRequestNotFoundException
  ...
  public LoanRescheduleRequestNotFoundException(final Long requestId) {
    super(
        "error.msg.loan.reschedule.request.id.invalid",
        "Loan reschedule request with identifier " + requestId + " does not exist",
        requestId);
  }
}
