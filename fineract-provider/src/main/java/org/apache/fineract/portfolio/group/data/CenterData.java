...
public class CenterData implements Serializable {
  ...
  public static CenterData importInstance(
      String name,
      List<GroupGeneralData> groupMembers,
  ...
  public static CenterData withTemplate(final CenterData templateCenter, final CenterData center) {
    return new CenterData(
        ...
        templateCenter.staffOptions,
        templateCenter.groupMembersOptions,
        templateCenter.collectionMeetingCalendar,
        templateCenter.closureReasons,
        center.timeline,
        center.totalCollected,
        center.totalOverdue,
        center.totaldue,
        center.installmentDue);
  }

  public static CenterData instance(
      final Long id,
      final String accountNo,
      final String name,
  ...
  public static CenterData withAssociations(
      final CenterData centerData,
      final Collection<GroupGeneralData> groupMembers,
      final CalendarData collectionMeetingCalendar) {
    return new CenterData(
        centerData.id,
        centerData.accountNo,
        centerData.name,
        centerData.externalId,
        centerData.status,
        centerData.activationDate,
        centerData.officeId,
        centerData.officeName,
        centerData.staffId,
        centerData.staffName,
        centerData.hierarchy,
        groupMembers,
        centerData.officeOptions,
        centerData.staffOptions,
        centerData.groupMembersOptions,
        collectionMeetingCalendar,
        centerData.closureReasons,
        centerData.timeline,
        centerData.totalCollected,
        centerData.totalOverdue,
        centerData.totaldue,
        centerData.installmentDue);
  }
