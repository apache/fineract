...
public class GuarantorData {
  ...
  public static GuarantorData importInstance(
  ...
  public static GuarantorData template(
    ...
    return new GuarantorData(
        ...
        null,
        null,
        GuarantorEnumerations.guarantorType(GuarantorType.CUSTOMER),
        null,
        null,
        null,
        null,
  ...
  public static GuarantorData templateOnTop(
    ...
    return new GuarantorData(
        guarantorData.id,
        guarantorData.loanId,
        guarantorData.clientRelationshipType,
        guarantorData.entityId,
        guarantorData.guarantorType,
        guarantorData.firstname,
        guarantorData.lastname,
        guarantorData.dob,
        guarantorData.addressLine1,
        guarantorData.addressLine2,
        guarantorData.city,
        guarantorData.state,
        guarantorData.zip,
        guarantorData.country,
        guarantorData.mobileNumber,
        guarantorData.housePhoneNumber,
        guarantorData.comment,
        guarantorData.officeName,
        guarantorData.joinedDate,
        guarantorData.externalId,
        guarantorData.status,
  ...
  public static GuarantorData mergeClientData(
      final ClientData clientData, final GuarantorData guarantorData) {
    return new GuarantorData(
        guarantorData.id,
        guarantorData.loanId,
        guarantorData.clientRelationshipType,
  ...
  public static GuarantorData mergeStaffData(
      final StaffData staffData, final GuarantorData guarantorData) {
    return new GuarantorData(
        guarantorData.id,
        guarantorData.loanId,
        guarantorData.clientRelationshipType,
  ...
  public GuarantorData(
      final Long id,
      final Long loanId,
      final CodeValueData clientRelationshipType,
      final Long entityId,
