 ...
 * under the License.
 */
package org.apache.fineract.portfolio.savingsproductmix.serialization;
...
@Component
public final class SavingsProductMixDataValidator {
    ...
    @Autowired
    public SavingsProductMixDataValidator(final FromJsonHelper fromApiJsonHelper) {
    ...
    public void validateForCreate(final String json) {
        ...
        final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors).resource("savingsproductmix");
