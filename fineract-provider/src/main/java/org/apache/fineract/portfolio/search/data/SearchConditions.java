...
public class SearchConditions {
  ...
  public SearchConditions(
      final String searchQueryParam, final String searchResource, Boolean exactMatch) {
    ...
    this.clientSearch =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.CLIENTS.name().toLowerCase()))
            ? true
            : false;
    this.groupSearch =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.GROUPS.name().toLowerCase()))
            ? true
            : false;
    this.loanSeach =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.LOANS.name().toLowerCase()))
            ? true
            : false;
    this.savingSeach =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.SAVINGS.name().toLowerCase()))
            ? true
            : false;
    this.shareSeach =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.SHARES.name().toLowerCase()))
            ? true
            : false;
    this.clientIdentifierSearch =
        (null == searchResource
                || searchResource
                    .toLowerCase()
                    .contains(SearchSupportedResources.CLIENTIDENTIFIERS.name().toLowerCase()))
            ? true
            : false;
  }

  public SearchConditions(
      final String searchQueryParam,
      final String searchResource,
      final Boolean clientSearch,
      final Boolean groupSearch,
      final Boolean loanSeach,
      final Boolean savingSeach,
      final Boolean shareSeach,
