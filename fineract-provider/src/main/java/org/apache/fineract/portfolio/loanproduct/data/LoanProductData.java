...
public class LoanProductData {
    ...
    private final boolean isValidateActualDisbursementDateAgainstExpectedDisbursementDate;
    ...
    public static LoanProductData lookup(final Long id, final String name) {
        ...
        final boolean isValidateActualDisbursementDateAgainstExpectedDisbursementDate = false;
    ...
    public LoanProductData(final LoanProductData productData, final Collection<ChargeData> chargeOptions,
        ...
        this.isValidateActualDisbursementDateAgainstExpectedDisbursementDate = 
        		productData.isValidateActualDisbursementDateAgainstExpectedDisbursementDate;
    }
