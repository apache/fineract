...
public class LoanProductData implements Serializable {
   ...
   */
  public static LoanProductData lookup(
      final Long id, final String name, final Boolean multiDisburseLoan) {
    ...
    final Collection<LoanProductBorrowerCycleVariationData> principalVariations =
        new ArrayList<>(1);
    final Collection<LoanProductBorrowerCycleVariationData> interestRateVariations =
        new ArrayList<>(1);
    final Collection<LoanProductBorrowerCycleVariationData> numberOfRepaymentVariations =
        new ArrayList<>(1);
  ...
  public static LoanProductData lookupWithCurrency(
      final Long id, final String name, final CurrencyData currency) {
    final String shortName = null;
    final String description = null;
    final BigDecimal principal = null;
    final BigDecimal minPrincipal = null;
  ...
  public static LoanProductData sensibleDefaultsForNewLoanProductCreation() {
    ...
    final LoanProductInterestRecalculationData interestRecalculationData =
        LoanProductInterestRecalculationData.sensibleDefaultsForNewLoanProductCreation();
    final Integer minimumDaysBetweenDisbursalAndFirstRepayment = null;
    final Boolean holdGuaranteeFunds = false;
    final LoanProductGuaranteeData productGuaranteeData = null;
    final BigDecimal principalThresholdForLastInstallment = null;
  ...
  public static LoanProductData loanProductWithFloatingRates(
      final Long id,
      final String name,
  ...
  public LoanProductData(
      ...
      final BigDecimal minPrincipal,
      final BigDecimal maxPrincipal,
      ...
      final BigDecimal maxInterestRatePerPeriod,
      ...
      final LoanProductGuaranteeData loanProductGuaranteeData,
      ...
      Integer floatingRateId,
      String floatingRateName,
      ...
      final Integer minimumGapBetweenInstallments,
      ...
      Collection<RateData> rateOptions,
      Collection<RateData> rates,
  ...
  public LoanProductData(
      ...
      final Collection<RateData> rateOptions,
    ...
    this.isFloatingInterestRateCalculationAllowed =
        productData.isFloatingInterestRateCalculationAllowed;
    ...
    if (this.transactionProcessingStrategyOptions != null
      ...
      final List<TransactionProcessingStrategyData> listOfOptions =
          new ArrayList<>(this.transactionProcessingStrategyOptions);
  ...
  public LoanInterestRecalculationData toLoanInterestRecalculationData() {
    ...
    return new LoanInterestRecalculationData(
        id,
        loanId,
        ...
        getInterestRecalculationRestWeekDayType(),
  ...
  public Boolean allowCompoundingOnEod() {
    return isInterestRecalculationEnabled()
        ? this.interestRecalculationData.allowCompoundingOnEod()
        : null;
  }
  ...
  public void setloanProductConfigurableAttributes(
