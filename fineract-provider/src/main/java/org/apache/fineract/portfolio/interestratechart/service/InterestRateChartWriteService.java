...
public interface InterestRateChartWriteService {

    InterestRateChartCreateResponse createInterestRateChart(InterestRateChartCreateRequest request);

    InterestRateChartUpdateResponse updateInterestRateChart(InterestRateChartUpdateRequest request);

    InterestRateChartDeleteResponse deleteInterestRateChart(InterestRateChartDeleteRequest request);
}
