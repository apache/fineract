...
public class LoanChargeCannotBeDeletedException extends AbstractPlatformDomainRuleException {
  ...
  public static enum LoanChargeCannotBeDeletedReason {
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("ALREADY_PAID")) {
        ...
        return "This charge cannot be deleted as the loan it is associated with is not in"
  ...
  public LoanChargeCannotBeDeletedException(
      final LoanChargeCannotBeDeletedReason reason, final Long loanChargeId) {
