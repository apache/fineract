  ...
  public static EnumOptionData lendingStrategy(final LendingStrategy type) {
    ...
    switch (type) {
      case INDIVIDUAL_LOAN:
        optionData =
            new EnumOptionData(type.getId().longValue(), type.getCode(), "Individual loan");
        break;
      case GROUP_LOAN:
      ...
      case JOINT_LIABILITY_LOAN:
        optionData =
            new EnumOptionData(type.getId().longValue(), type.getCode(), "Joint liability loan");
        break;
      case LINKED_LOAN:
      ...
      default:
        optionData =
            new EnumOptionData(
                LendingStrategy.INVALID.getId().longValue(),
                LendingStrategy.INVALID.getCode(),
                "Invalid");
        break;
    }
    return optionData;
