...
public class ChargeData implements Comparable<ChargeData>, Serializable {
  ...
  public static ChargeData instance(
      final Long id,
      final String name,
      ...
      final EnumOptionData feeFrequency,
  ...
  public LoanChargeData toLoanChargeData() {
    ...
    return LoanChargeData.newLoanChargeDetails(
        this.id,
        this.name,
        this.currency,
        this.amount,
  ...
  public boolean isOverdueInstallmentCharge() {
    ...
    if (this.chargeTimeType != null) {
      isOverdueInstallmentCharge =
          ChargeTimeType.fromInt(this.chargeTimeType.getId().intValue()).isOverdueInstallment();
    }
