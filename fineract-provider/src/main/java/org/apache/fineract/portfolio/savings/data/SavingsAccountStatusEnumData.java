...
public class SavingsAccountStatusEnumData implements Serializable {
  ...
  public SavingsAccountStatusEnumData(
      final Long id,
      final String code,
      final String value,
      final boolean submittedAndPendingApproval,
      final boolean approved,
      final boolean rejected,
      final boolean withdrawnByApplicant,
      final boolean active,
      final boolean closed,
      final boolean prematureClosed,
      final boolean transferInProgress,
      final boolean transferOnHold,
      final boolean matured) {
    this.id = id;
    this.code = code;
    this.value = value;
