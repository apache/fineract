...
public class LoanTermVariationsDataWrapper {
    ...
    private final List<LoanTermVariationsData> interestRateForInstallment;
    ...
    public LoanTermVariationsDataWrapper(final List<LoanTermVariationsData> exceptionData) {
        ...
        this.interestRateForInstallment = new ArrayList<>();
    ...
    public List<LoanTermVariationsData> getinterestRateForInstallment() {
        return this.interestRateForInstallment;
    }
    ...
    private void deriveLoanTermVariations() {
        ...
        for (LoanTermVariationsData loanTermVariationsData : this.exceptionData) {
            ...
            } else if(loanTermVariationsData.getTermVariationType().isInterestRateForInstallment()) {
                this.interestRateForInstallment.add(loanTermVariationsData);
            }
        }
        this.exceptionData.removeAll(this.interestRateChanges);
        this.exceptionData.removeAll(this.dueDateVariation);
        this.exceptionData.removeAll(this.interestRateForInstallment);
