...
public class GroupSavingsIndividualMonitoringAccountData 
{
	...
	private GroupSavingsIndividualMonitoringAccountData(final BigDecimal glimId,final BigDecimal groupId,final BigDecimal clientId,final String accountNumber,final BigDecimal childAccountId, final String childAccountNumber,
	...
	public static GroupSavingsIndividualMonitoringAccountData getInstance(final BigDecimal glimId, final BigDecimal groupId,final String accountNumber, final String childAccountNumber,
			final BigDecimal childDeposit, final BigDecimal parentDeposit,
			final Long childAccountsCount,final String savingsStatus)
	{
		return new GroupSavingsIndividualMonitoringAccountData(glimId,groupId,null,accountNumber,null,childAccountNumber,
				childDeposit,parentDeposit,childAccountsCount,savingsStatus);
	}
	
	public static GroupSavingsIndividualMonitoringAccountData getInstance1(final BigDecimal glimId,final BigDecimal groupId,final String accountNumber,
			final BigDecimal parentDeposit,final String savingsStatus)
	{
		return new GroupSavingsIndividualMonitoringAccountData(glimId,groupId,null,accountNumber,null,null,null,parentDeposit,null,savingsStatus);
	}
	
	public static GroupSavingsIndividualMonitoringAccountData getInstance2(final BigDecimal glimId, final BigDecimal groupId,final BigDecimal clientId,final String accountNumber,  final BigDecimal childAccountId,final String childAccountNumber,
			final BigDecimal childDeposit, final BigDecimal parentDeposit,
			final Long childAccountsCount,final String savingsStatus)
	{
