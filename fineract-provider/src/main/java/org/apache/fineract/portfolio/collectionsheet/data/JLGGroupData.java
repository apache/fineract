...
public class JLGGroupData {
  ...
  public static JLGGroupData instance(
      final Long groupId,
  ...
  public static JLGGroupData withClients(
      final JLGGroupData group, Collection<JLGClientData> clients) {
    return new JLGGroupData(
        group.groupId,
        group.groupName,
        group.staffId,
        group.staffName,
  ...
  private JLGGroupData(
      ...
      final Long levelId,
      final String levelName,
      final Collection<JLGClientData> clients) {
