...
public class LoanProductInterestRecalculationDetails extends AbstractPersistableCustom {
  ...
  public static LoanProductInterestRecalculationDetails createFrom(final JsonCommand command) {
    ...
    final Integer loanRescheduleStrategyMethod =
        LoanRescheduleStrategyMethod.fromInt(
                command.integerValueOfParameterNamed(
    ...
    final Integer recurrenceOnNthDay =
        command.integerValueOfParameterNamed(
    ...
    final Integer recurrenceOnWeekday =
        command.integerValueOfParameterNamed(
    ...
    RecalculationFrequencyType frequencyType =
        RecalculationFrequencyType.fromInt(recurrenceFrequency);
    ...
    if (compoundingMethod.isCompoundingEnabled()) {
      ...
      RecalculationFrequencyType compoundingFrequencyType =
          RecalculationFrequencyType.fromInt(compoundingRecurrenceFrequency);
      if (compoundingFrequencyType.isSameAsRepayment()) {
        recurrenceInterval = 0;
      }
      compoundingRecurrenceOnNthDay =
          command.integerValueOfParameterNamed(
              LoanProductConstants.recalculationCompoundingFrequencyNthDayParamName);
      compoundingRecurrenceOnDay =
          command.integerValueOfParameterNamed(
  ...
  private LoanProductInterestRecalculationDetails(
      final Integer interestRecalculationCompoundingMethod,
      ...
      final Integer restFrequencyOnDay,
      final Integer restFrequencyWeekday,
      ...
      final Integer compoundingFrequencyWeekday,
      final boolean isArrearsBasedOnOriginalSchedule,
  ...
  public void update(
    ...
    if (command.isChangeInIntegerParameterNamed(
      ...
      final Integer newValue =
          command.integerValueOfParameterNamed(
              LoanProductConstants.interestRecalculationCompoundingMethodParameterName);
      actualChanges.put(
          LoanProductConstants.interestRecalculationCompoundingMethodParameterName, newValue);
      actualChanges.put("locale", localeAsInput);
      this.interestRecalculationCompoundingMethod =
          InterestRecalculationCompoundingMethod.fromInt(newValue).getValue();
    }
    ...
    if (command.isChangeInIntegerParameterNamed(
        LoanProductConstants.recalculationRestFrequencyTypeParameterName, this.restFrequencyType)) {
      final Integer newValue =
          command.integerValueOfParameterNamed(
              LoanProductConstants.recalculationRestFrequencyTypeParameterName);
    ...
    RecalculationFrequencyType frequencyType =
        RecalculationFrequencyType.fromInt(this.restFrequencyType);
    if (frequencyType.isSameAsRepayment()) {
      this.restInterval = 0;
      ...
      if (command.isChangeInIntegerParameterNamed(
        ...
        Integer newValue =
            command.integerValueOfParameterNamed(
                LoanProductConstants.recalculationRestFrequencyIntervalParameterName);
        actualChanges.put(
            LoanProductConstants.recalculationRestFrequencyIntervalParameterName, newValue);
        actualChanges.put("locale", localeAsInput);
      ...
      if (command.isChangeInIntegerParameterNamed(
        ...
        Integer newValue =
            command.integerValueOfParameterNamed(
                LoanProductConstants.recalculationRestFrequencyWeekdayParamName);
        actualChanges.put(
            LoanProductConstants.recalculationRestFrequencyWeekdayParamName, newValue);
        actualChanges.put("locale", localeAsInput);
        this.restFrequencyWeekday = newValue;
        this.restFrequencyOnDay = null;
      }
      if (command.isChangeInIntegerParameterNamed(
          LoanProductConstants.recalculationRestFrequencyOnDayParamName, getRestFrequencyOnDay())) {
        Integer newValue =
            command.integerValueOfParameterNamed(
                LoanProductConstants.recalculationRestFrequencyOnDayParamName);
      ...
      if (frequencyType.isWeekly()) {
        ...
        if (command.integerValueOfParameterNamed(
                LoanProductConstants.recalculationRestFrequencyOnDayParamName)
            != null) {
          this.restFrequencyNthDay = null;
          this.restFrequencyWeekday = null;
    ...
    if (command.isChangeInIntegerParameterNamed(
      ...
      final Integer newValue =
          command.integerValueOfParameterNamed(
              LoanProductConstants.recalculationCompoundingFrequencyTypeParameterName);
      actualChanges.put(
          LoanProductConstants.recalculationCompoundingFrequencyTypeParameterName, newValue);
      this.compoundingFrequencyType = RecalculationFrequencyType.fromInt(newValue).getValue();
    }

    InterestRecalculationCompoundingMethod compoundingMethod =
        InterestRecalculationCompoundingMethod.fromInt(this.interestRecalculationCompoundingMethod);
    if (compoundingMethod.isCompoundingEnabled()) {
      RecalculationFrequencyType compoundingfrequencyType =
          RecalculationFrequencyType.fromInt(this.compoundingFrequencyType);
      if (compoundingfrequencyType.isSameAsRepayment()) {
        ...
        if (command.isChangeInIntegerParameterNamed(
          ...
          Integer newValue =
              command.integerValueOfParameterNamed(
                  LoanProductConstants.recalculationCompoundingFrequencyNthDayParamName);
          actualChanges.put(
              LoanProductConstants.recalculationCompoundingFrequencyNthDayParamName, newValue);
          actualChanges.put("locale", localeAsInput);
        ...
        if (command.isChangeInIntegerParameterNamed(
          ...
          Integer newValue =
              command.integerValueOfParameterNamed(
                  LoanProductConstants.recalculationCompoundingFrequencyWeekdayParamName);
          actualChanges.put(
              LoanProductConstants.recalculationCompoundingFrequencyWeekdayParamName, newValue);
          actualChanges.put("locale", localeAsInput);
        ...
        if (command.isChangeInIntegerParameterNamed(
          ...
          Integer newValue =
              command.integerValueOfParameterNamed(
                  LoanProductConstants.recalculationCompoundingFrequencyOnDayParamName);
          actualChanges.put(
              LoanProductConstants.recalculationCompoundingFrequencyOnDayParamName, newValue);
          actualChanges.put("locale", localeAsInput);
      ...
      if (!compoundingfrequencyType.isDaily()) {
        if (command.isChangeInBooleanParameterNamed(
            LoanProductConstants.allowCompoundingOnEodParamName, allowCompoundingOnEod())) {
          boolean newValue =
              command.booleanPrimitiveValueOfParameterNamed(
                  LoanProductConstants.allowCompoundingOnEodParamName);
    ...
    if (command.isChangeInIntegerParameterNamed(
      ...
      actualChanges.put(
          LoanProductConstants.preClosureInterestCalculationStrategyParamName, newValue);
    ...
    if (command.isChangeInBooleanParameterNamed(
      ...
      final boolean newValue =
          command.booleanPrimitiveValueOfParameterNamed(
              LoanProductConstants.isCompoundingToBePostedAsTransactionParamName);
      actualChanges.put(
          LoanProductConstants.isCompoundingToBePostedAsTransactionParamName, newValue);
  ...
  public LoanPreClosureInterestCalculationStrategy preCloseInterestCalculationStrategy() {
    return LoanPreClosureInterestCalculationStrategy.fromInt(
        this.preClosureInterestCalculationStrategy);
  }
