 ...
 */
@Component
public final class GuarantorCommandFromApiJsonDeserializer
    extends AbstractFromApiJsonDeserializer<GuarantorCommand> {
  ...
  private GuarantorCommand extractGuarantorCommand(
      final JsonElement element, final Locale locale, final String dateFormat) {
    ...
    final Long entityId =
        this.fromApiJsonHelper.extractLongNamed(
            GuarantorJSONinputParams.ENTITY_ID.getValue(), element);
    final String firstname =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.FIRSTNAME.getValue(), element);
    final String lastname =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.LASTNAME.getValue(), element);
    final String addressLine1 =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.ADDRESS_LINE_1.getValue(), element);
    final String addressLine2 =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.ADDRESS_LINE_2.getValue(), element);
    final String city =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.CITY.getValue(), element);
    final String state =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.STATE.getValue(), element);
    final String zip =
        this.fromApiJsonHelper.extractStringNamed(GuarantorJSONinputParams.ZIP.getValue(), element);
    final String country =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.COUNTRY.getValue(), element);
    final String mobileNumber =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.MOBILE_NUMBER.getValue(), element);
    final String housePhoneNumber =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.PHONE_NUMBER.getValue(), element);
    final String comment =
        this.fromApiJsonHelper.extractStringNamed(
            GuarantorJSONinputParams.COMMENT.getValue(), element);
    final LocalDate dob =
        this.fromApiJsonHelper.extractLocalDateNamed(
            GuarantorJSONinputParams.DATE_OF_BIRTH.getValue(), element, dateFormat, locale);
    final Long savingsId =
        this.fromApiJsonHelper.extractLongNamed(
            GuarantorJSONinputParams.SAVINGS_ID.getValue(), element);
    final BigDecimal amount =
        this.fromApiJsonHelper.extractBigDecimalNamed(
            GuarantorJSONinputParams.AMOUNT.getValue(), element, locale);

    return new GuarantorCommand(
