...
public class DepositAccountReadPlatformServiceImpl implements DepositAccountReadPlatformService {
  ...
  private final FixedDepositAccountMapper fixedDepositAccountRowMapper =
      new FixedDepositAccountMapper();
  private final RecurringDepositAccountMapper recurringDepositAccountRowMapper =
      new RecurringDepositAccountMapper();
  private final DepositAccountLookupMapper depositAccountLookupsRowMapper =
      new DepositAccountLookupMapper();
  private final DepositAccountForMaturityMapper depositAccountForMaturityRowMapper =
      new DepositAccountForMaturityMapper();
  ...
  private static final Set<String> supportedOrderByValues =
      new HashSet<>(Arrays.asList("id", "accountNumbr", "officeId", "officeName"));

  @Autowired
  public DepositAccountReadPlatformServiceImpl(
  ...
  @Override
  public Collection<DepositAccountData> retrieveAll(
      final DepositAccountType depositAccountType,
      final PaginationParameters paginationParameters) {

    this.context.authenticatedUser();
    final DepositAccountMapper depositAccountMapper =
        this.getDepositAccountMapper(depositAccountType);
    ...
    return this.jdbcTemplate.query(
        sqlBuilder.toString(), depositAccountMapper, new Object[] {depositAccountType.getValue()});
  }

  @Override
  public Page<DepositAccountData> retrieveAllPaged(
      final DepositAccountType depositAccountType,
      final PaginationParameters paginationParameters) {

    this.paginationParametersDataValidator.validateParameterValues(
        paginationParameters, supportedOrderByValues, depositAccountType.resourceName());
  ...
  @Override
  public Collection<DepositAccountData> retrieveAllForLookup(
      final DepositAccountType depositAccountType) {
    ...
    return this.jdbcTemplate.query(
        sqlBuilder.toString(),
        this.depositAccountLookupsRowMapper,
        new Object[] {depositAccountType.getValue()});
  }
  ...
  @Override
  public DepositAccountData retrieveOne(
      final DepositAccountType depositAccountType, final Long accountId) {
    try {
      this.context.authenticatedUser();
  ...
  @Override
  public DepositAccountData retrieveOneWithClosureTemplate(
      final DepositAccountType depositAccountType, final Long accountId) {
    try {
      this.context.authenticatedUser();
      ...
      DepositAccountData account =
          this.jdbcTemplate.queryForObject(
              sqlBuilder.toString(),
              depositAccountMapper,
              new Object[] {accountId, depositAccountType.getValue()});
      Collection<EnumOptionData> onAccountClosureOptions =
          SavingsEnumerations.depositAccountOnClosureType(DepositAccountOnClosureType.values());
      ...
      if (depositAccountType.isFixedDeposit()) {
        account =
            FixedDepositAccountData.withClosureTemplateDetails(
        ...
        account =
            RecurringDepositAccountData.withClosureTemplateDetails(
                (RecurringDepositAccountData) account,
                onAccountClosureOptions,
                paymentTypeOptions,
                savingsAccountDatas);
      }
  ...
  @Override
  public DepositAccountData retrieveOneWithChartSlabs(
      final DepositAccountType depositAccountType, Long accountId) {
    DepositAccountData depositAccount = this.retrieveOne(depositAccountType, accountId);
    DepositAccountInterestRateChartData chart =
        this.accountChartReadPlatformService.retrieveOneWithSlabsOnAccountId(accountId);

    if (depositAccountType.isFixedDeposit()) {
      depositAccount =
          FixedDepositAccountData.withInterestChart(
              (FixedDepositAccountData) depositAccount, chart);
    } else if (depositAccountType.isRecurringDeposit()) {
      ...
      final CalendarFrequencyType calendarFrequencyType =
          CalendarFrequencyType.fromInt(calendar.frequencyType().getId().intValue());
      final PeriodFrequencyType periodFrequencyType =
          CalendarFrequencyType.from(calendarFrequencyType);
      final EnumOptionData frequencyType =
          CommonEnumerations.termFrequencyType(periodFrequencyType, "recurring.deposit.frequency.");
      depositAccount =
          RecurringDepositAccountData.withInterestChartAndRecurringDetails(
              (RecurringDepositAccountData) depositAccount, chart, frequency, frequencyType);
    }
  ...
  public Collection<SavingsAccountTransactionData> retrieveAllTransactions(
    ...
    return this.jdbcTemplate.query(
        sql, this.transactionsMapper, new Object[] {accountId, depositAccountType.getValue()});
  }

  @Override
  public DepositAccountData retrieveTemplate(
      final DepositAccountType depositAccountType,
      final Long clientId,
      final Long groupId,
    ...
    if (clientId != null) {
      ...
      savingsAccountDatas =
          this.savingsAccountReadPlatformService.retrieveActiveForLookup(
              clientId, DepositAccountType.SAVINGS_DEPOSIT);
    }
    ...
    final Collection<DepositProductData> productOptions =
        this.depositProductReadPlatformService.retrieveAllForLookup(depositAccountType);
    DepositAccountData template = null;
    if (productId != null) {

      final DepositAccountTemplateMapper mapper =
          getDepositAccountTemplaMapper(depositAccountType, client, group);

      final String sql =
          "select " + mapper.schema() + " where sa.id = ? and sa.deposit_type_enum = ? ";
      template =
          this.jdbcTemplate.queryForObject(
              sql, mapper, new Object[] {productId, depositAccountType.getValue()});
      ...
      if (depositAccountType.isFixedDeposit()) {
        ...
        template =
            FixedDepositAccountData.withTemplateOptions(
                (FixedDepositAccountData) template,
                productOptions,
                fieldOfficerOptions,
        ...
        template =
            FixedDepositAccountData.withInterestChart(
                (FixedDepositAccountData) template, accountChart);
      } else if (depositAccountType.isRecurringDeposit()) {
        template =
            RecurringDepositAccountData.withTemplateOptions(
                (RecurringDepositAccountData) template,
                productOptions,
                fieldOfficerOptions,
                interestCompoundingPeriodTypeOptions,
                interestPostingPeriodTypeOptions,
        ...
        template =
            RecurringDepositAccountData.withInterestChartAndRecurringDetails(
                (RecurringDepositAccountData) template, accountChart, null, null);
      }
      ...
      if (depositAccountType.isFixedDeposit()) {
        ...
        template =
            FixedDepositAccountData.withClientTemplate(clientId, clientName, groupId, groupName);
        ...
        template =
            RecurringDepositAccountData.withClientTemplate(
                clientId, clientName, groupId, groupName);
  ...
  @Override
  public SavingsAccountTransactionData retrieveRecurringAccountDepositTransactionTemplate(
  ...
  public Collection<AccountTransferDTO> retrieveDataForInterestTransfer() {
    ...
    sqlBuilder.append(
        "st.transaction_date > (select IFNULL(max(sat.transaction_date),sa.activatedon_date) from"
            + " m_savings_account_transaction sat where sat.transaction_type_enum = ? and"
            + " sat.savings_account_id = sa.id and sat.is_reversed=0) ");
    sqlBuilder.append(
        "and st.transaction_type_enum = ? and sa.status_enum = ? and st.is_reversed=0 and"
            + " st.transaction_date > IFNULL(sa.lockedin_until_date_derived,sa.activatedon_date)");
  ...
  public Collection<Map<String, Object>> retriveDataForRDScheduleCreation() {
    ...
    sb.append(
        " select rd.savings_account_id savingsId, rd.mandatory_recommended_deposit_amount as"
            + " amount,");
    ...
    sb.append(
        " inner join m_savings_account sa on sa.id = dat.savings_account_id and sa.status_enum ="
            + " ?");
    sb.append(
        " inner join m_deposit_account_recurring_detail rd on rd.savings_account_id ="
            + " dat.savings_account_id ");
    sb.append(
        " inner join m_calendar_instance mci on mci.entity_type_enum = ? and mci.entity_id ="
            + " dat.savings_account_id  ");
    sb.append(
        " inner join m_calendar mc  on mc.id = mci.calendar_id and mc.calendar_type_enum = ?");
    sb.append(
        " inner join m_mandatory_savings_schedule ms on ms.savings_account_id ="
            + " dat.savings_account_id and ms.duedate > ?");
    sb.append(" where dat.deposit_period is null");
    sb.append(
        " group by ms.savings_account_id, rd.mandatory_recommended_deposit_amount, mc.recurrence");
  ...
  private abstract static class DepositAccountMapper implements RowMapper<DepositAccountData> {
    ...
    public DepositAccountMapper() {
      ...
      selectFieldsSqlBuilder.append(
          "sa.interest_compounding_period_enum as interestCompoundingPeriodType, ");
      selectFieldsSqlBuilder.append(
          "sa.interest_posting_period_enum as interestPostingPeriodType, ");
      selectFieldsSqlBuilder.append(
          "sa.interest_calculation_type_enum as interestCalculationType, ");
      selectFieldsSqlBuilder.append(
          "sa.interest_calculation_days_in_year_type_enum as interestCalculationDaysInYearType, ");
      selectFieldsSqlBuilder.append(
          "sa.min_required_opening_balance as minRequiredOpeningBalance, ");
      selectFieldsSqlBuilder.append("sa.lockin_period_frequency as lockinPeriodFrequency,");
      selectFieldsSqlBuilder.append(
          "sa.lockin_period_frequency_enum as lockinPeriodFrequencyType, ");
      selectFieldsSqlBuilder.append(
      ...
      selectTablesSqlBuilder.append(
          "left join m_deposit_account_term_and_preclosure datp on sa.id ="
              + " datp.savings_account_id ");
    ...
    public DepositAccountData mapRow(final ResultSet rs) throws SQLException {
      ...
      final EnumOptionData depositType =
          (depositTypeId == null) ? null : SavingsEnumerations.depositType(depositTypeId);
      ...
      final BigDecimal totalInterestPosted =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "totalInterestPosted");
      ...
      return DepositAccountData.instance(
          id,
          accountNo,
          externalId,
          groupId,
  ...
  private static class FixedDepositAccountMapper extends DepositAccountMapper {
    ...
    public FixedDepositAccountMapper() {
      ...
      sqlBuilder.append(
          "datp.in_multiples_of_deposit_term_type_enum as inMultiplesOfDepositTermTypeId, ");
    ...
    @Override
    public FixedDepositAccountData mapRow(
      ...
      final BigDecimal maturityAmount =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "maturityAmount");
      ...
      final Integer depositPeriodFrequencyTypeId =
          JdbcSupport.getInteger(rs, "depositPeriodFrequencyTypeId");
      final EnumOptionData depositPeriodFrequencyType =
          (depositPeriodFrequencyTypeId == null)
              ? null
      ...
      final EnumOptionData onAccountClosureType =
      ...
      return FixedDepositAccountData.instance(
          depositAccountData,
  ...
  private static class RecurringDepositAccountMapper extends DepositAccountMapper {
    ...
    public RecurringDepositAccountMapper() {
      ...
      sqlBuilder.append("datp.pre_closure_penal_interest_on_enum as preClosurePenalInterestOnId, ");
      sqlBuilder.append(
          "dard.mandatory_recommended_deposit_amount as mandatoryRecommendedDepositAmount, ");
      ...
      sqlBuilder.append(
          "dard.adjust_advance_towards_future_payments as adjustAdvanceTowardsFuturePayments, ");
    ...
    @Override
    public RecurringDepositAccountData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
      ...
      final BigDecimal mandatoryRecommendedDepositAmount =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "mandatoryRecommendedDepositAmount");
      final BigDecimal totalOverdueAmount =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "totalOverdueAmount");
      ...
      final boolean adjustAdvanceTowardsFuturePayments =
          rs.getBoolean("adjustAdvanceTowardsFuturePayments");
      ...
      final LocalDate expectedFirstDepositOnDate =
          JdbcSupport.getLocalDate(rs, "expectedFirstDepositOnDate");

      return RecurringDepositAccountData.instance(
          depositAccountData,
          preClosurePenalApplicable,
          preClosurePenalInterest,
          preClosurePenalInterestOnType,
  ...
  private static final class DepositAccountLookupMapper implements RowMapper<DepositAccountData> {
    ...
    public String schema() {
      return " sa.id as id, sa.account_no as accountNumber, sa.deposit_type_enum as depositTypeId"
          + " from m_savings_account sa ";
    }

    @Override
    public DepositAccountData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
  ...
  private DepositAccountMapper getDepositAccountMapper(
      final DepositAccountType depositAccountType) {
    if (depositAccountType.isFixedDeposit()) {
  ...
  private abstract static class DepositAccountTemplateMapper
      implements RowMapper<DepositAccountData> {
    ...
    public DepositAccountTemplateMapper(final ClientData client, final GroupGeneralData group) {
      ...
      selectFieldsSqlBuilder.append("curr.display_symbol as currencyDisplaySymbol, ");
      selectFieldsSqlBuilder.append(
          "sa.nominal_annual_interest_rate as nominalAnnualIterestRate, ");
      selectFieldsSqlBuilder.append(
          "sa.interest_compounding_period_enum as interestCompoundingPeriodType, ");
      selectFieldsSqlBuilder.append(
          "sa.interest_posting_period_enum as interestPostingPeriodType, ");
      ...
      selectTablesSqlBuilder.append(
          "left join m_deposit_product_term_and_preclosure dptp on sa.id ="
              + " dptp.savings_product_id ");
      selectTablesSqlBuilder.append("join m_currency curr on curr.code = sa.currency_code ");
      selectTablesSqlBuilder.append("left join m_tax_group tg on tg.id = sa.tax_group_id  ");
    ...
    @Override
    public abstract DepositAccountData mapRow(final ResultSet rs, final int rowNum)
        throws SQLException;
  ...
  private static class FixedDepositAccountTemplateMapper extends DepositAccountTemplateMapper {
    ...
    public FixedDepositAccountTemplateMapper(
        final ClientData client, final GroupGeneralData group) {
      super(client, group);
      final StringBuilder sqlBuilder = new StringBuilder(400);
      sqlBuilder.append(super.selectFieldsSql());
      ...
      sqlBuilder.append(
          "dptp.in_multiples_of_deposit_term_type_enum as inMultiplesOfDepositTermTypeId ");
  ...
  private static class RecurringDepositAccountTemplateMapper extends DepositAccountTemplateMapper {
    ...
    public RecurringDepositAccountTemplateMapper(
        final ClientData client, final GroupGeneralData group) {
      super(client, group);
      final StringBuilder sqlBuilder = new StringBuilder(400);
      sqlBuilder.append(this.selectFieldsSql());
      ...
      sqlBuilder.append(
          "dprd.adjust_advance_towards_future_payments as adjustAdvanceTowardsFuturePayments, ");
      sqlBuilder.append("dptp.min_deposit_term as minDepositTerm, ");
      sqlBuilder.append("dptp.max_deposit_term as maxDepositTerm, ");
      sqlBuilder.append("dptp.min_deposit_term_type_enum as minDepositTermTypeId, ");
      sqlBuilder.append("dptp.max_deposit_term_type_enum as maxDepositTermTypeId, ");
      ...
      sqlBuilder.append(this.selectTablesSql());
      sqlBuilder.append(
          "left join m_deposit_product_recurring_detail dprd on sa.id = dprd.savings_product_id ");
  ...
  private DepositAccountTemplateMapper getDepositAccountTemplaMapper(
      final DepositAccountType depositAccountType, ClientData client, GroupGeneralData group) {
    if (depositAccountType.isFixedDeposit()) {
  ...
  private static final class DepositAccountForMaturityMapper
      implements RowMapper<DepositAccountData> {
    ...
    public DepositAccountForMaturityMapper() {
      ...
      sqlBuilder.append(
          "inner join m_deposit_account_term_and_preclosure dat on dat.savings_account_id ="
              + " da.id ");
  ...
  private static final class RecurringAccountDepositTransactionTemplateMapper
      implements RowMapper<SavingsAccountTransactionData> {
    ...
    public RecurringAccountDepositTransactionTemplateMapper() {
      ...
      sqlBuilder.append("from m_savings_account sa ");
      sqlBuilder.append(
          "join m_mandatory_savings_schedule mss  on mss.savings_account_id=sa.id and"
              + " mss.completed_derived = false ");
      sqlBuilder.append("join m_currency curr on curr.code = sa.currency_code ");
      sqlBuilder.append("LEFT JOIN(SELECT s.savings_account_id AS savings_account_id ");
      sqlBuilder.append(
          ",SUM(IFNULL(s.amount_outstanding_derived,0.0)) AS amount_outstanding_derived  ");
      ...
      sqlBuilder.append(
          "AND s.is_active = TRUE GROUP BY s.savings_account_id)sac ON sac.savings_account_id ="
              + " sa.id ");
    ...
    public SavingsAccountTransactionData mapRow(
      ...
      final BigDecimal outstandingChargeAmount =
          JdbcSupport.getBigDecimalDefaultToNullIfZero(rs, "outstandingChargeAmount");
      ...
      final CurrencyData currency =
          new CurrencyData(
              ...
              currencyNameCode);
      final SavingsAccountTransactionEnumData transactionType =
          SavingsEnumerations.transactionType(SavingsAccountTransactionType.DEPOSIT.getValue());
  ...
  private class AccountTransferMapper implements RowMapper<AccountTransferDTO> {
    ...
    public AccountTransferMapper() {
      ...
      sqlBuilder
          .append(
              "sa.id as fromAcc ,aa.linked_savings_account_id as toAcc,st.amount as amount,"
    ...
    @Override
    public AccountTransferDTO mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum)
        throws SQLException {
