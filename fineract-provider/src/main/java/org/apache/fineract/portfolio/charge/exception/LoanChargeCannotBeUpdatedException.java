...
public class LoanChargeCannotBeUpdatedException extends AbstractPlatformDomainRuleException {
  ...
  public static enum LoanChargeCannotBeUpdatedReason {
    ALREADY_PAID,
    ALREADY_WAIVED,
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("ALREADY_PAID")) {
        ...
        return "This loan charge has already been waived";
          ...
          .toString()
          .equalsIgnoreCase("LOAN_NOT_IN_SUBMITTED_AND_PENDING_APPROVAL_STAGE")) {
        return "This charge cannot be updated as the loan it is associated with is not in"
            + " submitted and pending approval stage";
      }
  ...
  public LoanChargeCannotBeUpdatedException(
      final LoanChargeCannotBeUpdatedReason reason, final Long loanChargeId) {
