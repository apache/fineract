...
public class ScorecardApiResource {
  ...
  @Transactional
  @ApiOperation(
      value = "List all Scorecard entries",
      notes = "List all Scorecard entries for a survey.")
  @ApiResponses({
    @ApiResponse(code = 200, message = "", response = Scorecard.class, responseContainer = "list")
  })
  public List<ScorecardData> findBySurvey(
    ...
    return (List<ScorecardData>)
        this.scorecardReadPlatformService.retrieveScorecardBySurvey(surveyId);
  }
  ...
  @Transactional
  @ApiOperation(
      value = "Create a Scorecard entry",
      notes =
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @Transactional
  public List<ScorecardData> findBySurveyAndClient(
      @PathParam("surveyId") @ApiParam(value = "Enter surveyId") final Long surveyId,
    ...
    return (List<ScorecardData>)
        this.scorecardReadPlatformService.retrieveScorecardBySurveyAndClient(surveyId, clientId);
  }
  ...
  public List<ScorecardData> findByClient(@PathParam("clientId") final Long clientId) {
    ...
    this.clientRepositoryWrapper.findOneWithNotFoundDetection(clientId);
    return (List<ScorecardData>)
        this.scorecardReadPlatformService.retrieveScorecardByClient(clientId);
  }
}
