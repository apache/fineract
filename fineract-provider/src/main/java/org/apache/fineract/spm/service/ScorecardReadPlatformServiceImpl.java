...
public class ScorecardReadPlatformServiceImpl implements ScorecardReadPlatformService {
  ...
  @Autowired
  public ScorecardReadPlatformServiceImpl(
  ...
  private static final class ScorecardMapper implements RowMapper<ScorecardData> {
    ...
    @Override
    public ScorecardData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
        throws SQLException {
  ...
  private static final class ScorecardValueMapper implements RowMapper<ScorecardValue> {
    ...
    @Override
    public ScorecardValue mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
        throws SQLException {
  ...
  List<ScorecardValue> getScorecardValueBySurveyAndClient(
      final Long surveyId, final Long clientId) {
  ...
  Collection<ScorecardData> updateScorecardValues(Collection<ScorecardData> scorecard) {
    for (ScorecardData scorecardData : scorecard) {
      scorecardData.setScorecardValues(
          getScorecardValueBySurveyAndClient(
              scorecardData.getSurveyId(), scorecardData.getClientId()));
    }
    return scorecard;
  }
  ...
  @Override
  public Collection<ScorecardData> retrieveScorecardBySurveyAndClient(
      Long surveyId, Long clientId) {
    this.context.authenticatedUser();
    ScorecardMapper scm = new ScorecardMapper();
    String sql =
        "select "
            ...
            + " group by sc.survey_id, sc.client_id, sc.id ";
    Collection<ScorecardData> scorecardDatas =
        this.jdbcTemplate.query(sql, scm, new Object[] {surveyId, clientId});
    updateScorecardValues(scorecardDatas);
    return scorecardDatas;
  }
}
