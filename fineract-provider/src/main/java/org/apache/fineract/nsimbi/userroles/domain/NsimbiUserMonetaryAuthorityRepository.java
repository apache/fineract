...
public interface NsimbiUserMonetaryAuthorityRepository extends JpaRepository<NsimbiUserMonetaryAuthority, Long> {
    Optional<NsimbiUserMonetaryAuthority> findByAppUserIdAndAuthorityTypeAndCurrencyCode(Long appUserId, MonetaryAuthorityType authorityType, String currencyCode);
}
