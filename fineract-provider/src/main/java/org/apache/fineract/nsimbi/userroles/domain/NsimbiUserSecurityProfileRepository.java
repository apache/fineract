...
public interface NsimbiUserSecurityProfileRepository extends JpaRepository<NsimbiUserSecurityProfile, Long> {
    Optional<NsimbiUserSecurityProfile> findByAppUserId(Long appUserId);
}
