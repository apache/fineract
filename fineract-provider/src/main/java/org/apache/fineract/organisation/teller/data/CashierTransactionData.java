...
public final class CashierTransactionData implements Serializable {
   ...
   */
  private CashierTransactionData(
      final Long id,
      final Long cashierId,
      CashierTxnType txnType,
  ...
  public static CashierTransactionData instance(
      final Long id,
      final Long cashierId,
      CashierTxnType txnType,
      final BigDecimal txnAmount,
      ...
      Date startDate,
      Date endDate) {
    return new CashierTransactionData(
        id,
        cashierId,
        txnType,
        txnAmount,
  ...
  public static CashierTransactionData template(
      final Long cashierId,
      final Long tellerId,
      final String tellerName,
      final Long officeId,
