...
public class WorkingDays extends AbstractPersistableCustom {
  ...
  protected WorkingDays(
      ...
      final Integer repaymentReschedulingType,
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    if (command.isChangeInIntegerParameterNamed(
        repaymentRescheduleTypeParamName, this.repaymentReschedulingType)) {
    ...
    if (command.isChangeInBooleanParameterNamed(
        WorkingDaysApiConstants.extendTermForDailyRepayments, this.extendTermForDailyRepayments)) {
