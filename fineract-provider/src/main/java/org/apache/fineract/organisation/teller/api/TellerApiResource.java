...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "Teller cash management which will allow an organization to manage their cash"
                  + " transactions at branches or head office more effectively.")
    })
public class TellerApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.GetTellersResponse.class,
  ...
  public String findTeller(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId) {
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = TellerApiResourceSwagger.PostTellersRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.PostTellersResponse.class)
  })
  public String createTeller(@ApiParam(hidden = true) final String tellerData) {
    final CommandWrapper request =
        new CommandWrapperBuilder().createTeller().withJson(tellerData).build();

    final CommandProcessingResult result =
        this.commandWritePlatformService.logCommandSource(request);
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = TellerApiResourceSwagger.PutTellersRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.PutTellersResponse.class)
  })
  public String updateTeller(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @ApiParam(hidden = true) final String tellerData) {
    final CommandWrapper request =
        new CommandWrapperBuilder().updateTeller(tellerId).withJson(tellerData).build();
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.GetTellersTellerIdCashiersResponse.class)
  })
  public String getCashierData(
    ...
    final Date fromDate =
        (fromDateStr != null ? dateFormatter.parseDateTime(fromDateStr).toDate() : new Date());
    final Date toDate =
        (toDateStr != null ? dateFormatter.parseDateTime(toDateStr).toDate() : new Date());
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.GetTellersTellerIdCashiersCashierIdResponse.class)
  })
  public String findCashierData(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.GetTellersTellerIdCashiersTemplateResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = TellerApiResourceSwagger.PostTellersTellerIdCashiersRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.PostTellersTellerIdCashiersResponse.class)
  })
  public String createCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @ApiParam(hidden = true) final String cashierData) {
    final CommandWrapper request =
        new CommandWrapperBuilder().allocateTeller(tellerId).withJson(cashierData).build();
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = TellerApiResourceSwagger.PutTellersTellerIdCashiersCashierIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.PutTellersTellerIdCashiersCashierIdResponse.class)
  })
  public String updateCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId,
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = TellerApiResourceSwagger.DeleteTellersTellerIdCashiersCashierIdResponse.class)
  })
  public String deleteCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId) {
    final CommandWrapper request =
        new CommandWrapperBuilder().deleteAllocationTeller(tellerId, cashierId).build();
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Allocate Cash To Cashier",
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            TellerApiResourceSwagger.PostTellersTellerIdCashiersCashierIdAllocateRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response =
            TellerApiResourceSwagger.PostTellersTellerIdCashiersCashierIdAllocateResponse.class)
  })
  public String allocateCashToCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId,
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Settle Cash From Cashier",
      notes = "Mandatory Fields\n" + "Date, Amount, Currency, Notes/Comments")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        ...
        format = "body",
        dataTypeClass =
            TellerApiResourceSwagger.PostTellersTellerIdCashiersCashierIdSettleRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response =
            TellerApiResourceSwagger.PostTellersTellerIdCashiersCashierIdSettleResponse.class)
  })
  public String settleCashFromCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId,
      @ApiParam(hidden = true) final String cashierTxnData) {
    final CommandWrapper request =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "",
        response =
            TellerApiResourceSwagger.GetTellersTellerIdCashiersCashiersIdTransactionsResponse.class,
        responseContainer = "List")
  })
  public String getTransactionsForCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId,
    ...
    final Page<CashierTransactionData> cashierTxns =
        this.readPlatformService.retrieveCashierTransactions(
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "",
        response =
            TellerApiResourceSwagger
                .GetTellersTellerIdCashiersCashiersIdSummaryAndTransactionsResponse.class)
  })
  public String getTransactionsWtihSummaryForCashier(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId,
      @QueryParam("currencyCode") @ApiParam(value = "currencyCode") final String currencyCode,
      @QueryParam("offset") @ApiParam(value = "offset") final Integer offset,
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        response =
            TellerApiResourceSwagger
                .GetTellersTellerIdCashiersCashiersIdTransactionsTemplateResponse.class)
  })
  public String getCashierTxnTemplate(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerId,
      @PathParam("cashierId") @ApiParam(value = "cashierId") final Long cashierId) {
  ...
  public String getTransactionData(
    ...
    final Collection<TellerTransactionData> transactions =
        this.readPlatformService.fetchTellerTransactionsByTellerId(
  ...
  @Consumes({MediaType.TEXT_HTML, MediaType.APPLICATION_JSON})
  @Produces(MediaType.APPLICATION_JSON)
  public String findTransactionData(
      @PathParam("tellerId") @ApiParam(value = "tellerId") final Long tellerid,
      @PathParam("transactionId") @ApiParam(value = "transactionId") final Long transactionId) {
    final TellerTransactionData transaction =
        this.readPlatformService.findTellerTransaction(transactionId);
  ...
  public String getJournalData(
    ...
    final Collection<TellerJournalData> journals =
        this.readPlatformService.fetchTellerJournals(
