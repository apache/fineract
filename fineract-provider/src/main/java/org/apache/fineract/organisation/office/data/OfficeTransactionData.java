...
public class OfficeTransactionData {
  ...
  public static OfficeTransactionData instance(
      final Long id,
    ...
    return new OfficeTransactionData(
        id,
        transactionDate,
        fromOfficeId,
        fromOfficeName,
  ...
  public static OfficeTransactionData template(
      final LocalDate transactionDate,
      final Collection<OfficeData> parentLookups,
