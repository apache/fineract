...
public class Money implements Comparable<Money> {
  ...
  private Money(
    ...
    this.amount =
        amountScaled.setScale(this.currencyDigitsAfterDecimal, MoneyHelper.getRoundingMode());
  }
  ...
  public Money copy() {
    return new Money(
        ...
        this.amount.stripTrailingZeros(),
        this.inMultiplesOf);
  }
  ...
  public Money dividedBy(final double valueToDivideBy, final RoundingMode roundingMode) {
    ...
    final BigDecimal newAmount =
        this.amount.divide(BigDecimal.valueOf(valueToDivideBy), roundingMode);
    return Money.of(monetaryCurrency(), newAmount);
  }
  ...
  public Money multiplyRetainScale(
      final BigDecimal valueToMultiplyBy, final RoundingMode roundingMode) {
    if (valueToMultiplyBy.compareTo(BigDecimal.ONE) == 0) {
      return this;
    }
  ...
  public Money multiplyRetainScale(
      final double valueToMultiplyBy, final RoundingMode roundingMode) {
  ...
  public Money percentageOf(BigDecimal percentage, final RoundingMode roundingMode) {
    final BigDecimal newAmount =
        (this.amount.multiply(percentage)).divide(BigDecimal.valueOf(100), roundingMode);
    return Money.of(monetaryCurrency(), newAmount);
  }
  ...
  private MonetaryCurrency monetaryCurrency() {
    return new MonetaryCurrency(
        this.currencyCode, this.currencyDigitsAfterDecimal, this.inMultiplesOf);
  }
