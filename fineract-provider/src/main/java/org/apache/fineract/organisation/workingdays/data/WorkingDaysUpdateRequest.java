...
import org.apache.fineract.organisation.workingdays.validation.ValidRepaymentRescheduleType;
...
public class WorkingDaysUpdateRequest implements Serializable {
    ...
    @NotNull(message = "{org.apache.fineract.organisation.workingdays.data.update-request.documentTypeId.not-null}")
    ...
    @Schema(example = "4")
    @ValidRepaymentRescheduleType(min = 1, max = 4)
