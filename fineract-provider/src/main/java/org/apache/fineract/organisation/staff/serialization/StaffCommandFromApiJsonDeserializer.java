...
public final class StaffCommandFromApiJsonDeserializer {
  ...
  @Autowired
  public StaffCommandFromApiJsonDeserializer(
  ...
  public void validateForCreate(final String json) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("staff");
    ...
    if (this.fromApiJsonHelper.parameterExists("isLoanOfficer", element)) {
      final Boolean loanOfficerFlag =
          this.fromApiJsonHelper.extractBooleanNamed("isLoanOfficer", element);
    ...
    final LocalDate joiningDate =
        this.fromApiJsonHelper.extractLocalDateNamed("joiningDate", element);
  ...
  public void validateForUpdate(final String json, Long staffId) {
    ...
    if (this.fromApiJsonHelper.parameterExists("isActive", element)) {
      final Boolean activeFlag = this.fromApiJsonHelper.extractBooleanNamed("isActive", element);
      // Need to add here check to see if any clients, group, account and loans are assigned to this
      // staff if staff is being set to inactive --LJB
      final Boolean forceStatus =
          this.fromApiJsonHelper.extractBooleanNamed("forceStatus", element);
