...
public class ProvisioningCriteriaApiResource {
  ...
  private static final Set<String> PROVISIONING_CRITERIA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              ProvisioningCriteriaConstants.CRITERIA_PARAM,
              ProvisioningCriteriaConstants.LOANPRODUCTS_PARAM,
              ProvisioningCriteriaConstants.DEFINITIONS_PARAM));
  ...
  private static final Set<String> ALL_PROVISIONING_CRITERIA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              ProvisioningCriteriaConstants.CRITERIA_ID_PARAM,
  ...
  public String retrieveTemplate(@Context final UriInfo uriInfo) {
    ...
    return this.toApiJsonSerializer.serialize(
        settings, data, PROVISIONING_CRITERIA_TEMPLATE_PARAMETER);
  }
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieves a Provisioning Criteria",
      notes = "Retrieves a Provisioning Criteria")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
  ...
  public String retrieveProvisioningCriteria(
      @PathParam("criteriaId") @ApiParam(value = "criteriaId") final Long criteriaId,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieves all created Provisioning Criterias",
      notes = "Retrieves all created Provisioning Criterias")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        responseContainer = "List",
        response = ProvisioningCriteriaApiResourceSwagger.GetProvisioningCriteriaResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create a new Provisioning Criteria",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningCriteriaApiResourceSwagger.PostProvisioningCriteriaResponse.class)
  })
  public String createProvisioningCriteria(
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Updates a new Provisioning Criteria",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ProvisioningCriteriaApiResourceSwagger.PutProvisioningCriteriaRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningCriteriaApiResourceSwagger.PutProvisioningCriteriaResponse.class)
  })
  public String updateProvisioningCriteria(
      @PathParam("criteriaId") @ApiParam(value = "criteriaId") final Long criteriaId,
      @ApiParam(hidden = true) final String apiRequestBodyAsJson) {
    this.platformSecurityContext.authenticatedUser();
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder()
            .updateProvisioningCriteria(criteriaId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningCriteriaApiResourceSwagger.DeleteProvisioningCriteriaResponse.class)
  })
  public String deleteProvisioningCriteria(
      @PathParam("criteriaId") @ApiParam(value = "criteriaId") final Long criteriaId) {
    this.platformSecurityContext.authenticatedUser();
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteProvisioningCriteria(criteriaId).build();
    final CommandProcessingResult result =
        this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    return this.toApiJsonSerializer.serialize(result);
  }
