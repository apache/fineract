...
public class ProvisioningCriteriaReadPlatformServiceImpl
  ...
  @Autowired
  public ProvisioningCriteriaReadPlatformServiceImpl(
  ...
  public ProvisioningCriteriaData retrievePrivisiongCriteriaTemplate() {
    ...
    final Collection<ProvisioningCategoryData> categories =
        this.provisioningCategoryReadPlatformService.retrieveAllProvisionCategories();
    final Collection<LoanProductData> allLoanProducts =
    ...
    return ProvisioningCriteriaData.toTemplate(
        constructCriteriaTemplate(categories), allLoanProducts, glAccounts);
  }
  ...
  public ProvisioningCriteriaData retrievePrivisiongCriteriaTemplate(
    ...
    final Collection<GLAccountData> glAccounts =
        this.glAccountReadPlatformService.retrieveAllEnabledDetailGLAccounts();
    return ProvisioningCriteriaData.toTemplate(
        data, constructCriteriaTemplate(categories), allLoanProducts, glAccounts);
  }
  ...
  private Collection<ProvisioningCriteriaDefinitionData> constructCriteriaTemplate(
    ...
    for (ProvisioningCategoryData data : categories) {
      definitions.add(
          ProvisioningCriteriaDefinitionData.template(data.getId(), data.getCategoryName()));
    }
    return definitions;
  }
  ...
  private static final class ProvisioningCriteriaRowMapper
      implements RowMapper<ProvisioningCriteriaData> {

    @Override
    public ProvisioningCriteriaData mapRow(
    ...
    public String schema() {
      return "mpc.id as id, mpc.criteria_name as criteriaName, appu.username as username from"
          + " m_provisioning_criteria as mpc LEFT JOIN m_appuser appu on"
          + " mpc.createdby_id=appu.id";
    }
  }
  ...
  public ProvisioningCriteriaData retrieveProvisioningCriteria(Long criteriaId) {
    try {
      ...
      Collection<LoanProductData> loanProducts =
          loanProductReaPlatformService.retrieveAllLoanProductsForLookup(
              "select product_id from m_loanproduct_provisioning_mapping where"
                  + " m_loanproduct_provisioning_mapping.criteria_id="
                  + criteriaId);
      List<ProvisioningCriteriaDefinitionData> definitions =
          retrieveProvisioningDefinitions(criteriaId);
  ...
  private List<ProvisioningCriteriaDefinitionData> retrieveProvisioningDefinitions(
      Long criteriaId) {
    ProvisioningCriteriaDefinitionRowMapper rowMapper =
        new ProvisioningCriteriaDefinitionRowMapper();
  ...
  private static final class ProvisioningCriteriaDefinitionRowMapper
    ...
    private final StringBuilder sqlQuery =
        new StringBuilder()
            .append(
                "pc.id, pc.criteria_id, pc.category_id, mpc.category_name, pc.min_age,"
                    + " pc.max_age, ")
            .append(
                "pc.provision_percentage, pc.liability_account, pc.expense_account, lia.gl_code as"
                    + " liabilitycode, expe.gl_code as expensecode, ")
    ...
    @Override
    public ProvisioningCriteriaDefinitionData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
      ...
      return new ProvisioningCriteriaDefinitionData(
          id,
          categoryId,
          categoryName,
          minAge,
  ...
  private String retrieveCriteriaName(Long criteriaId) {
    ...
    final String sql =
        "select " + rowMapper.schema() + " from m_provisioning_criteria pc where pc.id = ?";
  ...
  private static final class ProvisioningCriteriaNameRowMapper implements RowMapper<String> {
    ...
    @Override
    public String mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
        throws SQLException {
