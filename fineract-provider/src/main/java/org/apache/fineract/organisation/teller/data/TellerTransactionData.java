...
public final class TellerTransactionData implements Serializable {
   ...
   */
  public static TellerTransactionData instance(
      final Long id,
      final Long officeId,
      final Long tellerId,
      final Long cashierId,
      ...
      final Double amount,
      final Date postingDate) {
    return new TellerTransactionData(
        id, officeId, tellerId, cashierId, clientId, type, amount, postingDate);
  }
