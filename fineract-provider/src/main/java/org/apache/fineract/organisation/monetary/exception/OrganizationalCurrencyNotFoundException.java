 ...
 * Organization.
 */
public class OrganizationalCurrencyNotFoundException
  ...
  public OrganizationalCurrencyNotFoundException(final String currencyCode) {
    super(
        "error.msg.currency.currencyCode.invalid.or.not.supported",
        "Currency with identifier "
            + currencyCode
            + " does not exist or is not supported by the Organization",
        currencyCode);
  }
}
