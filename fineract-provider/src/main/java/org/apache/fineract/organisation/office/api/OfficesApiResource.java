...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Offices",
          description =
              "Offices are used to model an MFIs structure. A hierarchical representation of"
                  + " offices is supported. There will always be at least one office (which"
                  + " represents the MFI or an MFIs head office). All subsequent offices added"
                  + " must have a parent office.")
    })
public class OfficesApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = OfficesApiResourceSwagger.GetOfficesResponse.class,
        responseContainer = "List")
  })
  public String retrieveOffices(
      @Context final UriInfo uriInfo,
      @DefaultValue("false") @QueryParam("includeAllOffices") @ApiParam(value = "includeAllOffices")
    ...
    final Collection<OfficeData> offices =
        this.readPlatformService.retrieveAllOffices(onlyManualEntries, searchParameters);
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Office Details Template",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = OfficesApiResourceSwagger.GetOfficesTemplateResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = OfficesApiResourceSwagger.PostOfficesRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = OfficesApiResourceSwagger.PostOfficesResponse.class)
  })
  ...
  public String retreiveOffice(
      @PathParam("officeId") @ApiParam(value = "officeId") final Long officeId,
      @Context final UriInfo uriInfo) {
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = OfficesApiResourceSwagger.PutOfficesOfficeIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = OfficesApiResourceSwagger.PutOfficesOfficeIdResponse.class)
  })
  ...
  public Response getOfficeTemplate(@QueryParam("dateFormat") final String dateFormat) {
    return bulkImportWorkbookPopulatorService.getTemplate(
        GlobalEntityType.OFFICES.toString(), null, null, dateFormat);
  }

  @POST
  @Path("uploadtemplate")
  @Consumes(MediaType.MULTIPART_FORM_DATA)
  public String postOfficeTemplate(
