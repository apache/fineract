...
@Entity
@Table(
    name = "interop_identifier",
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_hathor_identifier_account",
          columnNames = {"account_id", "type"}),
      @UniqueConstraint(
          name = "uk_hathor_identifier_value",
...
public class InteropIdentifier extends AbstractPersistableCustom {
  ...
  public InteropIdentifier(
      @NotNull SavingsAccount account,
      @NotNull InteropIdentifierType type,
      @NotNull String value,
      String subValueOrType,
  ...
  public boolean equals(Object o) {
    ...
    return subValueOrType != null
        ? subValueOrType.equals(that.subValueOrType)
        : that.subValueOrType == null;
  }
