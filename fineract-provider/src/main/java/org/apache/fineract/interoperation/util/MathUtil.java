...
public class MathUtil {
  ...
  public static BigDecimal min(BigDecimal first, BigDecimal second, boolean notNull) {
    return notNull
        ? first == null ? second : second == null ? first : min(first, second, false)
  ...
  public static BigDecimal min(
      BigDecimal first, BigDecimal second, BigDecimal third, boolean notNull) {
    return min(min(first, second, notNull), third, notNull);
  }
  ...
  public static BigDecimal add(
      BigDecimal first, BigDecimal second, BigDecimal third, MathContext mc) {
  ...
  /** @return sum the values considering null values */
  public static BigDecimal add(
      BigDecimal first, BigDecimal second, BigDecimal third, BigDecimal fourth, MathContext mc) {
    return add(add(add(first, second, mc), third, mc), fourth, mc);
  }

  /** @return sum the values considering null values */
  public static BigDecimal add(
      BigDecimal first, BigDecimal second, BigDecimal third, BigDecimal fourth, BigDecimal fifth) {
  ...
  /** @return first minus the others considering null values, maybe negative */
  public static BigDecimal subtractToZero(
      BigDecimal first, BigDecimal second, BigDecimal third, BigDecimal fourth) {
    return subtractToZero(subtract(subtract(first, second), third), fourth);
  }
  ...
  public static BigDecimal normalizeAmount(BigDecimal amount, @NotNull MonetaryCurrency currency) {
    return amount == null
        ? null
        : amount.setScale(currency.getDigitsAfterDecimal(), MoneyHelper.getRoundingMode());
  }
