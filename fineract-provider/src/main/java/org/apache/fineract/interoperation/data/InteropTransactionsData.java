...
public class InteropTransactionsData extends CommandProcessingResult {
  ...
  public static InteropTransactionsData build(
      SavingsAccount account, @NotNull Predicate<SavingsAccountTransaction> filter) {
    if (account == null) return null;

    List<InteropTransactionData> trans =
        account.getTransactions().stream()
            ...
            .map(InteropTransactionData::build)
