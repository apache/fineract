...
public class InteropQuoteResponseData extends InteropResponseData {
  ...
  private InteropQuoteResponseData(
      Long resourceId,
      Long officeId,
      Long commandId,
  ...
  public static InteropQuoteResponseData build(
      Long commandId,
      @NotNull String transactionCode,
      @NotNull InteropActionState state,
      LocalDateTime expiration,
      ...
      MoneyData fspFee,
      MoneyData fspCommission) {
    return new InteropQuoteResponseData(
        null,
        null,
        commandId,
        null,
  ...
  public static InteropQuoteResponseData build(
      ...
      MoneyData fspCommission) {
    return build(
        null, transactionCode, state, expiration, extensionList, quoteCode, fspFee, fspCommission);
  }
