...
public class InteropApiResource {
  ...
  public String getAccountDetails(
      @PathParam("accountId") @ApiParam(value = "accountId") String accountId,
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropTransactionsData.class)
  })
  public String getAccountTransactions(
      ...
      @QueryParam("fromBookingDateTime") @ApiParam(value = "fromBookingDateTime")
          String fromBookingDateTime,
      @QueryParam("toBookingDateTime") @ApiParam(value = "toBookingDateTime")
    ...
    InteropTransactionsData result =
        interopService.getAccountTransactions(
            accountId, debit, credit, transactionsFrom, transactionsTo);
    ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
  ...
  @ApiOperation(
      value = "Query Interoperation secondary identifiers by Account Id",
      httpMethod = "GET",
      notes = "")
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropIdentifiersResponseData.class)
  })
  public String getAccountIdentifiers(
      @PathParam("accountId") @ApiParam(value = "accountId") String accountId,
      @Context UriInfo uriInfo) {
  ...
  @ApiOperation(
      value = "Query Interoperation Account by secondary identifier",
      httpMethod = "GET",
      notes = "")
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropIdentifierAccountResponseData.class)
  })
  public String getAccountByIdentifier(
      @PathParam("idType") @ApiParam(value = "idType") InteropIdentifierType idType,
  ...
  public String getAccountByIdentifier(
      ...
      @Context UriInfo uriInfo) {
    InteropIdentifierAccountResponseData result =
        interopService.getAccountByIdentifier(idType, idValue, subIdOrType);
    ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
  ...
  public String registerAccountIdentifier(
      @PathParam("idType") @ApiParam(value = "idType") InteropIdentifierType idType,
      @PathParam("idValue") @ApiParam(value = "idValue") String idValue,
      @ApiParam(hidden = true) String identifierJson,
      @Context UriInfo uriInfo)
      throws Throwable {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder()
            .registerAccountIdentifier(idType, idValue, null)
            .withJson(identifierJson)
            .build();

    InteropIdentifierAccountResponseData result =
        (InteropIdentifierAccountResponseData)
            commandsSourceService.logCommandSource(commandRequest);
    ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
  ...
  public String registerAccountIdentifier(
    ...
    CommandWrapper commandRequest =
        new InteropWrapperBuilder()
            .registerAccountIdentifier(idType, idValue, subIdOrType)
            .withJson(identifierJson)
            .build();
  ...
  @Path("parties/{idType}/{idValue}")
  @ApiOperation(
      value = "Allow Interoperation Identifier registration",
      httpMethod = "DELETE",
      notes = "")
  @ApiImplicitParams({
    @ApiImplicitParam(
  ...
  public String deleteAccountIdentifier(
      ...
      throws Throwable {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder().deleteAccountIdentifier(idType, idValue, null).build();
  ...
  public String deleteAccountIdentifier(
      ...
      throws Throwable {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder().deleteAccountIdentifier(idType, idValue, subIdOrType).build();
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropTransactionRequestResponseData.class)
  })
  public String getTransactionRequest(
      @PathParam("transactionCode") @ApiParam(value = "transactionCode") String transactionCode,
      @PathParam("requestCode") @ApiParam(value = "requestCode") String requestCode,
      @Context UriInfo uriInfo) {
    context.authenticatedUser().validateHasReadPermission(ENTITY_NAME_REQUEST);

    InteropTransactionRequestResponseData result =
        interopService.getTransactionRequest(transactionCode, requestCode);
    ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
  ...
  public String createTransactionRequest(
      @ApiParam(hidden = true) String quotesJson, @Context UriInfo uriInfo) {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder().createTransactionRequest().withJson(quotesJson).build();
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropQuoteResponseData.class)
  })
  ...
  public String createQuote(@ApiParam(hidden = true) String quotesJson, @Context UriInfo uriInfo) {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder().createQuotes().withJson(quotesJson).build();
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "OK", response = InteropTransferResponseData.class)
  })
  ...
  public String performTransfer(
      @QueryParam("action") @ApiParam(value = "action") String action,
      @ApiParam(hidden = true) String quotesJson,
      @Context UriInfo uriInfo) {
    CommandWrapper commandRequest =
        new InteropWrapperBuilder()
