...
public class InteropIdentifierAccountResponseData extends CommandProcessingResult {
  ...
  protected InteropIdentifierAccountResponseData(
      Long resourceId,
      Long officeId,
      Long commandId,
  ...
  protected static InteropIdentifierAccountResponseData build(
      Long resourceId,
      Long officeId,
      Long commandId,
      Map<String, Object> changesOnly,
      @NotNull String accountId) {
    return new InteropIdentifierAccountResponseData(
        resourceId, officeId, commandId, changesOnly, accountId);
  }

  protected static InteropIdentifierAccountResponseData build(
      Long commandId, @NotNull String accountId) {
