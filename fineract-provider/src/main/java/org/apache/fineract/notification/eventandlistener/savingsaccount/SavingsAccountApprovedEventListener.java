...
@Service
public class SavingsAccountApprovedEventListener extends Listener implements ApplicationListener<SavingsAccountApprovedEvent> {

    @Autowired
    public SavingsAccountApprovedEventListener(final NotificationEvent notificationEvent,
    ...
    @Override
    public void onApplicationEvent(final SavingsAccountApprovedEvent event) {
        buildNotification(
