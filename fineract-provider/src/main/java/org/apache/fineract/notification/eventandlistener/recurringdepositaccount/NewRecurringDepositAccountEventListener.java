...
@Service
public class NewRecurringDepositAccountEventListener extends Listener implements ApplicationListener<NewRecurringDepositAccountEvent> {

    @Autowired
    public NewRecurringDepositAccountEventListener(final NotificationEvent notificationEvent,
    ...
    @Override
    public void onApplicationEvent(NewRecurringDepositAccountEvent event) {
        buildNotification(
