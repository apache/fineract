...
public class NotificationEventListener implements SessionAwareMessageListener {
    ...
    public void onMessage(Message message, Session session) throws JMSException {
        if (message instanceof ObjectMessage) {
            ...
            AppUser currentAppUser = appUserRepository.findAppUserByName(notificationData.getActor());
            ...
            if (notificationData.getUserId() == null) {
                ...
                userIds.add(notificationData.getUserId());
            }
            ...
            if (userIds.contains(currentAppUser.getId())) {
                userIds.remove(currentAppUser.getId());
            }
