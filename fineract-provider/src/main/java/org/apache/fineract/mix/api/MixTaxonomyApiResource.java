...
public class MixTaxonomyApiResource {
  ...
  private final Set<String> RESPONSE_DATA_PARAMETERS =
      new HashSet<>(Arrays.asList("taxonomyId", "name", "namespace", "dimension", "description"));
  ...
  @Autowired
  public MixTaxonomyApiResource(
      final PlatformSecurityContext context,
      final ToApiJsonSerializer<MixTaxonomyData> toApiJsonSerializer,
  ...
  public String retrieveAll(@Context final UriInfo uriInfo) {
    ...
    return this.toApiJsonSerializer.serialize(
        settings, taxonomyDatas, this.RESPONSE_DATA_PARAMETERS);
  }
}
