...
public class ResolveSavingsCOBCustomJobParametersTasklet implements Tasklet {
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) throws Exception {
        customJobParameterResolver.resolveToJobExecutionContext(contribution, chunkContext,
                new String[] { COBConstant.BUSINESS_DATE_PARAMETER_NAME }, new String[] { COBConstant.IS_CATCH_UP_PARAMETER_NAME });
