...
public class SavingsBusinessStepCategoryServiceImpl implements BusinessStepCategoryService {
    ...
    private static final Map<BusinessStepCategory, Class<? extends COBBusinessStep>> businessSteps = Map.of(BusinessStepCategory.SAVINGS,
            SavingsCOBBusinessStep.class);
