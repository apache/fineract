...
public class ProvisioningEntryAlreadyCreatedException
    extends AbstractPlatformResourceNotFoundException {

  public ProvisioningEntryAlreadyCreatedException(Long id, Date date) {
    super(
        "error.msg.provisioningentry.already.exists.for.this.date",
        "ProvisioningEntry with identifier " + id + " exists for given date" + date,
        id);
  }
}
