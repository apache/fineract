      ...
      @Tag(
          ...
          description =
              "This defines the Provisioning Entries for all active loan products\n"
                  ...
                  + "Boolean variable whether to add journal entries for generated provisioning"
                  + " entries\n")
    })
public class ProvisioningEntriesApiResource {
  ...
  private static final Set<String> PROVISIONING_ENTRY_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              ProvisioningEntriesApiConstants.PROVISIONINGENTRY_PARAM,
              ProvisioningEntriesApiConstants.ENTRIES_PARAM));
  private static final Set<String> ALL_PROVISIONING_ENTRIES =
      new HashSet<>(Arrays.asList(ProvisioningEntriesApiConstants.PROVISIONINGENTRY_PARAM));
  ...
  @ApiOperation(
      value = "Create new Provisioning Entries",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        value = "body",
        dataType = "body",
        dataTypeClass = ProvisioningEntriesApiResourceSwagger.PostProvisioningEntriesRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningEntriesApiResourceSwagger.PostProvisioningEntriesResponse.class)
  })
  public String createProvisioningEntries(
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Recreates Provisioning Entry",
      notes = "Recreates Provisioning Entry | createjournalentry.")
  @ApiImplicitParams({
    @ApiImplicitParam(
        paramType = "body",
        value = "body",
        dataType = "body",
        dataTypeClass = ProvisioningEntriesApiResourceSwagger.PutProvisioningEntriesRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningEntriesApiResourceSwagger.PutProvisioningEntriesResponse.class)
  })
  public String modifyProvisioningEntry(
      @PathParam("entryId") @ApiParam(value = "entryId") final Long entryId,
      @QueryParam("command")
          @ApiParam(value = "command=createjournalentry\ncommand=recreateprovisioningentry")
    ...
    if ("createjournalentry".equals(commandParam)) {
      commandWrapper =
          new CommandWrapperBuilder()
              .createProvisioningJournalEntries(entryId)
              .withJson(apiRequestBodyAsJson)
              .build();
      final CommandProcessingResult commandProcessingResult =
          this.commandsSourceWritePlatformService.logCommandSource(commandWrapper);
      ...
      commandWrapper =
          new CommandWrapperBuilder()
              .reCreateProvisioningEntries(entryId)
              .withJson(apiRequestBodyAsJson)
              .build();
      final CommandProcessingResult commandProcessingResult =
          this.commandsSourceWritePlatformService.logCommandSource(commandWrapper);
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieves a Provisioning Entry",
      notes = "Returns the details of a generated Provisioning Entry.")
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiResponses({
    @ApiResponse(code = 200, message = "", response = LoanProductProvisioningEntryData.class)
  })
  public String retrieveProviioningEntries(
    ...
    SearchParameters params =
        SearchParameters.forProvisioningEntries(
            entryId, officeId, productId, categoryId, offset, limit);
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.entriesApiJsonSerializer.serialize(
        settings, entries, PROVISIONING_ENTRY_PARAMETERS);
  }
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ProvisioningEntryData.class,
  ...
  public String retrieveAllProvisioningEntries(
    ...
    Page<ProvisioningEntryData> data =
        this.provisioningEntriesReadPlatformService.retrieveAllProvisioningEntries(offset, limit);
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
