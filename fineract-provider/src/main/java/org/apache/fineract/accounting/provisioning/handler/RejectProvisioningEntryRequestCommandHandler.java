...
@Service
@CommandType(entity = "PROVISIONENTRIES", action = "REJECT")
@RequiredArgsConstructor
public class RejectProvisioningEntryRequestCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.provisioningEntriesWritePlatformService.rejectProvisioningEntry(jsonCommand.entityId(), jsonCommand);
    }
