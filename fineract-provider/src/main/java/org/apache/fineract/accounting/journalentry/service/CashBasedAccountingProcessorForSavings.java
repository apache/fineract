...
public class CashBasedAccountingProcessorForSavings implements AccountingProcessorForSavings {
  ...
  @Autowired
  public CashBasedAccountingProcessorForSavings(
  ...
  public void createJournalEntriesForSavings(final SavingsDTO savingsDTO) {
    final GLClosure latestGLClosure =
        this.helper.getLatestClosureByBranch(savingsDTO.getOfficeId());
    ...
    for (final SavingsTransactionDTO savingsTransactionDTO :
        savingsDTO.getNewSavingsTransactions()) {
        ...
        if (savingsTransactionDTO.isAccountTransfer()) {
          ...
          if (amount.subtract(overdraftAmount).compareTo(BigDecimal.ZERO) == 1) {
            this.helper.createCashBasedJournalEntriesAndReversalsForSavings(
                ...
                transactionId,
                transactionDate,
                amount.subtract(overdraftAmount),
                isReversal);
          }
        } else {
          this.helper.createCashBasedJournalEntriesAndReversalsForSavings(
       ...
       **/
        ...
        this.helper.createCashBasedJournalEntriesAndReversalsForSavingsTax(
            ...
            CashAccountsForSavings.SAVINGS_REFERENCE,
            savingsProductId,
            paymentTypeId,
            savingsId,
            transactionId,
      ...
      /** Handle Fees Deductions and reversals of Fees Deductions **/
        ...
        if (penaltyPayments.size() > 0) {
          ...
          this.helper.createCashBasedJournalEntriesAndReversalsForSavingsCharges(
              ...
              currencyCode,
              CashAccountsForSavings.OVERDRAFT_PORTFOLIO_CONTROL,
              CashAccountsForSavings.INCOME_FROM_FEES,
              savingsProductId,
              paymentTypeId,
              savingsId,
              transactionId,
