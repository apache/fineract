...
public interface GLClosureRepository
    extends JpaRepository<GLClosure, Long>, JpaSpecificationExecutor<GLClosure> {

  @Query(
      "select closure from GLClosure closure where closure.closingDate = (select"
