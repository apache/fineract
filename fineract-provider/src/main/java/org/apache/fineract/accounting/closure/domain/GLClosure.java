...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          columnNames = {"office_id", "closing_date"},
...
public class GLClosure extends AbstractAuditableCustom {
  ...
  public static GLClosure fromJson(final Office office, final JsonCommand command) {
    ...
    final String comments =
        command.stringValueOfParameterNamed(GLClosureJsonInputParams.COMMENTS.getValue());
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    handlePropertyUpdate(
        command, actualChanges, GLClosureJsonInputParams.COMMENTS.getValue(), this.comments);
