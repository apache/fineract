...
public class SavingsProductToGLAccountMappingHelper extends ProductToGLAccountMappingHelper {
  ...
  @Autowired
  public SavingsProductToGLAccountMappingHelper(
  ...
  public void mergeSavingsToAssetAccountMappingChanges(
      final JsonElement element,
      final String paramName,
      final Long productId,
    ...
    mergeProductToAccountMappingChanges(
        element,
        paramName,
        productId,
        accountTypeId,
  ...
  public void mergeSavingsToIncomeAccountMappingChanges(
      final JsonElement element,
      final String paramName,
      final Long productId,
      final int accountTypeId,
  ...
  public void mergeSavingsToExpenseAccountMappingChanges(
      final JsonElement element,
      final String paramName,
      final Long productId,
      final int accountTypeId,
  ...
  public void mergeSavingsToLiabilityAccountMappingChanges(
      final JsonElement element,
      final String paramName,
      final Long productId,
      final int accountTypeId,
  ...
  public void createOrmergeSavingsToLiabilityAccountMappingChanges(
      final JsonElement element,
      final String paramName,
      final Long productId,
      final int accountTypeId,
      final Map<String, Object> changes) {
    createOrmergeProductToAccountMappingChanges(
        element,
        paramName,
        productId,
        accountTypeId,
  ...
  public void savePaymentChannelToFundSourceMappings(
      final JsonCommand command,
      final JsonElement element,
      final Long productId,
      final Map<String, Object> changes) {
    savePaymentChannelToFundSourceMappings(
        command, element, productId, changes, PortfolioProductType.SAVING);
  }

  public void updatePaymentChannelToFundSourceMappings(
      final JsonCommand command,
      final JsonElement element,
      final Long productId,
      final Map<String, Object> changes) {
    updatePaymentChannelToFundSourceMappings(
        command, element, productId, changes, PortfolioProductType.SAVING);
  }

  public void saveChargesToIncomeAccountMappings(
      final JsonCommand command,
      final JsonElement element,
      final Long productId,
      final Map<String, Object> changes) {
    // save both fee and penalty charges
    saveChargesToIncomeOrLiabilityAccountMappings(
        command, element, productId, changes, PortfolioProductType.SAVING, true);
    saveChargesToIncomeOrLiabilityAccountMappings(
        command, element, productId, changes, PortfolioProductType.SAVING, false);
  }

  public void updateChargesToIncomeAccountMappings(
      final JsonCommand command,
      final JsonElement element,
      final Long productId,
      final Map<String, Object> changes) {
  ...
  public Map<String, Object> populateChangesForNewSavingsProductToGLAccountMappingCreation(
    ...
    switch (accountingRuleType) {
      ...
      case CASH_BASED:
        ...
        changes.put(
            SavingProductAccountingParams.INTEREST_ON_SAVINGS.getValue(), interestOnSavingsId);
        changes.put(SavingProductAccountingParams.INCOME_FROM_FEES.getValue(), incomeFromFeesId);
        changes.put(
            SavingProductAccountingParams.INCOME_FROM_PENALTIES.getValue(), incomeFromPenaltiesId);
        changes.put(
        ...
        changes.put(
            ...
            overdraftControlId);
        changes.put(
            SavingProductAccountingParams.INCOME_FROM_INTEREST.getValue(), incomeFromInterest);
   ...
   */
  public void handleChangesToSavingsProductToGLAccountMappings(
    ...
    switch (accountingRuleType) {
      ...
      case CASH_BASED:
        ...
        mergeSavingsToAssetAccountMappingChanges(
            ...
            CashAccountsForSavings.OVERDRAFT_PORTFOLIO_CONTROL.toString(),
            changes);

        // income
        mergeSavingsToIncomeAccountMappingChanges(
            element,
            SavingProductAccountingParams.INCOME_FROM_FEES.getValue(),
            savingsProductId,
            CashAccountsForSavings.INCOME_FROM_FEES.getValue(),
            CashAccountsForSavings.INCOME_FROM_FEES.toString(),
            changes);
        ...
        mergeSavingsToIncomeAccountMappingChanges(
            ...
            CashAccountsForSavings.INCOME_FROM_PENALTIES.toString(),
            changes);
        ...
        mergeSavingsToIncomeAccountMappingChanges(
            ...
            CashAccountsForSavings.INCOME_FROM_INTEREST.toString(),
            changes);
        ...
        mergeSavingsToExpenseAccountMappingChanges(
            ...
            CashAccountsForSavings.INTEREST_ON_SAVINGS.toString(),
            changes);
        mergeSavingsToExpenseAccountMappingChanges(
            element,
            ...
            CashAccountsForSavings.LOSSES_WRITTEN_OFF.toString(),
            changes);

        // liability
        mergeSavingsToLiabilityAccountMappingChanges(
            element,
            SavingProductAccountingParams.SAVINGS_CONTROL.getValue(),
            savingsProductId,
            CashAccountsForSavings.SAVINGS_CONTROL.getValue(),
            CashAccountsForSavings.SAVINGS_CONTROL.toString(),
            changes);
        mergeSavingsToLiabilityAccountMappingChanges(
            element,
            SavingProductAccountingParams.TRANSFERS_SUSPENSE.getValue(),
            ...
            CashAccountsForSavings.TRANSFERS_SUSPENSE.toString(),
            changes);
