...
public class GLAccountInvalidDeleteException extends AbstractPlatformDomainRuleException {
  ...
  public static enum GlAccountInvalidDeleteReason {
    ...
    public String errorMessage() {
      if (name().toString().equalsIgnoreCase("TRANSANCTIONS_LOGGED")) {
        ...
        return "Cannot delete this Header GL Account without first deleting or reassinging its"
            + " children";
      }
  ...
  public GLAccountInvalidDeleteException(
      final GlAccountInvalidDeleteReason reason, final Long glAccountId) {
