...
public class JournalEntryData {
  ...
  public static JournalEntryData importInstance(
      Long officeId,
      LocalDate transactionDate,
      String currencyCode,
      Long paymentTypeId,
      Integer rowIndex,
      List<CreditDebit> credits,
  ...
  public JournalEntryData(
      ...
      final EnumOptionData glAccountClassification,
      ...
      final BigDecimal organizationRunningBalance,
