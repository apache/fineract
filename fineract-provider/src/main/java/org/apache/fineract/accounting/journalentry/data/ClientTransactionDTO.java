...
public class ClientTransactionDTO {
  ...
  public ClientTransactionDTO(
      ...
      final List<ClientChargePaymentDTO> clientChargePayments) {
  ...
  public boolean isChargePayment() {
    return ClientTransactionType.PAY_CHARGE
        .getValue()
        .equals(Integer.valueOf(this.transactionType.getId().intValue()));
  }
