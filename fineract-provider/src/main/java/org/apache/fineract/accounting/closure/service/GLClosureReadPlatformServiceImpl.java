...
public class GLClosureReadPlatformServiceImpl implements GLClosureReadPlatformService {
  ...
  private static final class GLClosureMapper implements RowMapper<GLClosureData> {
    ...
    public String schema() {
      return " glClosure.id as id, glClosure.office_id as officeId,office.name as officeName"
          + " ,glClosure.closing_date as closingDate, glClosure.is_deleted as isDeleted,"
          ...
          + " glClosure.created_date as createdDate, glClosure.lastmodified_date as"
          + " updatedDate, glClosure.comments as comments  from acc_gl_closure as"
          + " glClosure, m_appuser as creatingUser, m_appuser as updatingUser,m_office as"
          + " office where glClosure.createdby_id=creatingUser.id and "
          + " glClosure.lastmodifiedby_id=updatingUser.id and"
          + " glClosure.office_id=office.id";
    }
  ...
  public GLClosureData retrieveGLClosureById(final long glClosureId) {
    try {
      ...
      final GLClosureData glAccountData =
          this.jdbcTemplate.queryForObject(sql, rm, new Object[] {glClosureId});
