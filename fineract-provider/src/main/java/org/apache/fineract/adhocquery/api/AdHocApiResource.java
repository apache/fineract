...
public class AdHocApiResource {
    ...
    public String retrieveAllAdHocQuery(@Context final UriInfo uriInfo) {
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String updateAdHocQuery(@PathParam("adHocId") final Long adHocId, final String apiRequestBodyAsJson) {
