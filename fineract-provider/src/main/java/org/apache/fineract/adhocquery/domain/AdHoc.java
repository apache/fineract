...
public class AdHoc extends AbstractAuditableCustom {
  ...
  public static AdHoc fromJson(final JsonCommand command) {
    ...
    String commandQuery =
        command.stringValueOfParameterNamed(AdHocJsonInputParams.QUERY.getValue());
    ...
    final String tableFields =
        command.stringValueOfParameterNamed(AdHocJsonInputParams.TABLEFIELDS.getValue());
    ...
    return new AdHoc(
        name, query, tableName, tableFields, email, reportRunFrequency, reportRunEvery, isActive);
  }
