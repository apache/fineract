...
public class AdHocWritePlatformServiceJpaRepositoryImpl implements AdHocWritePlatformService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(AdHocWritePlatformServiceJpaRepositoryImpl.class);
  ...
  public AdHocWritePlatformServiceJpaRepositoryImpl(
      ...
      final AdHocRepository adHocRepository,
  ...
  private void handleDataIntegrityIssues(
    ...
    if (realCause.getMessage().contains("unq_name")) {
      ...
      throw new PlatformDataIntegrityException(
          ...
          "AdHocQuery with name `" + name + "` already exists",
          "name",
          name);
    }
    ...
    throw new PlatformDataIntegrityException(
        "error.msg.adhocquery.unknown.data.integrity.issue",
    ...
    try {
      ...
      final AdHoc adHoc =
          this.adHocRepository
              .findById(adHocId)
              .orElseThrow(() -> new AdHocNotFoundException(adHocId));
