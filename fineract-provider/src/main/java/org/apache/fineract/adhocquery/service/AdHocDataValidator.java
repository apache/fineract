...
public final class AdHocDataValidator {
  ...
  public void validateForCreate(final String json) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("adhoc");
    ...
    if (reportRunFrequencyCode != null) {
      baseDataValidator
          .reset()
          .parameter("reportRunFrequency")
          .value(reportRunFrequencyCode)
          .inMinMaxRange(
              (int) ReportRunFrequency.DAILY.getValue(),
              (int) ReportRunFrequency.CUSTOM.getValue());
    }
