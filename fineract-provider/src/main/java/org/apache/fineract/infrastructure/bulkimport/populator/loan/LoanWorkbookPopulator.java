...
public class LoanWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public void populate(Workbook workbook, String dateFormat) {
    ...
    setClientAndGroupDateLookupTable(
        loanSheet,
        clientSheetPopulator.getClients(),
        groupSheetPopulator.getGroups(),
        LoanConstants.LOOKUP_CLIENT_NAME_COL,
        LoanConstants.LOOKUP_ACTIVATION_DATE_COL,
        TemplatePopulateImportConstants.CONTAINS_CLIENT_EXTERNAL_ID,
        dateFormat);
  }
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            LoanConstants.OFFICE_NAME_COL);
    CellRangeAddressList loanTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList productNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.PRODUCT_COL,
            LoanConstants.PRODUCT_COL);
    CellRangeAddressList loanOfficerRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.LOAN_OFFICER_NAME_COL,
            LoanConstants.LOAN_OFFICER_NAME_COL);
    CellRangeAddressList submittedDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.SUBMITTED_ON_DATE_COL,
            LoanConstants.SUBMITTED_ON_DATE_COL);
    CellRangeAddressList fundNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.FUND_NAME_COL,
            LoanConstants.FUND_NAME_COL);
    CellRangeAddressList principalRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.PRINCIPAL_COL,
            LoanConstants.PRINCIPAL_COL);
    CellRangeAddressList noOfRepaymentsRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.NO_OF_REPAYMENTS_COL,
            LoanConstants.NO_OF_REPAYMENTS_COL);
    CellRangeAddressList repaidFrequencyRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.REPAID_EVERY_FREQUENCY_COL,
            LoanConstants.REPAID_EVERY_FREQUENCY_COL);
    CellRangeAddressList loanTermRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.LOAN_TERM_COL,
            LoanConstants.LOAN_TERM_COL);
    CellRangeAddressList loanTermFrequencyRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.LOAN_TERM_FREQUENCY_COL,
            LoanConstants.LOAN_TERM_FREQUENCY_COL);
    CellRangeAddressList interestFrequencyRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL,
            LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL);
    CellRangeAddressList interestRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.NOMINAL_INTEREST_RATE_COL,
            LoanConstants.NOMINAL_INTEREST_RATE_COL);
    CellRangeAddressList amortizationRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.AMORTIZATION_COL,
            LoanConstants.AMORTIZATION_COL);
    CellRangeAddressList interestMethodRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.INTEREST_METHOD_COL,
            LoanConstants.INTEREST_METHOD_COL);
    CellRangeAddressList intrestCalculationPeriodRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.INTEREST_CALCULATION_PERIOD_COL,
            LoanConstants.INTEREST_CALCULATION_PERIOD_COL);
    CellRangeAddressList repaymentStrategyRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.REPAYMENT_STRATEGY_COL,
            LoanConstants.REPAYMENT_STRATEGY_COL);
    CellRangeAddressList arrearsToleranceRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.ARREARS_TOLERANCE_COL,
            LoanConstants.ARREARS_TOLERANCE_COL);
    CellRangeAddressList graceOnPrincipalPaymentRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL,
            LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL);
    CellRangeAddressList graceOnInterestPaymentRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL,
            LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL);
    CellRangeAddressList graceOnInterestChargedRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.GRACE_ON_INTEREST_CHARGED_COL,
            LoanConstants.GRACE_ON_INTEREST_CHARGED_COL);
    CellRangeAddressList approvedDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.APPROVED_DATE_COL,
            LoanConstants.APPROVED_DATE_COL);
    CellRangeAddressList disbursedDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.DISBURSED_DATE_COL,
            LoanConstants.DISBURSED_DATE_COL);
    CellRangeAddressList paymentTypeRange =
        new CellRangeAddressList(
            ...
            LoanConstants.DISBURSED_PAYMENT_TYPE_COL);
    CellRangeAddressList repaymentTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            LoanConstants.REPAYMENT_TYPE_COL,
            LoanConstants.REPAYMENT_TYPE_COL);
    CellRangeAddressList lastrepaymentDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    DataValidationConstraint loanTypeConstraint =
    ...
    DataValidationConstraint disbursedDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN, "=$H1", "=TODAY()", dateFormat);
    ...
    DataValidationConstraint frequencyConstraint =
        validationHelper.createExplicitListConstraint(new String[] {"Days", "Weeks", "Months"});
    DataValidationConstraint loanTermConstraint =
        validationHelper.createIntegerConstraint(
            DataValidationConstraint.OperatorType.GREATER_OR_EQUAL, "=$M1*$N1", null);
    DataValidationConstraint interestFrequencyConstraint =
        validationHelper.createFormulaListConstraint(
            "INDIRECT(CONCATENATE(\"INTEREST_FREQUENCY_\",$E1))");
    ...
    DataValidationConstraint amortizationConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Equal principal payments", "Equal installments"});
    DataValidationConstraint interestMethodConstraint =
        validationHelper.createExplicitListConstraint(new String[] {"Flat", "Declining Balance"});
    DataValidationConstraint interestCalculationPeriodConstraint =
        validationHelper.createExplicitListConstraint(
            new String[] {"Daily", "Same as repayment period"});
    ...
    DataValidationConstraint lastRepaymentDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN, "=$I1", "=TODAY()", dateFormat);
    ...
    DataValidation interestMethodValidation =
        validationHelper.createValidation(interestMethodConstraint, interestMethodRange);
    DataValidation interestCalculationPeriodValidation =
        validationHelper.createValidation(
            interestCalculationPeriodConstraint, intrestCalculationPeriodRange);
    DataValidation repaymentStrategyValidation =
        validationHelper.createValidation(repaymentStrategyConstraint, repaymentStrategyRange);
    ...
    DataValidation repaymentTypeValidation =
        validationHelper.createValidation(paymentTypeConstraint, repaymentTypeRange);
    ...
    DataValidation disbursedDateValidation =
        validationHelper.createValidation(disbursedDateConstraint, disbursedDateRange);
    DataValidation lastRepaymentDateValidation =
        validationHelper.createValidation(lastRepaymentDateConstraint, lastrepaymentDateRange);
    ...
    DataValidation noOfRepaymentsValidation =
        validationHelper.createValidation(noOfRepaymentsConstraint, noOfRepaymentsRange);
    ...
    DataValidation arrearsToleranceValidation =
        validationHelper.createValidation(arrearsToleranceConstraint, arrearsToleranceRange);
    DataValidation graceOnPrincipalPaymentValidation =
        validationHelper.createValidation(
            graceOnPrincipalPaymentConstraint, graceOnPrincipalPaymentRange);
    ...
    DataValidation graceOnInterestChargedValidation =
        validationHelper.createValidation(
            graceOnInterestChargedConstraint, graceOnInterestChargedRange);
    DataValidation interestFrequencyValidation =
        validationHelper.createValidation(interestFrequencyConstraint, interestFrequencyRange);
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        LoanConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOAN_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CLIENT_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CLIENT_EXTERNAL_ID, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.PRODUCT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOAN_OFFICER_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.SUBMITTED_ON_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.APPROVED_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.DISBURSED_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.DISBURSED_PAYMENT_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.FUND_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.PRINCIPAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOAN_TERM_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOAN_TERM_FREQUENCY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.NO_OF_REPAYMENTS_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.REPAID_EVERY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.REPAID_EVERY_FREQUENCY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.NOMINAL_INTEREST_RATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.AMORTIZATION_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.INTEREST_METHOD_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.INTEREST_CALCULATION_PERIOD_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.ARREARS_TOLERANCE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.REPAYMENT_STRATEGY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
    ...
    worksheet.setColumnWidth(
        ...
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.INTEREST_CHARGED_FROM_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.FIRST_REPAYMENT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.TOTAL_AMOUNT_REPAID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LAST_REPAYMENT_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.REPAYMENT_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOOKUP_CLIENT_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOOKUP_CLIENT_EXTERNAL_ID, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LOOKUP_ACTIVATION_DATE_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_ID_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_AMOUNT_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_DUE_DATE_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_ID_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_AMOUNT_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.CHARGE_DUE_DATE_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.GROUP_ID, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanConstants.LINK_ACCOUNT_ID, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    ...
    writeString(
        LoanConstants.INTEREST_CALCULATION_PERIOD_COL, rowHeader, "Interest Calculation Period*");
  ...
  private void setDefaults(Sheet worksheet) {
    ...
    for (Integer rowNo = 1; rowNo < 1000; rowNo++) {
      ...
      writeFormula(
          LoanConstants.CLIENT_EXTERNAL_ID,
          row,
          "IF(ISERROR(VLOOKUP($C"
              + (rowNo + 1)
              + ",$AR$2:$AS$"
              + (clientSheetPopulator.getClients().size() + 1)
              + ",2,FALSE)),"
              + "\"\",(VLOOKUP($C"
              + (rowNo + 1)
              + ",$AR$2:$AS$"
      ...
      writeFormula(
          LoanConstants.FUND_NAME_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"FUND_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"FUND_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.PRINCIPAL_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"PRINCIPAL_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"PRINCIPAL_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.REPAID_EVERY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"REPAYMENT_EVERY_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"REPAYMENT_EVERY_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.REPAID_EVERY_FREQUENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"REPAYMENT_FREQUENCY_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"REPAYMENT_FREQUENCY_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.NO_OF_REPAYMENTS_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"NO_REPAYMENT_\",$E"
              + (rowNo + 1)
      ...
      writeFormula(
          LoanConstants.NOMINAL_INTEREST_RATE_FREQUENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"INTEREST_FREQUENCY_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"INTEREST_FREQUENCY_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.NOMINAL_INTEREST_RATE_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"INTEREST_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"INTEREST_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.AMORTIZATION_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"AMORTIZATION_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"AMORTIZATION_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.INTEREST_METHOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"INTEREST_TYPE_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"INTEREST_TYPE_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.INTEREST_CALCULATION_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"INTEREST_CALCULATION_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"INTEREST_CALCULATION_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.ARREARS_TOLERANCE_COL,
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"ARREARS_TOLERANCE_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"ARREARS_TOLERANCE_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.REPAYMENT_STRATEGY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"STRATEGY_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"STRATEGY_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.GRACE_ON_PRINCIPAL_PAYMENT_COL,
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"GRACE_PRINCIPAL_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"GRACE_PRINCIPAL_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.GRACE_ON_INTEREST_PAYMENT_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"GRACE_INTEREST_PAYMENT_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"GRACE_INTEREST_PAYMENT_\",$E"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          LoanConstants.GRACE_ON_INTEREST_CHARGED_COL,
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"GRACE_INTEREST_CHARGED_\",$E"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"GRACE_INTEREST_CHARGED_\",$E"
              + (rowNo + 1)
              + ")))");
    }
  }
  ...
  private void setNames(Sheet worksheet) {
    ...
    officeGroup.setRefersToFormula(
        TemplatePopulateImportConstants.OFFICE_SHEET_NAME + "!$B$2:$B$" + (officeNames.size() + 1));
    ...
    for (Integer i = 0; i < officeNames.size(); i++) {
      ...
      if (officeNameToBeginEndIndexesOfStaff != null) {
        ...
        loanOfficerName.setRefersToFormula(
            TemplatePopulateImportConstants.STAFF_SHEET_NAME
                + "!$B$"
                + officeNameToBeginEndIndexesOfStaff[0]
                + ":$B$"
      ...
      if (officeNameToBeginEndIndexesOfClients != null) {
        ...
        clientName.setRefersToFormula(
            TemplatePopulateImportConstants.CLIENT_SHEET_NAME
                + "!$B$"
      ...
      if (officeNameToBeginEndIndexesOfGroups != null) {
        ...
        groupName.setRefersToFormula(
            TemplatePopulateImportConstants.GROUP_SHEET_NAME
                + "!$B$"
                + officeNameToBeginEndIndexesOfGroups[0]
                + ":$B$"
    ...
    productGroup.setRefersToFormula(
        TemplatePopulateImportConstants.PRODUCT_SHEET_NAME
            + "!$B$2:$B$"
    ...
    for (Integer i = 0; i < products.size(); i++) {
      ...
      if (products.get(i).getFundName() != null)
        fundName.setRefersToFormula(
            TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$C$" + (i + 2));
      principalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$D$" + (i + 2));
      minPrincipalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$E$" + (i + 2));
      maxPrincipalName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$F$" + (i + 2));
      noOfRepaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$G$" + (i + 2));
      minNoOfRepayment.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$H$" + (i + 2));
      maxNoOfRepaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$I$" + (i + 2));
      repaymentEveryName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$J$" + (i + 2));
      repaymentFrequencyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$K$" + (i + 2));
      interestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$L$" + (i + 2));
      minInterestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$M$" + (i + 2));
      maxInterestName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$N$" + (i + 2));
      interestFrequencyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$O$" + (i + 2));
      amortizationName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$P$" + (i + 2));
      interestTypeName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$Q$" + (i + 2));
      interestCalculationPeriodName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$R$" + (i + 2));
      transactionProcessingStrategyName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$T$" + (i + 2));
      arrearsToleranceName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$S$" + (i + 2));
      graceOnPrincipalPaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$U$" + (i + 2));
      graceOnInterestPaymentName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$V$" + (i + 2));
      graceOnInterestChargedName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$W$" + (i + 2));
      startDateName.setRefersToFormula(
          TemplatePopulateImportConstants.PRODUCT_SHEET_NAME + "!$X$" + (i + 2));
    }
  }
}
