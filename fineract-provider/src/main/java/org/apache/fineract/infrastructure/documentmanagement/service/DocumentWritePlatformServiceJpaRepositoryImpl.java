...
public class DocumentWritePlatformServiceJpaRepositoryImpl implements DocumentWritePlatformService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(DocumentWritePlatformServiceJpaRepositoryImpl.class);
    ...
    try {
      ...
      final Document document =
          Document.createNew(
              ...
              documentCommand.getName(),
              documentCommand.getFileName(),
              documentCommand.getSize(),
              documentCommand.getType(),
              documentCommand.getDescription(),
              fileLocation,
  ...
  @Transactional
  @Override
  public Long createInternalDocument(
  ...
  public CommandProcessingResult updateDocument(
      final DocumentCommand documentCommand, final InputStream inputStream) {
    try {
      this.context.authenticatedUser();
      ...
      // user
      final Document documentForUpdate =
          this.documentRepository
              .findById(documentCommand.getId())
              .orElseThrow(
                  () ->
      ...
      if (inputStream != null && documentCommand.isFileNameChanged()) {
        final ContentRepository contentRepository =
            this.contentRepositoryFactory.getRepository(documentStoreType);
