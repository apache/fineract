...
public class EmailCampaignApiResource {
  ...
  public EmailCampaignApiResource(
      ...
      final DefaultToApiJsonSerializer<EmailCampaignData>
          emailCampaignDataDefaultToApiJsonSerializer,
      final FromJsonHelper fromJsonHelper,
      final EmailCampaignWritePlatformService emailCampaignWritePlatformService,
      final DefaultToApiJsonSerializer<PreviewCampaignMessage>
          previewCampaignMessageDefaultToApiJsonSerializer) {
  ...
  @Path("{resourceId}")
  @Produces({MediaType.APPLICATION_JSON})
  public String retrieveOneCampaign(
  ...
  public String retrieveAllCampaign(@Context final UriInfo uriInfo) {
    ...
    final ApiRequestJsonSerializationSettings settings =
        this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return this.emailCampaignDataDefaultToApiJsonSerializer.serialize(
        settings, emailCampaignDataCollection);
  }
  ...
  public String createCampaign(final String apiRequestBodyAsJson, @Context final UriInfo uriInfo) {
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createEmailCampaign().withJson(apiRequestBodyAsJson).build();
  ...
  public String updateCampaign(
      @PathParam("resourceId") final Long campaignId,
  ...
  public String template(@Context final UriInfo uriInfo) {
    ...
    final Collection<EmailBusinessRulesData> emailBusinessRulesDataCollection =
  ...
  public String retrieveOneTemplate(
      @PathParam("resourceId") final Long resourceId, @Context final UriInfo uriInfo) {
    this.context.authenticatedUser().validateHasReadPermission(this.resourceNameForPermissions);
  ...
  public String delete(@PathParam("resourceId") final Long resourceId) {
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().deleteEmailCampaign(resourceId).build();
