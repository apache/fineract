...
public class DataValidatorBuilder {
  ...
  public DataValidatorBuilder parameterAtIndexArray(
      final String arrayPart, final Integer arrayIndex) {
  ...
  public DataValidatorBuilder andNotBlank(
      final String linkedParameterName, final String linkedValue) {
    ...
    if (StringUtils.isBlank(linkedValue)) {
      final StringBuilder validationErrorCode =
          new StringBuilder("validation.msg.")
              .append(this.resource)
              .append(".")
              .append(linkedParameterName)
              .append(".cannot.be.empty.when.")
              .append(this.parameter)
              .append(".is.populated");
      final StringBuilder defaultEnglishMessage =
          new StringBuilder("The parameter ")
              .append(linkedParameterName)
              .append(" cannot be empty when ")
              .append(this.parameter)
              .append(" is populated.");
  ...
  public void failWithCode(final String errorCode, final Object... defaultUserMessageArgs) {
    final StringBuilder validationErrorCode =
        new StringBuilder("validation.msg.")
            ...
            .append(errorCode);
    final StringBuilder defaultEnglishMessage =
        new StringBuilder("Failed data validation due to: ").append(errorCode).append(".");
    final ApiParameterError error =
        ApiParameterError.parameterError(
            validationErrorCode.toString(),
            defaultEnglishMessage.toString(),
  ...
  public void failWithCodeNoParameterAddedToErrorCode(
      final String errorCode, final Object... defaultUserMessageArgs) {
    final StringBuilder validationErrorCode =
        new StringBuilder("validation.msg.").append(this.resource).append(".").append(errorCode);
    final StringBuilder defaultEnglishMessage =
        new StringBuilder("Failed data validation due to: ").append(errorCode).append(".");
    final ApiParameterError error =
        ApiParameterError.parameterError(
  ...
  public DataValidatorBuilder equalToParameter(
      final String linkedParameterName, final Object linkedValue) {
    if (this.value == null && linkedValue == null && this.ignoreNullValue) {
      return this;
    }
  ...
  public DataValidatorBuilder notSameAsParameter(
      final String linkedParameterName, final Object linkedValue) {
    if (this.value == null && linkedValue == null && this.ignoreNullValue) {
      return this;
    }
  ...
  public DataValidatorBuilder trueOrFalseRequired1(final boolean trueOfFalseFieldProvided) {
    if (!trueOfFalseFieldProvided && !this.ignoreNullValue) {
      ...
      final ApiParameterError error =
          ApiParameterError.parameterError(
              validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter);
      this.dataValidationErrors.add(error);
    }
    return this;
  }
  ...
  public DataValidatorBuilder notNull() {
    if (this.value == null && !this.ignoreNullValue) {
      ...
      if (this.arrayIndex != null && StringUtils.isNotBlank(this.arrayPart)) {
        ...
        realParameterName =
            new StringBuilder(this.parameter)
                .append('[')
                .append(this.arrayIndex)
                .append("][")
                .append(this.arrayPart)
                .append(']')
                .toString();
      }
      ...
      final StringBuilder defaultEnglishMessage =
          new StringBuilder("The parameter ").append(realParameterName).append(" is mandatory.");
      final ApiParameterError error =
          ApiParameterError.parameterError(
              validationErrorCode.toString(),
              defaultEnglishMessage.toString(),
      ...
      if (intValue < number + 1) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".not.greater.than.specified.number");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(this.parameter)
    ...
    if (this.value != null) {
      ...
      if (intValue < number) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(this.parameter)
                .append(" must be equal to or greater than")
                .append(number);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (!intValue.equals(number)) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".not.equal.to.specified.number");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(this.parameter)
                .append(" must be same as")
                .append(number);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (intValue < number || intValue % number != 0) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".not.in.multiples.of.specified.number");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(this.parameter)
                .append(" must be multiples of ")
                .append(number);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (number < 0) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".not.equal.or.greater.than.zero");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(this.parameter)
      ...
      if (longValue < number + 1) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".not.greater.than.specified.")
                .append(paramName)
                .append(".at Index.")
                .append(index);
        final StringBuilder defaultEnglishMessage =
  ...
  public void expectedArrayButIsNot() {
    ...
    final StringBuilder defaultEnglishMessage =
        new StringBuilder("The parameter ").append(this.parameter).append(" is not an array.");
    final ApiParameterError error =
        ApiParameterError.parameterError(
            validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter);
    this.dataValidationErrors.add(error);
  ...
  public DataValidatorBuilder anyOfNotNull(final Object... object) {
    ...
    if (!hasData) {
      ...
      final StringBuilder defaultEnglishMessage =
          new StringBuilder("No parameters passed for update.");
      final ApiParameterError error =
          ApiParameterError.parameterError(
              validationErrorCode.toString(), defaultEnglishMessage.toString(), "id");
      this.dataValidationErrors.add(error);
    }
    return this;
  }

  public DataValidatorBuilder inValidValue(
      final String parameterValueCode, final Object invalidValue) {
    final StringBuilder validationErrorCode =
        new StringBuilder("validation.msg.")
            .append(this.resource)
            .append(".")
            .append(this.parameter)
            .append(".invalid.")
            .append(parameterValueCode);
    final StringBuilder defaultEnglishMessage =
        new StringBuilder("The parameter ").append(this.parameter).append(" has an invalid value.");
    final ApiParameterError error =
        ApiParameterError.parameterError(
            validationErrorCode.toString(),
            defaultEnglishMessage.toString(),
  ...
  public DataValidatorBuilder mustBeBlankWhenParameterProvided(
    ...
    if (this.value != null
        && StringUtils.isBlank(this.value.toString())
        && parameterValue != null
  ...
  public DataValidatorBuilder mustBeBlankWhenParameterProvidedIs(
      final String parameterName, final Object parameterValue) {
    if (this.value == null && this.ignoreNullValue) {
      return this;
    }
  ...
  public DataValidatorBuilder cantBeBlankWhenParameterProvidedIs(
      final String parameterName, final Object parameterValue) {
  ...
  public DataValidatorBuilder comapareMinimumAndMaximumAmounts(
    ...
    if (minimumBalance != null && maximumBalance != null) {
      if (maximumBalance.compareTo(minimumBalance) == -1) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The parameter ")
                .append(" minimum amount ")
                .append(minimumBalance)
                .append(" should less than maximum amount ")
                .append(maximumBalance)
                .append(".");
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
  ...
  public DataValidatorBuilder inMinAndMaxAmountRange(
      ...
      if (amount.compareTo(min) == -1) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                ...
                .append(" value ")
                .append(amount)
                .append(" must not be less than minimum value ")
                .append(min);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (amount.compareTo(max) == 1) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                ...
                .append(" value ")
                .append(amount)
                .append(" must not be more than maximum value ")
                .append(max);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
  ...
  public DataValidatorBuilder comapareMinAndMaxOfTwoBigDecmimalNos(
      ...
      try {
        ...
        final ApiParameterError error =
            ApiParameterError.parameterError(
                ...
                "The Recurring Rule value: " + recurringRule + " is not valid.",
                this.parameter,
                recurringRule);
        this.dataValidationErrors.add(error);
        return this;
        ...
        final ApiParameterError error =
            ApiParameterError.parameterError(
                ...
                "Error in pasring the Recurring Rule value: " + recurringRule + ".",
                this.parameter,
                recurringRule);
        this.dataValidationErrors.add(error);
        return this;
    ...
    if (this.value != null && min != null) {
      ...
      if (number < min) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be greater than minimum value ")
                .append(min);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
    ...
    if (this.value != null && max != null) {
      ...
      if (number > max) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be less than maximum value ")
                .append(max);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
  ...
  public DataValidatorBuilder matchesRegularExpression(
      ...
      if (date.isAfter(dateVal)) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".is.less.than.date");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be greter than provided date")
                .append(date);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (date.isBefore(dateVal)) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".is.greater.than.date");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be less than provided date")
                .append(date);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
    ...
    if (this.value != null && date != null) {
      ...
      if (dateVal.isAfter(date)) {
        ...
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be less than or equal to provided date")
                .append(date);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
      ...
      if (!dateVal.isEqual(date)) {
        final StringBuilder validationErrorCode =
            new StringBuilder("validation.msg.")
                ...
                .append(".")
                .append(this.parameter)
                .append(".is.not.equal.to.date");
        final StringBuilder defaultEnglishMessage =
            new StringBuilder("The ")
                .append(this.parameter)
                .append(" must be equal to provided date")
                .append(date);
        final ApiParameterError error =
            ApiParameterError.parameterError(
                validationErrorCode.toString(),
