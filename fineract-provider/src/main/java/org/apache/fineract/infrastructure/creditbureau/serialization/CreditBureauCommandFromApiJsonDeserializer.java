...
public class CreditBureauCommandFromApiJsonDeserializer {
  ...
  private final Set<String> supportedParameters =
      new HashSet<>(Arrays.asList("alias", "is_active", "creditBureauId"));
  ...
  public void validateForCreate(final String json, final Long creditBureauId) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("CreditBureau");
  ...
  public void validateForUpdate(final String json) {
    ...
    if (this.fromApiJsonHelper.parameterExists(creditBureauIdParameter, element)) {
      final Long creditBureauId =
          this.fromApiJsonHelper.extractLongNamed("creditBureauId", element);
      baseDataValidator
          .reset()
          .parameter("creditBureauId")
          .value(creditBureauId)
          .notNull()
          .notBlank()
          .longGreaterThanZero();
    }
