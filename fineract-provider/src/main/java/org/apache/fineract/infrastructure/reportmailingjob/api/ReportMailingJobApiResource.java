...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "This resource allows you to create a scheduled job that runs a report and sents it"
                  + " by email to specified email addresses.\n\n"
                  + "The scheduled job can be configured to run once or on a regular basis (once a"
                  + " day, twice a week, etc)")
    })
public class ReportMailingJobApiResource {
  ...
  @ApiOperation(
      value = "Create a Report Mailing Job",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ReportMailingJobApiResourceSwagger.PostReportMailingJobsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ReportMailingJobApiResourceSwagger.PostReportMailingJobsResponse.class)
  })
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ReportMailingJobApiResourceSwagger.PutReportMailingJobsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ReportMailingJobApiResourceSwagger.PutReportMailingJobsResponse.class)
  })
  public String updateReportMailingJob(
      @PathParam("entityId") @ApiParam(value = "entityId") final Long entityId,
      @ApiParam(hidden = true) final String apiRequestBodyAsJson) {
    final CommandWrapper commandWrapper =
        new CommandWrapperBuilder()
            .updateReportMailingJob(
                ReportMailingJobConstants.REPORT_MAILING_JOB_ENTITY_NAME, entityId)
            .withJson(apiRequestBodyAsJson)
            .build();
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = ReportMailingJobApiResourceSwagger.DeleteReportMailingJobsRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ReportMailingJobApiResourceSwagger.DeleteReportMailingJobsResponse.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve a Report Mailing Job",
      notes =
          "Example Requests:\n"
              + "\n"
              + "reportmailingjobs/1\n"
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ReportMailingJobApiResourceSwagger.GetReportMailingJobsResponse.class)
  })
  public String retrieveReportMailingJob(
      @PathParam("entityId") @ApiParam(value = "entityId") final Long entityId,
    ...
    ReportMailingJobData reportMailingJobData =
        this.reportMailingJobReadPlatformService.retrieveReportMailingJob(entityId);

    if (settings.isTemplate()) {
      final ReportMailingJobData ReportMailingJobDataOptions =
          this.reportMailingJobReadPlatformService.retrieveReportMailingJobEnumOptions();
      reportMailingJobData =
          ReportMailingJobData.newInstance(reportMailingJobData, ReportMailingJobDataOptions);
    }

    return this.reportMailingToApiJsonSerializer.serialize(
        settings,
        reportMailingJobData,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve Report Mailing Job Details Template",
      notes =
          "This is a convenience resource. It can be useful when building maintenance user"
              + " interface screens for report mailing job applications. The template data"
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = ReportMailingJobApiResourceSwagger.GetReportMailingJobsTemplate.class)
  })
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "List Report Mailing Jobs",
  ...
  public String retrieveAllReportMailingJobs(
      @Context final UriInfo uriInfo,
    ...
    final SearchParameters searchParameters =
        SearchParameters.fromReportMailingJob(offset, limit, orderBy, sortOrder);
    final Page<ReportMailingJobData> reportMailingJobData =
        this.reportMailingJobReadPlatformService.retrieveAllReportMailingJobs(searchParameters);
