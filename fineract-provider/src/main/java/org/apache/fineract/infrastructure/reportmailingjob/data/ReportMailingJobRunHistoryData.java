...
public class ReportMailingJobRunHistoryData {
   ...
   **/
  private ReportMailingJobRunHistoryData(
      Long id,
      Long reportMailingJobId,
   ...
   **/
  public static ReportMailingJobRunHistoryData newInstance(
      Long id,
      Long reportMailingJobId,
      DateTime startDateTime,
      DateTime endDateTime,
      ...
      String errorMessage,
      String errorLog) {
    return new ReportMailingJobRunHistoryData(
