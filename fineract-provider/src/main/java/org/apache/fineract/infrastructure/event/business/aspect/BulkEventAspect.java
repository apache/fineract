...
public class BulkEventAspect {
    ...
    public Object processCommandJoinPoint(ProceedingJoinPoint proceedingJoinPoint, BulkEventSupport bulkEventSupport) {
    ...
    public Object taskletExecuteJoinPoint(ProceedingJoinPoint proceedingJoinPoint, BulkEventSupport bulkEventSupport) {
        return bulkAroundWrapper(proceedingJoinPoint, bulkEventSupport);
    }

    @SneakyThrows
    private Object bulkAroundWrapper(ProceedingJoinPoint proceedingJoinPoint, BulkEventSupport bulkEventSupport) {
