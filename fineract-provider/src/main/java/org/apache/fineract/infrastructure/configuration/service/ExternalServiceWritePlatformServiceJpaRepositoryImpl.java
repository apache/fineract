...
public class ExternalServiceWritePlatformServiceJpaRepositoryImpl
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(ExternalServiceWritePlatformServiceJpaRepositoryImpl.class);
  ...
  public ExternalServiceWritePlatformServiceJpaRepositoryImpl(
      ...
      final ExternalServicesPropertiesRepositoryWrapper repositoryWrapper,
  ...
  @Transactional
  @Override
  public CommandProcessingResult updateExternalServicesProperties(
    ...
    ExternalServicesData external =
        this.readPlatformService.getExternalServiceDetailsByServiceName(externalServiceName);
    ...
    while (it.hasNext()) {
      ...
      final ExternalServicesProperties externalServicesProperties =
          this.repositoryWrapper.findOneByIdAndName(externalServiceId, name, externalServiceName);
