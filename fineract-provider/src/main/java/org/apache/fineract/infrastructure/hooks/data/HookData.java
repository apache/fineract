...
public class HookData implements Serializable {
  ...
  public static HookData instance(
      final Long id,
      final String name,
  ...
  public static HookData template(
      final List<HookTemplateData> templates, final List<Grouping> groupings) {
    return new HookData(
        null, null, null, null, null, null, null, null, null, null, templates, groupings);
  }

  public static HookData templateExisting(
