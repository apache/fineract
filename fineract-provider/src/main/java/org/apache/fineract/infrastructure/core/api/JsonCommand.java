...
public final class JsonCommand {
  ...
  public static JsonCommand from(
  ...
  public static JsonCommand fromExistingCommand(
  ...
  public static JsonCommand fromExistingCommand(
      JsonCommand command, final JsonElement parsedCommand) {
    final String jsonCommand = command.fromApiJsonHelper.toJson(parsedCommand);
    return new JsonCommand(
        command.commandId,
        jsonCommand,
        parsedCommand,
        command.fromApiJsonHelper,
        command.entityName,
        command.resourceId,
        command.subresourceId,
        command.groupId,
        command.clientId,
        command.loanId,
        command.savingsId,
        ...
        command.url,
        command.productId,
        command.creditBureauId,
        command.organisationCreditBureauId);
  }

  public static JsonCommand fromExistingCommand(
      JsonCommand command, final JsonElement parsedCommand, final Long clientId) {
    final String jsonCommand = command.fromApiJsonHelper.toJson(parsedCommand);
    return new JsonCommand(
        command.commandId,
        jsonCommand,
  ...
  public static JsonCommand fromJsonElement(
      final Long resourceId, final JsonElement parsedCommand) {
  ...
  private boolean differenceExistsTime(
      final LocalDateTime baseValue, final LocalDateTime workingCopyValue) {
  ...
  public boolean isChangeInLongParameterNamed(
      final String parameterName, final Long existingValue) {
  ...
  public boolean isChangeInDateParameterNamed(
      final String parameterName, final Date existingValue) {
  ...
  public boolean isChangeInTimeParameterNamed(
      final String parameterName, final Date existingValue, final String timeFormat) {
  ...
  public boolean isChangeInLocalTimeParameterNamed(
      final String parameterName, final LocalDateTime existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInLocalDateParameterNamed(
      final String parameterName, final LocalDate existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public Date DateValueOfParameterNamed(final String parameterName) {
    final LocalDate localDate =
        this.fromApiJsonHelper.extractLocalDateNamed(parameterName, this.parsedCommand);
    if (localDate == null) {
      return null;
    }
  ...
  public boolean isChangeInStringParameterNamed(
      final String parameterName, final String existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInBigDecimalParameterNamedDefaultingZeroToNull(
      final String parameterName, final BigDecimal existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
      final BigDecimal workingValue =
          bigDecimalValueOfParameterNamedDefaultToNullIfZero(parameterName);
      isChanged = differenceExists(existingValue, workingValue);
    }
    return isChanged;
  }

  public boolean isChangeInBigDecimalParameterNamed(
      final String parameterName, final BigDecimal existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInBigDecimalParameterNamed(
      final String parameterName, final BigDecimal existingValue, final Locale locale) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInBigDecimalParameterNamedWithNullCheck(
      final String parameterName, final BigDecimal existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
      final BigDecimal workingValue = bigDecimalValueOfParameterNamed(parameterName);
  ...
  public BigDecimal bigDecimalValueOfParameterNamed(final String parameterName) {
    return this.fromApiJsonHelper.extractBigDecimalWithLocaleNamed(
        parameterName, this.parsedCommand);
  }

  public BigDecimal bigDecimalValueOfParameterNamed(
      final String parameterName, final Locale locale) {
  ...
  public boolean isChangeInIntegerParameterNamedDefaultingZeroToNull(
      final String parameterName, final Integer existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInIntegerParameterNamed(
      final String parameterName, final Integer existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInIntegerParameterNamed(
      final String parameterName, final Integer existingValue, final Locale locale) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInIntegerParameterNamedWithNullCheck(
      final String parameterName, final Integer existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
      final Integer workingValue = integerValueOfParameterNamed(parameterName);
  ...
  public boolean isChangeInIntegerSansLocaleParameterNamed(
      final String parameterName, final Integer existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInBooleanParameterNamed(
      final String parameterName, final Boolean existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInArrayParameterNamed(
      final String parameterName, final String[] existingValue) {
    boolean isChanged = false;
    if (parameterExists(parameterName)) {
  ...
  public boolean isChangeInPasswordParameterNamed(
    ...
    if (parameterExists(parameterName)) {
      final String workingValue =
          passwordValueOfParameterNamed(parameterName, platformPasswordEncoder, saltValue);
      isChanged = differenceExists(existingValue, workingValue);
    }
    return isChanged;
  }

  public String passwordValueOfParameterNamed(
      final String parameterName,
      final PlatformPasswordEncoder platformPasswordEncoder,
      final Long saltValue) {
    final String passwordPlainText = stringValueOfParameterNamed(parameterName);

    final PlatformUser dummyPlatformUser =
        new BasicPasswordEncodablePlatformUser(saltValue, "", passwordPlainText);
  ...
  public void checkForUnsupportedParameters(
      final Type typeOfMap, final String json, final Set<String> requestDataParameters) {
