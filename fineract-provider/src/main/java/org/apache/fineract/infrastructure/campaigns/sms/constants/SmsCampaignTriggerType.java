...
public enum SmsCampaignTriggerType {
  ...
  public static EnumOptionData triggerType(final SmsCampaignTriggerType triggerType) {
    EnumOptionData optionData =
        new EnumOptionData(
            SmsCampaignTriggerType.INVALID.getValue().longValue(),
            SmsCampaignTriggerType.INVALID.getCode(),
            "Invalid");
    switch (triggerType) {
      case INVALID:
        optionData =
      ...
      case DIRECT:
        optionData =
            new EnumOptionData(
                SmsCampaignTriggerType.DIRECT.getValue().longValue(),
                SmsCampaignTriggerType.DIRECT.getCode(),
                "Direct");
        break;
      case SCHEDULE:
        optionData =
            new EnumOptionData(
                SmsCampaignTriggerType.SCHEDULE.getValue().longValue(),
      ...
      case TRIGGERED:
        optionData =
            new EnumOptionData(
                SmsCampaignTriggerType.TRIGGERED.getValue().longValue(),
