...
public class CodeValueRepositoryWrapper {
  ...
  public CodeValue findOneByCodeNameAndIdWithNotFoundDetection(
      final String codeName, final Long id) {
  ...
  public CodeValue findOneByCodeNameAndLabelWithNotFoundDetection(
      final String codeName, final String label) {
