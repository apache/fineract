...
public final class EntityDatatableChecksDataValidator {
  ...
  public void validateForCreate(final String json) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("entityDatatableChecks");
    ...
    baseDataValidator
        ...
        .parameter("status")
        .value(status)
        .isOneOfTheseValues(entityTablesStatuses);

    final String datatableName =
        this.fromApiJsonHelper.extractStringNamed("datatableName", element);
    ...
    if (this.fromApiJsonHelper.parameterExists("systemDefined", element)) {
      final String systemDefined =
          this.fromApiJsonHelper.extractStringNamed("systemDefined", element);
      baseDataValidator
          .reset()
          .parameter("systemDefined")
          .value(systemDefined)
