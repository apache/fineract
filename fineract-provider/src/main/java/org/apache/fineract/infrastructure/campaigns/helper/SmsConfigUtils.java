...
public class SmsConfigUtils {
  ...
  @Autowired private ExternalServicesPropertiesReadPlatformService propertiesReadPlatformService;
  ...
  public Map<String, Object> getMessageGateWayRequestURI(
    ...
    headers.add(
        SmsCampaignConstants.FINERACT_TENANT_APP_KEY,
        messageGatewayConfigurationData.getTenantAppKey());
    StringBuilder pathBuilder = new StringBuilder();
    String endPoint =
        (messageGatewayConfigurationData.getEndPoint() == null
                || messageGatewayConfigurationData.getEndPoint().equals("/"))
            ? ""
    ...
    // pathBuilder.append("{endPoint}/{apiEndPoint}") ;
    UriBuilder builder =
        UriBuilder.fromPath(pathBuilder.toString())
            .host(messageGatewayConfigurationData.getHostName())
            .scheme("http")
