...
public class RecurringDepositTransactionWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public RecurringDepositTransactionWorkbookPopulator(
  ...
  public void populate(Workbook workbook, String dateFormat) {
    Sheet savingsTransactionSheet =
        workbook.createSheet(TemplatePopulateImportConstants.SAVINGS_TRANSACTION_SHEET_NAME);
    ...
    for (int j = 0; j < clientsWithActiveSavings.size(); j++) {
      ...
      name.setNameName(
          "Account_"
              ...
              + "_");
      name.setRefersToFormula(
          TemplatePopulateImportConstants.SAVINGS_TRANSACTION_SHEET_NAME
              + "!$Q$"
