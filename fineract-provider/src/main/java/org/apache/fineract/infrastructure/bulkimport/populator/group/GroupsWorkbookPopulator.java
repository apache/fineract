...
public class GroupsWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public GroupsWorkbookPopulator(
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        GroupConstants.NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.STAFF_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.CENTER_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.ACTIVE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.ACTIVATION_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.SUBMITTED_ON_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.MEETING_START_DATE_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.IS_REPEATING_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.FREQUENCY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.INTERVAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.REPEATS_ON_DAY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.STATUS_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.GROUP_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.FAILURE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.CLIENT_NAMES_STARTING_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.LOOKUP_OFFICE_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.LOOKUP_OFFICE_OPENING_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.LOOKUP_REPEAT_NORMAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.LOOKUP_REPEAT_MONTHLY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GroupConstants.LOOKUP_IF_REPEAT_WEEKLY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    ...
    writeString(
        GroupConstants.MEETING_START_DATE_COL, rowHeader, "Meeting Start Date* (On or After)");
    ...
    writeString(
        GroupConstants.CLIENT_NAMES_STARTING_COL,
        rowHeader,
        "Client Names* (Enter in consecutive cells horizontally)");
  ...
  private void setLookupTable(Sheet groupSheet, String dateFormat) {
    setOfficeDateLookupTable(
        ...
        GroupConstants.LOOKUP_OFFICE_NAME_COL,
        GroupConstants.LOOKUP_OFFICE_OPENING_DATE_COL,
        dateFormat);
    int rowIndex;
    ...
    for (rowIndex = 1; rowIndex <= 7; rowIndex++)
      writeString(
          GroupConstants.LOOKUP_IF_REPEAT_WEEKLY_COL,
          groupSheet.getRow(rowIndex),
          days[rowIndex - 1]);
  }
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    ...
    CellRangeAddressList staffNameRange =
        new CellRangeAddressList(
            ...
            GroupConstants.STAFF_NAME_COL);
    CellRangeAddressList centerNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList submittedOnDateRange =
        new CellRangeAddressList(
            ...
            GroupConstants.SUBMITTED_ON_DATE_COL);
    CellRangeAddressList meetingStartDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GroupConstants.MEETING_START_DATE_COL,
            GroupConstants.MEETING_START_DATE_COL);
    CellRangeAddressList isRepeatRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GroupConstants.IS_REPEATING_COL,
            GroupConstants.IS_REPEATING_COL);
    CellRangeAddressList repeatsRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GroupConstants.FREQUENCY_COL,
            GroupConstants.FREQUENCY_COL);
    CellRangeAddressList repeatsEveryRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GroupConstants.INTERVAL_COL,
            GroupConstants.INTERVAL_COL);
    CellRangeAddressList repeatsOnRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    DataValidationConstraint submittedOnDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.LESS_OR_EQUAL, "=$G1", null, dateFormat);
    ...
    DataValidation centerValidation =
        validationHelper.createValidation(centerNameConstraint, centerNameRange);
    ...
    DataValidation meetingStartDateValidation =
        validationHelper.createValidation(meetingStartDateConstraint, meetingStartDateRange);
  ...
  private void setNames(Sheet worksheet, List<OfficeData> offices) {
    ...
    officeCenter.setRefersToFormula(
    ...
    repeatsDaily.setRefersToFormula(
        TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$IT$2:$IT$4");
    Name repeatsWeekly = centerWorkbook.createName();
    repeatsWeekly.setNameName("Weekly");
    repeatsWeekly.setRefersToFormula(
        TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$IT$2:$IT$4");
    Name repeatYearly = centerWorkbook.createName();
    repeatYearly.setNameName("Yearly");
    repeatYearly.setRefersToFormula(
        TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$IT$2:$IT$4");
    Name repeatsMonthly = centerWorkbook.createName();
    repeatsMonthly.setNameName("Monthly");
    repeatsMonthly.setRefersToFormula(
        TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$IU$2:$IU$12");
    Name repeatsOnWeekly = centerWorkbook.createName();
    repeatsOnWeekly.setNameName("Weekly_Days");
    repeatsOnWeekly.setRefersToFormula(
        TemplatePopulateImportConstants.GROUP_SHEET_NAME + "!$IV$2:$IV$8");
    ...
    for (Integer i = 0; i < offices.size(); i++) {
      ...
      if (officeNameToBeginEndIndexesOfStaff != null) {
        loanOfficerName.setNameName(
            "Staff_" + offices.get(i).name().trim().replaceAll("[ )(]", "_"));
      ...
      if (officeNameToBeginEndIndexesOfCenters != null) {
        ...
        centerName.setRefersToFormula(
            TemplatePopulateImportConstants.CENTER_SHEET_NAME
                + "!$B$"
                + officeNameToBeginEndIndexesOfCenters[0]
                + ":$B$"
