...
public class CreditBureauLoanProductCommandFromApiJsonDeserializer {
  private final Set<String> supportedParameters =
      new HashSet<>(
          Arrays.asList(
              ...
              "is_active",
              "locale",
              "creditbureauLoanProductMappingId"));

  private final FromJsonHelper fromApiJsonHelper;

  @Autowired
  public CreditBureauLoanProductCommandFromApiJsonDeserializer(
  ...
  public void validateForCreate(final String json, final Long cb_id) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("CREDITBUREAU_LOANPRODUCT_MAPPING");
    ...
    baseDataValidator
        .reset()
        .parameter("loanProductId")
        .value(loanProductId)
        .notBlank()
        .integerGreaterThanZero();

    if (this.fromApiJsonHelper.extractBooleanNamed("isCreditcheckMandatory", element) != null) {
      final boolean isCreditcheckMandatory =
          this.fromApiJsonHelper.extractBooleanNamed("isCreditcheckMandatory", element);
      baseDataValidator
          .reset()
          .parameter("isCreditcheckMandatory")
          .value(isCreditcheckMandatory)
          .notBlank()
      ...
      baseDataValidator
          .reset()
          .parameter("isCreditcheckMandatory")
          .value(this.fromApiJsonHelper.extractBooleanNamed("isCreditcheckMandatory", element))
          .notBlank()
          .trueOrFalseRequired(
              this.fromApiJsonHelper.extractBooleanNamed("isCreditcheckMandatory", element));
    }
    ...
    if (this.fromApiJsonHelper.extractBooleanNamed("skipCreditcheckInFailure", element) != null) {
      final boolean skipCreditcheckInFailure =
          this.fromApiJsonHelper.extractBooleanNamed("skipCreditcheckInFailure", element);
      baseDataValidator
          .reset()
          .parameter("skipCreditcheckInFailure")
          .value(skipCreditcheckInFailure)
          .notBlank()
      ...
      baseDataValidator
          .reset()
          .parameter("skipCreditcheckInFailure")
          .value(this.fromApiJsonHelper.extractBooleanNamed("skipCreditcheckInFailure", element))
          .notBlank()
          .trueOrFalseRequired(
              this.fromApiJsonHelper.extractBooleanNamed("skipCreditcheckInFailure", element));
    }
    ...
    if (this.fromApiJsonHelper.extractLongNamed("stalePeriod", element) != null) {
      ...
      baseDataValidator
          .reset()
          .parameter("stalePeriod")
          .value(this.fromApiJsonHelper.extractLongNamed("stalePeriod", element))
          .notBlank()
          .integerGreaterThanZero();
    }
  ...
  public void validateForUpdate(final String json) {
    ...
    if (this.fromApiJsonHelper.parameterExists(
        creditbureauLoanProductMappingIdParameter, element)) {
      final Long creditbureauLoanProductMappingId =
          this.fromApiJsonHelper.extractLongNamed("creditbureauLoanProductMappingId", element);
      baseDataValidator
          .reset()
          .parameter("creditbureauLoanProductMappingId")
          .value(creditbureauLoanProductMappingId)
          .notNull()
          .notBlank()
          .longGreaterThanZero();
    }
