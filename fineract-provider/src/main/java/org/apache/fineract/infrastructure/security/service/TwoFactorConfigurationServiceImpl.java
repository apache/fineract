...
public class TwoFactorConfigurationServiceImpl implements TwoFactorConfigurationService {
  ...
  @Autowired
  public TwoFactorConfigurationServiceImpl(
      TwoFactorConfigurationRepository configurationRepository) {
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()")
  ...
  public Map<String, Object> update(JsonCommand command) {
    ...
    for (final String parameterName : TwoFactorConfigurationConstants.NUMBER_PARAMETERS) {
      ...
      if (command.isChangeInIntegerSansLocaleParameterNamed(
          parameterName, configuration.getIntegerValue())) {
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|smsEnabled'")
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|smsText'")
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|emailEnabled'")
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|emailSubject'")
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|emailBody'")
  ...
  public String getFormattedEmailSubjectFor(AppUser user, OTPRequest request) {
    ...
    return compileTextTemplate(
        getEmailSubject(), TwoFactorConstants.EMAIL_DELIVERY_METHOD_NAME, templateData);
  }
  ...
  public String getFormattedEmailBodyFor(AppUser user, OTPRequest request) {
    final Map<String, Object> templateData = processTemplateDataFor(user, request);
    return compileTextTemplate(
        getEmailBody(), TwoFactorConstants.EMAIL_DELIVERY_METHOD_NAME, templateData);
  }
  ...
  public String getFormattedSmsTextFor(AppUser user, OTPRequest request) {
    final Map<String, Object> templateData = processTemplateDataFor(user, request);
    return compileTextTemplate(
        getSmsText(), TwoFactorConstants.SMS_DELIVERY_METHOD_NAME, templateData);
  }
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|otpLength'")
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|otpTime'")
  public Integer getOTPTokenLiveTime() {
    Integer defaultValue = 300;
    Integer value =
        getIntegerConfig(TwoFactorConfigurationConstants.OTP_TOKEN_LIVE_TIME, defaultValue);
    if (value < 1) {
      return defaultValue;
    }
    return value;
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|tokenTime'")
  public Integer getAccessTokenLiveTime() {
    Integer defaultValue = 86400;
    Integer value =
        getIntegerConfig(TwoFactorConfigurationConstants.ACCESS_TOKEN_LIVE_TIME, defaultValue);
    if (value < 1) {
      return defaultValue;
    }
    return value;
  ...
  @Cacheable(
      value = "tfConfig",
      key =
          "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier()+'|tokenExtendedTime'")
  public Integer getAccessTokenExtendedLiveTime() {
    Integer defaultValue = 604800;
    Integer value =
        getIntegerConfig(
            TwoFactorConfigurationConstants.ACCESS_TOKEN_LIVE_TIME_EXTENDED, defaultValue);
    if (value < 1) {
      return defaultValue;
    }
    return value;
  ...
  private Map<String, Object> processTemplateDataFor(AppUser user, OTPRequest request) {
    ...
    final LocalDateTime expireTime =
        requestTime.plusSeconds(request.getMetadata().getTokenLiveTimeInSec());
  ...
  private String compileTextTemplate(
      final String template, final String name, final Map<String, Object> params) {
