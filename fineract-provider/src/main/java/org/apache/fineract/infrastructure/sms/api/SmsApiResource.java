...
public class SmsApiResource {
  ...
  public SmsApiResource(
      ...
      final SmsReadPlatformService readPlatformService,
      final DefaultToApiJsonSerializer<SmsData> toApiJsonSerializer,
  ...
  public String create(final String apiRequestBodyAsJson) {
    ...
    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().createSms().withJson(apiRequestBodyAsJson).build();
  ...
  public String retrieveAllSmsByStatus(
    ...
    final Page<SmsData> smsMessages =
        this.readPlatformService.retrieveSmsByStatus(
            campaignId, searchParameters, status.intValue(), fromDate, toDate);
  ...
  public String update(
      @PathParam("resourceId") final Long resourceId, final String apiRequestBodyAsJson) {

    final CommandWrapper commandRequest =
        new CommandWrapperBuilder().updateSms(resourceId).withJson(apiRequestBodyAsJson).build();
