...
public class FineractEntityAccess extends AbstractPersistableCustom {
  ...
  public static FineractEntityAccess createNew(
    ...
    return new FineractEntityAccess(
        entityType, entityId, accessType, secondEntityType, secondEntityId);
  }
  ...
  public static FineractEntityAccess fromJson(
      final CodeValue accessType, final JsonCommand command) {
    final String entityType =
  ...
  public Map<String, Object> update(final JsonCommand command) {
    ...
    paramName =
        FineractEntityAccessConstants.EntityAccessJSONinputParams.ENTITY_ACCESS_TYPE_ID.getValue();
    ...
    paramName =
        FineractEntityAccessConstants.EntityAccessJSONinputParams.SECOND_ENTITY_TYPE.getValue();
