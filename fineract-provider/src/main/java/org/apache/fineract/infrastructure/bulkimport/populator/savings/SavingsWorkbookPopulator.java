...
public class SavingsWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public SavingsWorkbookPopulator(
  ...
  public void populate(Workbook workbook, String dateFormat) {
    ...
    setClientAndGroupDateLookupTable(
        ...
        SavingsConstants.LOOKUP_ACTIVATION_DATE_COL,
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        SavingsConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.SAVINGS_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CLIENT_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.PRODUCT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.FIELD_OFFICER_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.SUBMITTED_ON_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.APPROVED_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.ACTIVATION_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CURRENCY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.DECIMAL_PLACES_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.IN_MULTIPLES_OF_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);

    worksheet.setColumnWidth(
        SavingsConstants.NOMINAL_ANNUAL_INTEREST_RATE_COL,
    ...
    worksheet.setColumnWidth(
        ...
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.INTEREST_CALCULATION_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.MIN_OPENING_BALANCE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.LOCKIN_PERIOD_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
    ...
    worksheet.setColumnWidth(
        SavingsConstants.LOOKUP_CLIENT_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.LOOKUP_ACTIVATION_DATE_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);

    worksheet.setColumnWidth(
        SavingsConstants.ALLOW_OVER_DRAFT_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.OVER_DRAFT_LIMIT_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);

    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_ID_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_AMOUNT_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_DUE_DATE_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_ID_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_AMOUNT_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        SavingsConstants.CHARGE_DUE_DATE_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    ...
    writeString(
        SavingsConstants.INTEREST_POSTING_PERIOD_COL, rowHeader, "Interest Posting Period*");
    writeString(SavingsConstants.INTEREST_CALCULATION_COL, rowHeader, "Interest Calculated*");
    writeString(
        SavingsConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL, rowHeader, "# Days in Year*");
    ...
    writeString(
        SavingsConstants.OVER_DRAFT_LIMIT_COL, rowHeader, "  Maximum Overdraft Amount Limit ");
  ...
  private void setDefaults(Sheet worksheet, String dateFormat) {
    ...
    for (Integer rowNo = 1; rowNo < 1000; rowNo++) {
      ...
      writeFormula(
          SavingsConstants.CURRENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Currency_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Currency_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.DECIMAL_PLACES_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Decimal_Places_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Decimal_Places_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.IN_MULTIPLES_OF_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"In_Multiples_\",$D"
              + (rowNo + 1)
      ...
      writeFormula(
          SavingsConstants.NOMINAL_ANNUAL_INTEREST_RATE_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Rate_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Rate_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.INTEREST_COMPOUNDING_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Compouding_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Compouding_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.INTEREST_POSTING_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Posting_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Posting_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.INTEREST_CALCULATION_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Calculation_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Calculation_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Days_In_Year_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Days_In_Year_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.MIN_OPENING_BALANCE_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Min_Balance_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Min_Balance_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.LOCKIN_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Lockin_Period_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Lockin_Period_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.LOCKIN_PERIOD_FREQUENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Lockin_Frequency_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Lockin_Frequency_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.APPLY_WITHDRAWAL_FEE_FOR_TRANSFERS,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Withdrawal_Fee_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Withdrawal_Fee_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.ALLOW_OVER_DRAFT_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Overdraft_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Overdraft_\",$D"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          SavingsConstants.OVER_DRAFT_LIMIT_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Overdraft_Limit_\",$D"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Overdraft_Limit_\",$D"
              + (rowNo + 1)
              + ")))");
    }
  }
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            SavingsConstants.OFFICE_NAME_COL);
    CellRangeAddressList savingsTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList lockinPeriodFrequencyRange =
        new CellRangeAddressList(
            ...
            SavingsConstants.LOCKIN_PERIOD_FREQUENCY_COL,
            SavingsConstants.LOCKIN_PERIOD_FREQUENCY_COL);
    CellRangeAddressList applyWithdrawalFeeForTransfersRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            SavingsConstants.APPLY_WITHDRAWAL_FEE_FOR_TRANSFERS,
            SavingsConstants.APPLY_WITHDRAWAL_FEE_FOR_TRANSFERS);
    CellRangeAddressList allowOverdraftRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            SavingsConstants.ALLOW_OVER_DRAFT_COL,
    ...
    DataValidationConstraint savingsTypeConstraint =
        validationHelper.createExplicitListConstraint(new String[] {"Individual", "Group"});
    ...
    DataValidation lockinPeriodFrequencyValidation =
        validationHelper.createValidation(
            lockinPeriodFrequencyConstraint, lockinPeriodFrequencyRange);
    ...
    DataValidation allowOverdraftValidation =
        validationHelper.createValidation(allowOverdraftConstraint, allowOverdraftRange);
  ...
  private void setNames(Sheet worksheet) {
    ...
    for (Integer i = 0; i < products.size(); i++) {
      ...
      if (product.getOverdraftLimit() != null) {
        ...
        overdraftLimitName.setRefersToFormula(
      ...
      if (product.getMinRequiredOpeningBalance() != null) {
        ...
        minOpeningBalanceName.setRefersToFormula(
      ...
      if (product.getCurrency().currencyInMultiplesOf() != null) {
        ...
        inMultiplesOfName.setRefersToFormula(
