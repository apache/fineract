...
public class DeviceRegistrationReadPlatformServiceImpl
  ...
  private static final class DeviceRegistrationDataMapper
      implements RowMapper<DeviceRegistrationData> {
    ...
    public DeviceRegistrationDataMapper() {
      ...
      sqlBuilder.append(
          " cdr.id as id, cdr.registration_id as registrationId, cdr.updatedon_date as"
              + " updatedOnDate, ");
    ...
    @Override
    public DeviceRegistrationData mapRow(
      ...
      return DeviceRegistrationData.instance(
          id, clientData, registrationId, updatedOnDate.toDate());
    }
  }
