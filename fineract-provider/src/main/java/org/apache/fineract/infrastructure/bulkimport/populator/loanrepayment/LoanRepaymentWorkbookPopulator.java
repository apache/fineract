...
public class LoanRepaymentWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public LoanRepaymentWorkbookPopulator(
  ...
  private void setDefaults(Sheet worksheet, String dateFormat) {
    for (Integer rowNo = 1; rowNo < 3000; rowNo++) {
      ...
      writeFormula(
          LoanRepaymentConstants.CLIENT_EXTERNAL_ID,
          row,
          "IF(ISERROR(VLOOKUP($B"
              + (rowNo + 1)
              + ",$R$2:$S$"
              + (allloans.size() + 1)
              + ",2,FALSE)),"
              ...
              + ",2,FALSE)))");
      writeFormula(
          LoanRepaymentConstants.PRODUCT_COL,
          row,
          "IF(ISERROR(VLOOKUP($D"
              ...
              + ",2,FALSE))");
      writeFormula(
          LoanRepaymentConstants.PRINCIPAL_COL,
          row,
          "IF(ISERROR(VLOOKUP($D"
              + (rowNo + 1)
              + ",$T$2:$X$"
      ...
      writeFormula(
          LoanRepaymentConstants.LOAN_DISBURSEMENT_DATE_COL,
          row,
          "IF(ISERROR(VLOOKUP($D"
              + (rowNo + 1)
              + ",$T$2:$X$"
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    ...
    CellRangeAddressList repaymentTypeRange =
        new CellRangeAddressList(
            ...
            LoanRepaymentConstants.REPAYMENT_TYPE_COL);
    CellRangeAddressList repaymentDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    DataValidationConstraint repaymentDateConstraint =
        validationHelper.createDateConstraint(
            ...
            "=VLOOKUP($D1,$T$2:$X$" + (allloans.size() + 1) + ",4,FALSE)",
            "=TODAY()",
            dateFormat);
    ...
    DataValidation repaymentDateValidation =
        validationHelper.createValidation(repaymentDateConstraint, repaymentDateRange);
  ...
  private void setNames(Sheet worksheet) {
    ...
    for (int j = 0; j < clientsWithActiveLoans.size(); j++) {
      ...
      name.setNameName(
          "Account_"
              + clientsWithActiveLoans.get(j).replace(" ", "_")
              + "_"
              + clientIdsWithActiveLoans.get(j)
              + "_");
      name.setRefersToFormula(
          TemplatePopulateImportConstants.LOAN_REPAYMENT_SHEET_NAME
              + "!$T$"
  ...
  private void populateLoansTable(Sheet loanRepaymentSheet, String dateFormat) {
    ...
    for (LoanAccountData loan : allloans) {
      ...
      writeString(
          LoanRepaymentConstants.LOOKUP_CLIENT_NAME_COL,
          row,
          loan.getClientName() + "(" + loan.getClientId() + ")");
      writeString(
          LoanRepaymentConstants.LOOKUP_CLIENT_EXTERNAL_ID,
          row,
          clientIdToClientExternalId.get(loan.getClientId()));
      writeString(
          LoanRepaymentConstants.LOOKUP_ACCOUNT_NO_COL,
          row,
      ...
      writeDouble(
          LoanRepaymentConstants.LOOKUP_PRINCIPAL_COL, row, loan.getPrincipal().doubleValue());
      if (loan.getTotalOutstandingAmount() != null)
        writeBigDecimal(
            LoanRepaymentConstants.LOOKUP_TOTAL_OUTSTANDING_AMOUNT_COL,
            row,
      ...
      if (loan.getDisbursementDate() != null) {
        ...
        writeDate(
            LoanRepaymentConstants.LOOKUP_LOAN_DISBURSEMENT_DATE_COL,
            row,
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        LoanRepaymentConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.CLIENT_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.CLIENT_EXTERNAL_ID, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.LOAN_ACCOUNT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.PRODUCT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.PRINCIPAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.TOTAL_OUTSTANDING_AMOUNT_COL,
    ...
    worksheet.setColumnWidth(
        ...
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.AMOUNT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.REPAID_ON_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.REPAYMENT_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.ACCOUNT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.CHECK_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.RECEIPT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.ROUTING_CODE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.BANK_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.LOOKUP_CLIENT_NAME_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
    ...
    worksheet.setColumnWidth(
        ...
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.LOOKUP_PRODUCT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.LOOKUP_PRINCIPAL_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        LoanRepaymentConstants.LOOKUP_TOTAL_OUTSTANDING_AMOUNT_COL,
    ...
    writeString(
        LoanRepaymentConstants.TOTAL_OUTSTANDING_AMOUNT_COL, rowHeader, "Total Outstanding Amount");
    writeString(
        LoanRepaymentConstants.LOAN_DISBURSEMENT_DATE_COL, rowHeader, "Loan Disbursement Date");
    ...
    writeString(
        LoanRepaymentConstants.LOOKUP_TOTAL_OUTSTANDING_AMOUNT_COL,
        rowHeader,
        "Lookup Total Outstanding amount");
    writeString(
        LoanRepaymentConstants.LOOKUP_LOAN_DISBURSEMENT_DATE_COL,
        rowHeader,
        "Lookup Loan Disbursement Date");
  }
}
