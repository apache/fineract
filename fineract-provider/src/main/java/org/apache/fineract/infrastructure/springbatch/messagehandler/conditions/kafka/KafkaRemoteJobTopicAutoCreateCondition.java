...
public class KafkaRemoteJobTopicAutoCreateCondition extends AllNestedConditions {

    public KafkaRemoteJobTopicAutoCreateCondition() {
    ...
    @ConditionalOnProperty(value = "fineract.remote-job-message-handler.kafka.topic.auto-create", havingValue = "true")
