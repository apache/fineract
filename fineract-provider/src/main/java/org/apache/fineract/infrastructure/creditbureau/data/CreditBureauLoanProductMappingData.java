...
public class CreditBureauLoanProductMappingData {
  ...
  private CreditBureauLoanProductMappingData(
      ...
      final boolean skipCrediCheckInFailure,
      final long stalePeriod,
  ...
  public static CreditBureauLoanProductMappingData instance(
      final long creditbureauLoanProductMappingId,
      final long organisationCreditBureauId,
      final String alias,
      final String creditbureauSummary,
      ...
      final long stalePeriod,
      final boolean is_active) {
    return new CreditBureauLoanProductMappingData(
        ...
        skipCrediCheckInFailure,
        stalePeriod,
        is_active);
  }

  public static CreditBureauLoanProductMappingData instance1(
      final String loanProductName, final long loanProductId) {
    return new CreditBureauLoanProductMappingData(
        0, 0, "", "", loanProductName, loanProductId, false, false, 0, false);
  }
