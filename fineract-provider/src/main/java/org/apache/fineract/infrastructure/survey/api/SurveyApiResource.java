...
public class SurveyApiResource {
  ...
  private final DefaultToApiJsonSerializer<ClientScoresOverview>
      toApiJsonClientScoreOverviewSerializer;
  ...
  public SurveyApiResource(
      final DefaultToApiJsonSerializer<SurveyData> toApiJsonSerializer,
  ...
  @ApiOperation(
      value = "Retrieve surveys",
      notes = "Retrieve surveys. This allows to retrieve the list of survey tables registered .")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = SurveyApiResourceSwagger.GetSurveyResponse.class,
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Retrieve survey",
      notes =
          "Lists a registered survey table details and the Apache Fineract Core application table"
  ...
  public String retrieveSurvey(
      @PathParam("surveyName") @ApiParam(value = "surveyName") final String surveyName) {
  ...
  @Produces({MediaType.APPLICATION_JSON})
  @ApiOperation(
      value = "Create an entry in the survey table",
      notes =
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = SurveyApiResourceSwagger.PostSurveySurveyNameApptableIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = SurveyApiResourceSwagger.PostSurveySurveyNameApptableIdResponse.class)
  })
  public String createDatatableEntry(
      @PathParam("surveyName") @ApiParam(value = "surveyName") final String datatable,
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public String getClientSurveyOverview(
      @PathParam("surveyName") final String surveyName,
    ...
    List<ClientScoresOverview> scores =
        this.readSurveyService.retrieveClientSurveyScoreOverview(clientId);
  ...
  public String getSurveyEntry(
    ...
    final GenericResultsetData results =
        this.readSurveyService.retrieveSurveyEntry(surveyName, clientId, entryId);
  ...
  public String register(
      @PathParam("surveyName") final String datatable,
