...
public class TwoFactorConfigurationValidator {
  ...
  public void validateForUpdate(final String json) {
    ...
    this.fromJsonHelper.checkForUnsupportedParameters(
        typeOfMap, json, TwoFactorConfigurationConstants.REQUEST_DATA_PARAMETERS);
  ...
  private void validateBooleanParameter(
      final String name, final JsonElement element, final DataValidatorBuilder baseDataValidator) {
  ...
  private void validateNumberParameter(
      final String name, final JsonElement element, final DataValidatorBuilder baseDataValidator) {
