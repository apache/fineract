...
public interface DeviceRegistrationWritePlatformService {
	...
	public DeviceRegistration registerDevice(final Long clientId,
			final String registrationId);

	public DeviceRegistration updateDeviceRegistration(final Long id,
			final Long clientId, final String registrationId);
}
