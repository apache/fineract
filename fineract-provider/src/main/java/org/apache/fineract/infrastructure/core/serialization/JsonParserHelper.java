...
public class JsonParserHelper {
  ...
  public BigDecimal extractBigDecimalWithLocaleNamed(
      final String parameterName, final JsonElement element, final Set<String> modifiedParameters) {
  ...
  public String extractMonthDayFormatParameter(final JsonObject element) {
    ...
    if (element.isJsonObject()) {
      ...
      if (object.has(monthDayFormatParameter)
          && object.get(monthDayFormatParameter).isJsonPrimitive()) {
        ...
        if (StringUtils.isNotBlank(valueAsString)) {
          try {
            final DateTimeFormatter formatter =
                DateTimeFormat.forPattern(dateFormat).withLocale(clientApplicationLocale);
  ...
  public LocalDateTime extractLocalTimeNamed(
    ...
    if (element.isJsonObject()) {
      final JsonObject object = element.getAsJsonObject();
      value =
          extractLocalTimeNamed(
              parameterName,
              element,
              extractTimeFormatParameter(object),
              parametersPassedInCommand);
    }
    return value;
  }
      ...
      if (object.has(parameterName) && object.get(parameterName).isJsonPrimitive()) {
        ...
        try {
          ...
          final String defaultMessage =
              new StringBuilder(
                      "The parameter '" + timeValueAsString + "' is not in correct format.")
                  .toString();
          final ApiParameterError error =
              ApiParameterError.parameterError(
  ...
  public static LocalDate convertFrom(
      final String dateAsString,
      final String parameterName,
      final String dateFormat,
      final Locale clientApplicationLocale) {

    return convertDateTimeFrom(dateAsString, parameterName, dateFormat, clientApplicationLocale)
        .toLocalDate();
  }

  public static LocalDateTime convertDateTimeFrom(
      final String dateTimeAsString,
      final String parameterName,
  ...
  private static void validateDateFormatAndLocale(
      final String parameterName, final String dateFormat, final Locale clientApplicationLocale) {
    if (StringUtils.isBlank(dateFormat) || clientApplicationLocale == null) {
      ...
      if (StringUtils.isBlank(dateFormat)) {
        ...
        final ApiParameterError error =
            ApiParameterError.parameterError(
                "validation.msg.missing.dateFormat.parameter", defaultMessage, parameterName);
        dataValidationErrors.add(error);
      }
      if (clientApplicationLocale == null) {
        ...
        final ApiParameterError error =
            ApiParameterError.parameterError(
                "validation.msg.missing.locale.parameter", defaultMessage, parameterName);
        dataValidationErrors.add(error);
      }
      throw new PlatformApiDataValidationException(
          "validation.msg.validation.errors.exist",
  ...
  public Integer convertToInteger(
      final String numericalValueFormatted,
      final String parameterName,
      final Locale clientApplicationLocale) {
  ...
  public Integer convertToIntegerSanLocale(
      final String numericalValueFormatted, final String parameterName) {
  ...
  private static Locale localeFrom(
      final String languageCode, final String courntryCode, final String variantCode) {
