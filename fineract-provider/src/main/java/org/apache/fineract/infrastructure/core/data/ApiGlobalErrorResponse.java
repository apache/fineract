...
public class ApiGlobalErrorResponse {
  ...
  public static ApiGlobalErrorResponse unAuthorized(final String defaultUserMessage) {
    ...
    globalErrorResponse.setDeveloperMessage(
        "The user associated with credentials passed on this request does not have sufficient"
  ...
  public static ApiGlobalErrorResponse domainRuleViolation(
  ...
  public static ApiGlobalErrorResponse notFound(
      final String globalisationMessageCode,
      final String defaultUserMessage,
      final Object... defaultUserMessageArgs) {
    ...
    final List<ApiParameterError> errors = new ArrayList<>();
    errors.add(
        ApiParameterError.resourceIdentifierNotFound(
            globalisationMessageCode, defaultUserMessage, defaultUserMessageArgs));
    globalErrorResponse.setErrors(errors);
  ...
  public static ApiGlobalErrorResponse dataIntegrityError(
      final String globalisationMessageCode,
      final String defaultUserMessage,
    ...
    errors.add(
        ApiParameterError.parameterError(
            globalisationMessageCode, defaultUserMessage, parameterName, defaultUserMessageArgs));
    globalErrorResponse.setErrors(errors);

    return globalErrorResponse;
  }

  public static ApiGlobalErrorResponse badClientRequest(
      final String globalisationMessageCode,
      final String defaultUserMessage,
    ...
    globalErrorResponse.setDeveloperMessage(
        "The request was invalid. This typically will happen due to validation errors which are"
            + " provided.");
    globalErrorResponse.setUserMessageGlobalisationCode(globalisationMessageCode);
    globalErrorResponse.setDefaultUserMessage(defaultUserMessage);
  ...
  public static ApiGlobalErrorResponse serverSideError(
      final String globalisationMessageCode,
      final String defaultUserMessage,
      final Object... defaultUserMessageArgs) {
    ...
    globalErrorResponse.setDefaultUserMessage(
        "An unexpected error occured on the platform server.");
  ...
  public static ApiGlobalErrorResponse serviceUnavailable(
      final String globalisationMessageCode,
      final String defaultUserMessage,
      final Object... defaultUserMessageArgs) {
    ...
    globalErrorResponse.setDeveloperMessage(
        "The server is currently unable to handle the request , please try after some time.");
