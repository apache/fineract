...
public class JournalEntriesWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public JournalEntriesWorkbookPopulator(
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        JournalEntryConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.TRANSACION_ON_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.CURRENCY_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.PAYMENT_TYPE_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.TRANSACTION_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.GL_ACCOUNT_ID_CREDIT_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.AMOUNT_CREDIT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.GL_ACCOUNT_ID_DEBIT_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.AMOUNT_DEBIT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.ACCOUNT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.CHECK_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.ROUTING_CODE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.RECEIPT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.BANK_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        JournalEntryConstants.COMMENTS_COL, TemplatePopulateImportConstants.EXTRALARGE_COL_SIZE);
  ...
  private void setRules(Sheet worksheet) {
    ...
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            JournalEntryConstants.OFFICE_NAME_COL,
            JournalEntryConstants.OFFICE_NAME_COL);

    CellRangeAddressList currencyCodeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList glaccountCreditRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            JournalEntryConstants.GL_ACCOUNT_ID_CREDIT_COL,
    ...
    CellRangeAddressList glaccountDebitRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            JournalEntryConstants.GL_ACCOUNT_ID_DEBIT_COL,
    ...
    DataValidationConstraint currencyCodeConstraint =
        validationHelper.createFormulaListConstraint("Currency");
    DataValidationConstraint paymentTypeConstraint =
        validationHelper.createFormulaListConstraint("PaymentType");

    DataValidationConstraint glaccountConstraint =
        validationHelper.createFormulaListConstraint("GlAccounts");
    ...
    DataValidation glaccountCreditValidation =
        validationHelper.createValidation(glaccountConstraint, glaccountCreditRange);
    DataValidation glaccountDebitValidation =
        validationHelper.createValidation(glaccountConstraint, glaccountDebitRange);
  ...
  private void setNames(Sheet worksheet) {
    ...
    glaccountGroup.setRefersToFormula(
        TemplatePopulateImportConstants.GL_ACCOUNTS_SHEET_NAME
            + "!$B$2:$B$"
