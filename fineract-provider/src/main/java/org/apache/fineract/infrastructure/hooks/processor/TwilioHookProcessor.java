...
public class TwilioHookProcessor implements HookProcessor {
  ...
  public void process(
    ...
    sendRequest(
        smsProviderData, payload, entityName, actionName, tenantIdentifier, authToken, hook);
  }

  @SuppressWarnings("unchecked")
  private void sendRequest(
      final SmsProviderData smsProviderData,
      final String payload,
      String entityName,
      String actionName,
      final String tenantIdentifier,
    ...
    String apiKey =
        this.hookConfigurationRepository.findOneByHookIdAndFieldName(hook.getId(), apiKeyName);
    if (apiKey == null) {
    ...
    if (apiKey != null && !apiKey.equals("")) {
      ...
      service.sendSmsBridgeRequest(
          entityName, actionName, tenantIdentifier, apiKey, json, callback);
    }
  }

  private JsonObject processUgdTemplate(
      final String payload, final Hook hook, final String authToken) {
    JsonObject json = null;
    try {
      @SuppressWarnings("unchecked")
      ...
      if (map.containsKey("clientId")) {
        ...
        if (mobileNo != null && !mobileNo.isEmpty()) {
          ...
          final String compiledMessage =
              this.templateMergeService
