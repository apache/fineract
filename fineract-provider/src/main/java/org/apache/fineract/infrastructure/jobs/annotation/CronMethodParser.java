...
public class CronMethodParser {
  ...
  public static ClassMethodNamesPair findTargetMethodDetails(final String attributeValue)
      throws IOException {
  ...
  private static void findAnnotationMethods(
    ...
    packageSearchPath =
        packageSearchPath.replace("//", "/"); // else it doesn't work if *.class are in WAR!!
