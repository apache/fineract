...
public class IPv4Helper {
   ...
   **/
  public static boolean ipAddressIsInRange(
      final String ipAddress, final String startOfRange, final String endOfRange) {
      ...
      if (localHost != null) {
        ...
        if (StringUtils.isNotEmpty(hostAddress)) {
          isRunningOnLocalMachine =
              ipAddressIsInRange(hostAddress, startOfIpAddressRange, endOfIpAddressRange);
        }
      }
