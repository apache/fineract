...
public class AddOrganisationCreditBureauCommandHandler implements NewCommandSourceHandler {
  ...
  @Autowired
  public AddOrganisationCreditBureauCommandHandler(
      final OrganisationCreditBureauWritePlatflormService writePlatformService) {
  ...
  public CommandProcessingResult processCommand(JsonCommand command) {
    ...
    return this.writePlatformService.addOrganisationCreditBureau(
        command.getOrganisationCreditBureauId(), command);
  }
}
