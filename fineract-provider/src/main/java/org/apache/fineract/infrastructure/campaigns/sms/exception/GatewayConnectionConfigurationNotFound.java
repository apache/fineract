...
public class GatewayConnectionConfigurationNotFound
    extends AbstractPlatformResourceNotFoundException {

  public GatewayConnectionConfigurationNotFound(String connectionName) {
    super(
        "error.msg.gateway.config.not.found",
        "Gateway Connection Configuration with name `" + connectionName + "` does not exist",
        connectionName);
  }
}
