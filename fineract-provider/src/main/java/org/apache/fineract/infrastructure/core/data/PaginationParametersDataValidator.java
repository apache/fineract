...
public class PaginationParametersDataValidator {
  ...
  public void validateParameterValues(
      ...
      final Set<String> supportedOrdeByValues,
    ...
    if (parameters.isOrderByRequested()
      ...
      final ApiParameterError error =
          ApiParameterError.parameterError(
              "validation.msg." + resourceName + ".orderBy.value.is.not.supported",
              defaultUserMessage,
              "orderBy",
              parameters.getOrderBy(),
              supportedOrdeByValues.toString());
    ...
    if (parameters.isSortOrderProvided()
      ...
      final ApiParameterError error =
          ApiParameterError.parameterError(
              "validation.msg." + resourceName + ".sortOrder.value.is.not.supported",
              defaultUserMessage,
              "sortOrder",
              parameters.getSortOrder(),
              sortOrderValues.toString());
