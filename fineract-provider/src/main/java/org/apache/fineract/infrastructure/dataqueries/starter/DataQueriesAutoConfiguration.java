...
public class DataQueriesAutoConfiguration {
    ...
    public ReadWriteNonCoreDataService readWriteNonCoreDataService(final JdbcTemplate jdbcTemplate,
            ...
            final NamedParameterJdbcTemplate namedParameterJdbcTemplate, final DatatableKeywordGenerator datatableKeywordGenerator,
            final SqlValidator sqlValidator, final SearchUtil searchUtil,
            @Lazy final BusinessEventNotifierService businessEventNotifierService) {
