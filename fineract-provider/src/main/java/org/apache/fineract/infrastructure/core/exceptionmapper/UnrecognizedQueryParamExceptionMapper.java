...
@Component
@Scope("singleton")
public class UnrecognizedQueryParamExceptionMapper
    implements ExceptionMapper<UnrecognizedQueryParamException> {
  ...
  public Response toResponse(final UnrecognizedQueryParamException exception) {
    ...
    final StringBuilder validationErrorCode =
        new StringBuilder("error.msg.query.parameter.value.unsupported");
    final StringBuilder defaultEnglishMessage =
        new StringBuilder("The query parameter ") //
