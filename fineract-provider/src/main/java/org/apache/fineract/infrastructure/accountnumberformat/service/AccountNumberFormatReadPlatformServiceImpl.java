...
public class AccountNumberFormatReadPlatformServiceImpl
  ...
  // data mapper
  private final AccountNumberFormatMapper accountNumberFormatMapper =
      new AccountNumberFormatMapper();
  ...
  private static final class AccountNumberFormatMapper
      implements RowMapper<AccountNumberFormatData> {
    ...
    public AccountNumberFormatMapper() {
      ...
      builder.append(
          " anf.id as id, anf.account_type_enum as accountTypeEnum, anf.prefix_type_enum as"
              + " prefixTypeEnum");
    ...
    @Override
    public AccountNumberFormatData mapRow(
      ...
      final EnumOptionData accountNumberType =
          AccountNumberFormatEnumerations.entityAccountType(accountTypeEnum);
  ...
  public AccountNumberFormatData getAccountNumberFormat(Long id) {
    try {
      ...
      final AccountNumberFormatData accountNumberFormatData =
          this.jdbcTemplate.queryForObject(sql, this.accountNumberFormatMapper, new Object[] {id});
  ...
  public AccountNumberFormatData retrieveTemplate(EntityAccountType entityAccountTypeForTemplate) {
    final List<EnumOptionData> entityAccountTypeOptions =
        AccountNumberFormatEnumerations.entityAccountType(EntityAccountType.values());
  ...
  public void determinePrefixTypesForAccounts(
      Map<String, List<EnumOptionData>> accountNumberPrefixTypeOptions,
    ...
    AccountNumberPrefixType[] accountNumberPrefixTypes =
        Arrays.copyOf(array, array.length, AccountNumberPrefixType[].class);

    accountNumberPrefixTypeOptions.put(
        entityAccountType.getCode(),
