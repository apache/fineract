...
public class DocumentCommandValidator {
  ...
  public void validateForUpdate() {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource("document");
    ...
    baseDataValidator
        .reset()
        .parameter("size")
        .value(this.command.getSize())
        .ignoreIfNull()
        .integerGreaterThanZero();
    baseDataValidator
        .reset()
        .parameter("fileName")
        .value(this.command.getFileName())
        .ignoreIfNull()
        .notBlank()
    ...
    baseDataValidator
        .reset()
        .parameter("location")
        .value(this.command.getLocation())
        .ignoreIfNull()
        .notBlank();
    baseDataValidator
        .reset()
  ...
  public void validateForCreate() {
    ...
    baseDataValidator
        .reset()
        .parameter("parentEntityType")
        .value(this.command.getParentEntityType())
        .notBlank()
        .notExceedingLengthOf(50);
    baseDataValidator
        .reset()
        .parameter("parentEntityId")
        .value(this.command.getParentEntityId())
        .integerGreaterThanZero();
    baseDataValidator
        .reset()
        .parameter("name")
