...
public class ApiRequestParameterHelper {
  ...
  public ApiRequestJsonSerializationSettings process(
    ...
    final Set<String> responseParameters =
        ApiParameterHelper.extractFieldsForResponseIfProvided(queryParameters);
    ...
    return ApiRequestJsonSerializationSettings.from(
        prettyPrint, responseParameters, template, makerCheckerable, includeJson);
  }
