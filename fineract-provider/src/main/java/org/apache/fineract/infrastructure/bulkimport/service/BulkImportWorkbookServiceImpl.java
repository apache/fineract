...
import org.apache.fineract.infrastructure.bulkimport.importhandler.chartofaccounts.ChartOfAccountsImportHandler;
    ...
    public Response importWorkbook(String entityType , InputStream inputStream, FormDataContentDisposition fileDetail) {
        try {
            ...
            if (entityType.trim().equalsIgnoreCase(GLAccountsApiConstants.GLACCOUNTS_RESOURCE_NAME)) {
                importHandler = new ChartOfAccountsImportHandler(workbook);
            }else {
