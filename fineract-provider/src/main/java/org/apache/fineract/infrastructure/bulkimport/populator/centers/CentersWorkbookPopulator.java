...
public class CentersWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public CentersWorkbookPopulator(
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        CenterConstants.CENTER_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.STAFF_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.ACTIVE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.ACTIVATION_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.SUBMITTED_ON_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.MEETING_START_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.IS_REPEATING_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.FREQUENCY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.INTERVAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.REPEATS_ON_DAY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.STATUS_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.CENTER_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.FAILURE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.GROUP_NAMES_STARTING_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.LOOKUP_OFFICE_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.LOOKUP_OFFICE_OPENING_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.LOOKUP_REPEAT_NORMAL_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.LOOKUP_REPEAT_MONTHLY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        CenterConstants.LOOKUP_IF_REPEAT_WEEKLY_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    ...
    writeString(
        CenterConstants.MEETING_START_DATE_COL, rowHeader, "Meeting Start Date* (On or After)");
    ...
    writeString(
        CenterConstants.GROUP_NAMES_STARTING_COL,
        rowHeader,
        "Group Names* (Enter in consecutive cells horizontally)");
  ...
  private void setLookupTable(Sheet centerSheet, String dateFormat) {
    setOfficeDateLookupTable(
        ...
        CenterConstants.LOOKUP_OFFICE_NAME_COL,
        CenterConstants.LOOKUP_OFFICE_OPENING_DATE_COL,
        dateFormat);
    int rowIndex;
    for (rowIndex = 1; rowIndex <= 11; rowIndex++) {
      Row row = centerSheet.getRow(rowIndex);
      if (row == null) row = centerSheet.createRow(rowIndex);
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            CenterConstants.OFFICE_NAME_COL,
            CenterConstants.OFFICE_NAME_COL);
    CellRangeAddressList staffNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            CenterConstants.STAFF_NAME_COL,
            CenterConstants.STAFF_NAME_COL);
    CellRangeAddressList activationDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            CenterConstants.ACTIVATION_DATE_COL,
            CenterConstants.ACTIVATION_DATE_COL);
    ...
    CellRangeAddressList submittedDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            CenterConstants.SUBMITTED_ON_DATE_COL,
            CenterConstants.SUBMITTED_ON_DATE_COL);
    ...
    CellRangeAddressList repeatsEveryRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            CenterConstants.INTERVAL_COL,
            CenterConstants.INTERVAL_COL);
    CellRangeAddressList repeatsOnRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            CenterConstants.REPEATS_ON_DAY_COL,
            CenterConstants.REPEATS_ON_DAY_COL);
    ...
    DataValidationConstraint submittedOnDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.LESS_OR_EQUAL, "=$F1", null, dateFormat);
    ...
    DataValidation submittedOnValidation =
        validationHelper.createValidation(submittedOnDateConstraint, submittedDateRange);
  ...
  private void setNames(Sheet worksheet, List<OfficeData> offices) {
    ...
    repeatsDaily.setRefersToFormula(
        TemplatePopulateImportConstants.CENTER_SHEET_NAME + "!$IT$2:$IT$4");
    ...
    repeatsMonthly.setRefersToFormula(
        TemplatePopulateImportConstants.CENTER_SHEET_NAME + "!$IU$2:$IU$12");
    Name repeatsOnWeekly = centerWorkbook.createName();
    repeatsOnWeekly.setNameName("Weekly_Days");
    repeatsOnWeekly.setRefersToFormula(
        TemplatePopulateImportConstants.CENTER_SHEET_NAME + "!$IV$2:$IV$8");
