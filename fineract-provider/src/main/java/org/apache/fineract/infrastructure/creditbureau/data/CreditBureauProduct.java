...
public class CreditBureauProduct {
  ...
  private CreditBureauProduct(
      final long creditBureauProductId,
      final String creditBureauProductName,
  ...
  public static CreditBureauProduct instance(
      final long creditBureauProductId,
      final String creditBureauProductName,
      final long creditBureauMasterId) {
    return new CreditBureauProduct(
        creditBureauProductId, creditBureauProductName, creditBureauMasterId);
  }
