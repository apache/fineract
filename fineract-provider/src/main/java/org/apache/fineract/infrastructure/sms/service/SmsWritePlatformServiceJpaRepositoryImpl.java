...
public class SmsWritePlatformServiceJpaRepositoryImpl implements SmsWritePlatformService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(SmsWritePlatformServiceJpaRepositoryImpl.class);
  ...
  @Autowired
  public SmsWritePlatformServiceJpaRepositoryImpl(
      final SmsMessageAssembler assembler,
  ...
  private void handleDataIntegrityIssues(
    ...
    if (realCause.getMessage().contains("mobile_no")) {
      throw new PlatformDataIntegrityException(
          "error.msg.sms.no.mobile.no.exists",
    ...
    throw new PlatformDataIntegrityException(
        "error.msg.sms.unknown.data.integrity.issue",
