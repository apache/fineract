...
public class RecurringDepositWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public RecurringDepositWorkbookPopulator(
  ...
  public void populate(Workbook workbook, String dateFormat) {
    Sheet recurringDepositSheet =
        workbook.createSheet(TemplatePopulateImportConstants.RECURRING_DEPOSIT_SHEET_NAME);
    ...
    setClientAndGroupDateLookupTable(
        ...
        null,
        RecurringDepositConstants.LOOKUP_CLIENT_NAME_COL,
        RecurringDepositConstants.LOOKUP_ACTIVATION_DATE_COL,
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        RecurringDepositConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CLIENT_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.PRODUCT_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.FIELD_OFFICER_NAME_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.SUBMITTED_ON_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.APPROVED_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.ACTIVATION_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.INTEREST_COMPOUNDING_PERIOD_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.INTEREST_POSTING_PERIOD_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.INTEREST_CALCULATION_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.LOCKIN_PERIOD_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.LOCKIN_PERIOD_FREQUENCY_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.RECURRING_DEPOSIT_AMOUNT_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.DEPOSIT_PERIOD_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.DEPOSIT_PERIOD_FREQUENCY_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.DEPOSIT_FREQUENCY_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.DEPOSIT_FREQUENCY_TYPE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.DEPOSIT_START_DATE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.IS_MANDATORY_DEPOSIT_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.ALLOW_WITHDRAWAL_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.ADJUST_ADVANCE_PAYMENTS_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.FREQ_SAME_AS_GROUP_CENTER_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);

    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_ID_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_AMOUNT_1, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_DUE_DATE_1,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_ID_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_AMOUNT_2, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        RecurringDepositConstants.CHARGE_DUE_DATE_2,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    ...
    writeString(
        RecurringDepositConstants.INTEREST_CALCULATION_COL, rowHeader, "Interest Calculated*");
    writeString(
        RecurringDepositConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
        rowHeader,
        "# Days in Year*");
    ...
    writeString(
        RecurringDepositConstants.IS_MANDATORY_DEPOSIT_COL, rowHeader, "Is Mandatory Deposit?");
    ...
    writeString(
        RecurringDepositConstants.LOOKUP_ACTIVATION_DATE_COL, rowHeader, "Client Activation Date");
  }
    ...
    for (Integer rowNo = 1; rowNo < 1000; rowNo++) {
      ...
      writeFormula(
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Compouding_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Compouding_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.INTEREST_POSTING_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Posting_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Posting_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.INTEREST_CALCULATION_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Interest_Calculation_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Interest_Calculation_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
          ...
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Days_In_Year_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Days_In_Year_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.LOCKIN_PERIOD_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Lockin_Period_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Lockin_Period_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.LOCKIN_PERIOD_FREQUENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Lockin_Frequency_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Lockin_Frequency_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.RECURRING_DEPOSIT_AMOUNT_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Deposit_\",$C"
              + (rowNo + 1)
      ...
      writeFormula(
          RecurringDepositConstants.DEPOSIT_PERIOD_FREQUENCY_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Term_Type_\",$C"
              + (rowNo + 1)
      ...
      writeFormula(
          RecurringDepositConstants.IS_MANDATORY_DEPOSIT_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Mandatory_Deposit_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Mandatory_Deposit_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.ALLOW_WITHDRAWAL_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Allow_Withdrawal_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Allow_Withdrawal_\",$C"
              + (rowNo + 1)
              + ")))");
      writeFormula(
          RecurringDepositConstants.ADJUST_ADVANCE_PAYMENTS_COL,
          row,
          "IF(ISERROR(INDIRECT(CONCATENATE(\"Adjust_Advance_\",$C"
              + (rowNo + 1)
              + "))),\"\",INDIRECT(CONCATENATE(\"Adjust_Advance_\",$C"
              + (rowNo + 1)
              + ")))");
    }
  }
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            RecurringDepositConstants.OFFICE_NAME_COL,
            RecurringDepositConstants.OFFICE_NAME_COL);
    CellRangeAddressList clientNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.CLIENT_NAME_COL,
            RecurringDepositConstants.CLIENT_NAME_COL);
    CellRangeAddressList productNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.PRODUCT_COL,
            RecurringDepositConstants.PRODUCT_COL);
    CellRangeAddressList fieldOfficerRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.FIELD_OFFICER_NAME_COL,
    ...
    CellRangeAddressList approvedDateRange =
        new CellRangeAddressList(
            ...
            RecurringDepositConstants.APPROVED_DATE_COL,
            RecurringDepositConstants.APPROVED_DATE_COL);
    CellRangeAddressList activationDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.ACTIVATION_DATE_COL,
    ...
    CellRangeAddressList interestCompudingPeriodRange =
        new CellRangeAddressList(
            ...
            RecurringDepositConstants.INTEREST_COMPOUNDING_PERIOD_COL,
            RecurringDepositConstants.INTEREST_COMPOUNDING_PERIOD_COL);
    CellRangeAddressList interestPostingPeriodRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.INTEREST_POSTING_PERIOD_COL,
            RecurringDepositConstants.INTEREST_POSTING_PERIOD_COL);
    CellRangeAddressList interestCalculationRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.INTEREST_CALCULATION_COL,
            RecurringDepositConstants.INTEREST_CALCULATION_COL);
    CellRangeAddressList interestCalculationDaysInYearRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL,
            RecurringDepositConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL);
    CellRangeAddressList lockinPeriodFrequencyRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.LOCKIN_PERIOD_FREQUENCY_COL,
    ...
    CellRangeAddressList depositAmountRange =
        new CellRangeAddressList(
            ...
            RecurringDepositConstants.RECURRING_DEPOSIT_AMOUNT_COL,
            RecurringDepositConstants.RECURRING_DEPOSIT_AMOUNT_COL);
    CellRangeAddressList depositPeriodTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.DEPOSIT_PERIOD_FREQUENCY_COL,
            RecurringDepositConstants.DEPOSIT_PERIOD_FREQUENCY_COL);
    CellRangeAddressList depositFrequencyTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.DEPOSIT_FREQUENCY_TYPE_COL,
            RecurringDepositConstants.DEPOSIT_FREQUENCY_TYPE_COL);
    CellRangeAddressList isMandatoryDepositRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.IS_MANDATORY_DEPOSIT_COL,
            RecurringDepositConstants.IS_MANDATORY_DEPOSIT_COL);
    CellRangeAddressList allowWithdrawalRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.ALLOW_WITHDRAWAL_COL,
            RecurringDepositConstants.ALLOW_WITHDRAWAL_COL);
    CellRangeAddressList adjustAdvancePaymentRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.ADJUST_ADVANCE_PAYMENTS_COL,
            RecurringDepositConstants.ADJUST_ADVANCE_PAYMENTS_COL);
    CellRangeAddressList sameFreqAsGroupRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.FREQ_SAME_AS_GROUP_CENTER_COL,
            RecurringDepositConstants.FREQ_SAME_AS_GROUP_CENTER_COL);
    CellRangeAddressList depositStartDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            RecurringDepositConstants.DEPOSIT_START_DATE_COL,
    ...
    DataValidationConstraint submittedDateConstraint =
        validationHelper.createDateConstraint(
            ...
            "=VLOOKUP($B1,$AF$2:$AG$" + (clientSheetPopulator.getClientsSize() + 1) + ",2,FALSE)",
            "=TODAY()",
            dateFormat);
    ...
    DataValidation fieldOfficerValidation =
        validationHelper.createValidation(fieldOfficerNameConstraint, fieldOfficerRange);
    DataValidation interestCompudingPeriodValidation =
        validationHelper.createValidation(
            interestCompudingPeriodConstraint, interestCompudingPeriodRange);
    ...
    DataValidation interestCalculationValidation =
        validationHelper.createValidation(interestCalculationConstraint, interestCalculationRange);
    ...
    DataValidation lockinPeriodFrequencyValidation =
        validationHelper.createValidation(frequency, lockinPeriodFrequencyRange);
    DataValidation depositPeriodTypeValidation =
        validationHelper.createValidation(frequency, depositPeriodTypeRange);
    DataValidation depositFrequencyTypeValidation =
        validationHelper.createValidation(frequency, depositFrequencyTypeRange);
    ...
    DataValidation isMandatoryDepositValidation =
        validationHelper.createValidation(booleanConstraint, isMandatoryDepositRange);
    DataValidation allowWithdrawalValidation =
        validationHelper.createValidation(booleanConstraint, allowWithdrawalRange);
    DataValidation adjustAdvancePaymentValidation =
        validationHelper.createValidation(booleanConstraint, adjustAdvancePaymentRange);
    DataValidation sameFreqAsGroupValidation =
        validationHelper.createValidation(booleanConstraint, sameFreqAsGroupRange);
    DataValidation depositStartDateValidation =
        validationHelper.createValidation(depositStartDateConstraint, depositStartDateRange);
  ...
  private void setNames(Sheet worksheet) {
    ...
    for (Integer i = 0; i < officeNames.size(); i++) {
      ...
      if (officeNameToBeginEndIndexesOfStaff != null) {
        ...
        fieldOfficerName.setRefersToFormula(
    ...
    for (Integer i = 0; i < products.size(); i++) {
      ...
      if (product.getLockinPeriodFrequency() != null) {
        ...
        lockinPeriodName.setRefersToFormula(
      ...
      if (product.getLockinPeriodFrequencyType() != null) {
        ...
        lockinPeriodFrequencyName.setRefersToFormula(
