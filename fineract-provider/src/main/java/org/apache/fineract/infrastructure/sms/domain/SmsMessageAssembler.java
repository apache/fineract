  ...
  public SmsMessage assembleFromJson(final JsonCommand command) {
    ...
    if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.campaignIdParamName, element)) {
      final Long campaignId =
          this.fromApiJsonHelper.extractLongNamed(SmsApiConstants.campaignIdParamName, element);
      smsCampaign =
    ...
    return SmsMessage.pendingSms(
        externalId, group, client, staff, message, mobileNo, smsCampaign, isNotification);
  }
