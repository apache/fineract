...
public class CreditBureauConfigurationData {
  ...
  private CreditBureauConfigurationData(
      final long creditBureauConfigurationId,
      final String configurationKey,
      final String value,
      final long organizationCreditBureauId,
  ...
  public static CreditBureauConfigurationData instance(
      final long creditBureauConfigurationId,
      final String configurationKey,
      final String value,
      final long organizationCreditBureauId,
      final String description) {
    return new CreditBureauConfigurationData(
        creditBureauConfigurationId,
        configurationKey,
        value,
        organizationCreditBureauId,
        description);
  }
