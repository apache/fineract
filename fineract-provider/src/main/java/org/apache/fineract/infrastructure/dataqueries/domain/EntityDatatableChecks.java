...
public class EntityDatatableChecks extends AbstractPersistableCustom {
    ...
    public static EntityDatatableChecks fromJson(final JsonCommand command) {
        ...
        return new EntityDatatableChecks().setEntity(entity).setDatatableName(datatableName).setStatus(status)
                .setSystemDefined(systemDefined).setProductId(productId);
