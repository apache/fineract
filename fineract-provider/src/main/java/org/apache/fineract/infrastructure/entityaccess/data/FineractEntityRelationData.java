...
public class FineractEntityRelationData implements Serializable {
  ...
  public FineractEntityRelationData(
      final Long id,
      final Integer fromEntityType,
      final Integer toEntityType,
      final String mappingTypes) {
    this.id = id;
  ...
  public static FineractEntityRelationData getMappingTypes(
      final Long id, final String mappingTypes) {
