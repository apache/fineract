  ...
  public static EnumOptionData status(final SmsCampaignStatus status) {
    EnumOptionData optionData =
        new EnumOptionData(
            ...
            SmsCampaignStatus.INVALID.getCode(),
            "Invalid");
    switch (status) {
      case INVALID:
        optionData =
      ...
      case PENDING:
        optionData =
            new EnumOptionData(
                SmsCampaignStatus.PENDING.getValue().longValue(),
                SmsCampaignStatus.PENDING.getCode(),
                "Pending");
        break;
      case ACTIVE:
        optionData =
            new EnumOptionData(
                SmsCampaignStatus.ACTIVE.getValue().longValue(),
                SmsCampaignStatus.ACTIVE.getCode(),
                "active");
        break;
      case CLOSED:
        optionData =
            new EnumOptionData(
                SmsCampaignStatus.CLOSED.getValue().longValue(),
                SmsCampaignStatus.CLOSED.getCode(),
                "closed");
        break;
    }
