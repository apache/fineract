...
public final class SmsDataValidator {
  ...
  private static final Set<String> CREATE_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
          Arrays.asList(
              SmsApiConstants.localeParamName,
              SmsApiConstants.dateFormatParamName,
              SmsApiConstants.groupIdParamName,
              SmsApiConstants.clientIdParamName,
              SmsApiConstants.staffIdParamName,
              SmsApiConstants.messageParamName,
              SmsApiConstants.campaignIdParamName));

  public static final Set<String> UPDATE_REQUEST_DATA_PARAMETERS =
      new HashSet<>(
  ...
  public void validateForCreate(final String json) {
    ...
    final DataValidatorBuilder baseDataValidator =
        new DataValidatorBuilder(dataValidationErrors).resource(SmsApiConstants.RESOURCE_NAME);
    ...
    if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.groupIdParamName, element)) {
      ...
      baseDataValidator
          .reset()
          .parameter(SmsApiConstants.groupIdParamName)
          .value(groupId)
          .notNull()
      ...
      if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.clientIdParamName, element)) {
        baseDataValidator
            .reset()
            .parameter(SmsApiConstants.clientIdParamName)
            .failWithCode("cannot.be.passed.with.groupId");
      }

      if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.staffIdParamName, element)) {
        baseDataValidator
            .reset()
            .parameter(SmsApiConstants.staffIdParamName)
            .failWithCode("cannot.be.passed.with.groupId");
      }
      ...
      if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.groupIdParamName, element)) {
        baseDataValidator
            .reset()
            .parameter(SmsApiConstants.groupIdParamName)
            .failWithCode("cannot.be.passed.with.clientId");
      }
      ...
      if (this.fromApiJsonHelper.parameterExists(SmsApiConstants.groupIdParamName, element)) {
        baseDataValidator
            .reset()
            .parameter(SmsApiConstants.groupIdParamName)
            .failWithCode("cannot.be.passed.with.staffId");
      }
    ...
    baseDataValidator
        .reset()
        .parameter(SmsApiConstants.messageParamName)
        .value(message)
        .notBlank()
