...
public class OrganisationCreditBureauWritePlatflormServiceImpl
  ...
  @Autowired
  public OrganisationCreditBureauWritePlatflormServiceImpl(
  ...
  @Override
  public CommandProcessingResult addOrganisationCreditBureau(
      Long creditBureauId, JsonCommand command) {
