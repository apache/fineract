...
@SwaggerDefinition(
    tags = {
      @Tag(
          ...
          description =
              "External Services Configuration related to set of supported configurations for"
                  + " third party services like Amazon S3 and SMTP:\n"
                  + "\n"
                  + "S3 (Amazon S3):\n"
                  + "s3_access_key -\n"
                  + "s3_bucket_name -\n"
...
public class ExternalServicesConfigurationApiResource {
  ...
  private final ExternalServicesPropertiesReadPlatformService
      externalServicePropertiesReadPlatformService;
  ...
  @Autowired
  public ExternalServicesConfigurationApiResource(
  ...
  @ApiOperation(
      value = "Retrieve External Services Configuration",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "", response = ExternalServicesPropertiesData.class)
  })
  public String retrieveOne(
      @PathParam("servicename") @ApiParam(value = "servicename") final String serviceName,
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        format = "body",
        dataTypeClass =
            ExternalServicesConfigurationApiResourceSwagger.PutExternalServiceRequest.class)
  })
