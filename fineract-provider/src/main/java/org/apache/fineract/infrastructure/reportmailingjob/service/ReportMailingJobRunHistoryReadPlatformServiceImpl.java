...
public class ReportMailingJobRunHistoryReadPlatformServiceImpl
  ...
  private final PaginationHelper<ReportMailingJobRunHistoryData> paginationHelper =
  ...
  @Override
  public Page<ReportMailingJobRunHistoryData> retrieveRunHistoryByJobId(
      final Long reportMailingJobId, final SearchParameters searchParameters) {
    ...
    sqlStringBuilder.append(
        this.reportMailingJobRunHistoryMapper.ReportMailingJobRunHistorySchema());
  ...
  private static final class ReportMailingJobRunHistoryMapper
      implements RowMapper<ReportMailingJobRunHistoryData> {
    ...
    public ReportMailingJobRunHistoryData mapRow(ResultSet rs, int rowNum) throws SQLException {
      ...
      return ReportMailingJobRunHistoryData.newInstance(
          id, reportMailingJobId, startDateTime, endDateTime, status, errorMessage, errorLog);
    }
  }
}
