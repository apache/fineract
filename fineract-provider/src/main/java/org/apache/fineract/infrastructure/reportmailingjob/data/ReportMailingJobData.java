...
public class ReportMailingJobData {
  ...
  private ReportMailingJobData(
      ...
      final EnumOptionData emailAttachmentFileFormat,
      final ReportData stretchyReport,
      final String stretchyReportParamMap,
      final DateTime previousRunDateTime,
   ...
   **/
  public static ReportMailingJobData newInstance(
      final Long id,
      final String name,
      final String description,
      final DateTime startDateTime,
      ...
      final boolean isActive,
      final Long runAsUserId) {
    return new ReportMailingJobData(
        id,
        name,
        description,
        startDateTime,
   ...
   **/
  public static ReportMailingJobData newInstance(
      final ReportMailingJobData dataWithoutEnumOptions,
      final ReportMailingJobData dataWithEnumOptions) {
    return new ReportMailingJobData(
        dataWithoutEnumOptions.id,
        dataWithoutEnumOptions.name,
        dataWithoutEnumOptions.description,
        dataWithoutEnumOptions.startDateTime,
        dataWithoutEnumOptions.recurrence,
        dataWithoutEnumOptions.timeline,
        dataWithoutEnumOptions.emailRecipients,
        dataWithoutEnumOptions.emailSubject,
        dataWithoutEnumOptions.emailMessage,
