    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.securityMatcher(API_MATCHER.matcher("/api/**")).authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers(API_MATCHER.matcher(HttpMethod.OPTIONS, "/api/**")).permitAll()
                    ...
                    // investor: external asset owners
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.GET, "/api/*/external-asset-owners/**"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_READ)
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/external-asset-owners/search"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_READ)
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/external-asset-owners"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "CREATE_EXTERNAL_ASSET_OWNER")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/external-asset-owners/transfers/loans/**"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "SALE_LOAN", "BUYBACK_LOAN", "INTERMEDIARYSALE_LOAN")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/external-asset-owners/transfers/**"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE)
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/external-asset-owners/loan-product/*/attributes"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "CREATE_EXTERNAL_ASSET_OWNER_LOAN_PRODUCT_ATTRIBUTE")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.PUT, "/api/*/external-asset-owners/loan-product/*/attributes/**"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "UPDATE_EXTERNAL_ASSET_OWNER_LOAN_PRODUCT_ATTRIBUTE")
                    // cache
