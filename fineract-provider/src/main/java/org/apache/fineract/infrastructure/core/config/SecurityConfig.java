    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.securityMatcher(API_MATCHER.matcher("/api/**")).authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers(API_MATCHER.matcher(HttpMethod.OPTIONS, "/api/**")).permitAll()
                    ...
                    // tax component
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.GET, "/api/*/taxes/component/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_READ, "READ_TAXCOMPONENT")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/taxes/component/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "CREATE_TAXCOMPONENT")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.PUT, "/api/*/taxes/component/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "UPDATE_TAXCOMPONENT")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.DELETE, "/api/*/taxes/component/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "DELETE_TAXCOMPONENT")
                    // tax group
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.GET, "/api/*/taxes/group/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_READ, "READ_TAXGROUP")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.POST, "/api/*/taxes/group/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "CREATE_TAXGROUP")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.PUT, "/api/*/taxes/group/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "UPDATE_TAXGROUP")
                    .requestMatchers(API_MATCHER.matcher(HttpMethod.DELETE, "/api/*/taxes/group/*"))
                    .hasAnyAuthority(ALL_FUNCTIONS, ALL_FUNCTIONS_WRITE, "DELETE_TAXGROUP")
