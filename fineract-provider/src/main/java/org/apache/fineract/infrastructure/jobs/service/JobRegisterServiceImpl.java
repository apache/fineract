...
public class JobRegisterServiceImpl
  ...
  private static final Logger logger = LoggerFactory.getLogger(JobRegisterServiceImpl.class);
  ...
  @Autowired
  public void setSchedularWritePlatformService(
  ...
  private JobDetail createJobDetail(final ScheduledJobDetail scheduledJobDetail) throws Exception {
    ...
    if (jobDetails == null) {
      throw new IllegalArgumentException(
          "Code has no @CronTarget with this job name (@see JobName); seems like DB/code are not"
              + " in line: "
