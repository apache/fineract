...
public class ClientEntityWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public ClientEntityWorkbookPopulator(
  ...
  private void setClientDataLookupTable(Sheet clientSheet) {
    ...
    for (CodeValueData clientTypeCodeValue : clientTypeCodeValues) {
      ...
      writeString(
          ClientEntityConstants.LOOKUP_CLIENT_TYPES,
          row,
    ...
    for (CodeValueData clientClassificationCodeValue : clientClassificationCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_CLIENT_CLASSIFICATION,
          row,
    ...
    for (CodeValueData constitutionCodeValue : constitutionCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_CONSTITUTION_COL,
          row,
    ...
    for (CodeValueData mainBusinessCodeValue : mainBusinesslineCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_MAIN_BUSINESS_LINE,
          row,
    ...
    for (CodeValueData addressTypeCodeValue : addressTypesCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_ADDRESS_TYPE,
          row,
    ...
    for (CodeValueData stateCodeValue : stateProvinceCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_STATE_PROVINCE,
          row,
    ...
    for (CodeValueData countryCodeValue : countryCodeValues) {
      ...
      if (row == null) row = clientSheet.createRow(rowIndex);
      writeString(
          ClientEntityConstants.LOOKUP_COUNTRY,
          row,
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        ClientEntityConstants.NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    writeString(ClientEntityConstants.NAME_COL, rowHeader, "Name*");
    worksheet.setColumnWidth(
        ClientEntityConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.STAFF_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.INCOPORATION_DATE_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.INCOPORATION_VALID_TILL_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.MOBILE_NO_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.CLIENT_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.CLIENT_CLASSIFICATION_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.INCOPORATION_NUMBER_COL,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.MAIN_BUSINESS_LINE, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.CONSTITUTION_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.REMARKS_COL, TemplatePopulateImportConstants.LARGE_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.SUBMITTED_ON_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ACTIVE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ACTIVATION_DATE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ADDRESS_ENABLED, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ADDRESS_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.STREET_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ADDRESS_LINE_1_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ADDRESS_LINE_2_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.ADDRESS_LINE_3_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.CITY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.STATE_PROVINCE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.COUNTRY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.POSTAL_CODE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.IS_ACTIVE_ADDRESS_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.WARNING_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    ...
    worksheet.setColumnWidth(
        ...
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_CLIENT_TYPES, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_CLIENT_CLASSIFICATION,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_ADDRESS_TYPE, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_STATE_PROVINCE,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_COUNTRY, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        ClientEntityConstants.LOOKUP_MAIN_BUSINESS_LINE,
        TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    writeString(ClientEntityConstants.NAME_COL, rowHeader, "Name");
    ...
    writeString(
        ClientEntityConstants.CLIENT_CLASSIFICATION_COL, rowHeader, "Client Classification ");
    ...
    writeString(
        ClientEntityConstants.WARNING_COL, rowHeader, "All * marked fields are compulsory.");

    writeString(
        ClientEntityConstants.RELATIONAL_OFFICE_NAME_COL, rowHeader, "Lookup office Name  ");
    writeString(
        ClientEntityConstants.RELATIONAL_OFFICE_OPENING_DATE_COL,
        rowHeader,
  ...
  private void setRules(Sheet worksheet, String dateFormat) {
    ...
    CellRangeAddressList staffNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.STAFF_NAME_COL,
            ClientEntityConstants.STAFF_NAME_COL);
    CellRangeAddressList submittedOnDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.SUBMITTED_ON_COL,
            ClientEntityConstants.SUBMITTED_ON_COL);
    CellRangeAddressList dateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.ACTIVATION_DATE_COL,
            ClientEntityConstants.ACTIVATION_DATE_COL);
    CellRangeAddressList activeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.ACTIVE_COL,
            ClientEntityConstants.ACTIVE_COL);
    CellRangeAddressList clientTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.CLIENT_TYPE_COL,
            ClientEntityConstants.CLIENT_TYPE_COL);
    CellRangeAddressList constitutionRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.CONSTITUTION_COL,
            ClientEntityConstants.CONSTITUTION_COL);
    CellRangeAddressList mainBusinessLineRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.MAIN_BUSINESS_LINE,
            ClientEntityConstants.MAIN_BUSINESS_LINE);
    ...
    CellRangeAddressList enabledAddressRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.ADDRESS_ENABLED,
            ClientEntityConstants.ADDRESS_ENABLED);
    CellRangeAddressList addressTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.ADDRESS_TYPE_COL,
            ClientEntityConstants.ADDRESS_TYPE_COL);
    CellRangeAddressList stateProvinceRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.STATE_PROVINCE_COL,
            ClientEntityConstants.STATE_PROVINCE_COL);
    CellRangeAddressList countryRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.COUNTRY_COL,
            ClientEntityConstants.COUNTRY_COL);
    CellRangeAddressList activeAddressRange =
        new CellRangeAddressList(
            ...
            ClientEntityConstants.IS_ACTIVE_ADDRESS_COL,
            ClientEntityConstants.IS_ACTIVE_ADDRESS_COL);
    CellRangeAddressList incorporateDateRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.INCOPORATION_DATE_COL,
            ClientEntityConstants.INCOPORATION_DATE_COL);
    CellRangeAddressList incorporateDateTillRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            ClientEntityConstants.INCOPORATION_VALID_TILL_COL,
    ...
    DataValidationConstraint submittedOnDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.LESS_OR_EQUAL, "=$O1", null, dateFormat);
    DataValidationConstraint activationDateConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.BETWEEN,
            "=VLOOKUP($B1,$AJ$2:$AK" + (offices.size() + 1) + ",2,FALSE)",
            "=TODAY()",
            dateFormat);
    ...
    DataValidationConstraint incorpDateTillConstraint =
        validationHelper.createDateConstraint(
            DataValidationConstraint.OperatorType.GREATER_OR_EQUAL, "=TODAY()", null, dateFormat);
    ...
    DataValidation incorporateDateValidation =
        validationHelper.createValidation(incorpDateConstraint, incorporateDateRange);
    DataValidation incorporateDateTillValidation =
        validationHelper.createValidation(incorpDateTillConstraint, incorporateDateTillRange);
  ...
  private void setNames(Sheet worksheet, List<OfficeData> offices) {
    ...
    clientTypeGroup.setRefersToFormula(
        TemplatePopulateImportConstants.CLIENT_ENTITY_SHEET_NAME
            + "!$AN$2:$AN$"
