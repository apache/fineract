...
public class FineractEntityToEntityMappingData implements Serializable {
  ...
  private FineractEntityToEntityMappingData(
      final Long mapId,
  ...
  public static FineractEntityToEntityMappingData getRelatedEntities(
      final Long mapId,
      final Long relationId,
      final Long fromId,
      final Long toId,
    ...
    return new FineractEntityToEntityMappingData(
        mapId, relationId, fromId, toId, startDate, endDate, fromEntity, toEntity);
  }
