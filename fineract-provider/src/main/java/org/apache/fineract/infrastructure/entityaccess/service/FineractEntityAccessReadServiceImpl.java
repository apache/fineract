...
public class FineractEntityAccessReadServiceImpl implements FineractEntityAccessReadService {
  ...
  @Autowired
  public FineractEntityAccessReadServiceImpl(
  ...
  public String getSQLQueryInClause_WithListOfIDsForEntityAccess(
    ...
    Collection<FineractEntityToEntityMappingData> accesslist =
        retrieveEntityAccessFor(firstEntityType, relId, fromEntityId, includeAllOffices);
  ...
  @Override
  public Collection<FineractEntityToEntityMappingData> retrieveEntityAccessFor(
      FineractEntityType firstEntityType,
      final Long relId,
      final Long fromEntityId,
    ...
    if (includeAllSubOffices && (firstEntityType.getTable().equals("m_office"))) {
      ...
      entityAccessData =
          this.jdbcTemplate.query(
              sql, mapper, new Object[] {fromEntityId, fromEntityId, hierarchySearchString});
    } else {
  ...
  private static final class FineractEntityAccessDataMapper
      implements RowMapper<FineractEntityAccessData> {

    @Override
    public FineractEntityAccessData mapRow(
      ...
      if (firstEntity != null && secondEntity != null && accessType != null) {
        returnFineractEntityAccessData =
            new FineractEntityAccessData(firstEntity, accessType, secondEntity);
      }
  ...
  public String getSQLQueryInClauseIDList_ForLoanProductsForOffice(
    ...
    return getSQLQueryInClause_WithListOfIDsForEntityAccess(
        firstEntityType, relId, officeId, includeAllOffices);
  }
  ...
  public String getSQLQueryInClauseIDList_ForSavingsProductsForOffice(
    ...
    FineractEntityRelation fineractEntityRelation =
        fineractEntityRelationRepository.findOneByCodeName(
            FineractEntityAccessType.OFFICE_ACCESS_TO_SAVINGS_PRODUCTS.toStr());
    Long relId = fineractEntityRelation.getId();
  ...
  public String getSQLQueryInClauseIDList_ForChargesForOffice(
    ...
    FineractEntityRelation fineractEntityRelation =
        fineractEntityRelationRepository.findOneByCodeName(
            FineractEntityAccessType.OFFICE_ACCESS_TO_CHARGES.toStr());
    Long relId = fineractEntityRelation.getId();
  ...
  public Collection<FineractEntityRelationData> retrieveAllSupportedMappingTypes() {
    ...
    final Collection<FineractEntityRelationData> mapTypes =
        this.jdbcTemplate.query(sql, entityMapper, new Object[] {});
    return mapTypes;
  }
  ...
  private static final class EntityRelationMapper implements RowMapper<FineractEntityRelationData> {
    ...
    private final StringBuilder sqlBuilder =
        new StringBuilder("select id as id,code_name as mapping_Types from m_entity_relation ");
    ...
    @Override
    public FineractEntityRelationData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
  ...
  @Override
  public Collection<FineractEntityToEntityMappingData> retrieveEntityToEntityMappings(
      Long mapId, Long fromId, Long toId) {

    EntityToEntityMapper entityToEntityMapper = new EntityToEntityMapper();
    String sql = entityToEntityMapper.schema();
    final Collection<FineractEntityToEntityMappingData> mapTypes =
        this.jdbcTemplate.query(
            sql, entityToEntityMapper, new Object[] {mapId, fromId, fromId, toId, toId});
    return mapTypes;
  }
  ...
  public Collection<FineractEntityToEntityMappingData> retrieveOneMapping(Long mapId) {
    ...
    final Collection<FineractEntityToEntityMappingData> mapTypes =
        this.jdbcTemplate.query(sql, entityMapper, new Object[] {mapId});
    return mapTypes;
  }

  private static final class GetOneEntityMapper
      implements RowMapper<FineractEntityToEntityMappingData> {
    ...
    public GetOneEntityMapper() {
      ...
      str.append(
          "eem.from_id as fromId,eem.to_Id as toId,eem.start_date as startDate,eem.end_date as"
              + " endDate ");
      str.append("from m_entity_to_entity_mapping eem ");
    ...
    @Override
    public FineractEntityToEntityMappingData mapRow(
        final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
      ...
      return FineractEntityToEntityMappingData.getRelatedEntities(
          relId, fromId, toId, startDate, endDate);
    }
  }

  private static final class EntityToEntityMapper
      implements RowMapper<FineractEntityToEntityMappingData> {
    ...
    public FineractEntityToEntityMappingData mapRow(
      ...
      final Date endDate = rs.getDate("endDate");
      return FineractEntityToEntityMappingData.getRelatedEntities(
          mapId, relId, fromId, toId, startDate, endDate, fromEntity, toEntity);
    }
  }
}
