...
public class CreditBureauMasterData {
  ...
  public static CreditBureauMasterData instance(
      final Long creditBureauId, final String creditBureauName, final String country) {
    return new CreditBureauMasterData(creditBureauId, creditBureauName, country);
  }

  private CreditBureauMasterData(
      final Long creditBureauId, final String creditBureauName, final String country) {
