...
@SwaggerDefinition(
    tags = {
      @Tag(
          name = "Documents",
          description =
              "Multiple Documents (a combination of a name, description and a file) may be"
                  + " attached to different Entities like Clients, Groups, Staff, Loans, Savings"
...
public class DocumentManagementApiResource {
  ...
  @Autowired
  public DocumentManagementApiResource(
      ...
      final ToApiJsonSerializer<DocumentData> toApiJsonSerializer) {
  ...
  public String retreiveAllDocuments(
    ...
    final Collection<DocumentData> documentDatas =
    ...
    return this.toApiJsonSerializer.serialize(
        settings, documentDatas, this.RESPONSE_DATA_PARAMETERS);
  }
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "Not Shown (multi-part form data)",
        response =
  ...
  @ApiOperation(
      value = "Retrieve Binary File associated with Document",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        message = "",
        response =
            DocumentManagementApiResourceSwagger.DeleteEntityTypeEntityIdDocumentsResponse.class)
  })
  public String deleteDocument(
    ...
    final DocumentCommand documentCommand =
        new DocumentCommand(
            null, documentId, entityType, entityId, null, null, null, null, null, null);

    final CommandProcessingResult documentIdentifier =
