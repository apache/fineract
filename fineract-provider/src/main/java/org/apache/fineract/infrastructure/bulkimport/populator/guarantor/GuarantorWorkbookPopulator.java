...
public class GuarantorWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  public GuarantorWorkbookPopulator(
      OfficeSheetPopulator officeSheetPopulator,
      ClientSheetPopulator clientSheetPopulator,
      List<LoanAccountData> loans,
      List<SavingsAccountData> savings,
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(
        GuarantorConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.CLIENT_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LOAN_ACCOUNT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.GUARANTO_TYPE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.CLIENT_RELATIONSHIP_TYPE_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.ENTITY_OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.ENTITY_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.FIRST_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LAST_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.ADDRESS_LINE_1_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.ADDRESS_LINE_2_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.CITY_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.DOB_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.ZIP_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.SAVINGS_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.AMOUNT, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LOOKUP_CLIENT_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LOOKUP_ACCOUNT_NO_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LOOKUP_SAVINGS_CLIENT_NAME_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    worksheet.setColumnWidth(
        GuarantorConstants.LOOKUP_SAVINGS_ACCOUNT_NO_COL,
        TemplatePopulateImportConstants.SMALL_COL_SIZE);
    ...
    writeString(
        GuarantorConstants.CLIENT_RELATIONSHIP_TYPE_COL, rowHeader, "Client Relationship type*");
    ...
    writeString(
        GuarantorConstants.LOOKUP_SAVINGS_CLIENT_NAME_COL, rowHeader, "Savings Lookup Client");
    writeString(
        GuarantorConstants.LOOKUP_SAVINGS_ACCOUNT_NO_COL, rowHeader, "Savings Lookup Account");
  }
  ...
  private void populateSavingsTable(Sheet addGuarantorSheet, String dateFormat) {
    ...
    for (SavingsAccountData savingsAccount : savings) {
      ...
      writeString(
          GuarantorConstants.LOOKUP_SAVINGS_ACCOUNT_NO_COL, row, savingsAccount.getAccountNo());
    }
  }
  ...
  private void populateLoansTable(Sheet addGuarantorSheet, String dateFormat) {
    ...
    for (LoanAccountData loan : loans) {
      ...
      writeString(
          GuarantorConstants.LOOKUP_CLIENT_NAME_COL,
          row,
          loan.getClientName() + "(" + loan.getClientId() + ")");
      writeString(
          GuarantorConstants.LOOKUP_ACCOUNT_NO_COL,
          row,
  ...
  private void populateGuarantorRelationshipTypes(Sheet addGuarantorSheet, String dateFormat) {
    ...
    for (CodeValueData relationshipType : guarantorRelationshipTypes) {
      ...
      writeString(
          GuarantorConstants.LOOKUP_GUARANTOR_RELATIONSHIPS,
          row,
          relationshipType.getName() + "-" + relationshipType.getId());
    }
  }
  ...
  private void setRules(Sheet worksheet) {
    ...
    CellRangeAddressList clientNameRange =
        new CellRangeAddressList(
            ...
            GuarantorConstants.CLIENT_NAME_COL);
    CellRangeAddressList entityofficeNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GuarantorConstants.ENTITY_OFFICE_NAME_COL,
            GuarantorConstants.ENTITY_OFFICE_NAME_COL);
    CellRangeAddressList entityclientNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    CellRangeAddressList accountNumberRange =
        new CellRangeAddressList(
            ...
            GuarantorConstants.LOAN_ACCOUNT_NO_COL);
    CellRangeAddressList savingsaccountNumberRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            GuarantorConstants.SAVINGS_ID_COL,
            GuarantorConstants.SAVINGS_ID_COL);
    CellRangeAddressList guranterTypeRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
    ...
    DataValidation savingsaccountNumberValidation =
        validationHelper.createValidation(
            savingsaccountNumberConstraint, savingsaccountNumberRange);
    DataValidation guranterTypeValidation =
        validationHelper.createValidation(guranterTypeConstraint, guranterTypeRange);
    DataValidation guarantorRelationshipValidation =
        validationHelper.createValidation(
            guarantorRelationshipConstraint, guranterRelationshipTypeRange);
    DataValidation entityofficeValidation =
        validationHelper.createValidation(entityofficeNameConstraint, entityofficeNameRange);
    DataValidation entityclientValidation =
        validationHelper.createValidation(entityclientNameConstraint, entityclientNameRange);
  ...
  private void setNames(Sheet worksheet) {
    ...
    guarantorRelationshipsGroup.setRefersToFormula(
    ...
    for (int j = 0; j < clientsWithActiveLoans.size(); j++) {
      ...
      name.setNameName(
          "Account_"
              + clientsWithActiveLoans.get(j).replaceAll(" ", "_")
              + "_"
    ...
    for (int j = 0; j < clientsWithActiveSavings.size(); j++) {
      ...
      name.setNameName(
          "SavingsAccount_"
              + clientsWithActiveSavings.get(j).replaceAll(" ", "_")
              + "_"
