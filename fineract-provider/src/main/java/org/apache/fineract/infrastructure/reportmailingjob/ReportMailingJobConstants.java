...
public class ReportMailingJobConstants implements Serializable {
  ...
  public static final String REPORT_MAILING_JOB_RUN_HISTORY_RESOURCE_NAME =
      ...
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList(
                  ...
                  STRETCHY_REPORT_PARAM_NAME,
                  STRETCHY_REPORT_PARAM_MAP_PARAM_NAME,
                  IS_ACTIVE_PARAM_NAME,
                  START_DATE_TIME_PARAM_NAME,
                  PREVIOUS_RUN_DATE_TIME_PARAM_NAME,
                  NEXT_RUN_DATE_TIME_PARAM_NAME,
                  PREVIOUS_RUN_STATUS,
