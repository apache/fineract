...
public class SharedProductsSheetPopulator extends AbstractWorkbookPopulator {
  ...
  public SharedProductsSheetPopulator(
      List<ShareProductData> shareProductDataList, List<ChargeData> chargesForShares) {
  ...
  private void populateSheet(Sheet sharedProductsSheet) {
    ...
    for (ShareProductData productData : sharedProductDataList) {
      ...
      if (chargesForSharedProducts != null) {
        ...
        productToBeginEndIndexesofCharges.put(
            productData.getId(), new Integer[] {startIndexCharges, endIndexCharges});
  ...
  private void setLayout(Sheet workSheet) {
    ...
    workSheet.setColumnWidth(
        CURRENCY_IN_MULTIPLES_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
