...
public class StaffWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  private void setRules(Sheet staffSheet, String dateFormat) {
    CellRangeAddressList officeNameRange =
        new CellRangeAddressList(
            ...
            StaffConstants.OFFICE_NAME_COL);
    CellRangeAddressList isLoanOfficerNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            StaffConstants.IS_LOAN_OFFICER,
            StaffConstants.IS_LOAN_OFFICER);
    CellRangeAddressList joinedOnNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            StaffConstants.JOINED_ON_COL,
            StaffConstants.JOINED_ON_COL);
    CellRangeAddressList isActiveNameRange =
        new CellRangeAddressList(
            1,
            SpreadsheetVersion.EXCEL97.getLastRowIndex(),
            StaffConstants.IS_ACTIVE_COL,
            StaffConstants.IS_ACTIVE_COL);
  ...
  private void setLayout(Sheet staffSheet) {
    ...
    staffSheet.setColumnWidth(
        StaffConstants.OFFICE_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.FIRST_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.LAST_NAME_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.IS_LOAN_OFFICER, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.MOBILE_NO_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.JOINED_ON_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.EXTERNAL_ID_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
    staffSheet.setColumnWidth(
        StaffConstants.IS_ACTIVE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
