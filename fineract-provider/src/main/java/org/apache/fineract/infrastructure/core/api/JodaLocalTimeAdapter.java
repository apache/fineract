...
/**
 * Serializer for Joda Time {@link LocalTime} that returns the date in array format to match previous Jackson
 * functionality.
 */
public class JodaLocalTimeAdapter implements JsonSerializer<LocalTime> {
