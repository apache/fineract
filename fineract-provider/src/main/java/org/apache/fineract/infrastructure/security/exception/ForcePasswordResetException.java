...
public class ForcePasswordResetException extends AbstractPlatformDomainRuleException {
  ...
  public ForcePasswordResetException() {
    super(
        ...
        "For enabling 'Force Password Reset Days' configuration , the value (number of days after"
            + " which a user is forced to reset his password) must be set to a number greater than"
            + " 0.");
  }
}
