...
public class UsersApiResource {
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.GetUsersResponse.class,
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.GetUsersUserIdResponse.class)
  })
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public String retrieveOne(
      @PathParam("userId") @ApiParam(value = "userId") final Long userId,
      @Context final UriInfo uriInfo) {

    this.context
        .authenticatedUser()
        .validateHasReadPermission(this.resourceNameForPermissions, userId);
  ...
  @Path("template")
  @ApiOperation(
      value = "Retrieve User Details Template",
      notes =
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.GetUsersTemplateResponse.class)
  })
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  ...
  @ApiOperation(
      ...
      notes =
          "Adds new application user.\n"
              + "\n"
              + "Note: Password information is not required (or processed). Password details at"
              + " present are auto-generated and then sent to the email account given (which is"
              + " why it can take a few seconds to complete).\n"
              + "\n"
              + "Mandatory Fields: \n"
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = UsersApiResourceSwagger.PostUsersRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.PostUsersResponse.class)
  })
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  ...
  @ApiOperation(
      value = "Update a User",
      notes = "When updating a password you must provide the repeatPassword parameter also.")
  @ApiImplicitParams({
    @ApiImplicitParam(
        value = "body",
        required = true,
        ...
        dataType = "body",
        format = "body",
        dataTypeClass = UsersApiResourceSwagger.PutUsersUserIdRequest.class)
  })
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.PutUsersUserIdResponse.class)
  })
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  ...
  @ApiOperation(
      value = "Delete a User",
      notes = "Removes the user and the associated roles and permissions.")
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "",
        response = UsersApiResourceSwagger.DeleteUsersUserIdResponse.class)
  })
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  ...
  public Response getUserTemplate(
  ...
  public String postUsersTemplate(
    ...
    final Long importDocumentId =
        this.bulkImportWorkbookService.importWorkbook(
            GlobalEntityType.USERS.toString(), uploadedInputStream, fileDetail, locale, dateFormat);
