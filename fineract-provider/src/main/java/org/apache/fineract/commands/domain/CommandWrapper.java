...
public class CommandWrapper {
  ...
  public static CommandWrapper wrap(
  ...
  public static CommandWrapper fromExistingCommand(
    ...
    return new CommandWrapper(
        commandId, actionName, entityName, resourceId, subresourceId, resourceGetUrl, productId);
  }
  ...
  public boolean isCreateDatatable() {
    return this.actionName.equalsIgnoreCase("CREATE")
        && this.href.startsWith("/datatables/")
        && this.entityId == null;
  }
  ...
  public boolean isUpdate() {
    ...
    return isPermissionResource() && isUpdateOperation()
        ...
        || isCacheResource() && isUpdateOperation()
        || isWorkingDaysResource() && isUpdateOperation()
        || isPasswordPreferencesResource() && isUpdateOperation()
