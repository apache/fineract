...
public class ClientHelper {
  ...
  public static Integer createClient(
      final RequestSpecification requestSpec, final ResponseSpecification responseSpec) {
  ...
  public static Integer createClientPending(
      final RequestSpecification requestSpec, final ResponseSpecification responseSpec) {
  ...
  public static Integer createClientPending(
      ...
      final String officeId) {
    LOG.info(
        "---------------------------------CREATING A CLIENT IN"
            + " PENDING---------------------------------------------");
    return Utils.performServerPost(
        requestSpec,
        responseSpec,
        CREATE_CLIENT_URL,
        getTestClientAsJSONPending(submittedOnDate, officeId),
        "clientId");
  }

  public Object createClientPendingWithError(final String jsonAttributeToGetBack) {
    LOG.info(
        "---------------------------------CREATING A CLIENT IN PENDING WITH"
            + " ERROR---------------------------------------------");
    return Utils.performServerPost(
        this.requestSpec,
        this.responseSpec,
  ...
  public static Integer createClientAsPerson(
      final RequestSpecification requestSpec, final ResponseSpecification responseSpec) {
  ...
  public static Integer createClientAsEntity(
      final RequestSpecification requestSpec, final ResponseSpecification responseSpec) {
  ...
  public static Integer createClientAsEntity(
    ...
    Integer constitutionCodeId =
        (Integer) CodeHelper.getCodeByName(requestSpec, responseSpec, "Constitution").get("id");
    Integer soleProprietorCodeValueId =
        (Integer)
            CodeHelper.retrieveOrCreateCodeValue(constitutionCodeId, requestSpec, responseSpec)
                .get("id");
    ...
    return Utils.performServerPost(
        ...
        responseSpec,
        CREATE_CLIENT_URL,
        getTestEntityClientAsJSON(activationDate, officeId, soleProprietorCodeValueId),
        "clientId");
  }

  public static Integer createClientForAccountPreference(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
    ...
    LOG.info(
        "---------------------------------CREATING A CLIENT BASED ON ACCOUNT"
            + " PREFERENCE---------------------------------------------");
    return Utils.performServerPost(
        requestSpec,
        responseSpec,
        CREATE_CLIENT_URL,
        getTestClientWithClientTypeAsJSON(activationDate, officeId, clientType.toString()),
        jsonAttributeToGetBack);
  }

  public static Object assignStaffToClient(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
    ...
    return Utils.performServerPost(
        requestSpec,
        responseSpec,
        CLIENT_ASSIGN_STAFF_URL,
        assignStaffToClientAsJson(staffId),
        "changes");
  }

  public static Integer getClientsStaffId(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String clientId) {
  ...
  public static String getTestClientAsJSONPending(
  ...
  public static String getTestDatatableAsJson(
      HashMap<String, Object> map, final String registeredTableName) {
  ...
  public static String getTestPersonClientAsJSON(
      final String dateOfJoining, final String officeId) {
    final HashMap<String, Object> map = new HashMap<>();
    map.put("officeId", officeId);
  ...
  public static String getTestEntityClientAsJSON(
      final String dateOfJoining, final String officeId, final Integer soleProprietorCodeValueId) {
    final HashMap<String, Object> map = new HashMap<>();
    map.put("officeId", officeId);
    map.put("fullname", Utils.randomNameGenerator("Client_FullName_", 5));
    map.put("externalId", randomIDGenerator("ID_", 7));
  ...
  public static String getTestClientWithClientTypeAsJSON(
      final String dateOfJoining, final String officeId, final String clientType) {
    final HashMap<String, String> map = new HashMap<>();
    map.put("officeId", officeId);
    map.put("firstname", Utils.randomNameGenerator("Client_FirstName_", 5));
    map.put("lastname", Utils.randomNameGenerator("Client_LastName_", 4));
  ...
  public static void verifyClientCreatedOnServer(
    ...
    final String CLIENT_URL =
        "/fineract-provider/api/v1/clients/" + generatedClientID + "?" + Utils.TENANT_IDENTIFIER;
    final Integer responseClientID =
        Utils.performServerGet(requestSpec, responseSpec, CLIENT_URL, "id");
  ...
  public static HashMap<String, Object> getClientStatus(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String clientId) {
  ...
  private String getCloseClientAsJSON() {
    ...
    HashMap<String, Object> code =
        CodeHelper.getCodeByName(this.requestSpec, this.responseSpec, codeName);
    Integer clientClosureCodeId = (Integer) code.get("id");

    /* Retrieve/Create Code Values for the Code "ClientClosureReason" */
    HashMap<String, Object> codeValue =
        CodeHelper.retrieveOrCreateCodeValue(
            clientClosureCodeId, this.requestSpec, this.responseSpec);
  ...
  private String getRejectClientAsJSON() {
    ...
    HashMap<String, Object> codeValue =
        CodeHelper.retrieveOrCreateCodeValue(
            clientRejectionReasonCodeId, this.requestSpec, this.responseSpec);
  ...
  private String getWithdrawClientAsJSON() {
    ...
    HashMap<String, Object> codeValue =
        CodeHelper.retrieveOrCreateCodeValue(
            clientWithdrawReasonCodeId, this.requestSpec, this.responseSpec);
  ...
  public static String getSpecifiedDueDateChargesClientAsJSON(
      final String chargeId, final String dueDate) {
    final HashMap<String, String> map = new HashMap<>();
  ...
  public HashMap<String, Object> closeClient(final Integer clientId) {
    ...
    return performClientActions(
        createClientOperationURL(CLOSE_CLIENT_COMMAND, clientId), getCloseClientAsJSON(), clientId);
  }

  public HashMap<String, Object> reactivateClient(final Integer clientId) {
    LOG.info("--------------------------------- REACTIVATE CLIENT -------------------------------");
    return performClientActions(
        createClientOperationURL(REACTIVATE_CLIENT_COMMAND, clientId),
        getReactivateClientAsJSON(),
        clientId);
  }
  ...
  public HashMap<String, Object> rejectClient(final Integer clientId) {
    ...
    return performClientActions(
        createClientOperationURL(REJECT_CLIENT_COMMAND, clientId),
        getRejectClientAsJSON(),
        clientId);
  }
  ...
  public HashMap<String, Object> activateClient(final Integer clientId) {
    ...
    return performClientActions(
        createClientOperationURL(ACTIVATE_CLIENT_COMMAND, clientId),
  ...
  public HashMap<String, Object> withdrawClient(final Integer clientId) {
    ...
    return performClientActions(
        createClientOperationURL(WITHDRAW_CLIENT_COMMAND, clientId),
        getWithdrawClientAsJSON(),
        clientId);
  }
  ...
  public HashMap<String, Object> undoReject(final Integer clientId) {
    LOG.info(
        "--------------------------------- UNDO REJECT CLIENT -------------------------------");
    return performClientActions(
        createClientOperationURL(UNDOREJECT_CLIENT_COMMAND, clientId),
        getUndoRejectClientAsJSON(CREATED_DATE_PLUS_TWO),
        clientId);
  }

  public HashMap<String, Object> undoWithdrawn(final Integer clientId) {
    LOG.info(
        "--------------------------------- UNDO WITHDRAWN CLIENT -------------------------------");
    return performClientActions(
        createClientOperationURL(UNDOWITHDRAWN_CLIENT_COMMAND, clientId),
        getUndoWithdrawnClientAsJSON(CREATED_DATE_PLUS_TWO),
        clientId);
  }

  public ArrayList<HashMap<String, Object>> undoRejectedclient(
      final Integer clientId, final String jsonAttributeToGetBack, final String rejectedDate) {
    LOG.info(
        "----------------------------------UNDO REJECT CLIENT ----------------------------------");
  ...
  public ArrayList<HashMap<String, Object>> undoWithdrawclient(
      final Integer clientId, final String jsonAttributeToGetBack, final String rejectedDate) {
    LOG.info(
        "----------------------------------UNDO WITHDRAW CLIENT"
            + " ----------------------------------");
    return performClientActionsWithValidationErrors(
        createClientOperationURL(UNDOWITHDRAWN_CLIENT_COMMAND, clientId),
  ...
  public ArrayList<HashMap<String, Object>> activateClient(
      final Integer clientId, final String jsonAttributeToGetBack) {
    LOG.info("--------------------------------- ACTIVATE CLIENT -------------------------------");
    return performClientActionsWithValidationErrors(
        createClientOperationURL(ACTIVATE_CLIENT_COMMAND, clientId),
        getActivateClientAsJSON(CREATED_DATE_PLUS_ONE),
  ...
  public HashMap<String, Object> activateClientWithDiffDateOption(
      final Integer clientId, final String activationDate) {
    LOG.info("--------------------------------- ACTIVATE CLIENT -------------------------------");
    return performClientActions(
        createClientOperationURL(ACTIVATE_CLIENT_COMMAND, clientId),
        getActivateClientAsJSON(activationDate),
        clientId);
  }

  private ArrayList<HashMap<String, Object>> performClientActionsWithValidationErrors(
      final String postURLForClient,
  ...
  private HashMap<String, Object> performClientActions(
      final String postURLForClient, final String jsonToBeSent, final Integer clientId) {
    Utils.performServerPost(
        this.requestSpec,
        this.responseSpec,
        postURLForClient,
        jsonToBeSent,
        CommonConstants.RESPONSE_STATUS);
  ...
  public static Integer addChargesForClient(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer clientId,
      final String request) {
    LOG.info(
        "--------------------------------- ADD CHARGES FOR Client"
            + " --------------------------------");
    final String ADD_CHARGES_URL =
        "/fineract-provider/api/v1/clients/" + clientId + "/charges?" + Utils.TENANT_IDENTIFIER;
  ...
  public static String payChargesForClients(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer clientId,
  ...
  public static String waiveChargesForClients(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer clientId,
      final Integer clientChargeId,
  ...
  public static Integer revertClientChargeTransaction(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String clientId,
    ...
    final HashMap<?, ?> response =
        Utils.performServerPost(requestSpec, responseSpec, CHARGES_URL, "", "");
    return (Integer) response.get("resourceId");
  }

  public static Object getClientCharge(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String clientId,
      final String clientChargeId) {
    LOG.info(
        "---------------------------------GET CLIENT"
            + " CHARGE---------------------------------------------");
    final String CHARGES_URL =
  ...
  public static Boolean getClientTransactions(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String clientId,
  ...
  public Workbook getClientEntityWorkbook(GlobalEntityType clientsEntity, String dateFormat)
      throws IOException {
