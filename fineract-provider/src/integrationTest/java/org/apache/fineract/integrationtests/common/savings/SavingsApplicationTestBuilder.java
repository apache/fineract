...
public class SavingsApplicationTestBuilder {
  ...
  public SavingsApplicationTestBuilder withSubmittedOnDate(
      final String savingsApplicationSubmittedDate) {
  ...
  public SavingsApplicationTestBuilder withWithdrawalFeeForTransfers(
  ...
  public SavingsApplicationTestBuilder withDatatables(
      final List<HashMap<String, Object>> datatables) {
    this.datatables = datatables;
    return this;
  }

  public SavingsApplicationTestBuilder withClientArray(
      final List<Map<String, Object>> clientArray) {
    this.clientArray = new ArrayList<>();
    this.clientArray.addAll(clientArray);
    return this;
  }

  public SavingsApplicationTestBuilder withSavingsArray(
      final List<Map<String, Object>> savingsArray) {
