...
public class ShareProductHelper {
  ...
  public void verifyShareProduct(Map<String, Object> shareProductData) {
    ...
    String allowDividendCalculationForInactiveClients =
        String.valueOf(shareProductData.get("allowDividendCalculationForInactiveClients"));
    Assert.assertEquals(
        this.allowDividendCalculationForInactiveClients,
        allowDividendCalculationForInactiveClients);

    Map<String, Object> accountingRuleMap =
        (Map<String, Object>) shareProductData.get("accountingRule");
    ...
    String minimumActivePeriodForDividends =
        String.valueOf(shareProductData.get("minimumActivePeriod"));
    Assert.assertEquals(this.minimumActivePeriodForDividends, minimumActivePeriodForDividends);

    Map<String, Object> minimumActivePeriodType =
        (Map<String, Object>) shareProductData.get("minimumActivePeriodForDividendsTypeEnum");
    ...
    Map<String, Object> lockinPeriodType =
        (Map<String, Object>) shareProductData.get("lockPeriodTypeEnum");
