...
public class LoanApplicationTestBuilder {
  ...
  private String build(
      final HashMap<String, Object> map, final String loanProductId, final String savingsID) {
  ...
  public LoanApplicationTestBuilder withExpectedDisbursementDate(
  ...
  public LoanApplicationTestBuilder withwithRepaymentStrategy(
      final String transactionProcessingStrategy) {
  ...
  public LoanApplicationTestBuilder withApprovalFormData(
