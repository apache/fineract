...
public class HookHelper {
  ...
  private static final String CREATE_HOOK_URL =
      "/fineract-provider/api/v1/hooks?" + Utils.TENANT_IDENTIFIER;
  ...
  public Integer createHook(final String payloadURL) {
    ...
    return Utils.performServerPost(
        requestSpec, responseSpec, CREATE_HOOK_URL, getTestHookAsJson(payloadURL), "resourceId");
  }
  ...
  public Integer updateHook(final String payloadURL, final Long hookId) {
    LOG.info(
        "---------------------------------UPDATING"
            + " HOOK---------------------------------------------");
    final String UPDATE_HOOK_URL =
        "/fineract-provider/api/v1/hooks/" + hookId + "?" + Utils.TENANT_IDENTIFIER;
    return Utils.performServerPut(
        this.requestSpec,
        this.responseSpec,
        UPDATE_HOOK_URL,
        getTestHookAsJson(payloadURL),
        "resourceId");
  }
  ...
  public Integer deleteHook(final Long hookId) {
    LOG.info(
        "---------------------------------DELETING"
            + " HOOK---------------------------------------------");
    final String DELETE_HOOK_URL =
        "/fineract-provider/api/v1/hooks/" + hookId + "?" + Utils.TENANT_IDENTIFIER;
    return Utils.performServerDelete(
        this.requestSpec, this.responseSpec, DELETE_HOOK_URL, "resourceId");
  }
  ...
  public void verifyHookCreatedOnServer(final Long hookId) {
    ...
    final String GET_URL =
        "/fineract-provider/api/v1/hooks/" + hookId + "?" + Utils.TENANT_IDENTIFIER;
    final Integer responseHookId =
        Utils.performServerGet(this.requestSpec, this.responseSpec, GET_URL, "id");
  ...
  public void verifyUpdateHook(final String updateURL, final Long hookId) {
    ...
    ArrayList<HashMap<String, String>> map =
        Utils.<ArrayList<HashMap<String, String>>>performServerGet(
            this.requestSpec, this.responseSpec, GET_URL, "config");
  ...
  public void verifyDeleteHook(final Long hookId) {
    ...
    ArrayList<HashMap<String, String>> array =
        Utils.<ArrayList<HashMap<String, String>>>performServerGet(
            this.requestSpec, responseSpec404, GET_URL, "errors");
