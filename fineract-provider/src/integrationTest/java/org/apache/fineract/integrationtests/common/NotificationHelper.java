...
public class NotificationHelper {
	...
	private final ResponseSpecification reponseSpec;
	
	private static final String NOTIFICATION_API_URL = "/fineract-provider/api/v1/notifications?" + Utils.TENANT_IDENTIFIER;

	public NotificationHelper(RequestSpecification requestSpec, ResponseSpecification reponseSpec) {
		this.requestSpec = requestSpec;
		this.reponseSpec = reponseSpec;
	}
