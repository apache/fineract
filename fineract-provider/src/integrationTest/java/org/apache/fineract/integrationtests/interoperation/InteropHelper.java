...
public class InteropHelper {
  ...
  public String getQuote(String quoteCode) {
    String url =
        buildUrl(
            TRANSACTIONS_URL + '/' + transactionCode + '/' + QUOTES_URL_PARAM + '/' + quoteCode);
  ...
  public String prepareTransfer(String transferCode) {
    return postTransfer(
        transferCode, InteropTransferActionType.PREPARE, InteropTransactionRole.PAYER);
  }
  ...
  public String postTransfer(
      String transferCode, InteropTransferActionType action, InteropTransactionRole role) {
