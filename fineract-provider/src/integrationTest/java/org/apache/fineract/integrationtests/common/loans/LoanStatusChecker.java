...
public class LoanStatusChecker {
  ...
  public static HashMap<String, Object> getStatusOfLoan(
  ...
  public static HashMap<String, Object> getSubStatusOfLoan(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer loanID) {
    final String url = "/fineract-provider/api/v1/loans/" + loanID + "?" + Utils.TENANT_IDENTIFIER;
  ...
  private static boolean getStatus(
      final HashMap loanStatusMap, final String nameOfLoanStatusString) {
    return (Boolean) loanStatusMap.get(nameOfLoanStatusString);
  }

  private static String getSubStatus(
      final HashMap loanStatusMap, final String nameOfLoanStatusString) {
