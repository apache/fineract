...
public class OfficeImportHandlerTest {
    ...
    public void testOfficeImport() throws IOException, InterruptedException, NoSuchFieldException, ParseException {
        ...
        Sheet sheet=workbook.getSheet(OfficeConstants.OFFICE_WORKBOOK_SHEET_NAME);
        ...
        Sheet officeSheet = outputWorkbook.getSheet(OfficeConstants.OFFICE_WORKBOOK_SHEET_NAME);
