...
public class SavingsAccountHelper {
  ...
  public Integer applyForSavingsApplication(
      final Integer ID, final Integer savingsProductID, final String accountType) {
    return applyForSavingsApplicationOnDate(ID, savingsProductID, accountType, CREATED_DATE);
  }

  public Integer applyForSavingsApplicationOnDate(
      final Integer ID,
      final Integer savingsProductID,
      final String accountType,
      final String submittedOnDate) {
    return applyForSavingsApplicationOnDate(
        ID, savingsProductID, accountType, null, false, submittedOnDate);
  }

  public Integer applyForSavingsApplicationWithExternalId(
      final Integer ID,
      final Integer savingsProductID,
      final String accountType,
      String externalId,
    ...
    return applyForSavingsApplicationOnDate(
        ID, savingsProductID, accountType, externalId, withdrawalFeeForTransfers, CREATED_DATE);
  }
  ...
  public Integer applyForSavingsApplicationOnDate(
    ...
    LOG.info(
        "--------------------------------APPLYING FOR SAVINGS"
            + " APPLICATION--------------------------------");
    final String savingsApplicationJSON =
        new SavingsApplicationTestBuilder() //
  ...
  public Integer applyForSavingsApplicationWithDatatables(
      final Integer ID,
      final Integer savingsProductID,
      final String accountType,
      final String submittedOnDate,
    ...
    LOG.info(
        "----------------------------APPLYING FOR SAVINGS APPLICATION WITH"
            + " DATATABLES----------------------------");
    final String savingsApplicationJSON =
        new SavingsApplicationTestBuilder() //
            .withSubmittedOnDate(submittedOnDate) //
  ...
  public Object applyForSavingsApplicationWithFailure(
      final Integer ID,
      final Integer savingsProductID,
      final String accountType,
      final String submittedOnDate,
  ...
  public HashMap updateSavingsAccount(
      final Integer ID,
      final Integer savingsProductID,
    ...
    return Utils.performServerPut(
        this.requestSpec,
        this.responseSpec,
        SAVINGS_ACCOUNT_URL + "/" + savingsId + "?" + Utils.TENANT_IDENTIFIER,
        savingsApplicationJSON,
  ...
  public static Integer applyForGsimApplication(
      final String clientArrays,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
    return Utils.performServerPost(
        requestSpec,
        responseSpec,
        SAVINGS_ACCOUNT_URL + GSIM_SAVINGS + "?" + Utils.TENANT_IDENTIFIER,
        clientArrays,
        "gsimId");
  }

  public HashMap updateSavingsAccountWithHoldTaxStatus(
      final Integer savingsId, final boolean value) {
  ...
  public HashMap approveSavingsOnDate(final Integer savingsID, final String approvalDate) {
    LOG.info(
        "--------------------------------- APPROVING SAVINGS APPLICATION"
            + " ------------------------------------");
    final String savingsOperationURL =
        createSavingsOperationURL(APPROVE_SAVINGS_COMMAND, savingsID);
    if (approvalDate == null || approvalDate.equals(""))
      return performSavingApplicationActions(
          savingsOperationURL, getApproveSavingsAsJSON(), isBlock);
    return performSavingApplicationActions(
        savingsOperationURL, getApproveSavingsAsJsonOnDate(approvalDate), isBlock);
  }
  ...
  public HashMap undoApproval(final Integer savingsID) {
    ...
    return performSavingApplicationActions(
        createSavingsOperationURL(UNDO_APPROVAL_SAVINGS_COMMAND, savingsID), undoBodyJson, isBlock);
  }
  ...
  public HashMap rejectApplication(final Integer savingsID) {
    LOG.info(
        "--------------------------------- REJECT SAVINGS APPLICATION"
            + " -------------------------------");
    return performSavingApplicationActions(
        createSavingsOperationURL(REJECT_SAVINGS_COMMAND, savingsID),
  ...
  public List rejectApplicationWithErrorCode(final Integer savingsId, final String date) {
    LOG.info(
        "--------------------------------- REJECT SAVINGS APPLICATION"
            + " -------------------------------");
    return (List)
        performSavingActions(
            createSavingsOperationURL(REJECT_SAVINGS_COMMAND, savingsId),
            getRejectedSavingsAsJSON(date),
  ...
  public HashMap withdrawApplication(final Integer savingsID) {
    LOG.info(
        "--------------------------------- Withdraw SAVINGS APPLICATION"
            + " -------------------------------");
    return performSavingApplicationActions(
        createSavingsOperationURL(WITHDRAWN_BY_CLIENT_SAVINGS_COMMAND, savingsID),
  ...
  public HashMap activateSavings(final Integer savingsID) {
    LOG.info(
        "---------------------------------- ACTIVATING SAVINGS APPLICATION"
            + " ----------------------------------");
    return performSavingApplicationActions(
        createSavingsOperationURL(ACTIVATE_SAVINGS_COMMAND, savingsID),
  ...
  public HashMap closeSavingsAccount(final Integer savingsID, String withdrawBalance) {
    LOG.info(
        "---------------------------------- CLOSE SAVINGS APPLICATION"
            + " ----------------------------------");
    return performSavingApplicationActions(
        createSavingsOperationURL(CLOSE_SAVINGS_COMMAND, savingsID),
        getCloseAccountJSON(withdrawBalance, LAST_TRANSACTION_DATE),
        isBlock);
  }

  public Object deleteSavingsApplication(
      final Integer savingsId, final String jsonAttributeToGetBack) {
    LOG.info(
  ...
  public Object depositToSavingsAccount(
      final Integer savingsID, final String amount, String date, String jsonAttributeToGetback) {
    LOG.info(
        "--------------------------------- SAVINGS TRANSACTION DEPOSIT"
            + " --------------------------------");
    return performSavingActions(
        createSavingsTransactionURL(DEPOSIT_SAVINGS_COMMAND, savingsID),
        getSavingsTransactionJSON(amount, date),
        jsonAttributeToGetback);
  }

  public Object withdrawalFromSavingsAccount(
      final Integer savingsId, final String amount, String date, String jsonAttributeToGetback) {
    LOG.info(
        "\n"
            ...
            + " --------------------------------");
    return performSavingActions(
        createSavingsTransactionURL(WITHDRAW_SAVINGS_COMMAND, savingsId),
        getSavingsTransactionJSON(amount, date),
        jsonAttributeToGetback);
  }

  public Integer updateSavingsAccountTransaction(
      final Integer savingsId, final Integer transactionId, final String amount) {
    LOG.info(
        "\n"
    ...
    return (Integer)
        performSavingActions(
            createAdjustTransactionURL(MODIFY_TRASACTION_COMMAND, savingsId, transactionId),
            getSavingsTransactionJSON(amount, LAST_TRANSACTION_DATE),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }

  public Integer undoSavingsAccountTransaction(
      final Integer savingsId, final Integer transactionId) {
    LOG.info(
        "\n"
    ...
    return (Integer)
        performSavingActions(
            createAdjustTransactionURL(UNDO_TRASACTION_COMMAND, savingsId, transactionId),
  ...
  public void calculateInterestForSavings(final Integer savingsId) {
    LOG.info(
        "--------------------------------- CALCULATING INTEREST FOR SAVINGS"
            + " --------------------------------");
    performSavingActions(
        createSavingsCalculateInterestURL(CALCULATE_INTEREST_SAVINGS_COMMAND, savingsId),
  ...
  public void postInterestForSavings(final Integer savingsId) {
    LOG.info(
        "--------------------------------- POST INTEREST FOR SAVINGS"
            + " --------------------------------");
    performSavingActions(
        createSavingsCalculateInterestURL(POST_INTEREST_SAVINGS_COMMAND, savingsId),
        getCalculatedInterestForSavingsApplicationAsJSON(),
        "");
  }
  ...
  public void postInterestAsOnSavings(final Integer savingsId, final String today) {
    LOG.info(
        "--------------------------------- POST INTEREST AS ON FOR SAVINGS"
            + " --------------------------------");
    performSavingActions(
        createSavingsPostInterestAsOnURL(POST_INTEREST_AS_ON_SAVINGS_COMMAND, savingsId),
        getCalculatedInterestForSavingsApplicationAsJSON(today),
        CommonConstants.RESPONSE_RESOURCE_ID);
  }

  public Integer addChargesForSavings(
      final Integer savingsId, final Integer chargeId, boolean addDueDate) {
    return addChargesForSavings(savingsId, chargeId, addDueDate, BigDecimal.valueOf(100));
  }

  public Integer addChargesForSavings(
      final Integer savingsId, final Integer chargeId, boolean addDueDate, BigDecimal amount) {
    LOG.info(
        "--------------------------------- ADD CHARGES FOR SAVINGS"
            + " --------------------------------");
    return (Integer)
        performSavingActions(
            SAVINGS_ACCOUNT_URL + "/" + savingsId + "/charges?" + Utils.TENANT_IDENTIFIER,
            getPeriodChargeRequestJSON(chargeId, addDueDate, amount),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }

  public Integer addChargesForSavingsWithDueDate(
      final Integer savingsId, final Integer chargeId, String addDueDate, Integer amount) {
    return (Integer)
        performSavingActions(
            SAVINGS_ACCOUNT_URL + "/" + savingsId + "/charges?" + Utils.TENANT_IDENTIFIER,
            getPeriodChargeRequestJSONWithDueDate(chargeId, addDueDate, amount),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }

  public Integer payCharge(
      final Integer chargeId, final Integer savingsId, String amount, String dueDate) {
    return (Integer)
        performSavingActions(
            createChargesURL("paycharge", savingsId, chargeId),
            getSavingsPayChargeJSON(amount, dueDate),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }
  ...
  public Integer waiveCharge(final Integer chargeId, final Integer savingsId) {
    return (Integer)
        performSavingActions(
            createChargesURL("waive", savingsId, chargeId),
            getSavingsWaiveChargeJSON(),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }
  ...
  public HashMap blockSavings(final Integer savingsID) {
    LOG.info(
        "---------------------------------- BLOCKING SAVINGS ACCOUNT"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(BLOCK_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap unblockSavings(final Integer savingsID) {
    LOG.info(
        "---------------------------------- UNBLOCKING SAVINGS ACCOUNT"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(UNBLOCK_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap blockDebit(final Integer savingsID) {
    LOG.info(
        "---------------------------------- BLOCKING DEBIT TRANSACTIONS"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(BLOCK_DEBITS_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap unblockDebit(final Integer savingsID) {
    LOG.info(
        "---------------------------------- UNBLOCKING DEBIT TRANSACTIONS"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(UNBLOCK_DEBITS_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap blockCredit(final Integer savingsID) {
    LOG.info(
        "---------------------------------- BLOCKING CREDIT TRANSACTIONS"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(BLOCK_CREDITS_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap unblockCredit(final Integer savingsID) {
    LOG.info(
        "---------------------------------- UNBLOCKING CREDIT TRANSACTIONS"
            + " ----------------------------------");
    Boolean isBlock = true;
    return performSavingApplicationActions(
        createSavingsOperationURL(UNBLOCK_CREDITS_SAVINGS_COMMAND, savingsID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }

  public Object holdAmountInSavingsAccount(
      final Integer savingsID, final String amount, String date, String jsonAttributeToGetback) {
    LOG.info(
        "--------------------------------- SAVINGS TRANSACTION HOLD"
            + " AMOUNT--------------------------------");
    return performSavingActions(
        createSavingsTransactionURL(HOLD_AMOUNT_SAVINGS_COMMAND, savingsID),
        getSavingsTransactionJSON(amount, date),
        jsonAttributeToGetback);
  }
  ...
  public Integer releaseAmount(final Integer savingsId, final Integer transactionId) {
    LOG.info(
        "\n"
            + "--------------------------------- SAVINGS TRANSACTION RELEASE"
            + " AMOUNT--------------------------------");
    return (Integer)
        performSavingActions(
            createAdjustTransactionURL(RELEASE_AMOUNT_SAVINGS_COMMAND, savingsId, transactionId),
            getSavingsTransactionJSON("1000", LAST_TRANSACTION_DATE),
            CommonConstants.RESPONSE_RESOURCE_ID);
  }
  ...
  private String createAdjustTransactionURL(
      final String command, final Integer savingsID, final Integer transactionId) {
    return SAVINGS_ACCOUNT_URL
        + "/"
        + savingsID
        + "/transactions/"
  ...
  private String createChargesURL(
      final String command, final Integer savingsID, final Integer chargeId) {
    return SAVINGS_ACCOUNT_URL
        + "/"
        + savingsID
        + "/charges/"
  ...
  public ArrayList getSavingsCollectionAttribute(
      final Integer savingsID, final String jSONAttribute) {
    final String URL =
        SAVINGS_ACCOUNT_URL + "/" + savingsID + "?associations=all&" + Utils.TENANT_IDENTIFIER;
    final ArrayList<HashMap> response =
        Utils.performServerGet(requestSpec, responseSpec, URL, jSONAttribute);
    return response;
  }
  ...
  public HashMap getSavingsTransaction(
      final Integer savingsID, final Integer savingsTransactionId) {
    final String URL =
        SAVINGS_ACCOUNT_URL
            + "/"
            + savingsID
  ...
  public Object getSavingsInterest(final Integer savingsID) {
    final String URL =
        SAVINGS_ACCOUNT_URL + "/" + savingsID + "?associations=summary&" + Utils.TENANT_IDENTIFIER;
  ...
  private HashMap performSavingApplicationActions(
      final String postURLForSavingsTransaction, final String jsonToBeSent, final Boolean isBlock) {
    HashMap status = null;
    final HashMap response =
        Utils.performServerPost(
            this.requestSpec,
            this.responseSpec,
            postURLForSavingsTransaction,
            jsonToBeSent,
            CommonConstants.RESPONSE_CHANGES);
    if (response != null) {
  ...
  private Object performSavingActions(
      final String postURLForSavingsTransaction,
  ...
  public Object closeSavingsAccountAndGetBackRequiredField(
      final Integer savingsID,
    ...
    return performSavingActions(
        createSavingsOperationURL(CLOSE_SAVINGS_COMMAND, savingsID),
        getCloseAccountJSON(withdrawBalance, closedOnDate),
        jsonAttributeToGetBack);
  }

  public Object closeSavingsAccountPostInterestAndGetBackRequiredField(
      final Integer savingsID,
      String withdrawBalance,
      final String jsonAttributeToGetBack,
      final String closedOnDate) {
    ...
    return performSavingActions(
        createSavingsOperationURL(CLOSE_SAVINGS_COMMAND, savingsID),
        getCloseAccountPostInterestJSON(withdrawBalance, closedOnDate),
        jsonAttributeToGetBack);
  }

  private String getPeriodChargeRequestJSON(
      Integer chargeId, boolean addDueDate, BigDecimal amount) {
    final HashMap<String, Object> map = new HashMap<>();
  ...
  private String getPeriodChargeRequestJSONWithDueDate(
      Integer chargeId, String addDueDate, Integer amount) {
    final HashMap<String, Object> map = new HashMap<>();
    map.put("chargeId", chargeId);
    map.put("amount", amount);
    map.put("locale", CommonConstants.locale);
  ...
  public Object inactivateCharge(
      final Integer chargeId, final Integer savingsId, final String jsonAttributeToGetBack) {
    return performSavingActions(
        createChargesURL("inactivate", savingsId, chargeId),
        getSavingsInactivateChargeJSON(),
        jsonAttributeToGetBack);
  }
  ...
  public static Integer openSavingsAccount(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer clientId,
      final String minimumOpeningBalance) {
    final Integer savingsProductID =
        createSavingsProduct(requestSpec, responseSpec, minimumOpeningBalance);
    Assert.assertNotNull(savingsProductID);

    SavingsAccountHelper savingsAccountHelper = new SavingsAccountHelper(requestSpec, responseSpec);

    final Integer savingsId =
        savingsAccountHelper.applyForSavingsApplication(
  ...
  private static Integer createSavingsProduct(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
  ...
  public static List<HashMap<String, Object>> getTestDatatableAsJson(
  ...
  public Workbook getSavingsWorkbook(String dateFormat) throws IOException {
    ...
    byte[] byteArray =
        Utils.performGetBinaryResponse(
            requestSpec,
            responseSpec,
            SAVINGS_ACCOUNT_URL
                + "/downloadtemplate"
  ...
  public String importSavingsTemplate(File file) {
    ...
    return Utils.performServerTemplatePost(
        requestSpec,
        responseSpec,
        SAVINGS_ACCOUNT_URL + "/uploadtemplate" + "?" + Utils.TENANT_IDENTIFIER,
        legalFormType,
        file,
        locale,
        dateFormat);
  ...
  public String getOutputTemplateLocation(final String importDocumentId) {
    ...
    return Utils.performServerOutputTemplateLocationGet(
        requestSpec,
        responseSpec,
  ...
  public HashMap approveGsimSavingsOnDate(final Integer gsimID, final String approvalDate) {
    LOG.info(
        "--------------------------------- APPROVING GSIM SAVINGS APPLICATION"
            + " ------------------------------------");
    final String savingsOperationURL =
        createSavingsGsimOperationURL(APPROVE_SAVINGS_COMMAND, gsimID);
  ...
  public HashMap rejectGsimApplication(final Integer gsimID) {
    LOG.info(
        "--------------------------------- REJECT SAVINGS APPLICATION"
            + " -------------------------------");
    return performSavingApplicationActions(
        createSavingsGsimOperationURL(REJECT_SAVINGS_COMMAND, gsimID),
        getRejectedSavingsAsJSON(CREATED_DATE_PLUS_ONE),
        isBlock);
  }
  ...
  public HashMap undoApprovalGsimSavings(final Integer gsimId) {
    LOG.info(
        "--------------------------------- UNDO APPROVING GSIM SAVINGS APPLICATION"
            + " -------------------------------");
    final String undoBodyJson = "{'note':'UNDO APPROVAL'}";
    return performSavingApplicationActions(
        createSavingsGsimOperationURL(UNDO_APPROVAL_SAVINGS_COMMAND, gsimId),
        undoBodyJson,
        isBlock);
  }
  ...
  public Integer depositGsimApplication(Integer savingsID, List<Map<String, Object>> savingsArray) {
    LOG.info(
        "--------------------------------- DEPOSIT GSIM SAVINGS APPLICATION"
            + " -------------------------------");
    String savingsArrays =
        new SavingsApplicationTestBuilder() //
            .withSavingsArray(savingsArray)
            .build();
    LOG.info("savingsArray : {} ", savingsArrays);
    return SavingsAccountHelper.depositGsimApplication(
        savingsID, savingsArrays, requestSpec, responseSpec);
  }

  public static Integer depositGsimApplication(
      Integer savingsID,
      final String savingsArrays,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {

    final String depositGsimURL =
        SAVINGS_ACCOUNT_URL
            + "/"
            + savingsID
            + "/transactions"
  ...
  public HashMap activateGsimSavings(final Integer gsimID) {
    LOG.info(
        "---------------------------------- ACTIVATING GSIM SAVINGS APPLICATION"
            + " ----------------------------------");
    return performSavingApplicationActions(
        createSavingsGsimOperationURL(ACTIVATE_SAVINGS_COMMAND, gsimID),
        getActivatedSavingsAsJSON(),
        isBlock);
  }
  ...
  public HashMap closeGsimSavingsAccount(final Integer gsimID, String withdrawBalance) {
    LOG.info(
        "---------------------------------- CLOSE SAVINGS APPLICATION"
            + " ----------------------------------");
    return performSavingApplicationActions(
        createSavingsGsimOperationURL(CLOSE_SAVINGS_COMMAND, gsimID),
        getCloseAccountJSON(withdrawBalance, LAST_TRANSACTION_DATE),
        isBlock);
  }

  public Object closeGsimSavingsAccountAndGetBackRequiredField(
  ...
  public HashMap updateGsimApplication(
      final Integer gsimID,
      final Integer clientID,
      final Integer groupID,
      final Integer productID) {
    LOG.info(
        "--------------------------------- UPDATE GSIM SAVINGS APPLICATION"
            + " -------------------------------");
    final String GSIM_URL =
        "/fineract-provider/api/v1/savingsaccounts/gsim/" + gsimID + "?" + Utils.TENANT_IDENTIFIER;
    return Utils.performServerPut(
        requestSpec,
        responseSpec,
        GSIM_URL,
