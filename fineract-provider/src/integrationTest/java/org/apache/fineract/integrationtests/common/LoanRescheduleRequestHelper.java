...
public class LoanRescheduleRequestHelper {
  ...
  private static final String LOAN_RESCHEDULE_REQUEST_URL =
      "/fineract-provider/api/v1/rescheduleloans";

  public LoanRescheduleRequestHelper(
  ...
  public Integer createLoanRescheduleRequest(final String requestJSON) {
    ...
    return Utils.performServerPost(
        this.requestSpec, this.responseSpec, URL, requestJSON, "resourceId");
  }
  ...
  public Object getLoanRescheduleRequest(final Integer requestId, final String param) {
    final String URL =
        LOAN_RESCHEDULE_REQUEST_URL + "/" + requestId + "?" + Utils.TENANT_IDENTIFIER;
