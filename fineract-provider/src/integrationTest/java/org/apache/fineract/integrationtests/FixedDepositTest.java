...
public class FixedDepositTest {
  ...
  public void testFixedDepositAccountWithPrematureClosureTypeWithdrawal() {
    ...
    Integer fixedDepositAccountId =
        applyForFixedDepositApplication(
            clientId.toString(), fixedDepositProductId.toString(), SUBMITTED_ON_DATE, WHOLE_TERM);
    ...
    this.fixedDepositAccountHelper.calculatePrematureAmountForFixedDeposit(
        fixedDepositAccountId, CLOSED_ON_DATE);
    ...
    fixedDepositAccountStatusHashMap =
        FixedDepositAccountStatusChecker.getStatusOfFixedDepositAccount(
            this.requestSpec, this.responseSpec, fixedDepositAccountId.toString());
    FixedDepositAccountStatusChecker.verifyFixedDepositAccountIsPrematureClosed(
        fixedDepositAccountStatusHashMap);
    ...
    HashMap accountDetails =
        this.fixedDepositAccountHelper.getFixedDepositAccountById(
            this.requestSpec, this.responseSpec, fixedDepositAccountId);
  ...
  public void testFixedDepositAccountWithPrematureClosureTypeWithdrawal_WITH_HOLD_TAX() {
    ...
    Integer fixedDepositProductId =
        createFixedDepositProductWithWithHoldTax(
            VALID_FROM,
            VALID_TO,
  ...
  public void testFixedDepositAccountClosureTypeWithdrawal_WITH_HOLD_TAX()
    ...
    fixedDepositAccountStatusHashMap =
        FixedDepositAccountStatusChecker.getStatusOfFixedDepositAccount(
            this.requestSpec, this.responseSpec, fixedDepositAccountId.toString());
    FixedDepositAccountStatusChecker.verifyFixedDepositAccountIsMatured(
        fixedDepositAccountStatusHashMap);
  }
  ...
  private void testFixedDepositAccountForInterestRate(
    ...
    Integer fixedDepositProductId =
        createFixedDepositProduct(VALID_FROM, VALID_TO, accountingRule, chartToUse);
    Assert.assertNotNull(fixedDepositProductId);
    ...
    HashMap accountSummary =
        this.fixedDepositAccountHelper.getFixedDepositDetails(fixedDepositAccountId);
  ...
  public void testFixedDepositAccountWithPrematureClosureTypeReinvest() {
    ...
    FixedDepositAccountHelper fixedDepositAccountHelperValidationError =
        new FixedDepositAccountHelper(this.requestSpec, new ResponseSpecBuilder().build());
    ...
    ArrayList<HashMap> errorResponse =
        (ArrayList<HashMap>)
            fixedDepositAccountHelperValidationError.prematureCloseForFixedDeposit(
                fixedDepositAccountId,
                CLOSED_ON_DATE,
    ...
    assertEquals(
        "validation.msg.fixeddepositaccount.onAccountClosureId.reinvest.not.allowed",
  ...
  public void testFixedDepositAccountUpdation() {
    ...
    this.fixedDepositProductHelper.retrieveAllFixedDepositProducts(
        this.requestSpec, this.responseSpec);
    this.fixedDepositProductHelper.retrieveFixedDepositProductById(
        this.requestSpec, this.responseSpec, fixedDepositProductId.toString());
    ...
    HashMap modificationsHashMap =
        this.fixedDepositAccountHelper.updateFixedDepositAccount(
            clientId.toString(),
            fixedDepositProductId.toString(),
  ...
  public void testFixedDepositAccountUndoApproval() {
    ...
    fixedDepositAccountStatusHashMap =
        this.fixedDepositAccountHelper.undoApproval(fixedDepositAccountId);
    FixedDepositAccountStatusChecker.verifyFixedDepositIsPending(fixedDepositAccountStatusHashMap);
  }
  ...
  public void testFixedDepositAccountRejectedAndClosed() {
    ...
    fixedDepositAccountStatusHashMap =
        this.fixedDepositAccountHelper.rejectApplication(fixedDepositAccountId, REJECTED_ON_DATE);
    FixedDepositAccountStatusChecker.verifyFixedDepositIsRejected(fixedDepositAccountStatusHashMap);
    FixedDepositAccountStatusChecker.verifyFixedDepositAccountIsClosed(
        fixedDepositAccountStatusHashMap);
  }
  ...
  public void testFixedDepositAccountWithdrawnByClientAndClosed() {
    ...
    fixedDepositAccountStatusHashMap =
        this.fixedDepositAccountHelper.withdrawApplication(
            fixedDepositAccountId, WITHDRAWN_ON_DATE);
    FixedDepositAccountStatusChecker.verifyFixedDepositIsWithdrawn(
        fixedDepositAccountStatusHashMap);
    FixedDepositAccountStatusChecker.verifyFixedDepositAccountIsClosed(
        fixedDepositAccountStatusHashMap);
  }
  ...
  public void testFixedDepositAccountIsDeleted() {
    ...
    fixedDepositAccountId =
        (Integer)
            this.fixedDepositAccountHelper.deleteFixedDepositApplication(
                fixedDepositAccountId, "resourceId");
    Assert.assertNotNull(fixedDepositAccountId);
  }
  ...
  public void testMaturityAmountForMonthlyCompoundingAndMonthlyPosting_With_365_Days() {
    ...
    HashMap fixedDepositAccountData =
        this.fixedDepositAccountHelper.getFixedDepositAccountById(
            this.requestSpec, this.responseSpec, fixedDepositAccountId);
    ...
    HashMap daysInYearMap =
        (HashMap) fixedDepositAccountData.get("interestCalculationDaysInYearType");
    ...
    Float interestRate =
        this.fixedDepositAccountHelper.getInterestRate(interestRateChartData, depositPeriod);
    ...
    principal =
        this.fixedDepositAccountHelper.getPrincipalAfterCompoundingInterest(
            todaysDate,
            principal,
            depositPeriod,
            interestPerDay,
    ...
    Assert.assertEquals(
        "Verifying Maturity amount for Fixed Deposit Account", principal, maturityAmount);
  }
  ...
  public void testMaturityAmountForMonthlyCompoundingAndMonthlyPosting_With_360_Days() {
    ...
    this.fixedDepositAccountHelper.updateInterestCalculationConfigForFixedDeposit(
        clientId.toString(),
        fixedDepositProductId.toString(),
        fixedDepositAccountId.toString(),
        SUBMITTED_ON_DATE,
  ...
  public void testPrematureClosureAmountWithPenalInterestForWholeTerm_With_365() {
    ...
    Float preClosurePenalInterestRate =
        (Float) fixedDepositAccountData.get("preClosurePenalInterest");
    Integer daysInYear = (Integer) daysInYearMap.get("id");
    ArrayList<ArrayList<HashMap>> interestRateChartData =
        this.fixedDepositProductHelper.getInterestRateChartSlabsByProductId(
            this.requestSpec, this.responseSpec, fixedDepositProductId);
    ...
    Float maturityAmount =
        Float.valueOf(decimalFormat.format(fixedDepositAccountData.get("maturityAmount")));
  ...
  public void testPrematureClosureAmountWithPenalInterestTillPrematureWithdrawal_With_365_Days() {
    ...
    Float interestRate =
        this.fixedDepositAccountHelper.getInterestRate(interestRateChartData, depositedPeriod);
    interestRate -= preClosurePenalInterestRate;
    double interestRateInFraction = (interestRate / 100);
    double perDay = (double) 1 / (daysInYear);
    LOG.info("per day = {}", perDay);
  ...
  private Integer createFixedDepositProductWithWithHoldTax(
      final String validFrom,
      final String validTo,
