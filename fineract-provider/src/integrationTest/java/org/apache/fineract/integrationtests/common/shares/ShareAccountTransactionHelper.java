...
public class ShareAccountTransactionHelper {
  ...
  private static final String CREATE_SHARE_ACCOUNT_URL =
      SHARE_ACCOUNT_URL + "?" + Utils.TENANT_IDENTIFIER;

  public static Integer createShareAccount(
      final String shareProductJSON,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
    return Utils.performServerPost(
        requestSpec, responseSpec, CREATE_SHARE_ACCOUNT_URL, shareProductJSON, "resourceId");
  }

  public static Map<String, Object> retrieveShareAccount(
  ...
  public static Integer updateShareAccount(
      final Integer shareAccountId,
      final String shareAccountJson,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
  ...
  public static Integer postCommand(
