...
public class CurrenciesTest {
  ...
  public void testCurrencyElements() {
    ...
    CurrencyDomain usd =
        CurrencyDomain.create("USD", "US Dollar", 2, "$", "currency.USD", "US Dollar ($)").build();
  ...
  public void testUpdateCurrencySelection() {
    ...
    ArrayList<String> currenciesOutput =
        CurrenciesHelper.updateSelectedCurrencies(
            this.requestSpec, this.responseSpec, currenciestoUpdate);
