...
public class ProvisioningIntegrationTest {
    ...
    public void testCreateProvisioningCriteria() {
        ...
        Map requestCriteria = ProvisioningHelper.createProvisioingCriteriaJson(loanProducts, categories, liability,
                expense);
        ...
        requestCriteria = ProvisioningHelper.createProvisioingCriteriaJson(loanProducts, categories, liability,
                expense);
