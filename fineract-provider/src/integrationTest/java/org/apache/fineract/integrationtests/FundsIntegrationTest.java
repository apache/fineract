...
public class FundsIntegrationTest {
  ...
  public void testCreateFundWithEmptyName() {
    FundsHelper fh =
        FundsHelper.create(null).externalId(Utils.randomNameGenerator("fund-", 5)).build();
    String jsonData = fh.toJSON();
  ...
  public void testCreateFundWithDuplicateName() {
    ...
    FundsHelper fh2 =
        FundsHelper.create(fh.getName()).externalId(Utils.randomNameGenerator("fund-", 5)).build();
    jsonData = fh2.toJSON();
  ...
  public void testCreateFundWithInvalidName() {
    FundsHelper fh =
        FundsHelper.create(Utils.randomNameGenerator("", 120))
            .externalId(Utils.randomNameGenerator("fund-", 5))
            .build();
    String jsonData = fh.toJSON();
  ...
  public void testRetrieveUnknownFund() {
    ...
    String jsonData =
        FundsResourceHandler.retrieveFund(Long.MAX_VALUE, this.requestSpec, responseSpec);
    HashMap<String, Object> map =
        new Gson().fromJson(jsonData, new TypeToken<HashMap<String, Object>>() {}.getType());
  ...
  public void testUpdateFund() {
    ...
    FundsHelper fh2 =
        FundsResourceHandler.updateFund(
            fundID, newName, newExternalId, this.requestSpec, this.statusOkResponseSpec);
  ...
  public void testUpdateUnknownFund() {
    ...
    FundsHelper fh =
        FundsResourceHandler.updateFund(
            Long.MAX_VALUE, newName, newExternalId, this.requestSpec, responseSpec);
  ...
  public void testUpdateFundWithInvalidNewName() {
    ...
    FundsHelper fh2 =
        FundsResourceHandler.updateFund(
            fundID, newName, newExternalId, this.requestSpec, responseSpec);
  ...
  public void testUpdateFundWithNewName() {
    ...
    FundsHelper fh2 =
        FundsResourceHandler.updateFund(
            fundID, newName, null, this.requestSpec, this.statusOkResponseSpec);
  ...
  private Long createFund(
      final String fundJSON,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
    String fundId =
        String.valueOf(FundsResourceHandler.createFund(fundJSON, requestSpec, responseSpec));
