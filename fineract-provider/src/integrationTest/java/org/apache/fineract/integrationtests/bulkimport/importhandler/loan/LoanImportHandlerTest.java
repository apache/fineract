...
public class LoanImportHandlerTest {
    ...
    public void testLoanImport() throws InterruptedException, IOException, ParseException {
        ...
        // LoanTransactionHelper ltHelper=new
        ...
        // Assert.assertNotNull("Could not create payment type"
        // ,outcome_payment_creation);
        ...
        firstLoanRow.createCell(LoanConstants.OFFICE_NAME_COL)
        ...
        firstLoanRow.createCell(LoanConstants.CLIENT_NAME_COL)
                .setCellValue(loanSheet.getRow(1).getCell(LoanConstants.LOOKUP_CLIENT_NAME_COL).getStringCellValue());
        firstLoanRow.createCell(LoanConstants.CLIENT_EXTERNAL_ID).setCellValue(
                loanSheet.getRow(1).getCell(LoanConstants.LOOKUP_CLIENT_EXTERNAL_ID).getStringCellValue());
        Sheet loanProductSheet = workbook.getSheet(TemplatePopulateImportConstants.PRODUCT_SHEET_NAME);
        firstLoanRow.createCell(LoanConstants.PRODUCT_COL)
        ...
        firstLoanRow.createCell(LoanConstants.LOAN_OFFICER_NAME_COL)
        ...
        firstLoanRow.createCell(LoanConstants.DISBURSED_PAYMENT_TYPE_COL)
                .setCellValue(extrasSheet.getRow(1).getCell(3).getStringCellValue());
        firstLoanRow.createCell(LoanConstants.FUND_NAME_COL)
                .setCellValue(extrasSheet.getRow(1).getCell(1).getStringCellValue());
        firstLoanRow.createCell(LoanConstants.PRINCIPAL_COL)
                .setCellValue(loanProductSheet.getRow(1).getCell(3).getNumericCellValue());
        firstLoanRow.createCell(LoanConstants.NO_OF_REPAYMENTS_COL)
                .setCellValue(loanProductSheet.getRow(1).getCell(6).getNumericCellValue());
        firstLoanRow.createCell(LoanConstants.REPAID_EVERY_COL)
        ...
        firstLoanRow.createCell(LoanConstants.LOAN_TERM_FREQUENCY_COL)
                .setCellValue(loanProductSheet.getRow(1).getCell(10).getStringCellValue());
        firstLoanRow.createCell(LoanConstants.NOMINAL_INTEREST_RATE_COL)
        ...
        firstLoanRow.createCell(LoanConstants.AMORTIZATION_COL)
                .setCellValue(loanProductSheet.getRow(1).getCell(15).getStringCellValue());
        firstLoanRow.createCell(LoanConstants.INTEREST_METHOD_COL)
        ...
        firstLoanRow.createCell(LoanConstants.REPAYMENT_TYPE_COL)
                .setCellValue(extrasSheet.getRow(1).getCell(3).getStringCellValue());

        String currentdirectory = new File("").getAbsolutePath();
        File directory = new File(currentdirectory + File.separator + "src" + File.separator + "integrationTest"
                + File.separator + "resources" + File.separator + "bulkimport" + File.separator + "importhandler"
                + File.separator + "loan");
        if (!directory.exists())
            directory.mkdirs();
