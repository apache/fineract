...
public class RecurringDepositTest {
  ...
  public void testRecurringDepositAccountWithPrematureClosureTypeWithdrawal() {
    ...
    recurringDepositAccountId =
        this.recurringDepositAccountHelper.calculateInterestForRecurringDeposit(
            recurringDepositAccountId);
    Assert.assertNotNull(recurringDepositAccountId);
     ...
     */
    HashMap recurringDepositPrematureData =
        this.recurringDepositAccountHelper.calculatePrematureAmountForRecurringDeposit(
            recurringDepositAccountId, CLOSED_ON_DATE);

    /***
     * Preclose the RD account verify whether account is preClosed
     */
    Integer prematureClosureTransactionId =
        (Integer)
            this.recurringDepositAccountHelper.prematureCloseForRecurringDeposit(
                recurringDepositAccountId,
                CLOSED_ON_DATE,
                CLOSURE_TYPE_WITHDRAW_DEPOSIT,
                null,
    ...
    recurringDepositAccountStatusHashMap =
        RecurringDepositAccountStatusChecker.getStatusOfRecurringDepositAccount(
            this.requestSpec, this.responseSpec, recurringDepositAccountId.toString());
    RecurringDepositAccountStatusChecker.verifyRecurringDepositAccountIsPrematureClosed(
        recurringDepositAccountStatusHashMap);
    ...
    Float maturityAmount =
        Float.valueOf(recurringDepositAccountData.get("maturityAmount").toString());
    this.journalEntryHelper.checkJournalEntryForAssetAccount(
        assetAccount,
        CLOSED_ON_DATE,
  ...
  public void testRecurringDepositAccountWithPrematureClosureTypeTransferToSavings_WITH_HOLD_TAX() {
    ...
    Integer recurringDepositProductId =
        createRecurringDepositProductWithWithHoldTax(
            VALID_FROM,
            VALID_TO,
            String.valueOf(taxGroupId),
            accountingRule,
            assetAccount,
            liabilityAccount,
            incomeAccount,
  ...
  public void testRecurringDepositAccountWithClosureTypeTransferToSavings_WITH_HOLD_TAX()
    ...
    recurringDepositAccountStatusHashMap =
        RecurringDepositAccountStatusChecker.getStatusOfRecurringDepositAccount(
            this.requestSpec, this.responseSpec, recurringDepositAccountId.toString());
    RecurringDepositAccountStatusChecker.verifyRecurringDepositAccountIsMatured(
        recurringDepositAccountStatusHashMap);
  }
  ...
  public void testRecurringDepositAccountWithPrematureClosureTypeReinvest() {
    ...
    RecurringDepositAccountHelper recurringDepositAccountHelperValidationError =
        new RecurringDepositAccountHelper(this.requestSpec, new ResponseSpecBuilder().build());
    ...
    ArrayList<HashMap> allRecurringDepositProductsData =
        this.recurringDepositProductHelper.retrieveAllRecurringDepositProducts(
            this.requestSpec, this.responseSpec);
    HashMap recurringDepositProductData =
        this.recurringDepositProductHelper.retrieveRecurringDepositProductById(
     ...
     */
    ArrayList<HashMap> errorResponse =
        (ArrayList<HashMap>)
            recurringDepositAccountHelperValidationError.prematureCloseForRecurringDeposit(
                recurringDepositAccountId,
                CLOSED_ON_DATE,
    ...
    assertEquals(
        "validation.msg.recurringdepositaccount.onAccountClosureId.reinvest.not.allowed",
  ...
  public void testRecurringDepositAccountUpdation() {
    ...
    HashMap modificationsHashMap =
        this.recurringDepositAccountHelper.updateRecurringDepositAccount(
            clientId.toString(),
            recurringDepositProductId.toString(),
  ...
  public void testRecurringDepositAccountUndoApproval() {
    ...
    recurringDepositAccountStatusHashMap =
        this.recurringDepositAccountHelper.undoApproval(recurringDepositAccountId);
    RecurringDepositAccountStatusChecker.verifyRecurringDepositIsPending(
        recurringDepositAccountStatusHashMap);
  }
  ...
  public void testRecurringDepositAccountRejectedAndClosed() {
    ...
    recurringDepositAccountStatusHashMap =
        this.recurringDepositAccountHelper.rejectApplication(
            recurringDepositAccountId, REJECTED_ON_DATE);
    RecurringDepositAccountStatusChecker.verifyRecurringDepositIsRejected(
        recurringDepositAccountStatusHashMap);
    RecurringDepositAccountStatusChecker.verifyRecurringDepositAccountIsClosed(
        recurringDepositAccountStatusHashMap);
  }
  ...
  public void testRecurringDepositAccountWithdrawnByClientAndClosed() {
    ...
    recurringDepositAccountStatusHashMap =
        this.recurringDepositAccountHelper.withdrawApplication(
            recurringDepositAccountId, WITHDRAWN_ON_DATE);
    RecurringDepositAccountStatusChecker.verifyRecurringDepositIsWithdrawn(
        recurringDepositAccountStatusHashMap);
    RecurringDepositAccountStatusChecker.verifyRecurringDepositAccountIsClosed(
        recurringDepositAccountStatusHashMap);
  }
  ...
  public void testRecurringDepositAccountIsDeleted() {
    ...
    recurringDepositAccountId =
        (Integer)
            this.recurringDepositAccountHelper.deleteRecurringDepositApplication(
  ...
  public void testUpdateAndUndoTransactionForRecurringDepositAccount() {
    ...
    HashMap recurringDepositSummaryBefore =
        this.recurringDepositAccountHelper.getRecurringDepositSummary(recurringDepositAccountId);
    ...
    Integer transactionIdForDeposit =
        this.recurringDepositAccountHelper.depositToRecurringDepositAccount(
            recurringDepositAccountId, DEPOSIT_AMOUNT, DEPOSIT_DATE);
    ...
    HashMap recurringDepositSummaryAfter =
        this.recurringDepositAccountHelper.getRecurringDepositSummary(recurringDepositAccountId);
    Float balanceAfter = (Float) recurringDepositSummaryAfter.get("accountBalance");

    Assert.assertEquals(
        "Verifying account balance after deposit", expectedBalanceAfter, balanceAfter);

    /***
     * Update transaction and verify account balance after transaction
     */
    Float updatedTransactionAmount = DEPOSIT_AMOUNT - 1000.0f;
    Integer updateTransactionId =
        this.recurringDepositAccountHelper.updateTransactionForRecurringDeposit(
            recurringDepositAccountId,
            transactionIdForDeposit,
            DEPOSIT_DATE,
    ...
    recurringDepositSummaryAfter =
        this.recurringDepositAccountHelper.getRecurringDepositSummary(recurringDepositAccountId);
    balanceAfter = (Float) recurringDepositSummaryAfter.get("accountBalance");

    Assert.assertEquals(
        "Verifying account balance after updating Transaction", expectedBalanceAfter, balanceAfter);

    Integer undoTransactionId =
        this.recurringDepositAccountHelper.undoTransactionForRecurringDeposit(
            recurringDepositAccountId, updateTransactionId, DEPOSIT_DATE, 0.0f);
    ...
    Assert.assertEquals(
        "Verifying account balance after Undo Transaction", expectedBalanceAfter, balanceAfter);
  }
  ...
  public void testMaturityAmountForMonthlyCompoundingAndMonthlyPosting_With_365_Days() {
    ...
    HashMap daysInYearMap =
        (HashMap) recurringDepositAccountData.get("interestCalculationDaysInYearType");
    Integer daysInYear = (Integer) daysInYearMap.get("id");
    ArrayList<ArrayList<HashMap>> interestRateChartData =
        this.recurringDepositProductHelper.getInterestRateChartSlabsByProductId(
    ...
    Float interestRate =
        this.recurringDepositAccountHelper.getInterestRate(interestRateChartData, depositPeriod);
    ...
    principal =
        this.recurringDepositAccountHelper.getPrincipalAfterCompoundingInterest(
            todaysDate,
            principal,
            depositAmount,
            depositPeriod,
    ...
    Assert.assertEquals(
        "Verifying Maturity amount for Recurring Deposit Account", principal, maturityAmount);
  }
  ...
  public void testPostInterestForRecurringDeposit() {
    ...
    Float interestToBePosted =
        Float.valueOf(decimalFormat.format(interestPerDay * principal * daysInMonth));
    ...
    HashMap recurringDepositAccountSummary =
        this.recurringDepositAccountHelper.getRecurringDepositSummary(recurringDepositAccountId);
    Float interestAmountPosted =
        Float.valueOf(
            decimalFormat.format(recurringDepositAccountSummary.get("totalInterestPosted")));
    Float principalAfter =
        Float.valueOf(decimalFormat.format(recurringDepositAccountSummary.get("accountBalance")));
    ...
    Assert.assertEquals(
        "Verifying Principal Amount after Interest Posting", expectedBalanceAfter, principalAfter);
  }
  ...
  public void testPrematureClosureAmountWithPenalInterestForWholeTerm_With_365_Days() {
    ...
    HashMap daysInYearMap =
        (HashMap) recurringDepositAccountData.get("interestCalculationDaysInYearType");
    Float preClosurePenalInterestRate =
        (Float) recurringDepositAccountData.get("preClosurePenalInterest");
    Integer daysInYear = (Integer) daysInYearMap.get("id");
    ArrayList<ArrayList<HashMap>> interestRateChartData =
        this.recurringDepositProductHelper.getInterestRateChartSlabsByProductId(
            this.requestSpec, this.responseSpec, recurringDepositProductId);
    ...
    principal = Float.valueOf(decimalFormat.format(principal));
    Float maturityAmount =
        Float.valueOf(decimalFormat.format(recurringDepositAccountData.get("maturityAmount")));
  ...
  public void testPrematureClosureAmountWithPenalInterestTillPrematureWithdrawal_With_365_Days() {
    ...
    Float interestRate =
        this.recurringDepositAccountHelper.getInterestRate(interestRateChartData, depositedPeriod);
    interestRate -= preClosurePenalInterestRate;
    double interestRateInFraction = (interestRate / 100);
    double perDay = (double) 1 / (daysInYear);
    LOG.info("per day = {}", perDay);
  ...
  public void testRecurringDepositWithBi_AnnualCompoundingAndPosting_365_Days() {
    ...
    Assert.assertEquals(
        "Verifying Pre-Closure maturity amount", expectedPrematureAmount, maturityAmount);
  }
  ...
  public void testMaturityAmountForDailyCompoundingAndAnnuallyPosting_With_365_Days() {
    ...
    recurringDepositAccountStatusHashMap =
        this.recurringDepositAccountHelper.approveRecurringDeposit(
            recurringDepositAccountId, APPROVED_ON_DATE);
    FixedDepositAccountStatusChecker.verifyFixedDepositIsApproved(
        recurringDepositAccountStatusHashMap);
  ...
  private void testFixedDepositAccountForInterestRate(
      final String chartToUse,
    ...
    final String accountingRule = NONE;
    Integer recurringDepositProductId =
        createRecurringDepositProduct(VALID_FROM, VALID_TO, accountingRule, chartToUse);
    Assert.assertNotNull(recurringDepositProductId);
  ...
  private Integer createRecurringDepositProduct(
    ...
    if (accountingRule.equals(CASH_BASED)) {
      recurringDepositProductHelper =
          recurringDepositProductHelper.withAccountingRuleAsCashBased(accounts);
    ...
    final String recurringDepositProductJSON =
        recurringDepositProductHelper.withPeriodRangeChart().build(validFrom, validTo);
    return RecurringDepositProductHelper.createRecurringDepositProduct(
        recurringDepositProductJSON, requestSpec, responseSpec);
  }

  private Integer createRecurringDepositProductWithWithHoldTax(
      final String validFrom,
      final String validTo,
  ...
  private Integer createRecurringDepositProduct(
    ...
    switch (chartToBePicked) {
      ...
      case "amount_period":
        recurringDepositProductHelper =
            recurringDepositProductHelper.withAmountAndPeriodRangeChart();
        break;
      default:
        break;
    }
    final String recurringDepositProductJSON =
        recurringDepositProductHelper.build(validFrom, validTo);
    return RecurringDepositProductHelper.createRecurringDepositProduct(
        recurringDepositProductJSON, requestSpec, responseSpec);
  }
  ...
  private Integer applyForRecurringDepositApplication(
    ...
    final String recurringDepositApplicationJSON =
        new RecurringDepositAccountHelper(this.requestSpec, this.responseSpec)
            .withSubmittedOnDate(submittedOnDate)
            .withExpectedFirstDepositOnDate(expectedFirstDepositOnDate)
            .withDepositPeriod(depositPeriod)
            .withMandatoryDepositAmount(depositAmount)
            .build(clientID, productID, penalInterestType);
    return this.recurringDepositAccountHelper.applyRecurringDepositApplication(
        recurringDepositApplicationJSON, this.requestSpec, this.responseSpec);
  }
  ...
  private Account getMappedLiabilityFinancialAccount() {
    final Integer liabilityTransferFinancialActivityId =
    ...
    if (financialActivities.isEmpty()) {
      financialAccount =
          createLiabilityFinancialAccountTransferType(liabilityTransferFinancialActivityId);
    } else {
      /***
      ...
      for (HashMap financialActivity : financialActivities) {
        ...
        if (financialActivityData.get("id").equals(liabilityTransferFinancialActivityId)) {
          ...
          mappedLiabilityAccount =
              new Account((Integer) glAccountData.get("id"), AccountType.LIABILITY);
          break;
        }
      }
      /***
  ...
  private Account createLiabilityFinancialAccountTransferType(
      final Integer liabilityTransferFinancialActivityId) {
    /***
  ...
  private void assertFinancialActivityAccountCreation(
      Integer financialActivityAccountId, Integer financialActivityId, Account glAccount) {
    HashMap mappingDetails =
        this.financialActivityAccountHelper.getFinancialActivityAccount(
            financialActivityAccountId, this.responseSpec);
    Assert.assertEquals(
        financialActivityId, ((HashMap) mappingDetails.get("financialActivityData")).get("id"));
    Assert.assertEquals(
        glAccount.getAccountID(), ((HashMap) mappingDetails.get("glAccountData")).get("id"));
  }
  ...
  private Integer createTaxGroup(final String percentage, final Account liabilityAccountForTax) {
    ...
    final Integer taxComponentId =
        TaxComponentHelper.createTaxComponent(
            this.requestSpec, this.responseSpec, percentage, liabilityAccountId);
    return TaxGroupHelper.createTaxGroup(
        this.requestSpec, this.responseSpec, Arrays.asList(taxComponentId));
  }
  ...
  public void tearDown() {
    ...
    for (HashMap financialActivity : financialActivities) {
      ...
      Integer deletedFinancialActivityAccountId =
          this.financialActivityAccountHelper.deleteFinancialActivityAccount(
