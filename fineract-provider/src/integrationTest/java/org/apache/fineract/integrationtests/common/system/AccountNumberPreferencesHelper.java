...
public class AccountNumberPreferencesHelper {
        ...
        public AccountNumberPreferencesHelper(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec) {
                this.requestSpec = requestSpec;
                this.responseSpec = responseSpec;
        }

        public Object createClientAccountNumberPreference(ResponseSpecification responseSpec,
                        String jsonAttributeToGetBack) {
                System.out.println(
                                "----------------------CREATING CLIENT ACCOUNT NUMBER PREFERENCE--------------------");
                ...
                return Utils.performServerPost(this.requestSpec, responseSpec, URL, requestJSON,
                                jsonAttributeToGetBack);
        }

        public Object createLoanAccountNumberPreference(ResponseSpecification responseSpec,
                        String jsonAttributeToGetBack) {
        ...
        public Object createSavingsAccountNumberPreference(ResponseSpecification responseSpec,
                        String jsonAttributeToGetBack) {
                System.out.println(
                                "----------------------CREATING SAVINGS ACCOUNT NUMBER PREFERENCE--------------------");
        ...
        public Object createGroupsAccountNumberPreference(ResponseSpecification responseSpec,
                        String jsonAttributeToGetBack) {
                System.out.println(
                                "----------------------CREATING GROUPS ACCOUNT NUMBER PREFERENCE--------------------");
        ...
        public Object createCenterAccountNumberPreference(ResponseSpecification responseSpec,
                        String jsonAttributeToGetBack) {
                System.out.println(
                                "----------------------CREATING CENTER ACCOUNT NUMBER PREFERENCE--------------------");
        ...
        public HashMap<String, Object> createAccountNumberPreferenceWithInvalidData(ResponseSpecification responseSpec,
                ...
                final String requestJSON = new AccountNumberPreferencesTestBuilder().invalidDataBuild(accountType,
                                prefixType);
        ...
        public HashMap<String, Object> updateAccountNumberPreference(final Integer accountNumberFormatId,
                        final String prefixType, ResponseSpecification responseSpec, String jsonAttributeToGetBack) {

                final String requestJSON = new AccountNumberPreferencesTestBuilder().updatePrefixType(prefixType);

                final String URL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + accountNumberFormatId + "?"
        ...
        public HashMap<String, Object> deleteAccountNumberPreference(final Integer accountNumberFormatId,
        ...
        public Object getAccountNumberPreference(final Integer accountNumberFormatId,
        ...
        public ArrayList<HashMap<String, Object>> getAllAccountNumberPreferences() {
                final String URL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "?" + Utils.TENANT_IDENTIFIER;
                final ArrayList<HashMap<String, Object>> response = Utils.performServerGet(requestSpec, responseSpec,
                                URL, "");
                return response;
        }
        ...
        public void verifyCreationOfAccountNumberPreferences(final Integer clientAccountNumberPreferenceId,
                ...
                final String clientURL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + clientAccountNumberPreferenceId
                                + "?" + Utils.TENANT_IDENTIFIER;

                Utils.performServerGet(requestSpec, responseSpec, clientURL, "id");

                final String loanURL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + loanAccountNumberPreferenceId + "?"
                                + Utils.TENANT_IDENTIFIER;
                ...
                final String groupsURL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + groupsAccountNumberPreferenceId
                                + "?" + Utils.TENANT_IDENTIFIER;

                Utils.performServerGet(requestSpec, responseSpec, groupsURL, "id");

                final String centerURL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + centerAccountNumberPreferenceId
                                + "?" + Utils.TENANT_IDENTIFIER;
        ...
        public void verifyUpdationOfAccountNumberPreferences(final Integer accountNumberPreferenceId,
                ...
                final String URL = ACCOUNT_NUMBER_FORMATS_REQUEST_URL + "/" + accountNumberPreferenceId + "?"
                                + Utils.TENANT_IDENTIFIER;
