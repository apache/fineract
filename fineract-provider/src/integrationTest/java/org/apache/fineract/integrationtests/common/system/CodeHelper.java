...
public class CodeHelper {
  ...
  public static Object updateCode(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
  ...
  public static HashMap<String, Object> getCodeByName(
    ...
    ArrayList<HashMap<String, Object>> getAllCodes =
        CodeHelper.getAllCodes(requestSpec, responseSpec);
  ...
  public static HashMap<String, Object> retrieveOrCreateCodeValue(
    ...
    final List<HashMap<String, Object>> codeValuesList =
        CodeHelper.getCodeValuesForCode(requestSpec, responseSpec, codeId, "");
      ...
      codeValueId =
          (Integer)
              CodeHelper.createCodeValue(
                  requestSpec, responseSpec, codeId, codeValue, codeValuePosition, "subResourceId");
  ...
  public static String getTestCodeValueAsJSON(
      final String codeValueName, final String description, final Integer position) {
  ...
  public static Object deleteCodeById(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer codeId,
      final String jsonAttributeToGetback) {
