...
public class ClientUndoRejectAndWithdrawalIntegrationTest {
  ...
  public void testClientUndoRejectWithDateBeforeRejectDate() {
    ...
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.undoRejectedclient(
            clientId, CommonConstants.RESPONSE_ERROR, ClientHelper.CREATED_DATE);
    assertEquals(
        "error.msg.client.reopened.date.cannot.before.client.rejected.date",
  ...
  public void testClientUndoRejectWithoutReject() {
    ...
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.undoRejectedclient(
            clientId, CommonConstants.RESPONSE_ERROR, undoRejectDate);
    assertEquals(
        "error.msg.client.undorejection.on.nonrejected.account",
        clientErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
  ...
  public void testClientUndoRejectWithFutureDate() {
    ...
    final String undoRejectDate = dateFormat.format(todaysDate.getTime());
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.undoWithdrawclient(
            clientId, CommonConstants.RESPONSE_ERROR, undoRejectDate);
    assertEquals(
        "validation.msg.client.reopenedDate.is.greater.than.date",
        clientErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
  ...
  public void testClientUndoWithDrawnWithDateBeforeWithdrawal() {
    ...
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.undoWithdrawclient(
            clientId, CommonConstants.RESPONSE_ERROR, ClientHelper.CREATED_DATE);
    assertEquals(
        "error.msg.client.reopened.date.cannot.before.client.withdrawal.date",
        clientErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
  ...
  public void testClientUndoWithDrawnWithoutWithdrawal() {
    ...
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.undoWithdrawclient(
            clientId, CommonConstants.RESPONSE_ERROR, undoWithdrawDate);
    assertEquals(
        "error.msg.client.undoWithdrawal.on.nonwithdrawal.account",
        clientErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
  ...
  public void testValidateReopenedDate() {
    ...
    ClientStatusChecker.verifyClientPending(status);
    ArrayList<HashMap<String, Object>> clientErrorData =
        validationErrorHelper.activateClient(clientId, CommonConstants.RESPONSE_ERROR);
    assertEquals(
  ...
  public void testReopenedDate() {
    ...
    ClientStatusChecker.verifyClientPending(status);
    status =
        this.clientHelper.activateClientWithDiffDateOption(
            clientId, ClientHelper.CREATED_DATE_PLUS_TWO);
  }
