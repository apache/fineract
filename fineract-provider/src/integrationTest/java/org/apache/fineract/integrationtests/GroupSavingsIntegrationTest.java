...
public class GroupSavingsIntegrationTest {
  ...
  public void testGsimSavingsAccount_REJECT_APPLICATION() {
    ...
    List<HashMap> error1 =
        savingsAccountHelperValidationError.rejectGsimApplicationWithErrorCode(
            gsimID, SavingsAccountHelper.CREATED_DATE_PLUS_ONE);
    assertEquals(
    ...
    error1 =
        savingsAccountHelperValidationError.rejectGsimApplicationWithErrorCode(
            gsimID, SavingsAccountHelper.getFutureDate());
    assertEquals(
    ...
    error1 =
        savingsAccountHelperValidationError.rejectGsimApplicationWithErrorCode(
            gsimID, SavingsAccountHelper.CREATED_DATE_MINUS_ONE);
    assertEquals(
  ...
  public void testGsimSavingsAccount_DEPOSIT_APPLICATION() {
    ...
    final Integer depositId =
        this.savingsAccountHelper.depositGsimApplication(savingsId, savingsArray);
  ...
  public void testGsimSavingsAccount_CLOSE_APPLICATION() {
    ...
    ArrayList<HashMap> savingsAccountErrorData =
        (ArrayList<HashMap>)
            validationErrorHelper.closeGsimSavingsAccountAndGetBackRequiredField(
                gsimID, withdrawBalance, CommonConstants.RESPONSE_ERROR, CLOSEDON_DATE);
    assertEquals(
        "validation.msg.savingsaccount.close.results.in.balance.not.zero",
        savingsAccountErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
    ...
    withdrawBalance = "true";
    savingsStatusHashMap =
        this.savingsAccountHelper.closeGsimSavingsAccount(gsimID, withdrawBalance);
    SavingsStatusChecker.verifySavingsAccountIsClosed(savingsStatusHashMap);
  }
  ...
  public void testGsimSavingsAccount_UPDATE_APPLICATION() {
    ...
    HashMap savingsStatusHashMap =
        this.savingsAccountHelper.updateGsimApplication(
            gsimID, clientID, groupID, savingsProductID);
  ...
  public void getGsimAccount() {
    ...
    Assert.assertNotNull(retrievedGsimId.toString());
  }
  ...
  public void testSavingsAccountCharges() {
    ...
    this.savingsAccountHelper.closeSavingsAccountAndGetBackRequiredField(
        savingsId, "true", null, sdf.format(cal.getTime()));
  }
  ...
  public static Integer createSavingsProduct(
      ...
      final String minBalanceForInterestCalculation,
      final String minRequiredBalance,
  ...
  private Map<String, Object> clientArray(
  ...
  private Map<String, Object> savingsArray(
      final Integer paymentId,
      final Integer savingsId,
      final Integer transactionAmount,
