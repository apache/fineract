...
public class GuarantorHelper {
  ...
  public HashMap updateGuarantor(
      final Integer guarantorId, final Integer loanId, final String guarantorJSON) {
  ...
  public HashMap deleteGuarantor(
      final Integer guarantorId, final Integer fundId, final Integer loanId) {
  ...
  public Object getGuarantor(
      final Integer guarantorId, final Integer loanId, final String jsonToGetBack) {
  ...
  public List getAllGuarantor(final Integer loanId) {
    return Utils.performServerGet(
        this.requestSpec, this.responseSpec, LOAN_URL + loanId + GUARANTOR_API_URL + TENANT, "");
  }
}
