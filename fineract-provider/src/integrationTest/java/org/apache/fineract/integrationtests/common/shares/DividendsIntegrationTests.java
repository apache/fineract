...
public class DividendsIntegrationTests {
  ...
  private final String[] dates = {
    "01 Jan 2015", "01 Apr 2015", "01 Oct 2015", "01 Dec 2015", "01 Mar 2016"
  };
  ...
  public void testCreateDividends() {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      final Integer shareAccountId =
          createShareAccount(clientId, productId, savingsAccountId, dates[i], shares[i]);
    ...
    final Integer dividendId =
        ShareDividendsTransactionHelper.createShareProductDividends(
            productId, createDividendsJson, requestSpec, responseSpec);

    Map<String, Object> productdividends =
        ShareDividendsTransactionHelper.retrieveAllDividends(productId, requestSpec, responseSpec);
    ...
    Assert.assertEquals(
        "shareAccountDividendStatusType.initiated", String.valueOf(status.get("code")));
    ...
    Map<String, Object> dividenddetails =
        ShareDividendsTransactionHelper.retrieveDividendDetails(
            productId, dividendId, requestSpec, responseSpec);
    Assert.assertEquals("5", String.valueOf(dividenddetails.get("totalFilteredRecords")));
    List<Map<String, Object>> pageItems =
        (List<Map<String, Object>>) dividenddetails.get("pageItems");
    for (Map<String, Object> dividendData : pageItems) {
      ...
      Assert.assertEquals(
          "shareAccountDividendStatusType.initiated", String.valueOf(statusMap.get("code")));
    }

    String jsonString = "";
    ShareDividendsTransactionHelper.postCommand(
        "approve", productId, dividendId, jsonString, requestSpec, responseSpec);
    ...
    Assert.assertEquals(
        "shareAccountDividendStatusType.approved", String.valueOf(status.get("code")));
  ...
  private Integer createShareAccount(
    ...
    String josn =
        new ShareAccountHelper()
            ...
            .withRequestedShares(requestedShares)
            .build();
