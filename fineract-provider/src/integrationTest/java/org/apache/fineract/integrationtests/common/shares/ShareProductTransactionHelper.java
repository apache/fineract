...
public class ShareProductTransactionHelper {
    ...
    public static Integer createShareProduct(final String savingsProductJSON, final RequestSpecification requestSpec,
        ...
        return Utils.performServerPost(requestSpec, responseSpec, CREATE_SHARE_PRODUCT_URL, savingsProductJSON,
                "resourceId");
    }

    public static Map<String, Object> retrieveShareProduct(final Integer shareProductId,
