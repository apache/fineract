...
public class ImageHelper {
  ...
  public static Integer createImageForStaff(
    ...
    return Utils.performServerPost(
        requestSpec, responseSpec, URL, generateImageAsText(), "resourceId");
  }

  public static Integer updateImageForStaff(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      Integer staffId) {
    LOG.info(
        "---------------------------------UPDATING AN IMAGE FOR"
            + " STAFF---------------------------------------------");
    String URL = STAFF_IMAGE_URL + staffId + IMAGES_URI + "?" + Utils.TENANT_IDENTIFIER;
  ...
  public static String getStaffImageAsText(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      Integer staffId) {
    LOG.info(
  ...
  public static byte[] getStaffImageAsBinary(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      Integer staffId) {
    LOG.info(
  ...
  public static Integer deleteStaffImage(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      Integer staffId) {
    LOG.info(
