...
public class BatchHelper {
  ...
  public static List<BatchResponse> postBatchRequestsWithoutEnclosingTransaction(
    ...
    final String response =
        Utils.performServerPost(
            requestSpec, responseSpec, BATCH_API_URL, jsonifiedBatchRequests, null);
   ...
   * @return a list of BatchResponse
   */
  public static List<BatchResponse> postBatchRequestsWithEnclosingTransaction(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final String jsonifiedBatchRequests) {
    final String response =
        Utils.performServerPost(
            requestSpec, responseSpec, BATCH_API_URL_EXT, jsonifiedBatchRequests, null);
    return BatchHelper.fromJsonString(response);
  }
   ...
   * @return List<BatchResponse>
   */
  public static List<BatchResponse> postWithSingleRequest(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final BatchRequest br) {
    ...
    final List<BatchResponse> response =
        BatchHelper.postBatchRequestsWithoutEnclosingTransaction(
            requestSpec, responseSpec, jsonifiedRequest);
  ...
  public static BatchRequest createClientRequest(final Long requestId, final String externalId) {
    ...
    if (externalId.equals("")) {
      extId =
          "ext" + String.valueOf((10000 * Math.random())) + String.valueOf((10000 * Math.random()));
    } else {
      extId = externalId;
    }

    final String body =
        "{ \"officeId\": 1, \"firstname\": \"Petra\", \"lastname\": \"Yton\","
            + "\"externalId\": "
            + extId
   ...
   * @return BatchRequest
   */
  public static BatchRequest createActiveClientRequest(
      final Long requestId, final String externalId) {
    ...
    final String body =
        "{ \"officeId\": 1, \"firstname\": \"Petra\", \"lastname\": \"Yton\","
            ...
            + " \"activationDate\": \"04 March 2010\", \"submittedOnDate\": \"04 March 2010\"}";
   ...
   * @return BatchRequest
   */
  public static BatchRequest applyLoanRequest(
      final Long requestId, final Long reference, final Integer productId) {
    ...
    final String body =
        "{\"dateFormat\": \"dd MMMM yyyy\", \"locale\": \"en_GB\", \"clientId\": \"$.clientId\","
            + "\"productId\": "
            + productId
            + ", \"principal\": \"10,000.00\", \"loanTermFrequency\":"
            + " 10,\"loanTermFrequencyType\": 2, \"loanType\": \"individual\","
            + " \"numberOfRepayments\": 10,\"repaymentEvery\": 1, \"repaymentFrequencyType\": 2,"
            + " \"interestRatePerPeriod\": 10,\"amortizationType\": 1, \"interestType\": 0,"
            + " \"interestCalculationPeriodType\": 1,\"transactionProcessingStrategyId\": 1,"
            + " \"expectedDisbursementDate\": \"10 Jun 2013\",\"submittedOnDate\": \"10 Jun"
            + " 2013\"}";
    br.setBody(body);
   ...
   * @return BatchRequest
   */
  public static BatchRequest applySavingsRequest(
      final Long requestId, final Long reference, final Integer productId) {
    ...
    final String body =
        "{\"clientId\": \"$.clientId\", \"productId\": "
            + productId
            + ",\"locale\": \"en\", \"dateFormat\": \"dd MMMM yyyy\", \"submittedOnDate\": \"01"
            + " March 2011\"}";
    br.setBody(body);
  ...
  public static BatchRequest createChargeRequest(final Long requestId, final Long reference) {
    ...
    final String body =
        "{\"chargeId\": \"2\", \"locale\": \"en\", \"amount\": \"100\", "
  ...
  public static BatchRequest activateClientRequest(final Long requestId, final Long reference) {
    ...
    br.setMethod("POST");
    br.setBody(
        "{\"locale\": \"en\", \"dateFormat\": \"dd MMMM yyyy\", \"activationDate\": \"01 March"
            + " 2011\"}");
  ...
  public static BatchRequest approveLoanRequest(final Long requestId, final Long reference) {
    ...
    br.setMethod("POST");
    br.setBody(
        "{\"locale\": \"en\", \"dateFormat\": \"dd MMMM yyyy\", \"approvedOnDate\": \"12 September"
            + " 2013\",\"note\": \"Loan approval note\"}");
  ...
  public static BatchRequest disburseLoanRequest(final Long requestId, final Long reference) {
    ...
    br.setMethod("POST");
    br.setBody(
        "{\"locale\": \"en\", \"dateFormat\": \"dd MMMM yyyy\", \"actualDisbursementDate\": \"15"
            + " September 2013\"}");
  ...
  public static void verifyClientCreatedOnServer(
    ...
    final String CLIENT_URL =
        "/fineract-provider/api/v1/clients?externalId="
            + externalId
            + "&"
            + Utils.TENANT_IDENTIFIER;
    final Integer responseRecords =
        Utils.performServerGet(requestSpec, responseSpec, CLIENT_URL, "totalFilteredRecords");
