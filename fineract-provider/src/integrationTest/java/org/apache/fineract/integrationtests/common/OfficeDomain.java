...
public class OfficeDomain {
  ...
  public int hashCode() {
    ...
    if (this.nameDecorated != null) hash += this.nameDecorated.hashCode();
    if (this.externalId != null) hash += this.externalId.hashCode();
    if (this.openingDate != null) hash += this.openingDate.hashCode();
