...
public class FundsResourceHandler {
    ...
    public static String retrieveFund(final Long fundID, final RequestSpecification requestSpec,
            final ResponseSpecification responseSpec) {
    ...
    public static FundsHelper updateFund(final Long fundID, final String newName, final String newExternalId,
        ...
        final String URL = FUNDS_URL + "/" + fundID + "?" + Utils.TENANT_IDENTIFIER;
        final HashMap<String, String> response = Utils.performServerPut(requestSpec, responseSpec, URL, updateJSON,
                "changes");
