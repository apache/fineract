...
public class FundsResourceHandler {
  ...
  public static Integer createFund(
      final String fundJSON,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
    return Utils.performServerPost(
        requestSpec, responseSpec, CREATE_FUNDS_URL, fundJSON, "resourceId");
  }

  public static List<FundsHelper> retrieveAllFunds(
  ...
  public static String retrieveFund(
      final Long fundID,
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec) {
  ...
  public static FundsHelper updateFund(
      final Long fundID,
    ...
    final String URL = FUNDS_URL + "/" + fundID + "?" + Utils.TENANT_IDENTIFIER;
    final HashMap<String, String> response =
        Utils.performServerPut(requestSpec, responseSpec, URL, updateJSON, "changes");
