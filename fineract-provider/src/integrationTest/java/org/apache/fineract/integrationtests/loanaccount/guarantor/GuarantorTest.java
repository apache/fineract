...
public class GuarantorTest {
  ...
  public void testGuarantor() {
    ...
    final Integer clientID_external =
        ClientHelper.createClient(this.requestSpec, this.responseSpec);
    final Integer clientID_external2 =
        ClientHelper.createClient(this.requestSpec, this.responseSpec);

    ClientHelper.verifyClientCreatedOnServer(
        this.requestSpec, this.responseSpec, clientID_external);

    final Integer selfSavigsId =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec, this.responseSpec, clientID, String.valueOf(self1_balance));
    final Integer externalSavigsId_1 =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec,
            this.responseSpec,
            clientID_external,
            String.valueOf(external1_balance));
    final Integer externalSavigsId_2 =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec,
            this.responseSpec,
            clientID_external2,
    ...
    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithoutGuaranteeAmount(String.valueOf(clientID_external))
            .build();
    ...
    ArrayList<HashMap> errorData =
        (ArrayList<HashMap>)
            this.loanTransactionHelper.approveLoan(
                LOAN_DISBURSEMENT_DATE, null, loanID, CommonConstants.RESPONSE_ERROR);
    assertTrue(
        checkForErrorCode(errorData, "validation.msg.loan.guarantor.min.self.guarantee.required"));
    assertTrue(
        checkForErrorCode(
            errorData, "validation.msg.loan.guarantor.min.external.guarantee.required"));
    assertTrue(
        checkForErrorCode(errorData, "validation.msg.loan.guarantor.mandated.guarantee.required"));

    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithGuaranteeAmount(
                String.valueOf(clientID),
                String.valueOf(selfSavigsId),
                String.valueOf(self1_guarantee))
            .build();
    ...
    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithGuaranteeAmount(
                String.valueOf(clientID_external),
                String.valueOf(externalSavigsId_1),
                String.valueOf(external1_guarantee))
            .build();
    ...
    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithGuaranteeAmount(
                String.valueOf(clientID_external2),
                String.valueOf(externalSavigsId_2),
                String.valueOf(external2_guarantee))
            .build();
  ...
  public void testGuarantor_UNDO_DISBURSAL() {
    ...
    final Integer externalSavigsId_1 =
        SavingsAccountHelper.openSavingsAccount(
            ...
            clientID_external,
            String.valueOf(external1_balance));
    final Integer externalSavigsId_3 =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec,
            this.responseSpec,
            clientID_external,
    ...
    List<HashMap> externalGuarantee_1_details =
        (List<HashMap>)
            this.guarantorHelper.getGuarantor(
                externalGuarantee_1, loanID, "guarantorFundingDetails");
    ...
    assertTrue(
        checkForErrorCode(error, "validation.msg.loan.guarantor.min.external.guarantee.required"));

    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithGuaranteeAmount(
                String.valueOf(clientID_external),
                String.valueOf(externalSavigsId_3),
                String.valueOf(external1_guarantee))
            .build();
    ...
    HashMap transactionDetail =
        this.loanTransactionHelper.makeRepayment(
            LOAN_REPAYMENT_DATE, totalDueForCurrentPeriod, loanID);
    ...
    // undo repayment
    this.loanTransactionHelper.adjustLoanTransaction(
        loanID,
        (Integer) transactionDetail.get(CommonConstants.RESPONSE_RESOURCE_ID),
        LOAN_REPAYMENT_DATE,
        "0",
        "");
    verifySavingsOnHoldBalance(selfSavigsId, self1_hold_funds);
  ...
  public void testGuarantor_RECOVER_GUARANTEES() {
    ...
    verifySavingsBalanceAndOnHoldBalance(
        selfSavigsId, Float.valueOf((float) 0), self1_balance - self1_hold_funds);
    verifySavingsBalanceAndOnHoldBalance(
        externalSavigsId_1, Float.valueOf((float) 0), external1_balance - external1_hold_funds);
  }
  ...
  public void testGuarantor_RECOVER_GUARANTEES_WITH_MORE_GUARANTEE() {
    ...
    final Integer selfSavigsId =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec, this.responseSpec, clientID, String.valueOf(selfBalance));
    final Integer externalSavigsId_1 =
        SavingsAccountHelper.openSavingsAccount(
            this.requestSpec,
            this.responseSpec,
    ...
    guarantorJSON =
        new GuarantorTestBuilder()
            .existingCustomerWithGuaranteeAmount(
                String.valueOf(clientID_external),
                String.valueOf(externalSavigsId_1),
                String.valueOf(externalguarantee))
            .build();
    Integer externalGuarantee_1 = this.guarantorHelper.createGuarantor(loanID, guarantorJSON);
    verifySavingsOnHoldBalance(externalSavigsId_1, null);
    Assert.assertNotNull(externalGuarantee_1);
    ...
    this.loanTransactionHelper.recoverFromGuarantor(loanID);
    verifySavingsBalanceAndOnHoldBalance(
        selfSavigsId, Float.valueOf((float) 0), selfBalance - Float.valueOf((float) 4615.385));
    verifySavingsBalanceAndOnHoldBalance(
        externalSavigsId_1,
  ...
  public void testGuarantor_WRITE_OFF_LOAN() {
    ...
    verifySavingsBalanceAndOnHoldBalance(
        externalSavigsId_1, Float.valueOf((float) 0), external1_balance);
  }

  private void verifySavingsOnHoldBalance(final Integer savingsId, final Float expectedBalance) {
    Float onHoldAmount =
        (Float) this.savingsAccountHelper.getSavingsDetails(savingsId, "onHoldFunds");
    assertEquals("Verifying On Hold Funds", expectedBalance, onHoldAmount);
  }

  @SuppressWarnings({"rawtypes", "cast"})
  private void verifySavingsBalanceAndOnHoldBalance(
      final Integer savingsId, final Float expectedBalance, final Float accountBalance) {
  ...
  private Integer createLoanProductWithHoldFunds(
    ...
    LoanProductTestBuilder builder =
        new LoanProductTestBuilder()
            ...
            .withOnHoldFundDetails(
                mandatoryGuarantee, minimumGuaranteeFromGuarantor, minimumGuaranteeFromOwnFunds);
  ...
  private Integer applyForLoanApplication(
      final Integer clientID, final Integer loanProductID, final String disbursementDate) {
    LOG.info(
        "--------------------------------APPLYING FOR LOAN"
            + " APPLICATION--------------------------------");
