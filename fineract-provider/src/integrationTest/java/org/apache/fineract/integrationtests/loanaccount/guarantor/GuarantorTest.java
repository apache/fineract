...
public class GuarantorTest {
        ...
        public void testGuarantor() {
                ...
                final Integer selfSavigsId = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID, String.valueOf(self1_balance));
                final Integer externalSavigsId_1 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external, String.valueOf(external1_balance));
                final Integer externalSavigsId_2 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external2, String.valueOf(external2_balance));
                ...
                guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithoutGuaranteeAmount(String.valueOf(clientID_external)).build();
                ...
                ArrayList<HashMap> errorData = (ArrayList<HashMap>) this.loanTransactionHelper
                                .approveLoan(LOAN_DISBURSEMENT_DATE, null, loanID, CommonConstants.RESPONSE_ERROR);
                ...
                errorData = (ArrayList<HashMap>) this.loanTransactionHelper.approveLoan(LOAN_DISBURSEMENT_DATE, null,
                ...
                guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID_external),
                                                String.valueOf(externalSavigsId_1), String.valueOf(external1_guarantee))
                                .build();
                ...
                guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID_external2),
                                                String.valueOf(externalSavigsId_2), String.valueOf(external2_guarantee))
                                .build();
        ...
        public void testGuarantor_UNDO_DISBURSAL() {
                ...
                final Integer externalSavigsId_1 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external, String.valueOf(external1_balance));
                final Integer externalSavigsId_3 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external, String.valueOf(external1_balance));
                final Integer externalSavigsId_2 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external2, String.valueOf(external2_balance));
                ...
                List<HashMap> externalGuarantee_1_details = (List<HashMap>) this.guarantorHelper
                                .getGuarantor(externalGuarantee_1, loanID, "guarantorFundingDetails");
                ...
                guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID_external),
                                                String.valueOf(externalSavigsId_3), String.valueOf(external1_guarantee))
                                .build();
                ...
                guarantors = this.guarantorHelper.getAllGuarantor(loanID);
                assertEquals(4, guarantors.size());
                externalGuarantee_1_details = (List<HashMap>) this.guarantorHelper.getGuarantor(externalGuarantee_1,
                                loanID, "guarantorFundingDetails");
                ...
                HashMap transactionDetail = this.loanTransactionHelper.makeRepayment(LOAN_REPAYMENT_DATE,
                ...
                // undo repayment
                this.loanTransactionHelper.adjustLoanTransaction(loanID,
        ...
        public void testGuarantor_RECOVER_GUARANTEES() {
                ...
                String guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID),
                                                String.valueOf(selfSavigsId), String.valueOf(self1_guarantee))
                                .build();
                Integer selfGuarantee = this.guarantorHelper.createGuarantor(loanID, guarantorJSON);
                verifySavingsOnHoldBalance(selfSavigsId, null);
                Assert.assertNotNull(selfGuarantee);
                ...
                verifySavingsBalanceAndOnHoldBalance(externalSavigsId_1, new Float(0),
                                external1_balance - external1_hold_funds);
        ...
        public void testGuarantor_RECOVER_GUARANTEES_WITH_MORE_GUARANTEE() {
                ...
                final Integer selfSavigsId = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID, String.valueOf(selfBalance));
                final Integer externalSavigsId_1 = SavingsAccountHelper.openSavingsAccount(this.requestSpec,
                                this.responseSpec, clientID_external, String.valueOf(externalBalance));
                ...
                String guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID),
                                                String.valueOf(selfSavigsId), String.valueOf(selfguarantee))
                                .build();
                Integer selfGuarantee = this.guarantorHelper.createGuarantor(loanID, guarantorJSON);
                verifySavingsOnHoldBalance(selfSavigsId, null);
                Assert.assertNotNull(selfGuarantee);
                ...
                guarantorJSON = new GuarantorTestBuilder()
                                .existingCustomerWithGuaranteeAmount(String.valueOf(clientID_external),
                                                String.valueOf(externalSavigsId_1), String.valueOf(externalguarantee))
                                .build();
                Integer externalGuarantee_1 = this.guarantorHelper.createGuarantor(loanID, guarantorJSON);
                verifySavingsOnHoldBalance(externalSavigsId_1, null);
                Assert.assertNotNull(externalGuarantee_1);
                ...
                verifySavingsBalanceAndOnHoldBalance(externalSavigsId_1, new Float(0),
                                externalBalance - new Float(2901.8553));
        ...
        private void verifySavingsBalanceAndOnHoldBalance(final Integer savingsId, final Float expectedBalance,
                        final Float accountBalance) {
        ...
        private Integer createLoanProductWithHoldFunds(final String mandatoryGuarantee,
                ...
                LoanProductTestBuilder builder = new LoanProductTestBuilder().withPrincipal("10000.00")
                                .withNumberOfRepayments("4").withRepaymentAfterEvery("1").withRepaymentTypeAsWeek()
                                ...
                                .withOnHoldFundDetails(mandatoryGuarantee, minimumGuaranteeFromGuarantor,
