...
public class CalendarHelper {
        ...
        public static Integer createMeetingCalendarForGroup(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec, final Integer groupId, final String startDate,
                        final String frequency, final String interval, final String repeatsOnDay) {

                System.out.println(
                                "----------------------CREATING A MEETING CALENDAR FOR THE GROUP-------------------");

                final String CALENDAR_RESOURCE_URL = BASE_URL + PARENT_ENTITY_NAME + groupId + ENITY_NAME + "?"
        ...
        public static Integer updateMeetingCalendarForGroup(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec, final Integer groupId, String calendarID,
                        final String startDate, final String frequency, final String interval,
                        final String repeatsOnDay) {

                System.out.println(
                                "----------------------UPDATING A MEETING CALENDAR FOR THE GROUP-------------------");
        ...
        public static String getTestCalendarAsJSON(final String frequency, final String interval,
        ...
        public static void verifyCalendarCreatedOnServer(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec, final Integer generatedGroupId,
                        final Integer generatedCalendarId) {
                System.out.println("-------------------CHECK CALENDAR DETAILS-------------------------\n");
                final String CLIENT_URL = "/fineract-provider/api/v1/groups/" + generatedGroupId + "?associations=all&"
                                + Utils.TENANT_IDENTIFIER;
                final String responseCalendarDetailsinJSON = Utils.performServerGet(requestSpec, responseSpec,
                                CLIENT_URL, "collectionMeetingCalendar");
        ...
        public static Integer createMeetingForGroup(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec, final Integer groupId, final String startDate,
                        final String frequency, final String interval, final String repeatsOnDay) {
                ...
                final String CALENDAR_RESOURCE_URL = BASE_URL + Center_Entity + groupId + ENITY_NAME + "?"
                                + Utils.TENANT_IDENTIFIER;
        ...
        public static Integer updateMeetingCalendarForCenter(final RequestSpecification requestSpec,
                        final ResponseSpecification responseSpec, Integer centerId, String calendarID, String oldDate,
                        String startDate) {

                System.out.println(
                                "----------------------UPADATING A MEETING CALENDAR FOR THE CENTER-------------------");
