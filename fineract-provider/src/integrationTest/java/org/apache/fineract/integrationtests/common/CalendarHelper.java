...
public class CalendarHelper {
  ...
  public static Integer createMeetingCalendarForGroup(
    ...
    final String CALENDAR_RESOURCE_URL =
        BASE_URL + PARENT_ENTITY_NAME + groupId + ENITY_NAME + "?" + Utils.TENANT_IDENTIFIER;
    ...
    return Utils.performServerPost(
        ...
        getTestCalendarAsJSON(frequency, interval, repeatsOnDay, startDate),
        "resourceId");
  }

  public static Integer updateMeetingCalendarForGroup(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer groupId,
      String calendarID,
    ...
    LOG.info(
        "---------------------------------UPDATING A MEETING CALENDAR FOR THE"
            + " GROUP------------------------------");

    final String CALENDAR_RESOURCE_URL =
        BASE_URL + PARENT_ENTITY_NAME + groupId + ENITY_NAME + "/" + calendarID;
  ...
  public static String getTestCalendarAsJSON(
      final String frequency,
      final String interval,
      final String repeatsOnDay,
      final String startDate) {
  ...
  public static void verifyCalendarCreatedOnServer(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
    ...
    final String responseCalendarDetailsinJSON =
        Utils.performServerGet(requestSpec, responseSpec, CLIENT_URL, "collectionMeetingCalendar");
  ...
  public static Integer createMeetingForGroup(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      final Integer groupId,
      final String startDate,
    ...
    final String CALENDAR_RESOURCE_URL =
        BASE_URL + Center_Entity + groupId + ENITY_NAME + "?" + Utils.TENANT_IDENTIFIER;
  ...
  public static Integer updateMeetingCalendarForCenter(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
      Integer centerId,
      String calendarID,
    ...
    LOG.info(
        "---------------------------------UPADATING A MEETING CALENDAR FOR THE"
            + " CENTER------------------------------");
    ...
    return Utils.performServerPut(
        ...
        responseSpec,
        CALENDAR_RESOURCE_URL,
        getTestCalendarMeetingAsJSON(oldDate, startDate),
        "resourceId");
  }
