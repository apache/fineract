...
public class GroupTest {
  ...
  public void checkGroupFunctions() {
    ...
    groupID =
        GroupHelper.disAssociateClient(
            this.requestSpec, this.responseSpec, groupID.toString(), clientID.toString());
    ...
    groupID =
        GroupHelper.updateGroup(
            this.requestSpec, this.responseSpec, updatedGroupName, groupID.toString());
    GroupHelper.verifyGroupDetails(
        this.requestSpec, this.responseSpec, groupID, "name", updatedGroupName);
  ...
  public void assignStaffToGroup() {
    ...
    Integer updateGroupId =
        GroupHelper.updateGroup(
            this.requestSpec, this.responseSpec, updateGroupName, groupID.toString());
    ...
    HashMap assignStaffGroupId =
        (HashMap)
            GroupHelper.assignStaff(
                this.requestSpec,
                this.responseSpec,
                groupID.toString(),
    ...
    assertEquals(
        ...
        assignStaffGroupId.get("staffId"),
        createStaffId1);

    // assign staff "createStaffId2" to client
    final HashMap assignStaffToClientChanges =
        (HashMap)
            ClientHelper.assignStaffToClient(
                this.requestSpec,
                this.responseSpec,
                clientID.toString(),
                createStaffId2.toString());
    assertEquals(
        "Verify assigned staff id is the same as id sent",
        assignStaffToClientChanges.get("staffId"),
        createStaffId2);
    ...
    final HashMap assignStaffAndInheritStaffForClientAccounts =
        (HashMap)
    ...
    final Integer getClientStaffId =
        ClientHelper.getClientsStaffId(this.requestSpec, this.responseSpec, clientID.toString());
    ...
    assertNotEquals(
        ...
        assignStaffAndInheritStaffForClientAccounts.get("staffId"),
        createStaffId2);
    assertEquals(
