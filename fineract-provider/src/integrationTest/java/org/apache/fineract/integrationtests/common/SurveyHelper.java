...
public class SurveyHelper {
  ...
  private static final String FULFIL_SURVEY_URL =
      "/fineract-provider/api/v1/survey/ppi_kenya_2009/clientId?" + Utils.TENANT_IDENTIFIER;

  public static Integer fulfilSurvey(
  ...
  public static Integer fulfilSurvey(
    ...
    return Utils.performServerPost(
        requestSpec, responseSpec, FULFIL_SURVEY_URL, getTestPPIAsJSON(), "clientId");
  }
  ...
  public static void verifySurveyCreatedOnServer(
      final RequestSpecification requestSpec,
      final ResponseSpecification responseSpec,
    ...
    final String SURVEY_URL =
        "/fineract-provider/api/v1/Survey/ppi_kenya_2009/clientid/entryId"
            + generatedClientID
            + "?"
            + Utils.TENANT_IDENTIFIER;
    final Integer responseClientID =
        Utils.performServerGet(requestSpec, responseSpec, SURVEY_URL, "id");
