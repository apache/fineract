...
public class PaymentTypeIntegrationTest {
    ...
    public void testPaymentType() {
        ...
        Integer position = 1;
        Long fundSourceAccountId = accountHelper.createAssetAccount().getAccountID().longValue();

        Integer paymentTypeId = PaymentTypeHelper.createPaymentType(requestSpec, responseSpec, name, description, isCashPayment, position,fundSourceAccountId);
        ...
        Assert.assertEquals(fundSourceAccountId, paymentTypeResponse.getFundSourceAccountId());
        ...
        Long newFundSourceAccountId = accountHelper.createAssetAccount().getAccountID().longValue();
        ...
        request.put("fundSourceAccountId", newFundSourceAccountId);
        ...
        Assert.assertEquals(newFundSourceAccountId, paymentTypeUpdatedResponse.getFundSourceAccountId());
