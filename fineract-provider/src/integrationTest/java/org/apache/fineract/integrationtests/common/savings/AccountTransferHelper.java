...
public class AccountTransferHelper {
  ...
  private static final String LOAN_REFUND_BY_TRANSFER_URL =
      "/fineract-provider/api/v1/accounttransfers/refundByTransfer";
  ...
  public Integer accountTransfer(
    ...
    final String accountTransferJSON =
        new AccountTransferHelper(this.requestSpec, this.responseSpec) //
            .withTransferOnDate(ACCOUNT_TRANSFER_DATE) //
            .build(
                fromAccountId.toString(),
                fromClientId.toString(),
  ...
  public Integer refundLoanByTransfer(
      final String date,
      final Integer fromClientId,
      final Integer fromAccountId,
      final Integer toClientId,
    ...
    return Utils.performServerPost(
        this.requestSpec,
        this.responseSpec,
        LOAN_REFUND_BY_TRANSFER_URL + "?" + Utils.TENANT_IDENTIFIER,
        accountTransferJSON,
        "savingsId");
  }
}
