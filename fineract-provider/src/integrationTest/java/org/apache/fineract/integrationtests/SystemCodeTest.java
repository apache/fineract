...
public class SystemCodeTest {
  ...
  public void testCreateCode() {
    ...
    final Integer createResponseId =
        (Integer)
            CodeHelper.createCode(
                this.requestSpec,
                this.responseSpec,
                codeName,
    ...
    final HashMap newCodeAttributes =
        (HashMap) CodeHelper.getCodeById(this.requestSpec, this.responseSpec, createResponseId, "");

    Assert.assertNotNull(newCodeAttributes);
    assertEquals(
        "Verify value of codeId",
        createResponseId,
        newCodeAttributes.get(CodeHelper.CODE_ID_ATTRIBUTE_NAME));

    assertEquals(
        "Verify code name", codeName, newCodeAttributes.get(CodeHelper.CODE_NAME_ATTRIBUTE_NAME));
    assertEquals(
        "Verify system defined is false",
        false,
        newCodeAttributes.get(CodeHelper.CODE_SYSTEM_DEFINED_ATTRIBUTE_NAME));

    // update code
    final HashMap updateChangeResponse =
        (HashMap)
            CodeHelper.updateCode(
                this.requestSpec,
                this.responseSpec,
                createResponseId,
                codeName + "(CHANGE)",
    ...
    assertEquals(
        "Verify code name updated",
        codeName + "(CHANGE)",
        updateChangeResponse.get(CodeHelper.CODE_NAME_ATTRIBUTE_NAME));

    // delete code
    final Integer deleteResponseId =
        (Integer)
            CodeHelper.deleteCodeById(
                this.requestSpec,
                this.responseSpec,
                createResponseId,
                CodeHelper.RESPONSE_ID_ATTRIBUTE_NAME);
    ...
    // verify code deleted
    final HashMap deletedCodeValues =
        (HashMap)
            CodeHelper.getCodeById(
                this.requestSpec, this.generalResponseSpec, deleteResponseId, "");
  ...
  public void testPreventCreateDuplicateCode() {
    ...
    // verify code deleted
    final HashMap deletedCodeAttributes =
        (HashMap)
            CodeHelper.getCodeById(
                this.requestSpec, this.generalResponseSpec, deleteResponseId, "");
    ...
    assertNull(
        "Verify value of codeId", deletedCodeAttributes.get(CodeHelper.CODE_ID_ATTRIBUTE_NAME));
  ...
  public void testUpdateDeleteSystemDefinedCode() {
    ...
    final HashMap systemDefinedCode =
        (HashMap) CodeHelper.getSystemDefinedCodes(this.requestSpec, this.responseSpec);
    ...
    final List<HashMap> updateError =
        (List)
            CodeHelper.updateCode(
                this.requestSpec,
                this.generalResponseSpec,
  ...
  public void testCodeValuesNotAssignedToTable() {
    ...
    // create code
    final Integer createCodeResponseId =
        (Integer)
            CodeHelper.createCode(
                this.requestSpec,
                this.responseSpec,
    ...
    final Integer createCodeValueResponseId1 =
        (Integer)
    ...
    final Integer createCodeValueResponseId2 =
        (Integer)
            CodeHelper.createCodeValue(
                this.requestSpec,
                this.responseSpec,
    ...
    final List<HashMap> codeValuesList =
        (List)
            CodeHelper.getCodeValuesForCode(
                this.requestSpec, this.responseSpec, createCodeResponseId, "");
    ...
    final HashMap codeValuesAttributes1 =
        (HashMap)
            CodeHelper.getCodeValueById(
                this.requestSpec,
                this.responseSpec,
                createCodeResponseId,
    ...
    final HashMap codeValuesAttributes2 =
        (HashMap)
            CodeHelper.getCodeValueById(
                this.requestSpec,
                this.responseSpec,
    ...
    // update code value 1
    final HashMap codeValueChanges =
        (HashMap)
            CodeHelper.updateCodeValue(
                this.requestSpec,
                this.responseSpec,
                createCodeResponseId,
                createCodeValueResponseId1,
    ...
    assertEquals(
        "Verify changed code value name", codeValueChanges.get("name"), codeValue1 + "CHANGE");

    assertEquals(
        "Verify changed code value description",
        codeValueChanges.get("description"),
        codeDescription1 + "CHANGE");

    // delete code value
    Integer deletedCodeValueResponseId1 =
        (Integer)
            CodeHelper.deleteCodeValueById(
                this.requestSpec,
                this.generalResponseSpec,
                createCodeResponseId,
                createCodeValueResponseId1,
    ...
    final ArrayList<HashMap> deletedCodeValueAttributes1 =
        (ArrayList<HashMap>)
            CodeHelper.getCodeValueById(
                ...
                this.generalResponseSpec,
                createCodeResponseId,
                deletedCodeValueResponseId1,
                CommonConstants.RESPONSE_ERROR);

    assertEquals(
        "error.msg.codevalue.id.invalid",
        deletedCodeValueAttributes1.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));

    final List<HashMap> deletedCodeValuesList =
        (List)
            CodeHelper.getCodeValuesForCode(
                this.requestSpec, this.responseSpec, createCodeResponseId, "");
    ...
    final Integer deletedCodeValueResponseId2 =
        (Integer)
            CodeHelper.deleteCodeValueById(
                this.requestSpec,
                this.generalResponseSpec,
    ...
    final List<HashMap> deletedCodeValuesList1 =
        (List)
            CodeHelper.getCodeValuesForCode(
                this.requestSpec, this.responseSpec, createCodeResponseId, "");
