...
public class ExternalServicesConfigurationHelper {
    ...
    public static ArrayList<HashMap> getExternalServicesConfigurationByServiceName(final RequestSpecification requestSpec,
        ...
        final String getExternalServicesConfigByServiceNameURL = "/fineract-provider/api/v1/externalservice/" + serviceName + "?"
                + Utils.TENANT_IDENTIFIER;
        // system.out.println("------------------------ RETRIEVING GLOBAL
        // CONFIGURATION
        // BY ID -------------------------");
        return Utils.performServerGet(requestSpec, responseSpec, getExternalServicesConfigByServiceNameURL, "");
    }
    ...
    public static HashMap updateValueForExternaServicesConfiguration(final RequestSpecification requestSpec,
        ...
        final String externalServicesConfigUpdateURL = "/fineract-provider/api/v1/externalservice/" + serviceName + "?"
                + Utils.TENANT_IDENTIFIER;
        // system.out.println("---------------------------------UPDATE VALUE FOR
        // GLOBAL
        // CONFIG---------------------------------------------");
        HashMap map = Utils.performServerPut(requestSpec, responseSpec, externalServicesConfigUpdateURL,
