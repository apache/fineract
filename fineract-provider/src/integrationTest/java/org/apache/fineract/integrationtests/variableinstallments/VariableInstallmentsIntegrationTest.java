...
public class VariableInstallmentsIntegrationTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(VariableInstallmentsIntegrationTest.class);
  ...
  public void testVariableLoanProductCreation() {
    final String json =
        VariableInstallmentsDecliningBalanceHelper.createLoanProductWithVaribleConfig(false, NONE);
    final Integer loanProductID = this.loanTransactionHelper.getLoanProductId(json);
    LOG.info(
        "------------------------------RETRIEVING CREATED LOAN PRODUCT DETAILS"
            + " ---------------------------------------");
    Map loanProduct =
        (Map)
            loanTransactionHelper.getLoanProductDetail(
  ...
  public void testLoanProductCreation() {
    final String josn =
        VariableInstallmentsDecliningBalanceHelper.createLoanProductWithoutVaribleConfig(
            false, NONE);
  ...
  public void testDeleteInstallmentsWithDecliningBalanceEqualInstallments() {
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    ...
    final String json =
        VariableInstallmentsDecliningBalanceHelper.applyForLoanApplication(
            clientID, loanProductID, null, null, "1,00,000.00");
    ...
    String toDeletedata =
        VariableInstallmentsDecliningBalanceHelper.createDeleteVariations(toDelete);
    ...
    ArrayList toVerifyData =
        VariableInstallmentsDecliningBalanceHelper.constructVerifyData(
  ...
  private void assertAfterSubmit(ArrayList<Map> serverData, ArrayList<Map> expectedData) {
    ...
    for (int i = 0; i < serverData.size(); i++) {
      ...
      Assert.assertTrue(
          VariableInstallmentsDecliningBalanceHelper.formatDate(
                  (ArrayList) serverMap.get("dueDate"))
              .equals(expectedMap.get("dueDate")));
      Assert.assertTrue(
          serverMap
              .get("totalOutstandingForPeriod")
              .toString()
              .equals(expectedMap.get("installmentAmount")));
    }
  }
  ...
  public void testAddInstallmentsWithDecliningBalanceEqualInstallments() {
    ...
    // Result: 20 October 2011 - 21,215.84, 31 October 2011 - 5000, 20 November 2011 26,477.31, 20
    // December 2011 26,477.31, 20 January 2012 25,947.7
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsDecliningBalanceHelper.createLoanProductWithVaribleConfig(false, NONE);
  ...
  public void testModifyInstallmentWithDecliningBalanceEqualInstallments() {
    ...
    // Result 20 October 2011 - 30000.0, 20 November 2011 - 24,966.34, 20 December 2011 - 24,966.34,
    // 20 January 2012 - 24,966.33
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsDecliningBalanceHelper.createLoanProductWithVaribleConfig(false, NONE);
    ...
    Map repaymentSchedule = (Map) list.get("repaymentSchedule");
    ArrayList periods = (ArrayList) repaymentSchedule.get("periods");
    String addVariationsjsondata =
        VariableInstallmentsDecliningBalanceHelper.createModifiyVariations(
            (Map) periods.get(1)); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsDecliningBalanceHelper.constructVerifyData(
            new String[] {
              "20 October 2011", "20 November 2011", "20 December 2011", "20 January 2012"
            },
  ...
  public void testAllVariationsDecliningBalancewithEqualInstallments() {
    // Request: Delete 20 December 2011 26,262.38, Modify 20 November 2011 from 26,262.38 to 30000,
    // Add 25 December 2011 5000
    // Result: 20 October 2011 - 26262.38, 20 November 2011 - 30000, 25 December 2011 - 5000, 20
    // January 2012 - 44077
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
    ...
    String addVariationsjsondata =
        VariableInstallmentsDecliningBalanceHelper
            .createAllVariations(); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsDecliningBalanceHelper.constructVerifyData(
            new String[] {
              "20 October 2011", "20 November 2011", "25 December 2011", "20 January 2012"
            },
  ...
  public void testAllVariationsDecliningBalancewithEqualPrincipal() {
    // Request: Delete 20 December 2011 26,262.38, Modify 20 November 2011 from 26,262.38 to 30000,
    // Add 25 December 2011 5000
    // Result: 20 October 2011 - 27000.0, 20 November 2011 - 31500.0, 25 December 2011 - 6045.16, 20
    // January 2012 - 40670.97
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsDecliningBalanceHelper
    ...
    ClientHelper.verifyClientCreatedOnServer(this.requestSpec, this.responseSpec, clientID);
    final String json =
        VariableInstallmentsDecliningBalanceHelper.applyForLoanApplicationWithEqualPrincipal(
            clientID, loanProductID, null, null, "1,00,000.00");
    final Integer loanID = this.loanTransactionHelper.getLoanId(json);
    HashMap loanStatusHashMap =
        LoanStatusChecker.getStatusOfLoan(this.requestSpec, this.responseSpec, loanID);
    ...
    String addVariationsjsondata =
        VariableInstallmentsDecliningBalanceHelper
            .createAllVariationsWithEqualPrincipal(); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsDecliningBalanceHelper.constructVerifyData(
  ...
  public void testModifyDatesWithDecliningBalanceEqualInstallments() {
    ...
    // Result 20 October 2011 -26262.38, 20 November 2011 - 26262.38, 04 January 2012 -20000, 08
    // February 2012 - 33242.97
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsDecliningBalanceHelper.createLoanProductWithVaribleConfig(false, NONE);
    ...
    //
    String addVariationsjsondata =
        VariableInstallmentsDecliningBalanceHelper.createModifiyDateVariations(
            new String[] {"20 December 2011", "20 January 2012"},
            new String[] {"04 January 2012", "08 February 2012"},
            new String[] {"20000"}); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsDecliningBalanceHelper.constructVerifyData(
            new String[] {
              "20 October 2011", "20 November 2011", "04 January 2012", "08 February 2012"
            },
  ...
  public void testDeleteInstallmentsWithInterestTypeFlat() {
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsFlatHelper.createLoanProductWithVaribleConfig(false, NONE);
    Integer loanProductID = this.loanTransactionHelper.getLoanProductId(loanProductJson);
    final Integer clientID = ClientHelper.createClient(this.requestSpec, this.responseSpec);
    ClientHelper.verifyClientCreatedOnServer(this.requestSpec, this.responseSpec, clientID);
    final String json =
        VariableInstallmentsFlatHelper.applyForLoanApplication(
            clientID, loanProductID, null, null, "1,00,000.00");
    final Integer loanID = this.loanTransactionHelper.getLoanId(json);
    HashMap loanStatusHashMap =
        LoanStatusChecker.getStatusOfLoan(this.requestSpec, this.responseSpec, loanID);
    ...
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsFlatHelper.constructVerifyData(
            new String[] {"20 November 2011", "20 December 2011", "20 January 2012"},
  ...
  public void testAddInstallmentsWithInterestTypeFlat() {
    // 31 October 2011 - 5000
    // Result: 20 October 2011 - 21600.0, 31 October 2011 - 6600.0, 20 November 2011 26600.0, 20
    // December 2011 26600.0, 20 January 2012 26600.0
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsFlatHelper.createLoanProductWithVaribleConfig(false, NONE);
  ...
  public void testModifyInstallmentsWithInterestTypeisFlat() {
    // 20 October 2011 - 30000 modify
    // Result 20 October 2011 - 32000.0, 20 November 2011 - 25333.33, 20 December 2011 - 25333.33,
    // 20 January 2012 - 25333.34
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsFlatHelper.createLoanProductWithVaribleConfig(false, NONE);
    ...
    ArrayList periods = (ArrayList) repaymentSchedule.get("periods");
    String addVariationsjsondata =
        VariableInstallmentsFlatHelper.createModifiyVariations(
            (Map) periods.get(1)); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
  ...
  public void testAllVariationsWithInterestTypeFlat() {
    // Request: Delete 20 December 2011 25000.0, Modify 20 November 2011 from 25,000 to 30000, Add
    // 25 December 2011 5000
    // Result: 20 October 2011 - 27000.0, 20 November 2011 - 32000.0, 25 December 2011 - 7000.0, 20
    // January 2012 - 42000.0
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsFlatHelper.createLoanProductWithVaribleConfig(false, NONE);
    ...
    String addVariationsjsondata =
        VariableInstallmentsFlatHelper.createAllVariations(); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
    ArrayList newperiods = (ArrayList) modifiedReschdule.get("periods");
    ArrayList toVerifyData =
        VariableInstallmentsFlatHelper.constructVerifyData(
  ...
  public void testModifyDatesWithInterestTypeFlat() {
    // Modify 20 December 2011:25000 -> 04 January 2012:20000
    // Modify 20 January 2012 -> 08 February 2012
    // Result 20 October 2011 -27306.45, 20 November 2011 - 27306.45, 04 January 2012 -22306.45, 08
    // February 2012 - 32306.46
    VariableIntallmentsTransactionHelper transactionHelper =
        new VariableIntallmentsTransactionHelper(requestSpec, responseSpec);
    final String loanProductJson =
        VariableInstallmentsFlatHelper.createLoanProductWithVaribleConfig(false, NONE);
    ...
    //
    String addVariationsjsondata =
        VariableInstallmentsFlatHelper.createModifiyDateVariations(
            new String[] {"20 December 2011", "20 January 2012"},
            new String[] {"04 January 2012", "08 February 2012"},
            new String[] {"20000"}); // 0th position will have disbursement
    HashMap modifiedReschdule = transactionHelper.validateVariations(addVariationsjsondata, loanID);
