...
public class GroupLoanIntegrationTest {
  ...
  public void checkGlimAccountCommands() {
    ...
    HashMap loanStatusHashMap =
        this.loanTransactionHelper.approveGlimAccount(
            this.requestSpec, this.responseSpec, approvalFormData, glimId);
  ...
  public void getGlimAccountByGroupId() {
    ...
    final List<String> retrievedGlimId =
        GroupHelper.verifyRetrieveGlimAccountsByGroupId(
  ...
  public void getGlimAccountByGlimId() {
    ...
    final List<String> retrievedGlimAccountId =
        GroupHelper.verifyRetrieveGlimAccountsByGlimId(this.requestSpec, this.responseSpec, glimId);
  ...
  private HashMap<String, Integer> applyForGlimApplication(
      final Integer clientID, final Integer groupID, final Integer loanProductID) {
    LOG.info(
        "--------------------------------APPLYING FOR LOAN"
            + " APPLICATION--------------------------------");
    final String GlimApplicationJSON =
        new LoanApplicationTestBuilder() //
            .withPrincipal("12,000.00") //
            .withLoanTermFrequency("4") //
            .withLoanTermFrequencyAsMonths() //
