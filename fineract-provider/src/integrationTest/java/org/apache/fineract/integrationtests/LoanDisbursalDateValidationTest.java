  ...
  public void LoanApplicationValidateDisbursalDate() {
    ...
    final Integer loanProductID =
        this.loanTransactionHelper.getLoanProductId(
            new LoanProductTestBuilder().withSyncExpectedWithDisbursementDate(true).build(null));
    LOG.info(
    ...
    List<HashMap> disbursalError =
        (List<HashMap>)
            this.loanTransactionHelper.disburseLoan(
                disbursalDate, loanID, this.responseForbiddenError);
