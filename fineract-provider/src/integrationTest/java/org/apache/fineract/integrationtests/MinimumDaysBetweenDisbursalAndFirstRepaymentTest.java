...
public class MinimumDaysBetweenDisbursalAndFirstRepaymentTest {
  ...
  public void
    ...
    List<HashMap> error =
        (List<HashMap>)
            this.loanTransactionHelper.createLoanAccount(
                loanApplicationJSON, CommonConstants.RESPONSE_ERROR);
    assertEquals(
  ...
  private void createGroupEntityWithCalendar() {
    this.groupId =
        GroupHelper.createGroup(this.requestSpec, this.responseSpec, this.groupActivationDate);
  ...
  private void createLoanProductEntity(final String minimumDaysBetweenDisbursalAndFirstRepayment) {
    final String loanProductJSON =
        new LoanProductTestBuilder()
            ...
            .withMinimumDaysBetweenDisbursalAndFirstRepayment(
