...
public class SkipRepaymentOnMonthFirstTest {
  ...
  public void testSkippingRepaymentOnFirstDayOfMonth() {
    this.globalConfigurationHelper =
        new GlobalConfigurationHelper(this.requestSpec, this.responseSpec);

    // Retrieving All Global Configuration details
    final ArrayList<HashMap> globalConfig =
        this.globalConfigurationHelper.getAllGlobalConfigurations(
            this.requestSpec, this.responseSpec);
  ...
  public void checkRepaymentSkipOnFirstDayOfMonth() {
    ...
    Integer calendarID =
        calendarHelper.createMeetingForGroup(
            requestSpec, responseSpec, groupID, startDate, frequency, interval, null);
  ...
  private Integer applyForLoanApplication(
      final Integer groupID, final Integer loanProductID, Integer calendarID, Integer clientID) {
    LOG.info(
        "--------------------------------APPLYING FOR LOAN"
            + " APPLICATION--------------------------------");
  ...
  private void verifyLoanRepaymentSchedule(final ArrayList<HashMap> loanSchedule) {
    ...
    assertEquals(
        ...
        new ArrayList<>(Arrays.asList(2011, 10, 15)),
    ...
    assertEquals(
        ...
        new ArrayList<>(Arrays.asList(2011, 11, 15)),
    ...
    assertEquals(
        ...
        new ArrayList<>(Arrays.asList(2011, 12, 15)),
    ...
    assertEquals(
        ...
        new ArrayList<>(Arrays.asList(2012, 1, 15)),
