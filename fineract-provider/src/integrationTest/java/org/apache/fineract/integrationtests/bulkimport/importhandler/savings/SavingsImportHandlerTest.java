...
public class SavingsImportHandlerTest {
  ...
  public void testSavingsImport() throws InterruptedException, IOException, ParseException {
    ...
    Integer outcome_sp_creaction =
        savingsProductHelper.createSavingsProduct(jsonSavingsProduct, requestSpec, responseSpec);
    ...
    firstSavingsRow
        .createCell(SavingsConstants.OFFICE_NAME_COL)
    ...
    firstSavingsRow
        .createCell(SavingsConstants.CLIENT_NAME_COL)
        .setCellValue(
            savingsSheet
                .getRow(1)
                .getCell(SavingsConstants.LOOKUP_CLIENT_NAME_COL)
                .getStringCellValue());
    Sheet savingsProductSheet =
        workbook.getSheet(TemplatePopulateImportConstants.PRODUCT_SHEET_NAME);
    firstSavingsRow
        .createCell(SavingsConstants.PRODUCT_COL)
    ...
    firstSavingsRow
        .createCell(SavingsConstants.FIELD_OFFICER_NAME_COL)
    ...
    firstSavingsRow
        .createCell(SavingsConstants.INTEREST_POSTING_PERIOD_COL)
        .setCellValue(savingsProductSheet.getRow(1).getCell(4).getStringCellValue());
    firstSavingsRow
        .createCell(SavingsConstants.INTEREST_CALCULATION_COL)
        .setCellValue(savingsProductSheet.getRow(1).getCell(5).getStringCellValue());
    firstSavingsRow
        .createCell(SavingsConstants.INTEREST_CALCULATION_DAYS_IN_YEAR_COL)
    ...
    firstSavingsRow
        .createCell(SavingsConstants.APPLY_WITHDRAWAL_FEE_FOR_TRANSFERS)
        .setCellValue("False");
    firstSavingsRow.createCell(SavingsConstants.ALLOW_OVER_DRAFT_COL).setCellValue("False");
    firstSavingsRow
        .createCell(SavingsConstants.OVER_DRAFT_LIMIT_COL)
    ...
    Sheet OutputSavingsSheet =
        Outputworkbook.getSheet(TemplatePopulateImportConstants.SAVINGS_ACCOUNTS_SHEET_NAME);
