...
public class ClientSavingsIntegrationTest {
        ...
        public void testSavingsAccount() {
                ...
                HashMap modifications = this.savingsAccountHelper.updateSavingsAccount(clientID, savingsProductID,
                                savingsId, ACCOUNT_TYPE_INDIVIDUAL);
        ...
        public void testSavingsAccount_CLOSE_APPLICATION() {
                ...
                ArrayList<HashMap> savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                .closeSavingsAccountAndGetBackRequiredField(savingsId, withdrawBalance,
        ...
        public void testSavingsAccount_WITH_ENFORCE_MIN_BALANCE() {
                ...
                final boolean allowOverdraft = false;
                final Integer savingsProductID = createSavingsProduct(this.requestSpec, this.responseSpec,
                                openningBalance, minBalanceForInterestCalculation, minRequiredBalance,
                                enforceMinRequiredBalance, allowOverdraft);
                Assert.assertNotNull(savingsProductID);
                ...
                final Integer savingsActivationChargeId = ChargesHelper.createCharges(this.requestSpec,
                                this.responseSpec, ChargesHelper.getSavingsActivationFeeJSON());
                ...
                ArrayList<HashMap> savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                .withdrawalFromSavingsAccount(savingsId, withdrawAmt, TRANSACTION_DATE,
                ...
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                DEPOSIT_AMOUNT, TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                HashMap depositTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                ...
                Integer withdrawTransactionId = (Integer) this.savingsAccountHelper.withdrawalFromSavingsAccount(
                                savingsId, withdrawAmt, TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                HashMap withdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
        ...
        public void testSavingsAccount_DELETE_APPLICATION() {
                ...
                List<HashMap> error1 = (List<HashMap>) savingsAccountHelperValidationError
                                .deleteSavingsApplication(savingsId, CommonConstants.RESPONSE_ERROR);
                ...
                List<HashMap> error = savingsAccountHelperValidationError.getSavingsCollectionAttribute(savingsId,
                                CommonConstants.RESPONSE_ERROR);
                assertEquals("error.msg.saving.account.id.invalid",
        ...
        public void testSavingsAccount_REJECT_APPLICATION() {
                ...
                error1 = savingsAccountHelperValidationError.rejectApplicationWithErrorCode(savingsId,
        ...
        public void testSavingsAccountTransactions() {
                ...
                List<HashMap> error = (List) savingsAccountHelperValidationError.withdrawalFromSavingsAccount(savingsId,
                                "100", SavingsAccountHelper.TRANSACTION_DATE, CommonConstants.RESPONSE_ERROR);
                assertEquals("error.msg.savingsaccount.transaction.account.is.not.active",
                                error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));

                error = (List) savingsAccountHelperValidationError.depositToSavingsAccount(savingsId, "100",
                ...
                Integer withdrawTransactionId = (Integer) this.savingsAccountHelper.withdrawalFromSavingsAccount(
                                savingsId, WITHDRAW_AMOUNT, SavingsAccountHelper.TRANSACTION_DATE,
                                CommonConstants.RESPONSE_RESOURCE_ID);
                HashMap withdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                withdrawTransactionId);
                balance -= new Float(WITHDRAW_AMOUNT);
                assertEquals("Verifying Withdrawal Amount", new Float(WITHDRAW_AMOUNT),
                                withdrawTransaction.get("amount"));
                assertEquals("Verifying Balance after Withdrawal", balance, withdrawTransaction.get("runningBalance"));

                Integer newWithdrawTransactionId = this.savingsAccountHelper.updateSavingsAccountTransaction(savingsId,
                                withdrawTransactionId, WITHDRAW_AMOUNT_ADJUSTED);
                HashMap newWithdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                newWithdrawTransactionId);
                balance = balance + new Float(WITHDRAW_AMOUNT) - new Float(WITHDRAW_AMOUNT_ADJUSTED);
                assertEquals("Verifying adjusted Amount", new Float(WITHDRAW_AMOUNT_ADJUSTED),
                ...
                newWithdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                withdrawTransactionId);
                ...
                assertEquals("error.msg.savingsaccount.transaction.in.the.future",
                                error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
        ...
        public void testSavingsAccountCharges() {
                ...
                ArrayList<HashMap> savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                .inactivateCharge(annualSavingsChargeId, savingsId, CommonConstants.RESPONSE_ERROR);
                ...
                for (int i = 1; i <= n; i++) {
                        ...
                        HashMap paidCharge = this.savingsAccountHelper.getSavingsCharge(savingsId,
                ...
                Integer inactivatedChargeId = (Integer) this.savingsAccountHelper.inactivateCharge(
                ...
                savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                .inactivateCharge(monthlySavingsCharge, savingsId, CommonConstants.RESPONSE_ERROR);
                assertEquals("validation.msg.savingsaccountcharge.inactivation.of.charge.not.allowed.when.charge.is.due",
                                savingsAccountErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));

                this.savingsAccountHelper.waiveCharge((Integer) savingsChargeForWaive.get("id"), savingsId);
                HashMap waiveCharge = this.savingsAccountHelper.getSavingsCharge(savingsId,
                ...
                waiveCharge = this.savingsAccountHelper.getSavingsCharge(savingsId,
                                (Integer) savingsChargeForWaive.get("id"));
                BigDecimal totalWaiveAmount = BigDecimal
                                .valueOf(Double.valueOf((Float) savingsChargeForWaive.get("amount")));
                ...
                savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                .inactivateCharge(weeklySavingsFeeId, savingsId, CommonConstants.RESPONSE_ERROR);
                assertEquals("validation.msg.savingsaccountcharge.inactivation.of.charge.not.allowed.when.charge.is.due",
                                savingsAccountErrorData.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
                ...
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                "100000", SavingsAccountHelper.TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                ...
                LocalDate nextDueDate = new LocalDate((Integer) nextDueDates.get(0), (Integer) nextDueDates.get(1),
                                (Integer) nextDueDates.get(2));
                LocalDate expectedNextDueDate = new LocalDate((Integer) dates.get(0), (Integer) dates.get(1),
                                (Integer) dates.get(2)).plusWeeks((Integer) paidCharge.get("feeInterval"));
                assertEquals(expectedNextDueDate, nextDueDate);
        }

        /***
         * Test case for overdraft account functionality. Open account with zero
         * balance, perform transactions then post interest and verify posted interest
         */
        @SuppressWarnings("unchecked")
        @Test
        public void testSavingsAccountWithOverdraft() {
                ...
                final Integer savingsProductID = createSavingsProduct(this.requestSpec, this.responseSpec,
                                zeroOpeningBalance, minBalanceForInterestCalculation, minRequiredBalance,
                                enforceMinRequiredBalance, allowOverdraft);
                Assert.assertNotNull(savingsProductID);
                 ...
                 *
                 * @param activationDate this value is every time first day of previous month
                 */
                ...
                /***
                 * Perform withdraw transaction, verify account balance(account balance will go
                 * to negative as no deposits are there prior to this transaction)
                 */
                Integer withdrawTransactionId = (Integer) this.savingsAccountHelper.withdrawalFromSavingsAccount(
                 ...
                 *
                 * @param transactionDate this value is every time last day of previous month
                 */
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                DEPOSIT_AMOUNT, TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                HashMap depositTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                ...
                /***
                 * Calculate expected interest to be posted, interest should be posted for one
                 * day only because deposit transaction happened on last day of month before
                 * this account balance is negative.
                 */
                final Float nominalAnnualInterest = Float
                                .valueOf(accountDetails.get("nominalAnnualInterestRate").toString());
                ...
                /***
                 * Apply rounding on interestPosted, actualInterestPosted and verify both are
                 * same
                 */
        ...
        public void testSavingsAccountPostInterestOnLastDayWithOverdraft() {
                 ...
                 */
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                DEPOSIT_AMOUNT, WITHDRAWAL_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                HashMap depositTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                depositTransactionId);
                balance += new Float(DEPOSIT_AMOUNT);
                assertEquals("Verifying Deposit Amount", new Float(DEPOSIT_AMOUNT), depositTransaction.get("amount"));
                ...
                decimalFormat.applyPattern("#.###");
                interestPosted = new Float(decimalFormat.format(interestPosted));
                accountDetailsPostInterestPosted = new Float(decimalFormat.format(accountDetailsPostInterestPosted));
                ...
                accountDetailsPostInterestPosted = new Float(decimalFormat.format(accountDetailsPostInterestPosted));
                assertEquals("Verifying interest posted", interestPosted, accountDetailsPostInterestPosted);
                System.out.println("-----Post Interest As on Successfully Worked----------");
        ...
        public void testSavingsAccountPostInterestWithOverdraft() {
                ...
                summary = (HashMap) accountDetails.get("summary");
                ArrayList interestPostingTransaction = (ArrayList) ((HashMap) ((ArrayList) accountDetails
                                .get("transactions")).get(0)).get("date");
                Float accountDetailsPostInterestPosted = Float.valueOf(summary.get("totalInterestPosted").toString());
                ...
                decimalFormat.applyPattern("#.###");
                interestPosted = new Float(decimalFormat.format(interestPosted));
                // actualInterestPosted = new
                // Float(decimalFormat.format(accountDetailsPostInterestPosted));
                assertEquals("Verifying interest posted", interestPosted, accountDetailsPostInterestPosted);
                ...
                interestPostingDate.set((int) interestPostingTransaction.get(0),
                                (int) interestPostingTransaction.get(1) - 1, (int) interestPostingTransaction.get(2));
                ...
                if (TODYS_POSTING_DATE.equalsIgnoreCase(INTEREST_POSTING_DATE)) {
                        final SavingsAccountHelper validationErrorHelper = new SavingsAccountHelper(this.requestSpec,
                                        responseSpec);
                        validationErrorHelper.closeSavingsAccountPostInterestAndGetBackRequiredField(savingsId,
                                        withdrawBalance, CommonConstants.RESPONSE_ERROR, CLOSEDON_DATE);
                } else {
                        final SavingsAccountHelper validationErrorHelper = new SavingsAccountHelper(this.requestSpec,
                                        errorResponse);
                        ArrayList<HashMap> savingsAccountErrorData = (ArrayList<HashMap>) validationErrorHelper
                                        .closeSavingsAccountPostInterestAndGetBackRequiredField(savingsId,
                                                        withdrawBalance, CommonConstants.RESPONSE_ERROR, CLOSEDON_DATE);
                        assertEquals("error.msg.postInterest.notDone", savingsAccountErrorData.get(0)
        ...
        public void testPostInterestAsOnSavingsAccountWithOverdraft() {
                ...
                final Float nominalLastAnnualInterest = Float
                                .valueOf(accountDetails.get("nominalAnnualInterestRate").toString());
        ...
        public void testSavingsAccount_WITH_WITHHOLD_TAX() {
                ...
                final Integer savingsProductID = createSavingsProduct(this.requestSpec, this.responseSpec,
                                MINIMUM_OPENING_BALANCE, minBalanceForInterestCalculation, minRequiredBalance,
                                enforceMinRequiredBalance, allowOverdraft, String.valueOf(taxGroupId), false);
                Assert.assertNotNull(savingsProductID);
        ...
        public void testSavingsAccount_WITH_WITHHOLD_TAX_DISABLE_AT_ACCOUNT_LEVEL() {
                ...
                final HashMap changes = this.savingsAccountHelper.updateSavingsAccountWithHoldTaxStatus(savingsId,
                                false);
        ...
        public void testSavingsAccount_DormancyTracking() {
                ...
                final Integer savingsProductID = createSavingsProduct(this.requestSpec, this.responseSpec,
                                MINIMUM_OPENING_BALANCE, minBalanceForInterestCalculation, minRequiredBalance,
                                enforceMinRequiredBalance, allowOverdraft, String.valueOf(taxGroupId), true);
                Assert.assertNotNull(savingsProductID);
                ...
                for (int i = 0; i < 5; i++) {
                        ...
                        HashMap modifications = this.savingsAccountHelper.updateSavingsAccount(clientID,
                                        savingsProductID, savingsId, ACCOUNT_TYPE_INDIVIDUAL);
                        Assert.assertTrue(modifications.containsKey("submittedOnDate"));
                ...
                for (int i = 0; i < 4; i++) {
                        ...
                        Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(
                                        savingsList.get(i), DEPOSIT_AMOUNT, TRANSACTION_DATE,
                                        CommonConstants.RESPONSE_RESOURCE_ID);
                ...
                savingsStatusHashMap = SavingsStatusChecker.getStatusOfSavings(this.requestSpec, this.responseSpec,
                                savingsList.get(0));
                SavingsStatusChecker.verifySavingsIsActive(savingsStatusHashMap);
                savingsStatusHashMap = SavingsStatusChecker.getSubStatusOfSavings(this.requestSpec, this.responseSpec,
                                savingsList.get(0));
                ...
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(
                                savingsList.get(1), DEPOSIT_AMOUNT, TRANSACTION_DATE,
                                CommonConstants.RESPONSE_RESOURCE_ID);
                savingsStatusHashMap = SavingsStatusChecker.getStatusOfSavings(this.requestSpec, this.responseSpec,
                                savingsList.get(1));
                SavingsStatusChecker.verifySavingsIsActive(savingsStatusHashMap);
                ...
                depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsList.get(2),
                                DEPOSIT_AMOUNT, TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                savingsStatusHashMap = SavingsStatusChecker.getStatusOfSavings(this.requestSpec, this.responseSpec,
                                savingsList.get(2));
                SavingsStatusChecker.verifySavingsIsActive(savingsStatusHashMap);
        ...
        private Integer createSavingsProduct(final RequestSpecification requestSpec,
                ...
                return createSavingsProduct(requestSpec, responseSpec, minOpenningBalance,
                                minBalanceForInterestCalculation, minRequiredBalance, enforceMinRequiredBalance,
                                allowOverdraft, taxGroupId, false);
        }
        ...
        private Integer createTaxGroup(final String percentage) {
                ...
                final Integer taxComponentId = TaxComponentHelper.createTaxComponent(this.requestSpec,
                                this.responseSpec, percentage, liabilityAccountId);
                return TaxGroupHelper.createTaxGroup(this.requestSpec, this.responseSpec,
        ...
        public void testSavingsAccountBlockStatus() {
                ...
                depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                DEPOSIT_AMOUNT, SavingsAccountHelper.TRANSACTION_DATE,
                                CommonConstants.RESPONSE_RESOURCE_ID);
                ...
                withdrawTransactionId = (Integer) this.savingsAccountHelper.withdrawalFromSavingsAccount(savingsId,
                                WITHDRAW_AMOUNT, SavingsAccountHelper.TRANSACTION_DATE,
                                CommonConstants.RESPONSE_RESOURCE_ID);
                withdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId, withdrawTransactionId);
                balance -= new Float(WITHDRAW_AMOUNT);
                assertEquals("Verifying Withdrawal Amount", new Float(WITHDRAW_AMOUNT),
                ...
                Integer holdTransactionId = (Integer) this.savingsAccountHelper.holdAmountInSavingsAccount(savingsId,
                                String.valueOf(balance - 100), SavingsAccountHelper.TRANSACTION_DATE,
                                CommonConstants.RESPONSE_RESOURCE_ID);
                ...
                withdrawTransactionId = (Integer) this.savingsAccountHelper.withdrawalFromSavingsAccount(savingsId,
                                "300", todayDate, CommonConstants.RESPONSE_RESOURCE_ID);
                withdrawTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId, withdrawTransactionId);
        ...
        public void testAccountBalanceAfterTransactionReversal() {
                ...
                Integer depositTransactionId = (Integer) this.savingsAccountHelper.depositToSavingsAccount(savingsId,
                                "500", SavingsAccountHelper.TRANSACTION_DATE, CommonConstants.RESPONSE_RESOURCE_ID);
                ...
                final Integer chargeId = this.savingsAccountHelper.addChargesForSavingsWithDueDate(savingsId,
                                savingsChargeId, SavingsAccountHelper.TRANSACTION_DATE, amount);
                ...
                final Integer undoSavingsTransaction = this.savingsAccountHelper
                                .undoSavingsAccountTransaction(savingsId, depositTransactionId);
                HashMap reversedDepositTransaction = this.savingsAccountHelper.getSavingsTransaction(savingsId,
                                depositTransactionId);
