...
public class LoanReschedulingWithinCenterTest {
  ...
  public void testCenterReschedulingLoansWithInterestRecalculationEnabled() {
    ...
    final Integer loanId =
        applyForLoanApplicationForInterestRecalculation(
            clientId,
            groupId,
            calendarId,
            loanProductID,
    ...
    CalendarHelper.updateMeetingCalendarForCenter(
        this.requestSpec,
        this.responseSpec,
        centerId,
        calendarId.toString(),
    ...
    ArrayList loanRepaymnetSchedule =
        this.loanTransactionHelper.getLoanRepaymentSchedule(
            requestSpec, generalResponseSpec, loanId);
  ...
  private Integer createClient(Integer officeId) {
    ...
    Integer clientId =
        ClientHelper.createClient(
            this.requestSpec, this.responseSpec, clientActivationDate, officeId.toString());
  ...
  private Integer createCalendarMeeting(Integer centerId) {
    ...
    Integer calendarId =
        CalendarHelper.createMeetingForGroup(
            this.requestSpec,
            this.responseSpec,
            centerId,
            startDate,
  ...
  public void testCenterReschedulingMultiTrancheLoansWithInterestRecalculationEnabled() {
    ...
    createTranches.add(
        this.loanApplicationApprovalTest.createTrancheDetail(disbursementDate, "5000"));
    createTranches.add(
        this.loanApplicationApprovalTest.createTrancheDetail(secondDisbursement, "5000"));
  ...
  private Integer createLoanProductWithInterestRecalculation(
      ...
      final String recalculationRestFrequencyDate,
    ...
    return createLoanProductWithInterestRecalculation(
        repaymentStrategy,
  ...
  private Integer createLoanProductWithInterestRecalculation(
      ...
      final String recalculationRestFrequencyInterval,
      final String recalculationRestFrequencyDate,
      final String recalculationCompoundingFrequencyType,
    ...
    LOG.info(
        "------------------------------CREATING NEW LOAN PRODUCT"
            + " ---------------------------------------");
    LoanProductTestBuilder builder =
        new LoanProductTestBuilder()
            ...
            .withInterestRecalculationDetails(
                interestRecalculationCompoundingMethod,
                rescheduleStrategyMethod,
                preCloseInterestCalculationStrategy)
            .withInterestRecalculationRestFrequencyDetails(
                recalculationRestFrequencyType,
                recalculationRestFrequencyInterval,
                recalculationRestFrequencyOnDayType,
                recalculationRestFrequencyDayOfWeekType)
  ...
  @SuppressWarnings("rawtypes")
  private Integer applyForLoanApplicationForInterestRecalculation(
      final Integer clientID,
      Integer groupId,
      Integer calendarId,
      final Integer loanProductID,
      final String disbursementDate,
      final String restStartDate,
      final String repaymentStrategy,
    ...
    return applyForLoanApplicationForInterestRecalculation(
        clientID,
        groupId,
        calendarId,
        loanProductID,
  ...
  private Integer applyForLoanApplicationForInterestRecalculation(
      ...
      final String disbursementDate,
      final String restStartDate,
      final String compoundingStartDate,
      final String repaymentStrategy,
      final List<HashMap> charges,
      final String graceOnInterestPayment,
