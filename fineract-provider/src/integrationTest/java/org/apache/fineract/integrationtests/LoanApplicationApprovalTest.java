...
public class LoanApplicationApprovalTest {
    ...
    public void loanApplicationApprovedAmountGreaterThanProposedAmount() {
        ...
        List<HashMap> error = (List<HashMap>) this.loanTransactionHelper.approveLoan(approveDate, approvalAmount,
    ...
    private void trancheLoansApprovedAmountLesserThanProposedAmount(Integer clientID, Integer loanProductID,
        ...
        final Integer loanID = applyForLoanApplicationWithTranches(clientID, loanProductID, proposedAmount,
                createTranches);
        ...
        LoanStatusChecker.verifyLoanIsWaitingForDisbursal(loanStatusHashMap);
        System.out.println("-------------MULTI DISBURSAL LOAN APPROVED SUCCESSFULLY-----------------");
    ...
    private void trancheLoansApprovalValidation(Integer clientID, Integer loanProductID, List<HashMap> createTranches) {
        ...
        HashMap<String, Object> loanStatusHashMap = LoanStatusChecker.getStatusOfLoan(this.requestSpec,
        ...
        List<HashMap<String, Object>> error = this.loanTransactionHelper.approveLoanForTranches(approveDate,
                expectedDisbursementDate, approvalAmount2, loanID, approveTranche2, CommonConstants.RESPONSE_ERROR);
        ...
        error = this.loanTransactionHelper.approveLoanForTranches(approveDate, expectedDisbursementDate,
                approvalAmount1, loanID, approveTranche1, CommonConstants.RESPONSE_ERROR);
        assertEquals("error.msg.loan.approval.amount.can't.be.greater.than.loan.amount.demanded",
                error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));

        /* No. of tranches exceeds the max tranche count at product level */
        error = this.loanTransactionHelper.approveLoanForTranches(approveDate, expectedDisbursementDate,
                approvalAmount3, loanID, approveTranche3, CommonConstants.RESPONSE_ERROR);
    ...
    public Integer applyForLoanApplicationWithTranches(final Integer clientID, final Integer loanProductID,
            String principal, List<HashMap> tranches) {
