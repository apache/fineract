...
public class EntityDatatableChecksIntegrationTest {
        ...
        public void validateCreateDeleteEntityDatatableCheck() {
                ...
                Integer entityDatatableCheckId = this.entityDatatableChecksHelper
                                .createEntityDatatableCheck(CLIENT_APP_TABLE_NAME, datatableName, 100, null);
                assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

                // deleting entity datatable check
                entityDatatableCheckId = this.entityDatatableChecksHelper
        ...
        public void validateCreateClientWithEntityDatatableCheck() {
                ...
                DatatableHelper.verifyDatatableCreatedOnServer(this.requestSpec, this.responseSpec,
                                registeredTableName);

                // creating new entity datatable check
                Integer entityDatatableCheckId = this.entityDatatableChecksHelper
                                .createEntityDatatableCheck(CLIENT_APP_TABLE_NAME, registeredTableName, 100, null);
                assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

                // creating client with datatables
                final Integer clientID = ClientHelper.createClientPendingWithDatatable(requestSpec, responseSpec,
                                registeredTableName);
                ...
                Integer appTableId = this.datatableHelper.deleteDatatableEntries(registeredTableName, clientID,
                                "clientId");
        ...
        public void validateCreateClientWithEntityDatatableCheckWithFailure() {
                ...
                clientErrorData = (ArrayList<HashMap<Object, Object>>) validationErrorHelper
        ...
        public void validateCreateGroupWithEntityDatatableCheck() {
                ...
                // creating new entity datatable check
                Integer entityDatatableCheckId = this.entityDatatableChecksHelper
                                .createEntityDatatableCheck(GROUP_APP_TABLE_NAME, registeredTableName, 100, null);
                assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

                // creating group with datatables
                final Integer groupId = GroupHelper.createGroupPendingWithDatatable(this.requestSpec, this.responseSpec,
                                registeredTableName);
                ...
                // deleting datatable entries
                Integer appTableId = this.datatableHelper.deleteDatatableEntries(registeredTableName, groupId,
                                "groupId");
        ...
        public void validateCreateGroupWithEntityDatatableCheckWithFailure() {
                ...
                groupErrorData = (ArrayList<HashMap<Object, Object>>) validationErrorHelper
        ...
        public void validateCreateSavingsWithEntityDatatableCheck() {
                ...
                // creating new entity datatable check
                Integer entityDatatableCheckId = this.entityDatatableChecksHelper
                                .createEntityDatatableCheck(SAVINGS_APP_TABLE_NAME, registeredTableName, 100, null);
                assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);
                ...
                final Integer savingsId = this.savingsAccountHelper.applyForSavingsApplicationWithDatatables(clientID,
                                savingsProductID, ACCOUNT_TYPE_INDIVIDUAL, "01 December 2016", registeredTableName);
                ...
                // deleting datatable entries
                Integer appTableId = this.datatableHelper.deleteDatatableEntries(registeredTableName, savingsId,
                                "savingsId");
        ...
        public void validateCreateSavingsWithEntityDatatableCheckWithFailure() {
                ...
                ArrayList<HashMap<Object, Object>> groupErrorData;
                groupErrorData = (ArrayList<HashMap<Object, Object>>) validationErrorHelper
                                .applyForSavingsApplicationWithFailure(clientID, savingsProductID,
                                                ACCOUNT_TYPE_INDIVIDUAL, "01 December 2016",
        ...
        public void validateCreateLoanWithEntityDatatableCheck() {
                ...
                // creating new entity datatable check
                Integer entityDatatableCheckId = this.entityDatatableChecksHelper.createEntityDatatableCheck(
        ...
        public void validateCreateLoanWithEntityDatatableCheckWithFailure() {
                ...
                loanErrorData = (ArrayList<HashMap<Object, Object>>) applyForLoanApplicationWithError(clientID,
        ...
        private Integer applyForLoanApplication(final Integer clientID, final Integer loanProductID,
                        String graceOnPrincipalPayment, final String registeredTableName) {
        ...
        private Object applyForLoanApplicationWithError(final Integer clientID, final Integer loanProductID,
                        String graceOnPrincipalPayment, final String responseAttribute) {
                System.out.println("----------APPLYING FOR LOAN APPLICATION----------");
                final String loanApplicationJSON = new LoanApplicationTestBuilder() //
                                .withPrincipal("10000000.00") //
                                .withLoanTermFrequency("24") //
