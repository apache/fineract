...
public class EntityDatatableChecksIntegrationTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(EntityDatatableChecksIntegrationTest.class);
  ...
  public void setup() {
    ...
    this.entityDatatableChecksHelper =
        new EntityDatatableChecksHelper(this.requestSpec, this.responseSpec);
  ...
  public void validateCreateDeleteEntityDatatableCheck() {
    ...
    DatatableHelper.verifyDatatableCreatedOnServer(
        this.requestSpec, this.responseSpec, datatableName);

    // creating new entity datatable check
    Integer entityDatatableCheckId =
        this.entityDatatableChecksHelper.createEntityDatatableCheck(
            CLIENT_APP_TABLE_NAME, datatableName, 100, null);
    ...
    entityDatatableCheckId =
        this.entityDatatableChecksHelper.deleteEntityDatatableCheck(entityDatatableCheckId);
  ...
  public void validateRetriveEntityDatatableChecksList() {
    ...
    String entityDatatableChecksList =
        this.entityDatatableChecksHelper.retrieveEntityDatatableCheck();
  ...
  public void validateCreateClientWithEntityDatatableCheck() {
    ...
    DatatableHelper.verifyDatatableCreatedOnServer(
        this.requestSpec, this.responseSpec, registeredTableName);

    // creating new entity datatable check
    Integer entityDatatableCheckId =
        this.entityDatatableChecksHelper.createEntityDatatableCheck(
            CLIENT_APP_TABLE_NAME, registeredTableName, 100, null);
    assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

    // creating client with datatables
    final Integer clientID =
        ClientHelper.createClientPendingWithDatatable(
            requestSpec, responseSpec, registeredTableName);
    ...
    Integer appTableId =
        this.datatableHelper.deleteDatatableEntries(registeredTableName, clientID, "clientId");
  ...
  public void validateCreateClientWithEntityDatatableCheckWithFailure() {
    ...
    ArrayList<HashMap<Object, Object>> clientErrorData =
        (ArrayList<HashMap<Object, Object>>)
            validationErrorHelper.createClientPendingWithError(CommonConstants.RESPONSE_ERROR);
    assertEquals(
        "error.msg.entry.required.in.datatable.[" + registeredTableName + "]",
  ...
  public void validateCreateGroupWithEntityDatatableCheck() {
    ...
    Integer entityDatatableCheckId =
        this.entityDatatableChecksHelper.createEntityDatatableCheck(
            GROUP_APP_TABLE_NAME, registeredTableName, 100, null);
    assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

    // creating group with datatables
    final Integer groupId =
        GroupHelper.createGroupPendingWithDatatable(
            this.requestSpec, this.responseSpec, registeredTableName);
    ...
    // deleting datatable entries
    Integer appTableId =
        this.datatableHelper.deleteDatatableEntries(registeredTableName, groupId, "groupId");
  ...
  public void validateCreateGroupWithEntityDatatableCheckWithFailure() {
    ...
    ArrayList<HashMap<Object, Object>> groupErrorData =
        (ArrayList<HashMap<Object, Object>>)
            validationErrorHelper.createGroupWithError(CommonConstants.RESPONSE_ERROR);
    assertEquals(
        "error.msg.entry.required.in.datatable.[" + registeredTableName + "]",
  ...
  public void validateCreateSavingsWithEntityDatatableCheck() {
    ...
    String registeredTableName =
        this.datatableHelper.createDatatable(SAVINGS_APP_TABLE_NAME, false);
    DatatableHelper.verifyDatatableCreatedOnServer(
        this.requestSpec, this.responseSpec, registeredTableName);
    ...
    Integer entityDatatableCheckId =
        this.entityDatatableChecksHelper.createEntityDatatableCheck(
            SAVINGS_APP_TABLE_NAME, registeredTableName, 100, null);
    assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);
    ...
    final Integer savingsId =
        this.savingsAccountHelper.applyForSavingsApplicationWithDatatables(
            clientID,
            savingsProductID,
    ...
    // deleting datatable entries
    Integer appTableId =
        this.datatableHelper.deleteDatatableEntries(registeredTableName, savingsId, "savingsId");
  ...
  public void validateCreateSavingsWithEntityDatatableCheckWithFailure() {
    ...
    ArrayList<HashMap<Object, Object>> groupErrorData =
        (ArrayList<HashMap<Object, Object>>)
            validationErrorHelper.applyForSavingsApplicationWithFailure(
                clientID,
                savingsProductID,
                ACCOUNT_TYPE_INDIVIDUAL,
                "01 December 2016",
  ...
  public void validateCreateLoanWithEntityDatatableCheck() {
    ...
    final Integer loanProductID =
        createLoanProduct("100", "0", LoanProductTestBuilder.DEFAULT_STRATEGY);
    ...
    Integer entityDatatableCheckId =
        this.entityDatatableChecksHelper.createEntityDatatableCheck(
            LOAN_APP_TABLE_NAME, registeredTableName, 100, loanProductID);
    assertNotNull("ERROR IN CREATING THE ENTITY DATATABLE CHECK", entityDatatableCheckId);

    // creating new loan application
    final Integer loanID =
        applyForLoanApplication(clientID, loanProductID, "5", registeredTableName);
    ...
    // deleting datatable entries
    Integer appTableId =
        this.datatableHelper.deleteDatatableEntries(registeredTableName, loanID, "loanId");
  ...
  public void validateCreateLoanWithEntityDatatableCheckWithFailure() {
    ...
    ArrayList<HashMap<Object, Object>> loanErrorData =
        (ArrayList<HashMap<Object, Object>>)
            applyForLoanApplicationWithError(
                clientID, loanProductID, "5", CommonConstants.RESPONSE_ERROR);
    assertEquals(
        "error.msg.entry.required.in.datatable.[" + registeredTableName + "]",
  ...
  private Integer createLoanProduct(
      final String inMultiplesOf, final String digitsAfterDecimal, final String repaymentStrategy) {
    LOG.info(
  ...
  private Integer applyForLoanApplication(
      final Integer clientID,
      final Integer loanProductID,
    ...
    final String loanApplicationJSON =
        new LoanApplicationTestBuilder() //
            ...
            .withExpectedDisbursementDate("2 June 2014") //
  ...
  private Object applyForLoanApplicationWithError(
      final Integer clientID,
      final Integer loanProductID,
      String graceOnPrincipalPayment,
