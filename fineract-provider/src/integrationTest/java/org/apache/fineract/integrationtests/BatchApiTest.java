...
public class BatchApiTest {
  ...
  public void shouldReturnStatusNotImplementedUnknownCommand() {
    ...
    final List<BatchResponse> response =
        BatchHelper.postWithSingleRequest(this.requestSpec, this.responseSpec, br);
  ...
  public void shouldRollBackAllTransactionsOnFailure() {
    ...
    final List<BatchResponse> response =
        BatchHelper.postBatchRequestsWithEnclosingTransaction(
            this.requestSpec, this.responseSpec, jsonifiedRequest);
    ...
    Assert.assertEquals(
        "Verify Status code 400", (long) 400, (long) response.get(0).getStatusCode());
  }
  ...
  public void shouldReflectChangesOnClientUpdate() {
    ...
    Assert.assertEquals(
        "Verify Firstname", "TestFirstName", changes.get("firstname").getAsString());
  ...
  public void shouldReturnOkStatusForApplyLoanCommand() {
    ...
    final JsonElement clientId =
        new FromJsonHelper().parse(response.get(0).getBody()).getAsJsonObject().get("clientId");
  ...
  public void shouldReturnOkStatusForApplySavingsCommand() {
    ...
    final String savingsProductJSON =
        savingsProductHelper //
            ...
            .withMinimumOpenningBalance("5000")
            .build();
  ...
  public void shouldReturnOkStatusForCollectChargesCommand() {
    ...
    Assert.assertEquals(
        "Verify Status Code 200 for Create Loan Charge",
        200L,
  ...
  public void shouldReturnOkStatusForBatchRepayment() {
    ...
    Assert.assertEquals(
        "Verify Status Code 200 for Repayment", 200L, (long) response.get(5).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for Repayment", 200L, (long) response.get(6).getStatusCode());
  }
  ...
  public void shouldReturnOkStatusOnSuccessfulClientActivation() {
    ...
    Assert.assertEquals(
        "Verify Status Code 200 for Create Client", 200L, (long) response.get(0).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for Activate Client", 200L, (long) response.get(1).getStatusCode());
  }
  ...
  public void shouldReturnOkStatusOnSuccessfulLoanApprovalAndDisburse() {
    ...
    Assert.assertEquals(
        "Verify Status Code 200 for Approve Loan", 200L, (long) response.get(3).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for Disburse Loan", 200L, (long) response.get(4).getStatusCode());
  }
  ...
  public void shouldReturnOkStatusOnSuccessfulLoanApprovalAndDisburseWithTransaction() {
    ...
    Assert.assertEquals(
        "Verify Status Code 200 for create client", 200L, (long) response.get(0).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for apply Loan", 200L, (long) response.get(1).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for approve Loan", 200L, (long) response.get(2).getStatusCode());
    Assert.assertEquals(
        "Verify Status Code 200 for disburse Loan", 200L, (long) response.get(3).getStatusCode());
  }
}
