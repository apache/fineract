...
public class CenterDomain implements Comparable<CenterDomain> {
  ...
  public static class Builder {
    ...
    public CenterDomain build() {
      return new CenterDomain(
          this.id,
          this.accountNo,
          (int) this.status.get("id"),
          (String) this.status.get("code"),
          (String) this.status.get("value"),
          this.active,
          this.name,
          this.externalId,
          this.staffId,
  ...
  public static String jsonRequestToCreateCenter(
      Integer id,
      Integer statusId,
      String statusCode,
      String statusValue,
    ...
    if (active) {
      ...
      if (submittedDate == null) map.put("submittedOnDate", DateUtils.getDateOfTenant());
      else map.put("submittedOnDate", submittedDate);
    }
