...
public abstract class AbstractApiException extends RuntimeException {
    ...
    protected AbstractApiException(String globalisationMessageCode, String defaultUserMessage) {
    ...
    protected AbstractApiException(String globalisationMessageCode, String defaultUserMessage, Throwable cause) {
    ...
    protected AbstractApiException(String globalisationMessageCode, String defaultUserMessage, Object[] defaultUserMessageArgs) {
        super(defaultUserMessage, findThrowableCause(defaultUserMessageArgs));
        this.globalisationMessageCode = globalisationMessageCode;
        this.defaultUserMessage = defaultUserMessage;
        this.defaultUserMessageArgs = AbstractApiException.filterThrowableCause(defaultUserMessageArgs);
    }
