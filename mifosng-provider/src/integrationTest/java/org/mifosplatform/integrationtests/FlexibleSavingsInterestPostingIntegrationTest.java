...
public class FlexibleSavingsInterestPostingIntegrationTest {
    ...
    public void testSavingsInterestPostingAtPeriodEnd() {
        ...
        ArrayList<HashMap<String, Object>> transactions = (ArrayList<HashMap<String, Object>>)
        		accountDetails.get("transactions");
        HashMap<String, Object> interestPostingTransaction = transactions.get(0);
        ...
        assertEquals("Equality check for interest posted amount",
        		"33.7016", interestPostingTransaction.get("amount").toString());
        assertEquals("Date check for Interest Posting transaction",
        		"[2014, 3, 31]", interestPostingTransaction.get("date").toString());
    ...
    private Integer createSavingsAccount(final Integer clientID, final String startDate) {
        ...
        final Integer savingsId = this.savingsAccountHelper.applyForSavingsApplicationOnDate(clientID,
        		savingsProductID, ACCOUNT_TYPE_INDIVIDUAL, startDate);
	...
	private void configureInterestPosting(final Boolean periodEndEnable,
    ...
    private Integer createSavingsProduct() {
        final String savingsProductJSON = this.savingsProductHelper
                .withInterestCompoundingPeriodTypeAsDaily()
                .withInterestPostingPeriodTypeAsAnnual()
