...
public class ClientSavingsIntegrationTest {
    ...
    public void testSavingsAccountCharges() {
        ...
        ArrayList<HashMap> chargesPendingState = this.savingsAccountHelper.getSavingsChanrges(savingsId);
        ...
        chargesPendingState = this.savingsAccountHelper.getSavingsChanrges(savingsId);
        ...
        ArrayList<HashMap> charges = this.savingsAccountHelper.getSavingsChanrges(savingsId);
        Assert.assertTrue(charges == null || charges.size() == 0);

        this.savingsAccountHelper.addChargesForSavings(savingsId, chargeId);
        charges = this.savingsAccountHelper.getSavingsChanrges(savingsId);
