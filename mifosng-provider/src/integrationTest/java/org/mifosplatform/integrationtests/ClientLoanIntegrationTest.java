...
public class ClientLoanIntegrationTest {
    ...
    private Integer applyForLoanApplicationWithPaymentStrategyAndPastMonth(final Integer clientID, final Integer loanProductID, List<HashMap> charges,
            final String savingsId, String principal, final String repaymentStrategy, final int month) {
        System.out.println("--------------------------------APPLYING FOR LOAN APPLICATION--------------------------------");
    ...
    public void testLoanRefundByCashCashBasedAccounting() {
        ...
        final Integer loanProductID = createLoanProduct("0", "0", LoanProductTestBuilder.MIFOS_STANDARD_STRATEGY, CASH_BASED,
        ...
        final Integer loanID = applyForLoanApplicationWithPaymentStrategyAndPastMonth(clientID, loanProductID, charges, savingsId, principal,
        ...
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, twoMonthsfromNow,
                new JournalEntry(Float.valueOf("2290"), JournalEntry.TransactionType.DEBIT), new JournalEntry(Float.valueOf("2000"),
                        JournalEntry.TransactionType.CREDIT));
        ...
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, oneMonthfromNow,
                new JournalEntry(Float.valueOf("4580"), JournalEntry.TransactionType.DEBIT), new JournalEntry(Float.valueOf("4000"),
                        JournalEntry.TransactionType.CREDIT));
        ...
        //refund 20 means paid: principal 1980, interest 240, fees 50, penalty 0
        ...
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, now,
                new JournalEntry(Float.valueOf("20"), JournalEntry.TransactionType.CREDIT), new JournalEntry(Float.valueOf("20"),
                        JournalEntry.TransactionType.DEBIT));
        ...
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, now,
                new JournalEntry(Float.valueOf("2000"), JournalEntry.TransactionType.CREDIT), new JournalEntry(Float.valueOf("1980"),
                        JournalEntry.TransactionType.DEBIT));
    ...
    public void testLoanRefundByCashAccrualBasedAccounting() {
        ...
        final Integer loanProductID = createLoanProduct("0", "0", LoanProductTestBuilder.MIFOS_STANDARD_STRATEGY, ACCRUAL_UPFRONT,
                        assetAccount, incomeAccount, expenseAccount, overpaymentAccount);//, LoanProductTestBuilder.EQUAL_INSTALLMENTS,
        ...
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, twoMonthsfromNow,
                ...
                new JournalEntry(Float.valueOf("50"), JournalEntry.TransactionType.CREDIT),new JournalEntry(Float.valueOf("240"),
