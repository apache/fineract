...
public class AccountNumberPreferencesTest {
	...
	private void deleteAllAccountNumberPreferences() {
		...
		for (HashMap<String,Object> preferenceId : preferenceIds) {
			...
			HashMap<String,Object> delResponse= (HashMap<String,Object>) this.accountNumberPreferencesHelper.deleteAccountNumberPreference(id, this.responseSpec,"");
		...
		HashMap<String,Object> deletionError = (HashMap<String,Object>) this.accountNumberPreferencesHelper
	...
	private void createAccountNumberPreference() {
		...
		this.accountNumberPreferencesHelper.verifyCreationOfAccountNumberPreferences(
	...
	private void createAccountNumberPreferenceDuplicateData(final String accountType,final String prefixType){
		...
		HashMap<String, Object> creationError = (HashMap<String, Object>) this.accountNumberPreferencesHelper
				.createAccountNumberPreferenceWithInvalidData(this.responseForbiddenError, accountType, prefixType,"");
		
		Assert.assertEquals("error.msg.account.number.format.duplicate.account.type",creationError.get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
	...
	private void createAccountNumberPreferenceInvalidData(final String accountType,final String prefixType){
		...
		if (creationError
			...
			Assert.assertEquals("validation.msg.accountNumberFormat.accountType.is.not.within.expected.range",creationError.get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
		} 
		else if (creationError
				.get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE)
				.equals("validation.msg.accountNumberFormat.prefixType.is.not.one.of.expected.enumerations")) {
			Assert.assertEquals("validation.msg.accountNumberFormat.prefixType.is.not.one.of.expected.enumerations",creationError.get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
		}
	}
		
	private void updateAccountNumberPreference() {
		HashMap<String,Object> accountNumberPreferences = (HashMap<String,Object>) this.accountNumberPreferencesHelper
				.updateAccountNumberPreference(this.clientAccountNumberPreferenceId, "101",this.responseSpec, "");
		
		System.out
				.println("--------------------------UPDATION SUCCESSFUL FOR ACCOUNT NUMBER PREFERENCE ID "+ (Integer)accountNumberPreferences.get("resourceId"));
		...
		HashMap<String,Object> updationError = (HashMap<String,Object>) this.accountNumberPreferencesHelper
														.updateAccountNumberPreference(5, "101", this.responseNotFoundError,"");
		if(updationError
				.get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE)
		...
		/* Invalid Prefix Type */
		HashMap<String,Object> updationError1 = (HashMap<String,Object>) this.accountNumberPreferencesHelper
	...
	private void createAndValidateClientBasedOnAccountPreference() {
		...
		if (clientPrefixName.equals(this.clientTypeName)) {
			...
			HashMap<String,Object> code = (HashMap<String,Object>)CodeHelper.getCodeByName(this.requestSpec, this.responseSpec, codeName, "");
			this.clientTypeCodeId = (Integer)code.get("id");
			
			/* Retrieve/Create Code Values for the Code "ClientType" */			
			HashMap<String,Object> codeValue = (HashMap<String,Object>) CodeHelper.retrieveOrCreateCodeValue(this.clientTypeCodeId,this.requestSpec,this.responseSpec,"");
			...
			this.clientId = ClientHelper
						.createClientForAccountPreference(this.requestSpec,this.responseSpec, this.clientCodeValueId,"clientId");
	...
	private void createAndValidateLoanEntity(Boolean isAccountPreferenceSetUp) {
		...
		String loanAccountNo = (String) this.loanTransactionHelper.getLoanDetail(this.requestSpec, this.responseSpec, this.loanId, "accountNo");
		...
		if (isAccountPreferenceSetUp) {
			...
			if (loanPrefixName.equals(this.officeName)) {
				...
				String loanShortName = (String) this.loanTransactionHelper
												.getLoanProductDetail(this.requestSpec,this.responseSpec, this.loanProductId,"shortName");
