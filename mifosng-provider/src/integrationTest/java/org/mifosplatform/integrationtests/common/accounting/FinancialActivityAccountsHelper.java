...
public class FinancialActivityAccountsHelper {

    private static final String ACCOUNT_MAPPING_URL = "/mifosng-provider/api/v1/financialactivityaccounts";
    private final RequestSpecification requestSpec;
    private final ResponseSpecification responseSpec;

    public FinancialActivityAccountsHelper(final RequestSpecification requestSpec, final ResponseSpecification responseSpec) {
        this.requestSpec = requestSpec;
        this.responseSpec = responseSpec;
    }

    public Object createFinancialactivityaccounts(Integer officeId, Integer glAccountId, String jsonBack) {
    ...
    public Object updateFinancialactivityaccounts(Integer mappingId, Integer officeId, Integer glAccountId, String jsonBack) {
        String json = OfficeAccountMappingBuilder.build(officeId, glAccountId);
    ...
    public HashMap getFinancialactivityaccount(final Integer mappingId) {
