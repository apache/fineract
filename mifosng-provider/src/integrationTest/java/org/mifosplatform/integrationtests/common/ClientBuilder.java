...
public class ClientBuilder {
    ...
    public static String getTestClientAsJSON(String dateOfJoining) {
        ...
        map.put("officeId", "1");
        map.put("firstname", ClientBuilder.randomNameGenerator("Client_FirstName_", 5));
        map.put("lastname", ClientBuilder.randomNameGenerator("Client_LastName_", 4));
        map.put("externalId", ClientBuilder.randomIDGenerator("ID_", 7));
