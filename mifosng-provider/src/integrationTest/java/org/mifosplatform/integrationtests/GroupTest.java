...
public class GroupTest {
    ...
    private String accountingRule = "1";
...
//        GroupHelper.verifyGroupDeleted(this.requestSpec, this.responseSpec, groupID);
    ...
    public void assignStaffToGroup(){
        ...
        HashMap assignStaffGroupId = (HashMap)GroupHelper.assignStaff(this.requestSpec,this.responseSpec,groupID.toString(),createStaffId1.longValue());
        ...
        final HashMap assignStaffToClientChanges = (HashMap)ClientHelper.assignStaffToClient(this.requestSpec,this.responseSpec,clientID.toString(),createStaffId2.toString());
        ...
        final HashMap assignStaffAndInheritStaffForClientAccounts = (HashMap)GroupHelper.assignStaffInheritStaffForClientAccounts(this.requestSpec,this.responseSpec,groupID.toString(),createStaffId1.toString());
        final Integer getClientStaffId  = ClientHelper.getClient(this.requestSpec,this.responseSpec,clientID.toString());

        //assert if client staff officer has change Note client was assigned staff with  createStaffId2
        ...
        assertEquals("Verify if client inherited staff assigned above", assignStaffAndInheritStaffForClientAccounts.get("staffId"), getClientStaffId);
    ...
    private Integer createLoanProduct() {
        final String loanProductJSON = new LoanProductTestBuilder()
                ...
                .withNumberOfRepayments(this.numberOfRepayments)
                .withinterestRatePerPeriod(this.interestRatePerPeriod)
