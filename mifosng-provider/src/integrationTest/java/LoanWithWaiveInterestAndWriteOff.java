...
import org.mifosplatform.integrationtests.testbuilder.LoanStatusChecker;
...
public class LoanWithWaiveInterestAndWriteOff {
    ...
    public void checkClientLoanCreateAndDisburseFlow(){
        //CREATE CLIENT
        Integer clientID = createClient(DATE_OF_JOINING);
        ...
        LoanStatusChecker.verifyLoanStatusIsPending(loanStatusHashMap);

        //APPROVE LOAN
        loanStatusHashMap = approveLoan("28 September 2010", loanID);
        LoanStatusChecker.verifyLoanIsApproved(loanStatusHashMap);
        LoanStatusChecker.verifyLoanStatusIsWaitingForDisbursal(loanStatusHashMap);
        ...
        LoanStatusChecker.verifyLoanStatusIsActive(loanStatusHashMap);
    ...
    private Integer createClient(String dateOfJoining) {
        System.out.println("---------------------------------CREATING A CLIENT---------------------------------------------");
        String json = given().spec(requestSpec).body(Utils.getTestClientAsJSON(dateOfJoining))
                .expect().spec(responseSpec).log().ifError()
