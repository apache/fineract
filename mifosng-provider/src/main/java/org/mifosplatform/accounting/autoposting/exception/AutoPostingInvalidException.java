 ...
 */
public class AutoPostingInvalidException extends AbstractPlatformDomainRuleException {
    ...
    public AutoPostingInvalidException(final GL_CLOSURE_INVALID_REASON reason, final Date date) {
