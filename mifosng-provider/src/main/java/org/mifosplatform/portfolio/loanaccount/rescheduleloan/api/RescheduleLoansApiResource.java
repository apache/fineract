...
public class RescheduleLoansApiResource {
	...
	public RescheduleLoansApiResource(
			final DefaultToApiJsonSerializer<LoanRescheduleRequestData> loanRescheduleRequestToApiJsonSerializer, 
	...
	@Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
	public String updateLoanRescheduleRequest(@PathParam("requestId") final Long requestId, 
		...
		if(compareIgnoreCase(command, "approve")) {
			commandWrapper = new CommandWrapperBuilder()
				.approveLoanRescheduleRequest(RescheduleLoansApiConstants.ENTITY_NAME, requestId)
				.withJson(apiRequestBodyAsJson)
				.build();
		}
			...
			commandWrapper = new CommandWrapperBuilder()
				.rejectLoanRescheduleRequest(RescheduleLoansApiConstants.ENTITY_NAME, requestId)
				.withJson(apiRequestBodyAsJson)
				.build();
		}
