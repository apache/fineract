...
public class PeriodicInterestRateCalculator {
    ...
    public BigDecimal calculateFrom(final LoanProductRelatedDetail loanScheduleInfo) {
        ...
        Integer paymentPeriodsInOneYear = this.paymentPeriodsInOneYearCalculator.calculate(loanScheduleInfo
    ...
    public Money calculateInterestOn(final Money outstandingBalance, final BigDecimal periodInterestRateForRepaymentPeriod,
            final int daysInPeriod, final LoanProductRelatedDetail loanScheduleInfo) {
        ...
        switch (loanScheduleInfo.getInterestCalculationPeriodMethod()) {
            case DAILY:
                BigDecimal dailyInterestRate = loanScheduleInfo.getAnnualNominalInterestRate()
                        .divide(BigDecimal.valueOf(Long.valueOf(365)), mc).divide(BigDecimal.valueOf(Double.valueOf("100.0")), mc)
    ...
    public Money calculatePrincipalOn(final Money totalDuePerInstallment, final Money interestForInstallment,
