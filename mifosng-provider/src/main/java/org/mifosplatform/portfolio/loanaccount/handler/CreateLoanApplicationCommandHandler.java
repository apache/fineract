...
@Service
public class CreateLoanApplicationCommandHandler implements NewCommandSourceHandler {

    private final LoanWritePlatformService writePlatformService;

    @Autowired
    public CreateLoanApplicationCommandHandler(final LoanWritePlatformService writePlatformService) {
