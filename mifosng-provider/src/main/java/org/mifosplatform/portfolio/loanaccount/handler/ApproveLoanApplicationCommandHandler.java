...
@Service
public class ApproveLoanApplicationCommandHandler implements NewCommandSourceHandler {

    private final LoanWritePlatformService writePlatformService;

    @Autowired
    public ApproveLoanApplicationCommandHandler(final LoanWritePlatformService writePlatformService) {
