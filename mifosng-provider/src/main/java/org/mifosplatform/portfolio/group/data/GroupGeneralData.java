...
public class GroupGeneralData {
    ...
    public static GroupGeneralData lookup(final Long groupId, final String groupName) {
        ...
        return new GroupGeneralData(groupId, groupName, null, null, null, null, null, null, null, null, clientMembers, null, null, null,
                null);
    }
    ...
    public static GroupGeneralData template(final Long officeId, final Long centerId, final String centerName, final Long staffId,
        ...
        return new GroupGeneralData(null, null, null, officeId, null, centerId, centerName, staffId, staffName, null, clientMembers,
                centerOptions, officeOptions, staffOptions, clientOptions);
    }

    public static GroupGeneralData withTemplate(final GroupGeneralData templatedGrouping, final GroupGeneralData grouping) {
        return new GroupGeneralData(grouping.id, grouping.name, grouping.externalId, grouping.officeId, grouping.officeName,
                grouping.centerId, grouping.centerName, grouping.staffId, grouping.staffName, grouping.hierarchy, grouping.clientMembers,
    ...
    public static GroupGeneralData withTemplateAndAssociations(final GroupGeneralData templatedGrouping, final GroupGeneralData grouping,
        ...
        return new GroupGeneralData(grouping.id, grouping.name, grouping.externalId, grouping.officeId, grouping.officeName,
                grouping.centerId, grouping.centerName, grouping.staffId, grouping.staffName, grouping.hierarchy, membersOfGroup,
                templatedGrouping.centerOptions, templatedGrouping.officeOptions, templatedGrouping.staffOptions,
                templatedGrouping.clientOptions);
    }
    ...
    public static GroupGeneralData withAssocations(final GroupGeneralData grouping, final Collection<ClientData> membersOfGroup) {
        return new GroupGeneralData(grouping.id, grouping.name, grouping.externalId, grouping.officeId, grouping.officeName,
                grouping.centerId, grouping.centerName, grouping.staffId, grouping.staffName, grouping.hierarchy, membersOfGroup,
                grouping.centerOptions, grouping.officeOptions, grouping.staffOptions, grouping.clientOptions);
    }
