...
public class LoanChargeCannotBeWaivedException extends AbstractPlatformDomainRuleException {
    ...
    public static enum LOAN_CHARGE_CANNOT_BE_WAIVED_REASON {
        ALREADY_PAID, ALREADY_WAIVED, LOAN_INACTIVE;
        ...
        public String errorMessage() {
            ...
            } else if (name().toString().equalsIgnoreCase("LOAN_INACTIVE")) { return "This loan charge can be waived as the loan associated with it is currently inactive"; }
        ...
        public String errorCode() {
            ...
            } else if (name().toString().equalsIgnoreCase("LOAN_INACTIVE")) { return "error.msg.loan.charge.associated.loan.inactive"; }
            return name().toString();
        }
    }
