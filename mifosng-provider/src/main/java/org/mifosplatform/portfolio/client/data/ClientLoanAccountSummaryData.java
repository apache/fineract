...
public class ClientLoanAccountSummaryData {
    ...
    public ClientLoanAccountSummaryData(final Long id, final String accountNo, final String externalId, final Long productId,
