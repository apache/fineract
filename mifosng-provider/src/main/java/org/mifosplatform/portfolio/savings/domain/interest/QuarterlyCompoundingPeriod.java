...
public class QuarterlyCompoundingPeriod implements CompoundingPeriod {
    ...
    public static QuarterlyCompoundingPeriod create(final LocalDateInterval periodInterval, final List<EndOfDayBalance> allEndOfDayBalances, final LocalDate upToInterestCalculationDate) {
