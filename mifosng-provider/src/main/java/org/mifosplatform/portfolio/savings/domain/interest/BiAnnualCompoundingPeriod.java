...
public class BiAnnualCompoundingPeriod implements CompoundingPeriod {
    ...
    public static BiAnnualCompoundingPeriod create(final LocalDateInterval periodInterval, final List<EndOfDayBalance> allEndOfDayBalances, final LocalDate upToInterestCalculationDate) {
