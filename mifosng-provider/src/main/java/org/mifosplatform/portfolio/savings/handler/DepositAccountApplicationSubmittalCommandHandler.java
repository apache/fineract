...
@Service
public class DepositAccountApplicationSubmittalCommandHandler implements NewCommandSourceHandler {

    private final DepositApplicationProcessWritePlatformService depositAccountWritePlatformService;

    @Autowired
    public DepositAccountApplicationSubmittalCommandHandler(
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.depositAccountWritePlatformService.submitApplication(command, command.depositAccounttype());
    }
}