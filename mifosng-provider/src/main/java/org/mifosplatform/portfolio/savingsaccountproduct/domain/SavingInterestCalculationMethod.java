...
public enum SavingInterestCalculationMethod {
	...
	AVERAGEBAL(1,"savinginterest.calculation.method.averagebal"),
	MINBAL(2,"savinginterest.calculation.method.minbal"),
	MONTHLYCOLLECTION(3,"savinginterest.calculation.method.monthlycllection"),
	INVALID(0,"savinginterest.calculation.method.invalid");
