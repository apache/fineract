...
@Service
public class UpdateOneToOneDatatableEntryCommandHandler implements
	...
	public EntityIdentifier processCommand(final JsonCommand command) {
		...
		this.writePlatformService.updateDatatableEntryOneToOne(command.entityName(), command.resourceId(), command);
