...
public class AuditReadPlatformServiceImpl implements AuditReadPlatformService {
    ...
    public AuditSearchData retrieveSearchTemplate() {
        ...
        List<String> apiOperations = this.jdbcTemplate.query(mapper.schema(), mapper, new Object[] {});

        ApiResourcesMapper mapper2 = new ApiResourcesMapper();
        List<String> resources = this.jdbcTemplate.query(mapper2.schema(), mapper2, new Object[] {});
