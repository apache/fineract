...
/**
 * An {@link ExceptionMapper} to map {@link NoAuthorizationException} thrown by platform into a HTTP API friendly format.
 * 
 * The {@link NoAuthorizationException} is thrown on platform when an attempt is made to use functionality 
