...
public class PortfolioApiDataConversionServiceImpl implements PortfolioApiDataConversionService {
    ...
    @Override
    public ClientIdentifierCommand convertJsonToClientIdentifierCommand(Long resourceIdentifier, Long clientId, String json) {
        if (StringUtils.isBlank(json)) { throw new InvalidJsonException(); }
        ...
        return new ClientIdentifierCommand(modifiedParameters, resourceIdentifier, clientId, documentTypeId, documentKey,
                documentDescription);
    }
