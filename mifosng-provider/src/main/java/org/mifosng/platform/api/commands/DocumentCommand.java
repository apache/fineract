...
public class DocumentCommand {
	...
	public DocumentCommand(final Set<String> modifiedParameters, final Long id,
			final String parentEntityType, final Long parentEntityId,
			final String name, final String fileName, Long size, String type,
			final String description, String location) {
