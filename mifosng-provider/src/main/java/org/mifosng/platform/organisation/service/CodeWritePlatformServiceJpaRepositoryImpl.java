...
import org.mifosng.platform.fund.service.FundWritePlatformServiceJpaRepositoryImpl;
...
public class CodeWritePlatformServiceJpaRepositoryImpl implements CodeWritePlatformService {
	...
	private void handleCodeDataIntegrityIssues(final CodeCommand command, DataIntegrityViolationException dve)  {
