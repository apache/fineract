...
public class ClientTest extends IntegrationTest {
    ...
    Long create() {
        ...
        // TODO why dateFormat and locale required even when no activationDate?! https://issues.apache.org/jira/browse/FINERACT-1233
        return (long) ok(fineract().clients.create5(new
                PostClientsRequest().officeId(1).fullname("TestClient").dateFormat(dateFormat()).locale("en_US"))).getClientId();
    }
